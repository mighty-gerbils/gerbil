...
The source code for all the examples is available at [src/tutorial/lang](https://git.cons.io/mighty-gerbils/gerbil/tree/master/src/tutorial/lang).
You can build the tutorial code using the [build script](https://git.cons.io/mighty-gerbils/gerbil/tree/master/src/tutorial/lang/build.ss):
...
The [dot-app](https://git.cons.io/mighty-gerbils/gerbil/tree/master/src/tutorial/lang/dot-app.ss) prelude accomplishes this by redefining
...
For a contrived example, consider the code in [example/my-app.ss](https://git.cons.io/mighty-gerbils/gerbil/tree/master/src/tutorial/lang/example/my-app.ss):
...
The [auto-export](https://git.cons.io/mighty-gerbils/gerbil/tree/master/src/tutorial/lang/auto-export.ss) prelude accomplishes this by
...
The [example](https://git.cons.io/mighty-gerbils/gerbil/tree/master/src/tutorial/lang/example/my-auto-export.ss) is a module
...
The [sexp](https://git.cons.io/mighty-gerbils/gerbil/tree/master/src/tutorial/lang/sexp.ss) prelude is a minimal module with a custom
reader:
```scheme
(import :gerbil/core) ;; so that we can re-export
(export (import: :gerbil/core)
...
The [example](https://git.cons.io/mighty-gerbils/gerbil/tree/master/src/tutorial/lang/example/my-sexp.ss) demonstrates just that:
```
...
library, as part of the [:std/parser](https://git.cons.io/mighty-gerbils/gerbil/tree/master/src/std/parser) package.
...
There is some scuby code in the [example module](https://git.cons.io/mighty-gerbils/gerbil/tree/master/src/tutorial/lang/example/my-scuby.ss).
...
So let's take a look at the [grammar](https://git.cons.io/mighty-gerbils/gerbil/tree/master/src/tutorial/lang/scuby-grammar.ss).
...
The [scuby](https://git.cons.io/mighty-gerbils/gerbil/tree/master/src/tutorial/lang/scuby.ss) prelude defines a custom module reader
...
And putting it all together, we can import our small corpus of [scuby code](https://git.cons.io/mighty-gerbils/gerbil/tree/master/src/tutorial/lang/example/my-scuby.ss):
```
$ gerbil env gxi
