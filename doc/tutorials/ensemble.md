...
[src/tutorial/ensemble](https://git.cons.io/mighty-gerbils/gerbil/tree/master/src/tutorial/ensemble).
You can build it using the [build script](https://git.cons.io/mighty-gerbils/gerbil/tree/master/src/tutorial/ensemble/build.ss):
```
...
First let's look at the server implementation in [src/tutorial/ensemble/server.ss](https://git.cons.io/mighty-gerbils/gerbil/tree/master/src/tutorial/ensemble/server.ss):
```scheme
...
This is the code for the wrapper (see [src/tutorial/ensemble/httpd-svc.ss](https://git.cons.io/mighty-gerbils/gerbil/tree/master/src/tutorial/ensemble/httpd-svc.ss)):
```scheme
(import ./server)
(export main)
...
the code with the handlers lives in [src/tutorial/ensemble/handler.ss](https://git.cons.io/mighty-gerbils/gerbil/tree/master/src/tutorial/ensemble/handler.ss):
```scheme
...
Here is an example binary executable running our httpd; the code is at [src/tutorial/ensemble/httpd-exe.ss](https://git.cons.io/mighty-gerbils/gerbil/tree/master/src/tutorial/ensemble/httpd-exe.ss):
```scheme
(import :std/actor
        ./server)
(export main)
...
[Makefile](https://git.cons.io/mighty-gerbils/gerbil/tree/master/src/tutorial/ensemble/Makefile)
...
This gives us the [`httpd-prod-exe`](https://git.cons.io/mighty-gerbils/gerbil/tree/master/src/tutorial/ensemble/httpd-prod-exe.ss) and [`registry-prod-exe`](https://git.cons.io/mighty-gerbils/gerbil/tree/master/src/tutorial/ensemble/registry-prod-exe.ss) binaries in `.gerbil`.
