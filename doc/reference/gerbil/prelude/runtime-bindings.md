...
### Runtime Bindings
The `:gerbil/core/runtime` module defines all runtime bindings for the system.
It is organized in submodules that collect all the relevant bindings by source

#### R5RSRuntime
Procedures defined in the R5RS standard.
...
#### R7RSRuntime
Additional procedures defined in the R7RS standard
```scheme
(extern namespace: #f
...
#### GambitRuntime
Procedures provided by the Gambit runtime.
```scheme
(extern namespace: #f
    ;; source: gambit.sld
...
#### GerbilRuntime
Procedures and objects provided by the Gerbil runtime.
```scheme
(extern namespace: #f
...
### Expander Bindings
The `:gerbil/core/expander` module defines the public symbols from the expander,
available at `phi=+1`.
