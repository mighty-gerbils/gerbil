...
the only one that implements C3 (and C4) in O(dn) instead of O(d²n²) as in the original
...
(Object system for Common lisp, introduces multimethods. Has local precedence order.)
