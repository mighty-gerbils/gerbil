...
Check the [PR queue](https://git.cons.io/mighty-gerbils/gerbil/pulls) and the
[Open Issues](https://git.cons.io/mighty-gerbils/gerbil/issues) for any release blocker.
...
- Include a high-level summary of changes in the
  [CHANGELOG.md](https://git.cons.io/mighty-gerbils/gerbil/blob/master/CHANGELOG.md)
...
- Create a release announcement on
  [GitHub discussions](https://git.cons.io/mighty-gerbils/gerbil/discussions),
  with a `release` label, a one-paragraph blurb introduction,
  and the contents of the CHANGELOG.md entry above.
  See e.g. [this previous announcement](https://git.cons.io/mighty-gerbils/gerbil/discussions/1009)
- Create [a release on GitHub](https://git.cons.io/mighty-gerbils/gerbil/releases).
  ...
  See e.g. [this previous release](https://git.cons.io/mighty-gerbils/gerbil/releases/tag/v0.18).
...
- Assets are auto-published to the artifacts page on Github
  [release page](https://git.cons.io/mighty-gerbils/gerbil/releases/)
