...
If you want to find more about Gerbil FFI programming, the std lib sources for the [os package](https://git.cons.io/mighty-gerbils/gerbil/tree/master/src/std/os) are a good starting point.
