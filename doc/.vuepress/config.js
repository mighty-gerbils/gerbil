          ...
          '/stdlib/': [
            {
              ...
              children:  ['', 'sugar', 'getopt', 'format', 'sort', 'regexp', 'generic', 'iterators', 'coroutine', 'events', 'actor', 'db', 'requests', 'httpd', 'web', 'xml', 'sockets', 'os', 'crypto',  'debug', 'errors', 'logger', 'misc', 'text', 'net', 'parser', 'lazy', 'stxparam', 'srfi', 'test', 'make']
            }
          ]
        },
