        ...
        sidebar: {
            ...
            '/tutorials/': [
                ...
                { title: 'Reference',
                  children: [
                      '',
                      { title: 'Gerbil Core Language',
                        path: '/reference/gerbil/',
                        children: [
                            '',
                            'program',
                            'object',
                            ...
                            'interface',
                            'contract',
                            { title: "The Gerbil Core Prelude",
                              path: "/reference/gerbil/core/",
	                          children: [
                                  '',
                              ],
	                        },
	                        { title: "The Gerbil Runtime",
                              path: "/reference/gerbil/runtime/",
	                          children:
	                          [
		                          '',
	                          ]
	                        },
                            {title: "The Gerbil Expander",
                             path: "/reference/gerbil/expander/",
	                         children: [
                                 '',
                                 ]
	                        },
                            {title: "The Gerbil Compiler",
                             path: "/reference/gerbil/compiler/",
	                         children: [
                                 '',
                                 ]
	                        }
