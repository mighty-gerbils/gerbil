...
(def (print-usage! program-name)
  (displayln "Usage: " program-name " arguments ...")
  (displayln)
  (displayln "Arguments: ")
  ...
  (displayln "  interactive                      the gerbil interpreter")
  (displayln "  compile                          the gerbil compiler")
  (displayln "  pkg                              the gerbil package manager")
  (displayln "  test                             the gerbil test runner")
  (displayln "  tags                             the gerbil tag generator")
  (displayln "  prof                             the gerbil profiler")
  (displayln)
