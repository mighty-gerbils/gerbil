    ...
    (def (generate hd slots body)
      (syntax-case hd ()
        ...
        (_ (if (identifier? hd)
             ...
             (raise-syntax-error #f "bad syntax; head should be class name or list of class names" stx hd)))))
...
(module MOP-5
  ...
  ;; (defsystem-class-info :values values::t (:subtyped) ##values?)
  ...
  (defsystem-class-info :return return::t (:t) ##return?)
