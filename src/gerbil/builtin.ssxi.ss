...
(declare-primitive-procedures
 ...
 (call-with-output-string [((procedure::t) string::t effect: (io))
                           ((t::t procedure::t) string::t effect: (io))])
 (call-with-output-u8vector [((procedure::t) u8vector::t effect: (io))
                             ((t::t procedure::t) u8vector::t effect: (io))])
 (call-with-output-vector [((procedure::t) vector::t effect: (io))
                           ((t::t procedure::t) vector::t effect: (io))])
