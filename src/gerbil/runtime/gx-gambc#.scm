...
(define-macro (%%vector-ref . args)
  `(let () (declare (not safe)) (_gx#vector-ref ,@args)))
(define-macro (%%vector-set! . args)
  `(let () (declare (not safe)) (_gx#vector-set! ,@args)))
(define-macro (%%vector-length . args)
  `(let () (declare (not safe)) (_gx#vector-length ,@args)))
...
(define-macro (%%vector->list . args)
  `(let () (declare (not safe)) (_gx#vector->list ,@args)))
