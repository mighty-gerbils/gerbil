...
(define-macro (%%apply . args)
  `(let () (declare (safe)) (##apply ,@args)))
(define-macro (%%car . args)
  `(let () (declare (safe)) (##car ,@args)))
(define-macro (%%cdr . args)
  `(let () (declare (safe)) (##cdr ,@args)))
(define-macro (%%set-car! . args)
  `(let () (declare (safe)) (##set-car! ,@args)))
(define-macro (%%set-cdr! . args)
  `(let () (declare (safe)) (##set-cdr! ,@args)))
(define-macro (%%vector-ref . args)
  `(let () (declare (safe)) (_gx#vector-ref ,@args)))
(define-macro (%%vector-set! . args)
  `(let () (declare (safe)) (_gx#vector-set! ,@args)))
(define-macro (%%vector-length . args)
  `(let () (declare (safe)) (_gx#vector-length ,@args)))
(define-macro (%%string-ref . args)
  `(let () (declare (safe)) (##string-ref ,@args)))
(define-macro (%%string-set! . args)
  `(let () (declare (safe)) (##string-set! ,@args)))
(define-macro (%%string-length . args)
  `(let () (declare (safe)) (##string-length ,@args)))
(define-macro (%%string-append . args)
  `(let () (declare (safe)) (##string-append ,@args)))
(define-macro (%%substring . args)
  `(let () (declare (safe)) (##substring ,@args)))
(define-macro (%%substring-move! . args)
  `(let () (declare (safe)) (##substring-move! ,@args)))
(define-macro (%%make-vector . args)
  `(let () (declare (safe)) (##make-vector ,@args)))
(define-macro (%%vector->list . args)
  `(let () (declare (safe)) (_gx#vector->list ,@args)))
(define-macro (%%values? . args)
  `(let () (declare (safe)) (##values? ,@args)))
(define-macro (%%fx+ . args)
  `(let () (declare (safe)) (##fx+ ,@args)))
(define-macro (%%fx- . args)
  `(let () (declare (safe)) (##fx- ,@args)))
(define-macro (%%fx= . args)
  `(let () (declare (safe)) (##fx= ,@args)))
...
(define-macro (%%fxior . args)
  `(let () (declare (safe)) (##fxior ,@args)))
(define-macro (%%fxand . args)
  `(let () (declare (safe)) (##fxand ,@args)))
(define-macro (%%fxmodulo . args)
  `(let () (declare (safe)) (##fxmodulo ,@args)))
(define-macro (%%fxarithmetic-shift . args)
  `(let () (declare (safe)) (##fxarithmetic-shift ,@args)))
(define-macro (%%fxzero? . args)
  `(let () (declare (safe)) (##fxzero? ,@args)))
(define-macro (%%fxbit-set? . args)
  `(let () (declare (safe)) (##fxbit-set? ,@args)))
(define-macro (%%fl> . args)
  `(let () (declare (safe)) (##fl> ,@args)))
(define-macro (%%type . args)
  `(let () (declare (safe)) (##type ,@args)))
(define-macro (%%type? . args)
  `(let () (declare (safe)) (##type? ,@args)))
(define-macro (%%type-id . args)
  `(let () (declare (safe)) (##type-id ,@args)))
(define-macro (%%type-super . args)
  `(let () (declare (safe)) (##type-super ,@args)))
(define-macro (%%type-flags . args)
  `(let () (declare (safe)) (##type-flags ,@args)))
(define-macro (%%structure . args)
  `(let () (declare (safe)) (##structure ,@args)))
(define-macro (%%structure-instance-of? . args)
  `(let () (declare (safe)) (##structure-instance-of? ,@args)))
(define-macro (%%structure-direct-instance-of? . args)
  `(let () (declare (safe)) (##structure-direct-instance-of? ,@args)))
(define-macro (%%structure-ref . args)
  `(let () (declare (safe)) (##structure-ref ,@args)))
(define-macro (%%structure-set! . args)
  `(let () (declare (safe)) (##structure-set! ,@args)))
(define-macro (%%unchecked-structure-ref . args)
  `(let () (declare (safe)) (##unchecked-structure-ref ,@args)))
(define-macro (%%unchecked-structure-set! . args)
  `(let () (declare (safe)) (##unchecked-structure-set! ,@args)))
(define-macro (%%subtype-set! . args)
  `(let () (declare (safe)) (##subtype-set! ,@args)))
