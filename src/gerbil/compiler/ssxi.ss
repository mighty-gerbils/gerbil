...
(defrules @lambda ()
  ...
  ((_ primitive: arity dispatch return: return effect: effect arguments: arguments)
   (make-!primitive-lambda 'lambda 'arity 'dispatch return: 'return effect: 'effect arguments: 'arguments))
  ((_ arity dispatch)
   (make-!lambda 'lambda 'arity 'dispatch))
  ((_ arity dispatch return: return effect: effect arguments: arguments)
   (make-!lambda 'lambda 'arity 'dispatch return: 'return effect: 'effect arguments: 'arguments))
  ((recur arity)
   (recur arity #f))
  ((recur arity return: return effect: effect arguments: arguments)
   (recur arity #f return: return effect: effect arguments: arguments)))

(defrules @case-lambda ()
  ((_ primitive: (arity dispatch) ...)
   (make-!primitive-case-lambda 'case-lambda [(@lambda primitive: arity dispatch) ...]))
  ((_ primitive: (arity dispatch return: return effect: effect arguments: arguments) ...)
   (make-!primitive-case-lambda 'case-lambda [(@lambda primitive: arity dispatch return: return effect: effect arguments: arguments) ...]))
  ((_ (arity dispatch) ...)
   (make-!case-lambda 'case-lambda [(@lambda arity dispatch) ...]))
  ((_ (arity dispatch return: return effect: effect arguments: arguments) ...)
   (make-!case-lambda 'case-lambda [(@lambda arity dispatch return: return effect: effect arguments: arguments) ...])))
