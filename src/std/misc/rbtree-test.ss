...
(def rbtree-test
  (test-suite "test :std/misc/rbtree"
    (test-case "test rbtree ops"
      ...
      (check (rbtree->list t) => '((5 . e) (4 . d) (3 . c) (2 . b) (1 . a)))
      (rbtree-remove! t 10)
      (check (rbtree->list t) => '((5 . e) (4 . d) (3 . c) (2 . b) (1 . a)))
      (rbtree-remove! t 3)
      (check (rbtree-get t 3) => #f)
      (check (rbtree->list t) => '((5 . e) (4 . d) (2 . b) (1 . a)))
      (rbtree-remove! t 1)
      (check (rbtree-get t 1) => #f)
      (check (rbtree->list t) => '((5 . e) (4 . d) (2 . b)))
      (rbtree-remove! t 4)
      (check (rbtree-get t 4) => #f)
      (check (rbtree->list t) => '((5 . e) (2 . b)))
      (rbtree-remove! t 2)
      (check (rbtree-get t 2) => #f)
      (check (rbtree->list t) => '((5 . e)))
      (rbtree-remove! t 5)
