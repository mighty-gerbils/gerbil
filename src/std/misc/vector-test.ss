...
(def vector-test
  (test-suite "test suite for std/misc/vector"
    (test-case "vector"
      ...
      (check (vector-most-index negative? #(-10 -6 -2 -1 0 3 8 19)) => 4)
      (check (vector-most-index negative? #(-20 -16 -12 -11 -10 -9 -8 -3)) => 8)
      (check (vector-most-index negative? #(3 8 19 23 42 57 83)) => 0)
