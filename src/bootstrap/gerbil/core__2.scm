...
(begin
  (define |gerbil/core$<syntax-sugar>[1]#_g41746_|
    (##structure
     gx#syntax-quote::t
     'values
     #f
                                  ...
                                  (if (gx#stx-pair/null? _tl402441_)
                                      (let ((_g41742_
                                        ...
                                        (begin
                                          (let ((_g41743_
                                                 (if (##values? _g41742_)
                                                     (##vector-length _g41742_)
                                                     1)))
                                            (if (not (##fx= _g41743_ 2))
                                                (error "Context expects 2 values"
                                                       _g41743_)))
                                          (let ((_target403444_
                                                 (##vector-ref _g41742_ 0))
                                                (_tl405447_
                                                 (##vector-ref _g41742_ 1)))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                      ...
                      (let ((_tl510610_ (##cdr _e508603_))
                        ...
                        (if (gx#stx-null? _tl510610_)
                            (___kont3621836219_ _hd509607_ _hd506597_)
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                             2))
                 (error "Context expects 2 values" _g41745_)))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                   (let ((_target646667_
                                                          (##vector-ref
                                                           _g41744_
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
    ...
    (define |gerbil/core$<syntax-sugar>[:0:]#with-syntax|
      (lambda (_stx729_)
        (let* ((___stx3625936260_ _stx729_)
               (_g734819_
                (lambda ()
                  (gx#raise-syntax-error
                   '#f
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                      ...
                                      (let ((_pat798897_ (reverse _pat796861_))
                                        ...
                                        (if (gx#stx-pair/null? _tl787843_)
                                            (let ((___splice3627436275_
                                                   (gx#syntax-split-splice
                                                    _tl787843_
                                                    '0)))
                                              (let ((_tl807903_
                                                     (##vector-ref
                                                      ___splice3627436275_
                                                      '1))
                                                    (_target805900_
                                                     (##vector-ref
                                                      ___splice3627436275_
                                ...
                                (lambda (_hd7441139_ _body7501142_)
                                  (if (gx#stx-pair? _hd7441139_)
                                      ...
                                      (let ((_body7511155_
                                        ...
                                        (___kont3626236263_ _body7511155_))))))
                        (_loop7461135_ _target7431129_ '())))))
              (if (gx#stx-pair? ___stx3625936260_)
                  (let ((_e7371109_ (gx#syntax-e ___stx3625936260_)))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                           _tl7631014_)
                          (if (gx#stx-pair/null? _tl7421126_)
                              (let ((___splice3626836269_
                                     (gx#syntax-split-splice _tl7421126_ '0)))
                                (let ((_tl7721040_
                                       (##vector-ref ___splice3626836269_ '1))
                                      (_target7701037_
                                       (##vector-ref ___splice3626836269_ '0)))
                          ...
                          (if (gx#stx-pair/null? _hd7411123_)
                              (let ((___splice3627236273_
                                ...
                                (let ((_tl790849_
                                       (##vector-ref ___splice3627236273_ '1))
                                      (_target788846_
                                       (##vector-ref ___splice3627236273_ '0)))
                                  (if (gx#stx-null? _tl790849_)
                                      (___match3636036361_
                                       _e7371109_
                                       _hd7381113_
              ...
              (if (gx#stx-pair/null? _hd7411123_)
                  (let ((___splice3627236273_
                         (gx#syntax-split-splice _hd7411123_ '0)))
                    (let ((_tl790849_ (##vector-ref ___splice3627236273_ '1))
                          (_target788846_
                           (##vector-ref ___splice3627236273_ '0)))
                      (if (gx#stx-null? _tl790849_)
                          (___match3636036361_
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
    ...
    (define |gerbil/core$<syntax-sugar>[:0:]#with-syntax*|
      (lambda (_stx1192_)
        (let* ((___stx3636336364_ _stx1192_)
               (_g11971274_
                (lambda ()
                  (gx#raise-syntax-error
                   '#f
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
            ...
            (let* ((___match3647636477_
              ...
              (if (gx#stx-pair? ___stx3636336364_)
                  (let ((_e12001520_ (gx#syntax-e ___stx3636336364_)))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                           |gerbil/core$<syntax-sugar>[1]#_g41746_|
                           _hd12331426_)
                          ...
                          (if (gx#stx-pair/null? _tl12051537_)
                              (let ((___splice3637636377_
                                ...
                                (let ((_tl12621314_
                                       (##vector-ref ___splice3637636377_ '1))
                                      (_target12601311_
                                       (##vector-ref ___splice3637636377_ '0)))
                                  (if (gx#stx-null? _tl12621314_)
                                      (___match3647636477_
                                       _e12001520_
                                       _hd12011524_
              ...
              (if (gx#stx-pair/null? _tl12051537_)
                  (let ((___splice3637636377_
                         (gx#syntax-split-splice _tl12051537_ '0)))
                    (let ((_tl12621314_ (##vector-ref ___splice3637636377_ '1))
                          (_target12601311_
                           (##vector-ref ___splice3637636377_ '0)))
                      (if (gx#stx-null? _tl12621314_)
                          (___match3647636477_
