...
(begin
  (define |gerbil/core$<syntax-sugar>[1]#_g47394_|
    (##structure
     gx#syntax-quote::t
     'values
     #f
                                      ...
                                      (let ((_g47314_
                                        ...
                                        (begin
                                          ...
                                          (let ((_target61102_
                                                 (let ()
                                                   (declare (not safe))
                                                   (##vector-ref _g47314_ 0)))
                                                (_tl63105_
                                                 (let ()
                                                   (declare (not safe))
                                                   (##vector-ref _g47314_ 1))))
                                              ...
                                              (let ((___kont4160741608_
                                                     (lambda (_L270_ _L272_)
                                                       (let ((__tmp47316
                                                              (let ((__tmp47317
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                             (let ((__tmp47319 (gx#datum->syntax '#f 'syntax))
                                   (__tmp47318
                                    (let ()
                                      (declare (not safe))
                                      (cons _L270_ '()))))
                               (declare (not safe))
                               (cons __tmp47319 __tmp47318))))
                        (declare (not safe))
                        (cons __tmp47317 '()))))
                 (declare (not safe))
                 (cons _L272_ __tmp47316))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                    (___kont4160941610_
                                                     (lambda (_L222_
                                                              _L224_
                                    ...
                                    (let ((__tmp47324
                                          ...
                                          (__tmp47323
                                           (let ()
                                             ...
                                             (cons _L222_ '()))))
                                      (declare (not safe))
                                      (cons __tmp47324 __tmp47323))))
                               (declare (not safe))
                               (cons __tmp47322 '()))))
                        (declare (not safe))
                        (cons _L224_ __tmp47321))))
                 (declare (not safe))
                 (cons _L225_ __tmp47320)))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                (if (gx#stx-pair?
                                                     ___stx4160441605_)
                                                    (let ((_e164250_
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                          (not safe))
                        (##fx= _g47327_ 2)))
                 (error "Context expects 2 values" _g47327_)))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                   (let ((_target303324_
                                                          (let ()
                                                            (declare
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                         ...
                         (__tmp47331
                          (let ((__tmp47335 (gx#datum->syntax '#f '$stx))
                                (__tmp47332
                                 (let ((__tmp47333
                                        (let ((__tmp47334
                                               (lambda (_g367370_ _g368373_)
                                                 (let ()
                                                   ...
                                                   (cons _g367370_
                                                         _g368373_)))))
                                          (declare (not safe))
                                          (foldr1 __tmp47334 '() _L354_))))
                                   (declare (not safe))
                                   (cons _L134_ __tmp47333))))
                            (declare (not safe))
                            (cons __tmp47335 __tmp47332))))
                     (declare (not safe))
                     (cons __tmp47336 __tmp47331))))
              (declare (not safe))
              (cons __tmp47330 '()))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                               (declare (not safe))
                                               (cons __tmp47337 __tmp47329))))
                                        (declare (not safe))
                                        (cons __tmp47339 __tmp47328)))
                                    _clause311350_))))))
      ...
      (lambda (_stx386_)
        (let* ((___stx4164841649_ _stx386_)
          ...
          (let ((___kont4165141652_
                 (lambda (_L816_)
                   (let ((__tmp47343 (gx#datum->syntax '#f 'let-values))
                         (__tmp47340
                          (let ((__tmp47341
                                 (let ((__tmp47342
                                   ...
                                   (declare (not safe))
                                   (foldr1 __tmp47342 '() _L816_))))
                            (declare (not safe))
                            (cons '() __tmp47341))))
                     (declare (not safe))
                     (cons __tmp47343 __tmp47340))))
                (___kont4165541656_
                 (lambda (_L724_ _L726_ _L727_)
                   (let ((__tmp47354 (gx#datum->syntax '#f 'syntax-case))
                         (__tmp47344
                          (let ((__tmp47345
                                 (let ((__tmp47346
                                        (let ((__tmp47347
                           ...
                           (__tmp47350
                            (let ((__tmp47351
                                   (let ((__tmp47352
                                     ...
                                     (declare (not safe))
                                     (foldr1 __tmp47352 '() _L724_))))
                              (declare (not safe))
                              (cons '() __tmp47351))))
                       (declare (not safe))
                       (cons __tmp47353 __tmp47350))))
                (declare (not safe))
                (cons __tmp47349 '()))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                 (declare (not safe))
                                                 (cons _L727_ __tmp47348))))
                                          (declare (not safe))
                                          (cons __tmp47347 '()))))
                                   (declare (not safe))
                                   (cons '() __tmp47346))))
                            (declare (not safe))
                            (cons _L726_ __tmp47345))))
                     (declare (not safe))
                     (cons __tmp47354 __tmp47344))))
                (___kont4165941660_
                 (lambda (_L587_ _L589_ _L590_)
                   (let ((__tmp47371 (gx#datum->syntax '#f 'syntax-case))
                         (__tmp47355
                          (let ((__tmp47367
                                 (let ((__tmp47370
                                               ...
                                               (lambda (_g616619_ _g617622_)
                                                 (let ()
                                                   ...
                                                   (cons _g616619_
                                                         _g617622_)))))
                                          (declare (not safe))
                                          (foldr1 __tmp47369 '() _L589_))))
                                   (declare (not safe))
                                   (cons __tmp47370 __tmp47368)))
                                (__tmp47356
                                 (let ((__tmp47357
                                        (let ((__tmp47358
                                               (let ((__tmp47365
                           ...
                           (__tmp47361
                            (let ((__tmp47362
                                   (let ((__tmp47363
                                     ...
                                     (declare (not safe))
                                     (foldr1 __tmp47363 '() _L587_))))
                              (declare (not safe))
                              (cons '() __tmp47362))))
                       (declare (not safe))
                       (cons __tmp47364 __tmp47361))))
                (declare (not safe))
                (cons __tmp47360 '()))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                 (declare (not safe))
                                   ...
                                   (cons '() __tmp47357))))
                            (declare (not safe))
                            (cons __tmp47367 __tmp47356))))
                     (declare (not safe))
                     (cons __tmp47371 __tmp47355)))))
      ...
      (lambda (_stx849_)
        (let* ((___stx4175241753_ _stx849_)
          ...
          (let ((___kont4175541756_
                 (lambda (_L1227_)
                   (let ((__tmp47375 (gx#datum->syntax '#f 'let-values))
                         (__tmp47372
                          (let ((__tmp47373
                                 (let ((__tmp47374
                                   ...
                                   (declare (not safe))
                                   (foldr1 __tmp47374 '() _L1227_))))
                            (declare (not safe))
                            (cons '() __tmp47373))))
                     (declare (not safe))
                     (cons __tmp47375 __tmp47372))))
                (___kont4175941760_
                 (lambda (_L1129_ _L1131_ _L1132_ _L1133_ _L1134_)
                   (let ((__tmp47385 (gx#datum->syntax '#f 'let-values))
                         (__tmp47376
                          (let ((__tmp47382
                                 (let ((__tmp47383
                                        (let ((__tmp47384
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                ...
                (declare (not safe))
                (foldr1 __tmp47381 '() _L1129_))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                 (declare (not safe))
                                                 (cons _L1131_ __tmp47380))))
                                          (declare (not safe))
                                          (cons _L1134_ __tmp47379))))
                                   (declare (not safe))
                                   (cons __tmp47378 '()))))
                            (declare (not safe))
                            (cons __tmp47382 __tmp47377))))
                     (declare (not safe))
                     (cons __tmp47385 __tmp47376))))
                (___kont4176341764_
                 (lambda (_L998_ _L1000_ _L1001_ _L1002_)
                   (let ((__tmp47393 (gx#datum->syntax '#f 'with-syntax))
                         (__tmp47386
                          (let ((__tmp47392
                                 (let ()
                                   (declare (not safe))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                ...
                (declare (not safe))
                (foldr1 __tmp47391 '() _L998_))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                 (declare (not safe))
                                                 (cons _L1000_ __tmp47390))))
                                          (declare (not safe))
                                          (cons _L1002_ __tmp47389))))
                                   (declare (not safe))
                                   (cons __tmp47388 '()))))
                            (declare (not safe))
                            (cons __tmp47392 __tmp47387))))
                     (declare (not safe))
                     (cons __tmp47393 __tmp47386)))))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                  ...
                  (if (gx#identifier? _hd8901083_)
                      (if (gx#free-identifier=?
                           |gerbil/core$<syntax-sugar>[1]#_g47394_|
                           _hd8901083_)
