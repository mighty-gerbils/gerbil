...
(begin
  (define |gerbil/core$<syntax-sugar>[1]#_g47669_|
    (##structure
     gx#syntax-quote::t
     'values
     #f
                                      ...
                                      (let ((_g47589_
                                        ...
                                        (begin
                                          ...
                                          (let ((_target61102_
                                                 (let ()
                                                   (declare (not safe))
                                                   (##vector-ref _g47589_ 0)))
                                                (_tl63105_
                                                 (let ()
                                                   (declare (not safe))
                                                   (##vector-ref _g47589_ 1))))
                                                   ...
                                                   (_g158185_
                                                    (lambda ()
                                                      (gx#raise-syntax-error
                                                       ...
                                                       '"Bad syntax; invalid match target"
                                                       ___stx4187941880_))))
                                              (let ((___kont4188241883_
                                                     (lambda (_L270_ _L272_)
                                                       (let ((__tmp47591
                                                              (let ((__tmp47592
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                             (let ((__tmp47594 (gx#datum->syntax '#f 'syntax))
                                   (__tmp47593
                                    (let ()
                                      (declare (not safe))
                                      (cons _L270_ '()))))
                               (declare (not safe))
                               (cons __tmp47594 __tmp47593))))
                        (declare (not safe))
                        (cons __tmp47592 '()))))
                 (declare (not safe))
                 (cons _L272_ __tmp47591))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                    (___kont4188441885_
                                                     (lambda (_L222_
                                                              _L224_
                                    ...
                                    (let ((__tmp47599
                                          ...
                                          (__tmp47598
                                           (let ()
                                             ...
                                             (cons _L222_ '()))))
                                      (declare (not safe))
                                      (cons __tmp47599 __tmp47598))))
                               (declare (not safe))
                               (cons __tmp47597 '()))))
                        (declare (not safe))
                        (cons _L224_ __tmp47596))))
                 (declare (not safe))
                 (cons _L225_ __tmp47595)))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                (if (gx#stx-pair?
                                                     ___stx4187941880_)
                                                    (let ((_e164250_
                    ...
                    (let ((_e167260_ (gx#syntax-e _tl162257_)))
                      (let ((_tl165267_
                        ...
                        (if (gx#stx-null? _tl165267_)
                            (___kont4188241883_ _hd166264_ _hd163254_)
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                          (not safe))
                        (##fx= _g47602_ 2)))
                 (error "Context expects 2 values" _g47602_)))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                   (let ((_target303324_
                                                          (let ()
                                                            (declare
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                         ...
                         (__tmp47606
                          (let ((__tmp47610 (gx#datum->syntax '#f '$stx))
                                (__tmp47607
                                 (let ((__tmp47608
                                        (let ((__tmp47609
                                               (lambda (_g367370_ _g368373_)
                                                 (let ()
                                                   ...
                                                   (cons _g367370_
                                                         _g368373_)))))
                                          (declare (not safe))
                                          (foldr1 __tmp47609 '() _L354_))))
                                   (declare (not safe))
                                   (cons _L134_ __tmp47608))))
                            (declare (not safe))
                            (cons __tmp47610 __tmp47607))))
                     (declare (not safe))
                     (cons __tmp47611 __tmp47606))))
              (declare (not safe))
              (cons __tmp47605 '()))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                               (declare (not safe))
                                               (cons __tmp47612 __tmp47604))))
                                        (declare (not safe))
                                        (cons __tmp47614 __tmp47603)))
                                    _clause311350_))))))
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
    ...
    (define |gerbil/core$<syntax-sugar>[:0:]#with-syntax|
      (lambda (_stx386_)
        (let* ((___stx4192341924_ _stx386_)
               (_g391476_
                (lambda ()
                  (gx#raise-syntax-error
                   '#f
                   '"Bad syntax; invalid match target"
                   ___stx4192341924_))))
          (let ((___kont4192641927_
                 (lambda (_L816_)
                   (let ((__tmp47618 (gx#datum->syntax '#f 'let-values))
                         (__tmp47615
                          (let ((__tmp47616
                                 (let ((__tmp47617
                                   ...
                                   (declare (not safe))
                                   (foldr1 __tmp47617 '() _L816_))))
                            (declare (not safe))
                            (cons '() __tmp47616))))
                     (declare (not safe))
                     (cons __tmp47618 __tmp47615))))
                (___kont4193041931_
                 (lambda (_L724_ _L726_ _L727_)
                   (let ((__tmp47629 (gx#datum->syntax '#f 'syntax-case))
                         (__tmp47619
                          (let ((__tmp47620
                                 (let ((__tmp47621
                                        (let ((__tmp47622
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                 (declare (not safe))
                                                 (cons _L727_ __tmp47623))))
                                          (declare (not safe))
                                          (cons __tmp47622 '()))))
                                   (declare (not safe))
                                   (cons '() __tmp47621))))
                            (declare (not safe))
                            (cons _L726_ __tmp47620))))
                     (declare (not safe))
                     (cons __tmp47629 __tmp47619))))
                (___kont4193441935_
                 (lambda (_L587_ _L589_ _L590_)
                   (let ((__tmp47646 (gx#datum->syntax '#f 'syntax-case))
                         (__tmp47630
                          (let ((__tmp47642
                                 (let ((__tmp47645
                                               ...
                                               (lambda (_g616619_ _g617622_)
                                                 (let ()
                                                   ...
                                                   (cons _g616619_
                                                         _g617622_)))))
                                          (declare (not safe))
                                          (foldr1 __tmp47644 '() _L589_))))
                                   (declare (not safe))
                                   (cons __tmp47645 __tmp47643)))
                                (__tmp47631
                                 (let ((__tmp47632
                                        (let ((__tmp47633
                                               (let ((__tmp47640
                           ...
                           (__tmp47636
                            (let ((__tmp47637
                                   (let ((__tmp47638
                                     ...
                                     (declare (not safe))
                                     (foldr1 __tmp47638 '() _L587_))))
                              (declare (not safe))
                              (cons '() __tmp47637))))
                       (declare (not safe))
                       (cons __tmp47639 __tmp47636))))
                (declare (not safe))
                (cons __tmp47635 '()))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                 (declare (not safe))
                                   ...
                                   (cons '() __tmp47632))))
                            (declare (not safe))
                            (cons __tmp47642 __tmp47631))))
                     (declare (not safe))
                     (cons __tmp47646 __tmp47630)))))
            (let* ((___match4202442025_
                    (lambda (_e441483_
                             _hd440487_
                             _tl439490_
                             _e444493_
                                ...
                                (lambda (_hd401796_ _body407799_)
                                  (if (gx#stx-pair? _hd401796_)
                                      ...
                                      (let ((_body408812_
                                        ...
                                        (___kont4192641927_ _body408812_))))))
                        (_loop403792_ _target400786_ '())))))
              (if (gx#stx-pair? ___stx4192341924_)
                  (let ((_e396766_ (gx#syntax-e ___stx4192341924_)))
                    (let ((_tl394773_
                      ...
                      (if (gx#stx-pair/null? _hd398780_)
                          (let ((___splice4193641937_
                            ...
                            (let ((_tl447506_
                                   (let ()
                                     (declare (not safe))
                                     (##vector-ref ___splice4193641937_ '1)))
                                  (_target445503_
                                   (let ()
                                     (declare (not safe))
                                     (##vector-ref ___splice4193641937_ '0))))
                              (if (gx#stx-null? _tl447506_)
                                  (___match4202442025_
                                   _e396766_
                                   _hd395770_
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
    ...
    (define |gerbil/core$<syntax-sugar>[:0:]#with-syntax*|
      (lambda (_stx849_)
        (let* ((___stx4202742028_ _stx849_)
               (_g854931_
                (lambda ()
                  (gx#raise-syntax-error
                   '#f
                   '"Bad syntax; invalid match target"
                   ___stx4202742028_))))
          (let ((___kont4203042031_
                 (lambda (_L1227_)
                   (let ((__tmp47650 (gx#datum->syntax '#f 'let-values))
                         (__tmp47647
                          (let ((__tmp47648
                                 (let ((__tmp47649
                                   ...
                                   (declare (not safe))
                                   (foldr1 __tmp47649 '() _L1227_))))
                            (declare (not safe))
                            (cons '() __tmp47648))))
                     (declare (not safe))
                     (cons __tmp47650 __tmp47647))))
                (___kont4203442035_
                 (lambda (_L1129_ _L1131_ _L1132_ _L1133_ _L1134_)
                   (let ((__tmp47660 (gx#datum->syntax '#f 'let-values))
                         (__tmp47651
                          (let ((__tmp47657
                                 (let ((__tmp47658
                                        (let ((__tmp47659
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                ...
                (declare (not safe))
                (foldr1 __tmp47656 '() _L1129_))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                 (declare (not safe))
                                                 (cons _L1131_ __tmp47655))))
                                          (declare (not safe))
                                          (cons _L1134_ __tmp47654))))
                                   (declare (not safe))
                                   (cons __tmp47653 '()))))
                            (declare (not safe))
                            (cons __tmp47657 __tmp47652))))
                     (declare (not safe))
                     (cons __tmp47660 __tmp47651))))
                (___kont4203842039_
                 (lambda (_L998_ _L1000_ _L1001_ _L1002_)
                   (let ((__tmp47668 (gx#datum->syntax '#f 'with-syntax))
                         (__tmp47661
                          (let ((__tmp47667
                                 (let ()
                                   (declare (not safe))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                ...
                (declare (not safe))
                (foldr1 __tmp47666 '() _L998_))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                 (declare (not safe))
                                                 (cons _L1000_ __tmp47665))))
                                          (declare (not safe))
                                          (cons _L1002_ __tmp47664))))
                                   (declare (not safe))
                                   (cons __tmp47663 '()))))
                            (declare (not safe))
                            (cons __tmp47667 __tmp47662))))
                     (declare (not safe))
                     (cons __tmp47668 __tmp47661)))))
                                ...
                                (lambda (_hd8641207_ _body8701210_)
                                  (if (gx#stx-pair? _hd8641207_)
                                      ...
                                      (let ((_body8711223_
                                        ...
                                        (___kont4203042031_ _body8711223_))))))
                        (_loop8661203_ _target8631197_ '())))))
              (if (gx#stx-pair? ___stx4202742028_)
                  (let ((_e8591177_ (gx#syntax-e ___stx4202742028_)))
                    (let ((_tl8571184_
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                  ...
                  (if (gx#identifier? _hd8901083_)
                      (if (gx#free-identifier=?
                           |gerbil/core$<syntax-sugar>[1]#_g47669_|
                           _hd8901083_)
                      ...
                      (if (gx#stx-pair/null? _tl8601194_)
                          (let ((___splice4204042041_
                            ...
                            (let ((_tl919971_
                                   (let ()
                                     (declare (not safe))
                                     (##vector-ref ___splice4204042041_ '1)))
                                  (_target917968_
                                   (let ()
                                     (declare (not safe))
                                     (##vector-ref ___splice4204042041_ '0))))
                              (if (gx#stx-null? _tl919971_)
                                  (___match4214042141_
                                   _e8591177_
                                   _hd8581181_
                              ...
                              (let ((__tmp47674
                                    ...
                                    (__tmp47673
                                     (let ()
                                       ...
                                       (cons _L1319_ '()))))
                                (declare (not safe))
                                (cons __tmp47674 __tmp47673))))
                         (declare (not safe))
                         (cons __tmp47672 '()))))
                  (declare (not safe))
                  (cons __tmp47675 __tmp47671))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                   (declare (not safe))
                                                   (cons __tmp47678
                                                         __tmp47670)))
