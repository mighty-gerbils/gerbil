...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
      ...
      (|gerbil/core$<MOP>$<MOP:2>[1]#make-extended-struct-info|
       ...
       (cons '#f
             (cons |gx[1]#_g16063_|
                   (cons |gx[1]#_g16064_|
                         (cons |gx[1]#_g16065_|
                               (cons (cons |gx[1]#_g16066_|
                                           (cons |gx[1]#_g16067_|
                                                 (cons |gx[1]#_g16068_| '())))
                                     (cons (cons |gx[1]#_g16069_|
                                                 (cons |gx[1]#_g16070_|
                                                       (cons |gx[1]#_g16071_|
                                                             '())))
                                           '()))))))
      ...
      (|gerbil/core$<MOP>$<MOP:2>[1]#make-extended-struct-info|
       ...
       (cons '#f
             (cons |gx[1]#_g16072_|
                   (cons |gx[1]#_g16073_|
                         (cons |gx[1]#_g16074_|
                               (cons (cons |gx[1]#_g16075_|
                                           (cons |gx[1]#_g16076_|
                                                 (cons |gx[1]#_g16077_| '())))
                                     (cons (cons |gx[1]#_g16078_|
                                                 (cons |gx[1]#_g16079_|
                                                       (cons |gx[1]#_g16080_|
                                                             '())))
                                           '()))))))
    ...
    (define |gx[:0:]#import-expander|
      (|gerbil/core$<MOP>$<MOP:2>[1]#make-extended-class-info|
       ...
       |gx[1]#_g16081_|
       'expander-identifiers:
       (cons (cons |gx[1]#_g16082_| '())
             (cons |gx[1]#_g16081_|
                   (cons |gx[1]#_g16083_|
                         (cons |gx[1]#_g16084_| (cons '() (cons '() '()))))))
       'type-exhibitor:
    ...
    (define |gx[:0:]#import-export-expander|
      (|gerbil/core$<MOP>$<MOP:2>[1]#make-extended-class-info|
       ...
       |gx[1]#_g16089_|
       'expander-identifiers:
       (cons (cons |gx[1]#_g16081_| (cons |gx[1]#_g16086_| '()))
             (cons |gx[1]#_g16089_|
                   (cons |gx[1]#_g16090_|
                         (cons |gx[1]#_g16091_| (cons '() (cons '() '()))))))
       'type-exhibitor:
       (|gerbil/core$<MOP>$<MOP:2>[1]#make-runtime-class-exhibitor|
        'gx#import-export-expander::t
        (list |gx[1]#_g16092_| |gx[1]#_g16093_|)
        'import-export-expander
        ':init!
        '()
        '())))))
