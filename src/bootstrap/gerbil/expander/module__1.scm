...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
      ...
      (|gerbil/core$<MOP>$<MOP:2>[1]#make-extended-struct-info|
       ...
       (cons '#f
             (cons |gx[1]#_g16001_|
                   (cons |gx[1]#_g16002_|
                         (cons |gx[1]#_g16003_|
                               (cons (cons |gx[1]#_g16004_|
                                           (cons |gx[1]#_g16005_|
                                                 (cons |gx[1]#_g16006_| '())))
                                     (cons (cons |gx[1]#_g16007_|
                                                 (cons |gx[1]#_g16008_|
                                                       (cons |gx[1]#_g16009_|
                                                             '())))
                                           '()))))))
    ...
    (define |gx[:0:]#import-export-expander|
      (|gerbil/core$<MOP>$<MOP:2>[1]#make-extended-class-info|
       ...
       |gx[1]#_g16027_|
       'expander-identifiers:
       (cons (cons |gx[1]#_g16019_| (cons |gx[1]#_g16024_| '()))
             (cons |gx[1]#_g16027_|
                   (cons |gx[1]#_g16028_|
                         (cons |gx[1]#_g16029_| (cons '() (cons '() '()))))))
       'type-exhibitor:
       (|gerbil/core$<MOP>$<MOP:2>[1]#make-runtime-class-exhibitor|
        'gx#import-export-expander::t
        (list |gx[1]#_g16030_| |gx[1]#_g16031_|)
        'import-export-expander
        ':init!
        '()
        '())))))
