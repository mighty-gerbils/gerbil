...
(begin
  (declare-type
   ...
   (@case-lambda
    ...
    (2 gx#core-expand-lambda%__opt-lambda8547)))
  (declare-type
   gx#core-expand-letrec-values%
   (@case-lambda
    (1 gx#core-expand-letrec-values%__0)
    (2 gx#core-expand-letrec-values%__opt-lambda8410)))
  (declare-type
   gx#core-expand-let-bind-syntax!
   (@case-lambda
    (2 gx#core-expand-let-bind-syntax!__0)
    (3 gx#core-expand-let-bind-syntax!__opt-lambda8002)))
  (declare-type
   gx#macro-expand-let-values
   (@case-lambda
    (1 gx#macro-expand-let-values__0)
    (2 gx#macro-expand-let-values__opt-lambda7153)))
  (declare-type
   gx#check-duplicate-identifiers
   (@case-lambda
    (1 gx#check-duplicate-identifiers__0)
    (2 gx#check-duplicate-identifiers__opt-lambda6951)))
  (declare-type
   gx#core-bind-values!
   (@case-lambda
    ...
    (4 gx#core-bind-values!__opt-lambda6907)))
  (declare-type
   ...
   (@case-lambda
    ...
    (4 gx#core-bind-runtime!__opt-lambda6846)))
  (declare-type
   ...
   (@case-lambda
    ...
    (5 gx#core-bind-runtime-reference!__opt-lambda6801)))
  (declare-type
   gx#core-bind-extern!
   (@case-lambda
    ...
    (5 gx#core-bind-extern!__opt-lambda6761)))
  (declare-type
   gx#core-bind-syntax!
   (@case-lambda
    ...
    (5 gx#core-bind-syntax!__opt-lambda6715)))
  (declare-type
   gx#core-bind-root-syntax!
   (@case-lambda
    (2 gx#core-bind-root-syntax!__0)
    (3 gx#core-bind-root-syntax!__opt-lambda6698)))
  (declare-type
   gx#core-bind-alias!
   (@case-lambda
    ...
    (5 gx#core-bind-alias!__opt-lambda6656)))
  (declare-type
   gx#make-binding-id
   (@case-lambda
    ...
    (4 gx#make-binding-id__opt-lambda6613))))
