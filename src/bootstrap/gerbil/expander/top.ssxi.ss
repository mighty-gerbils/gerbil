...
(begin
  (declare-type
   ...
   (@case-lambda
    ...
    (2 gx#core-expand-lambda%__opt-lambda8057)))
  (declare-type
   gx#core-expand-letrec-values%
   (@case-lambda
    (1 gx#core-expand-letrec-values%__0)
    (2 gx#core-expand-letrec-values%__opt-lambda7920)))
  (declare-type
   gx#core-expand-let-bind-syntax!
   (@case-lambda
    (2 gx#core-expand-let-bind-syntax!__0)
    (3 gx#core-expand-let-bind-syntax!__opt-lambda7512)))
  (declare-type
   gx#macro-expand-let-values
   (@case-lambda
    (1 gx#macro-expand-let-values__0)
    (2 gx#macro-expand-let-values__opt-lambda6663)))
  (declare-type
   gx#check-duplicate-identifiers
   (@case-lambda
    (1 gx#check-duplicate-identifiers__0)
    (2 gx#check-duplicate-identifiers__opt-lambda6461)))
  (declare-type
   gx#core-bind-values!
   (@case-lambda
    ...
    (4 gx#core-bind-values!__opt-lambda6417)))
  (declare-type
   ...
   (@case-lambda
    ...
    (4 gx#core-bind-runtime!__opt-lambda6356)))
  (declare-type
   ...
   (@case-lambda
    ...
    (5 gx#core-bind-runtime-reference!__opt-lambda6311)))
  (declare-type
   gx#core-bind-extern!
   (@case-lambda
    ...
    (5 gx#core-bind-extern!__opt-lambda6271)))
  (declare-type
   gx#core-bind-syntax!
   (@case-lambda
    ...
    (5 gx#core-bind-syntax!__opt-lambda6225)))
  (declare-type
   gx#core-bind-root-syntax!
   (@case-lambda
    (2 gx#core-bind-root-syntax!__0)
    (3 gx#core-bind-root-syntax!__opt-lambda6208)))
  (declare-type
   gx#core-bind-alias!
   (@case-lambda
    ...
    (5 gx#core-bind-alias!__opt-lambda6166)))
  (declare-type
   gx#make-binding-id
   (@case-lambda
    ...
    (4 gx#make-binding-id__opt-lambda6123))))
