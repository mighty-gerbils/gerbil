...
(begin
  (define gerbil/expander/common::timestamp 1712155161)
  (begin
    (define gx#AST::t
      (let ((__tmp113159 (list))
            (__tmp113158 (cons (cons 'struct: '#t) '((print: e)))))
        (declare (not safe))
        (make-class-type
         'gerbil#AST::t
         'syntax
    ...
    (define gx#make-AST
      (lambda _%$args113057%_ (apply make-instance gx#AST::t _%$args113057%_)))
    (define gx#AST-e
