...
(begin
  (define gerbil/expander/common::timestamp 1771178564)
  (begin
    (define gx#AST::t
      (let ((__tmp172484 (list))
            (__tmp172483 (cons (cons 'struct: '#t) '((print: e)))))
        (declare (not safe))
        (__make-class-type
         'gerbil#AST::t
         'syntax
    ...
    (define gx#make-AST
      (lambda _%$args172382%_ (apply make-instance gx#AST::t _%$args172382%_)))
    (define gx#AST-e
