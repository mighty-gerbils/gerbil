...
(begin
  (define gerbil/expander/common::timestamp 1771030479)
  (begin
    (define gx#AST::t
      (let ((__tmp171414 (list))
            (__tmp171413 (cons (cons 'struct: '#t) '((print: e)))))
        (declare (not safe))
        (__make-class-type
         'gerbil#AST::t
         'syntax
    ...
    (define gx#make-AST
      (lambda _%$args171312%_ (apply make-instance gx#AST::t _%$args171312%_)))
    (define gx#AST-e
