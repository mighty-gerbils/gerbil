...
(begin
  (define gerbil/expander/common::timestamp 1712084085)
  (begin
    (define gx#AST::t
      (let ((__tmp113025 (list)) (__tmp113024 (cons (cons 'struct: '#t) '())))
        (declare (not safe))
        (make-class-type
         'gerbil#AST::t
         'syntax
    ...
    (define gx#make-AST
      (lambda _%$args112923%_ (apply make-instance gx#AST::t _%$args112923%_)))
    (define gx#AST-e
