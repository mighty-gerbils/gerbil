...
(begin
  (define gerbil/expander/common::timestamp 1779274770)
  (begin
    (define gx#AST::t
      (let ((__tmp173362 (list))
            (__tmp173361 (cons (cons 'struct: '#t) '((print: e)))))
        (declare (not safe))
        (__make-class-type
         'gerbil#AST::t
         'syntax
    ...
    (define gx#make-AST
      (lambda _%$args173260%_ (apply make-instance gx#AST::t _%$args173260%_)))
    (define gx#AST-e
