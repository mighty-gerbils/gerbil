...
(begin
  (define gerbil/expander/common::timestamp 1756156300)
  (begin
    (define gx#AST::t
      (let ((__tmp125044 (list))
            (__tmp125043 (cons (cons 'struct: '#t) '((print: e)))))
        (declare (not safe))
        (__make-class-type
         'gerbil#AST::t
         'syntax
    ...
    (define gx#make-AST
      (lambda _%$args124942%_ (apply make-instance gx#AST::t _%$args124942%_)))
    (define gx#AST-e
