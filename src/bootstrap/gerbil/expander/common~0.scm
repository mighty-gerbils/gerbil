...
(begin
  (define gerbil/expander/common::timestamp 1768863412)
  (begin
    (define gx#AST::t
      (let ((__tmp128725 (list)) (__tmp128724 (cons (cons 'struct: '#t) '())))
        (declare (not safe))
        (__make-class-type
         'gerbil#AST::t
         'syntax
    ...
    (define gx#make-AST
      (lambda _%$args128623%_ (apply make-instance gx#AST::t _%$args128623%_)))
    (define gx#AST-e
