...
(begin
  (define gerbil/expander/common::timestamp 1756142015)
  (begin
    (define gx#AST::t
      (let ((__tmp124062 (list))
            (__tmp124061 (cons (cons 'struct: '#t) '((print: e)))))
        (declare (not safe))
        (__make-class-type
         'gerbil#AST::t
         'syntax
    ...
    (define gx#make-AST
      (lambda _%$args123960%_ (apply make-instance gx#AST::t _%$args123960%_)))
    (define gx#AST-e
