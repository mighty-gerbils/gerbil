...
(begin
  (define gerbil/expander/common::timestamp 1771101400)
  (begin
    (define gx#AST::t
      (let ((__tmp172431 (list))
            (__tmp172430 (cons (cons 'struct: '#t) '((print: e)))))
        (declare (not safe))
        (__make-class-type
         'gerbil#AST::t
         'syntax
    ...
    (define gx#make-AST
      (lambda _%$args172329%_ (apply make-instance gx#AST::t _%$args172329%_)))
    (define gx#AST-e
