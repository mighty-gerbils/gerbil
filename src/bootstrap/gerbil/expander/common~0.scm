...
(begin
  (define gerbil/expander/common::timestamp 1734225193)
  (begin
    (define gx#AST::t
      (let ((__tmp117952 (list))
            (__tmp117951 (cons (cons 'struct: '#t) '((print: e)))))
        (declare (not safe))
        (__make-class-type
         'gerbil#AST::t
         'syntax
    ...
    (define gx#make-AST
      (lambda _%$args117850%_ (apply make-instance gx#AST::t _%$args117850%_)))
    (define gx#AST-e
