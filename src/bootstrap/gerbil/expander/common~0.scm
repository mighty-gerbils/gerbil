...
(begin
  (define gerbil/expander/common::timestamp 1771036674)
  (begin
    (define gx#AST::t
      (let ((__tmp354826 (list))
            (__tmp354825 (cons (cons 'struct: '#t) '((print: e)))))
        (declare (not safe))
        (__make-class-type
         'gerbil#AST::t
         'syntax
    ...
    (define gx#make-AST
      (lambda _%$args354724%_ (apply make-instance gx#AST::t _%$args354724%_)))
    (define gx#AST-e
