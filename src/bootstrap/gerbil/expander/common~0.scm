...
(begin
  (define gerbil/expander/common::timestamp 1770505716)
  (begin
    (define gx#AST::t
      (let ((__tmp168956 (list)) (__tmp168955 (cons (cons 'struct: '#t) '())))
        (declare (not safe))
        (__make-class-type
         'gerbil#AST::t
         'syntax
    ...
    (define gx#make-AST
      (lambda _%$args168854%_ (apply make-instance gx#AST::t _%$args168854%_)))
    (define gx#AST-e
