...
(begin
  (define gerbil/expander/common::timestamp 1756715352)
  (begin
    (define gx#AST::t
      (let ((__tmp125464 (list))
            (__tmp125463 (cons (cons 'struct: '#t) '((print: e)))))
        (declare (not safe))
        (__make-class-type
         'gerbil#AST::t
         'syntax
    ...
    (define gx#make-AST
      (lambda _%$args125362%_ (apply make-instance gx#AST::t _%$args125362%_)))
    (define gx#AST-e
