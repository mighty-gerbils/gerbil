...
(begin
  (define gerbil/expander/common::timestamp 1712573430)
  (begin
    (define gx#AST::t
      (let ((__tmp112911 (list))
            (__tmp112910 (cons (cons 'struct: '#t) '((print: e)))))
        (declare (not safe))
        (__make-class-type
         'gerbil#AST::t
         'syntax
    ...
    (define gx#make-AST
      (lambda _%$args112809%_ (apply make-instance gx#AST::t _%$args112809%_)))
    (define gx#AST-e
