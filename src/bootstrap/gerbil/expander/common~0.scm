...
(begin
  (define gerbil/expander/common::timestamp 1783878476)
  (begin
    (define gx#AST::t
      (let ((__tmp178188 (list))
            (__tmp178187 (cons (cons 'struct: '#t) '((print: e)))))
        (declare (not safe))
        (__make-class-type
         'gerbil#AST::t
         'syntax
    ...
    (define gx#make-AST
      (lambda _%$args178086%_ (apply make-instance gx#AST::t _%$args178086%_)))
    (define gx#AST-e
