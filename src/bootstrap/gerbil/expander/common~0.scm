...
(begin
  (define gerbil/expander/common::timestamp 1768864948)
  (begin
    (define gx#AST::t
      (let ((__tmp128752 (list)) (__tmp128751 (cons (cons 'struct: '#t) '())))
        (declare (not safe))
        (__make-class-type
         'gerbil#AST::t
         'syntax
    ...
    (define gx#make-AST
      (lambda _%$args128650%_ (apply make-instance gx#AST::t _%$args128650%_)))
    (define gx#AST-e
