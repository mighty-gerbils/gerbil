...
(begin
  (define gerbil/expander/common::timestamp 1755903075)
  (begin
    (define gx#AST::t
      (let ((__tmp121369 (list))
            (__tmp121368 (cons (cons 'struct: '#t) '((print: e)))))
        (declare (not safe))
        (__make-class-type
         'gerbil#AST::t
         'syntax
    ...
    (define gx#make-AST
      (lambda _%$args121267%_ (apply make-instance gx#AST::t _%$args121267%_)))
    (define gx#AST-e
