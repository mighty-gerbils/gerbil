...
(begin
  (define gerbil/expander/common::timestamp 1734215269)
  (begin
    (define gx#AST::t
      (let ((__tmp117158 (list))
            (__tmp117157 (cons (cons 'struct: '#t) '((print: e)))))
        (declare (not safe))
        (__make-class-type
         'gerbil#AST::t
         'syntax
    ...
    (define gx#make-AST
      (lambda _%$args117056%_ (apply make-instance gx#AST::t _%$args117056%_)))
    (define gx#AST-e
