...
(begin
  (define gerbil/expander/common::timestamp 1712697255)
  (begin
    (define gx#AST::t
      (let ((__tmp112936 (list))
            (__tmp112935 (cons (cons 'struct: '#t) '((print: e)))))
        (declare (not safe))
        (__make-class-type
         'gerbil#AST::t
         'syntax
    ...
    (define gx#make-AST
      (lambda _%$args112834%_ (apply make-instance gx#AST::t _%$args112834%_)))
    (define gx#AST-e
