...
(begin
  (define gerbil/expander/common::timestamp 1712823026)
  (begin
    (define gx#AST::t
      (let ((__tmp114941 (list))
            (__tmp114940 (cons (cons 'struct: '#t) '((print: e)))))
        (declare (not safe))
        (__make-class-type
         'gerbil#AST::t
         'syntax
    ...
    (define gx#make-AST
      (lambda _%$args114839%_ (apply make-instance gx#AST::t _%$args114839%_)))
    (define gx#AST-e
