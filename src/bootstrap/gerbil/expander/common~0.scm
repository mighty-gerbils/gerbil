...
(begin
  (define gerbil/expander/common::timestamp 1779289639)
  (begin
    (define gx#AST::t
      (let ((__tmp173809 (list))
            (__tmp173808 (cons (cons 'struct: '#t) '((print: e)))))
        (declare (not safe))
        (__make-class-type
         'gerbil#AST::t
         'syntax
    ...
    (define gx#make-AST
      (lambda _%$args173707%_ (apply make-instance gx#AST::t _%$args173707%_)))
    (define gx#AST-e
