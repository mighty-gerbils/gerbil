...
(begin
  (define gerbil/expander/common::timestamp 1733687559)
  (begin
    (define gx#AST::t
      (let ((__tmp116913 (list))
            (__tmp116912 (cons (cons 'struct: '#t) '((print: e)))))
        (declare (not safe))
        (__make-class-type
         'gerbil#AST::t
         'syntax
    ...
    (define gx#make-AST
      (lambda _%$args116811%_ (apply make-instance gx#AST::t _%$args116811%_)))
    (define gx#AST-e
