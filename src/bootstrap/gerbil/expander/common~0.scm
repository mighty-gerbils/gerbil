...
(begin
  (define gerbil/expander/common::timestamp 1734131746)
  (begin
    (define gx#AST::t
      (let ((__tmp117056 (list))
            (__tmp117055 (cons (cons 'struct: '#t) '((print: e)))))
        (declare (not safe))
        (__make-class-type
         'gerbil#AST::t
         'syntax
    ...
    (define gx#make-AST
      (lambda _%$args116954%_ (apply make-instance gx#AST::t _%$args116954%_)))
    (define gx#AST-e
