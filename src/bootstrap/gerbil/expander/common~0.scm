...
(begin
  (define gerbil/expander/common::timestamp 1712786278)
  (begin
    (define gx#AST::t
      (let ((__tmp114943 (list))
            (__tmp114942 (cons (cons 'struct: '#t) '((print: e)))))
        (declare (not safe))
        (__make-class-type
         'gerbil#AST::t
         'syntax
    ...
    (define gx#make-AST
      (lambda _%$args114841%_ (apply make-instance gx#AST::t _%$args114841%_)))
    (define gx#AST-e
