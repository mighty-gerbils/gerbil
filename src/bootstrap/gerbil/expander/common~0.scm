...
(begin
  (define gerbil/expander/common::timestamp 1712246555)
  (begin
    (define gx#AST::t
      (let ((__tmp113764 (list))
            (__tmp113763 (cons (cons 'struct: '#t) '((print: e)))))
        (declare (not safe))
        (__make-class-type
         'gerbil#AST::t
         'syntax
    ...
    (define gx#make-AST
      (lambda _%$args113662%_ (apply make-instance gx#AST::t _%$args113662%_)))
    (define gx#AST-e
