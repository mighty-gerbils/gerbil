...
(begin
  (define gerbil/expander/common::timestamp 1712269045)
  (begin
    (define gx#AST::t
      (let ((__tmp113673 (list))
            (__tmp113672 (cons (cons 'struct: '#t) '((print: e)))))
        (declare (not safe))
        (__make-class-type
         'gerbil#AST::t
         'syntax
    ...
    (define gx#make-AST
      (lambda _%$args113571%_ (apply make-instance gx#AST::t _%$args113571%_)))
    (define gx#AST-e
