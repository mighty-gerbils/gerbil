...
(begin
  (define gerbil/expander/common::timestamp 1733868035)
  (begin
    (define gx#AST::t
      (let ((__tmp116950 (list))
            (__tmp116949 (cons (cons 'struct: '#t) '((print: e)))))
        (declare (not safe))
        (__make-class-type
         'gerbil#AST::t
         'syntax
    ...
    (define gx#make-AST
      (lambda _%$args116848%_ (apply make-instance gx#AST::t _%$args116848%_)))
    (define gx#AST-e
