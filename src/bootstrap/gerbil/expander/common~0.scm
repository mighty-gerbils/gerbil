...
(begin
  (define gerbil/expander/common::timestamp 1768865823)
  (begin
    (define gx#AST::t
      (let ((__tmp128767 (list)) (__tmp128766 (cons (cons 'struct: '#t) '())))
        (declare (not safe))
        (__make-class-type
         'gerbil#AST::t
         'syntax
    ...
    (define gx#make-AST
      (lambda _%$args128665%_ (apply make-instance gx#AST::t _%$args128665%_)))
    (define gx#AST-e
