...
(begin
  (define gerbil/expander/common::timestamp 1712533289)
  (begin
    (define gx#AST::t
      (let ((__tmp113674 (list))
            (__tmp113673 (cons (cons 'struct: '#t) '((print: e)))))
        (declare (not safe))
        (__make-class-type
         'gerbil#AST::t
         'syntax
    ...
    (define gx#make-AST
      (lambda _%$args113572%_ (apply make-instance gx#AST::t _%$args113572%_)))
    (define gx#AST-e
