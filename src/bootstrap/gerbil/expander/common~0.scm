...
(begin
  (define gerbil/expander/common::timestamp 1712784665)
  (begin
    (define gx#AST::t
      (let ((__tmp114225 (list))
            (__tmp114224 (cons (cons 'struct: '#t) '((print: e)))))
        (declare (not safe))
        (__make-class-type
         'gerbil#AST::t
         'syntax
    ...
    (define gx#make-AST
      (lambda _%$args114123%_ (apply make-instance gx#AST::t _%$args114123%_)))
    (define gx#AST-e
