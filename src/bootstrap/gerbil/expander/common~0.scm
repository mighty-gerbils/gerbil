...
(begin
  (define gerbil/expander/common::timestamp 1771037608)
  (begin
    (define gx#AST::t
      (let ((__tmp181011 (list))
            (__tmp181010 (cons (cons 'struct: '#t) '((print: e)))))
        (declare (not safe))
        (__make-class-type
         'gerbil#AST::t
         'syntax
    ...
    (define gx#make-AST
      (lambda _%$args180909%_ (apply make-instance gx#AST::t _%$args180909%_)))
    (define gx#AST-e
