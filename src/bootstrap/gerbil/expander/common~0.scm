...
(begin
  (define gerbil/expander/common::timestamp 1713453199)
  (begin
    (define gx#AST::t
      (let ((__tmp115622 (list))
            (__tmp115621 (cons (cons 'struct: '#t) '((print: e)))))
        (declare (not safe))
        (__make-class-type
         'gerbil#AST::t
         'syntax
    ...
    (define gx#make-AST
      (lambda _%$args115520%_ (apply make-instance gx#AST::t _%$args115520%_)))
    (define gx#AST-e
