...
(begin
  (define gerbil/expander/common::timestamp 1742237312)
  (begin
    (define gx#AST::t
      (let ((__tmp117996 (list))
            (__tmp117995 (cons (cons 'struct: '#t) '((print: e)))))
        (declare (not safe))
        (__make-class-type
         'gerbil#AST::t
         'syntax
    ...
    (define gx#make-AST
      (lambda _%$args117894%_ (apply make-instance gx#AST::t _%$args117894%_)))
    (define gx#AST-e
