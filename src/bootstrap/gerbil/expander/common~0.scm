...
(begin
  (define gerbil/expander/common::timestamp 1771093448)
  (begin
    (define gx#AST::t
      (let ((__tmp172008 (list))
            (__tmp172007 (cons (cons 'struct: '#t) '((print: e)))))
        (declare (not safe))
        (__make-class-type
         'gerbil#AST::t
         'syntax
    ...
    (define gx#make-AST
      (lambda _%$args171906%_ (apply make-instance gx#AST::t _%$args171906%_)))
    (define gx#AST-e
