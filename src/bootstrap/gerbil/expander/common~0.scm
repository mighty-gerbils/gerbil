...
(begin
  (define gerbil/expander/common::timestamp 1712093476)
  (begin
    (define gx#AST::t
      (let ((__tmp113220 (list)) (__tmp113219 (cons (cons 'struct: '#t) '())))
        (declare (not safe))
        (make-class-type
         'gerbil#AST::t
         'syntax
    ...
    (define gx#make-AST
      (lambda _%$args113118%_ (apply make-instance gx#AST::t _%$args113118%_)))
    (define gx#AST-e
