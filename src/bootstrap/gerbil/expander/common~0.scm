...
(begin
  (define gerbil/expander/common::timestamp 1770405373)
  (begin
    (define gx#AST::t
      (let ((__tmp168948 (list)) (__tmp168947 (cons (cons 'struct: '#t) '())))
        (declare (not safe))
        (__make-class-type
         'gerbil#AST::t
         'syntax
    ...
    (define gx#make-AST
      (lambda _%$args168846%_ (apply make-instance gx#AST::t _%$args168846%_)))
    (define gx#AST-e
