...
(begin
  (define gerbil/expander/common::timestamp 1712262513)
  (begin
    (define gx#AST::t
      (let ((__tmp113747 (list))
            (__tmp113746 (cons (cons 'struct: '#t) '((print: e)))))
        (declare (not safe))
        (__make-class-type
         'gerbil#AST::t
         'syntax
    ...
    (define gx#make-AST
      (lambda _%$args113645%_ (apply make-instance gx#AST::t _%$args113645%_)))
    (define gx#AST-e
