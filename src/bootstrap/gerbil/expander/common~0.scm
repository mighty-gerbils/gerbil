...
(begin
  (define gerbil/expander/common::timestamp 1712124234)
  (begin
    (define gx#AST::t
      (let ((__tmp113166 (list)) (__tmp113165 (cons (cons 'struct: '#t) '())))
        (declare (not safe))
        (make-class-type
         'gerbil#AST::t
         'syntax
    ...
    (define gx#make-AST
      (lambda _%$args113064%_ (apply make-instance gx#AST::t _%$args113064%_)))
    (define gx#AST-e
