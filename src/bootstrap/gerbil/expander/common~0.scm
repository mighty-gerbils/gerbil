...
(begin
  (define gerbil/expander/common::timestamp 1784471381)
  (begin
    (define gx#AST::t
      (let ((__tmp181113 (list))
            (__tmp181112 (cons (cons 'struct: '#t) '((print: e)))))
        (declare (not safe))
        (__make-class-type
         'gerbil#AST::t
         'syntax
    ...
    (define gx#make-AST
      (lambda _%$args181011%_ (apply make-instance gx#AST::t _%$args181011%_)))
    (define gx#AST-e
