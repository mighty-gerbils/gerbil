...
(begin
  (define gerbil/expander/common::timestamp 1769382894)
  (begin
    (define gx#AST::t
      (let ((__tmp129172 (list)) (__tmp129171 (cons (cons 'struct: '#t) '())))
        (declare (not safe))
        (__make-class-type
         'gerbil#AST::t
         'syntax
    ...
    (define gx#make-AST
      (lambda _%$args129070%_ (apply make-instance gx#AST::t _%$args129070%_)))
    (define gx#AST-e
