...
(begin
  (define gerbil/expander/common::timestamp 1712696213)
  (begin
    (define gx#AST::t
      (let ((__tmp113699 (list))
            (__tmp113698 (cons (cons 'struct: '#t) '((print: e)))))
        (declare (not safe))
        (__make-class-type
         'gerbil#AST::t
         'syntax
    ...
    (define gx#make-AST
      (lambda _%$args113597%_ (apply make-instance gx#AST::t _%$args113597%_)))
    (define gx#AST-e
