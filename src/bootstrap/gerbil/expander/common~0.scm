...
(begin
  (define gerbil/expander/common::timestamp 1756224515)
  (begin
    (define gx#AST::t
      (let ((__tmp125047 (list))
            (__tmp125046 (cons (cons 'struct: '#t) '((print: e)))))
        (declare (not safe))
        (__make-class-type
         'gerbil#AST::t
         'syntax
    ...
    (define gx#make-AST
      (lambda _%$args124945%_ (apply make-instance gx#AST::t _%$args124945%_)))
    (define gx#AST-e
