...
(begin
  (define gerbil/expander/common::timestamp 1783939348)
  (begin
    (define gx#AST::t
      (let ((__tmp178456 (list))
            (__tmp178455 (cons (cons 'struct: '#t) '((print: e)))))
        (declare (not safe))
        (__make-class-type
         'gerbil#AST::t
         'syntax
    ...
    (define gx#make-AST
      (lambda _%$args178354%_ (apply make-instance gx#AST::t _%$args178354%_)))
    (define gx#AST-e
