...
(begin
  (define gerbil/expander/common::timestamp 1713004410)
  (begin
    (define gx#AST::t
      (let ((__tmp115400 (list))
            (__tmp115399 (cons (cons 'struct: '#t) '((print: e)))))
        (declare (not safe))
        (__make-class-type
         'gerbil#AST::t
         'syntax
    ...
    (define gx#make-AST
      (lambda _%$args115298%_ (apply make-instance gx#AST::t _%$args115298%_)))
    (define gx#AST-e
