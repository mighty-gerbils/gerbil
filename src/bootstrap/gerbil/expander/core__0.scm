...
(begin
          ...
          (cond ((fx= _g4375_ 1)
                 (apply (lambda (_self4329_)
                          (let ((_super4331_ (gx#current-expander-context)))
                            (_opt-lambda43214326_ _self4329_ _super4331_)))
                        _g4376_))
                ((fx= _g4375_ 2)
                 (apply (lambda (_self4333_ _super4334_)
                          (_opt-lambda43214326_ _self4333_ _super4334_))
                        _g4376_))
  ...
  (define gx#eval-syntax
    (let ((_opt-lambda42304235_
           (lambda (_stx4232_ _expression?4233_)
             (gx#eval-syntax* (gx#core-expand _stx4232_ _expression?4233_)))))
      (lambda _g4378_
        (let ((_g4377_ (length _g4378_)))
          (cond ((fx= _g4377_ 1)
                 (apply (lambda (_stx4238_)
                          (let ((_expression?4240_ '#f))
                            (_opt-lambda42304235_
                             _stx4238_
                             _expression?4240_)))
                        _g4378_))
                ((fx= _g4377_ 2)
                 (apply (lambda (_stx4242_ _expression?4243_)
                          (_opt-lambda42304235_ _stx4242_ _expression?4243_))
                        _g4378_))
    ...
    (let ((_opt-lambda42144219_
      ...
      (lambda _g4380_
        (let ((_g4379_ (length _g4380_)))
          (cond ((fx= _g4379_ 1)
                 (apply (lambda (_stx4222_)
                          (let ((_expression?4224_ '#f))
                            (_opt-lambda42144219_
                             _stx4222_
                             _expression?4224_)))
                        _g4380_))
                ((fx= _g4379_ 2)
                 (apply (lambda (_stx4226_ _expression?4227_)
                          (_opt-lambda42144219_ _stx4226_ _expression?4227_))
                        _g4380_))
                (else (error "No clause matching arguments" _g4380_)))))))
  (define gx#core-expand-top
    (lambda (_stx4183_)
      (let ((_stx4185_ (gx#core-expand* _stx4183_)))
                         ...
                         (let ((_e41894201_ (gx#syntax-e _e41864193_)))
                           (let ((_hd41904204_ (##car _e41894201_))
                             ...
                             (let ((_form4209_ _hd41904204_))
                               (if (gx#core-bound-identifier? _form4209_)
                                   _stx4185_
                                   (_E41884197_)))))
                         (_E41884197_)))))
              (let () (_E41874211_))))))))
                 ...
                 (lambda (_form4146_ _hd4147_)
                   (let ((_bind4149_
                          (if (##structure-instance-of?
                               ...
                               'gx#binding::t)
                              _form4146_
                              (gx#resolve-identifier _form4146_))))
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                       ...
                                       (_E41144123_)))))
                            (let () (_E41134142_)))))
                      (if (gx#core-bound-identifier? _hd4111_)
                          (_illegal-expression4108_ _hd4111_)
    ...
    (let ((_opt-lambda40794090_
      ...
      (lambda _g4383_
        (let ((_g4382_ (length _g4383_)))
          (cond ((fx= _g4382_ 1)
                 (apply (lambda (_stx4093_)
                          (let ((_stop?4095_ false))
                            (_opt-lambda40794090_ _stx4093_ _stop?4095_)))
                        _g4383_))
                ((fx= _g4382_ 2)
                 (apply (lambda (_stx4097_ _stop?4098_)
                          (_opt-lambda40794090_ _stx4097_ _stop?4098_))
                        _g4383_))
  ...
  (define gx#core-expand1
    (lambda (_stx4031_)
      (let ((_step4033_
             (lambda (_hd4070_)
               (let ((_bind4072_ (gx#resolve-identifier _hd4070_)))
                 (if (##structure-instance-of?
                      _bind4072_
                      'gx#runtime-binding::t)
                     _stx4031_
                                ...
                                (let ((_e40054017_ (gx#syntax-e _e40024009_)))
                                  (let ((_hd40064020_ (##car _e40054017_))
                                    ...
                                    (let ((_hd4025_ _hd40064020_))
                                      (if '#t
                                          (gx#core-bound-identifier? _hd4025_)
                                          (_E40044013_)))))
                                (_E40044013_)))))
                     (let () (_E40034027_))))))))
        (gx#core-expand* _stx3997_ _stop?3999_))))
  (define gx#core-expand-block
    (let ((_opt-lambda38013976_
           (lambda (_stx3803_
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                         _form3895_)
                        (gx#resolve-identifier _form3895_)
                        '#f)))
               (if (gx#special-form-binding? _bind3899_)
                   (let ((_$e3901_
                          (##structure-ref _bind3899_ '1 gx#binding::t '#f)))
                     (if (eq? _$e3901_ '%#begin)
                         (_expand-splice3808_
                          _hd3871_
                          _body3897_
                          _rest3869_
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
  ...
  (define gx#core-expand-block*
    (lambda (_stx3751_ _expand-special3752_)
      (let ((_g37533764_
             (gx#core-expand-block _stx3751_ _expand-special3752_ '#f)))
        (let ((_E37573768_
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                     ...
                     (if _$e3590_
                         ...
                         (gx#core-resolve-path
                          _path3588_
                          (gx#stx-source _stx3552_))))))
              (if (member _rpath3593_ (gx#current-expander-path))
                  (gx#raise-syntax-error
                   '#f
                  ...
                  (gx#syntax-local-rewrap
                   (gx#stx-wrap-source
                    (gx#core-cons '%#begin (read-syntax-from-file _rpath3593_))
                    (gx#stx-source _stx3552_)))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                    (_E35563568_))
                                                (_E35563568_)))))
        ...
        (let ((_g4386_ (length _g4387_)))
          (cond ((fx= _g4386_ 1)
                 (apply (lambda (_stx3602_)
                          (let ((_rpath3604_ '#f))
                            (_opt-lambda35503599_ _stx3602_ _rpath3604_)))
                        _g4387_))
                ((fx= _g4386_ 2)
                 (apply (lambda (_stx3606_ _rpath3607_)
                          (_opt-lambda35503599_ _stx3606_ _rpath3607_))
                        _g4387_))
                (else (error "No clause matching arguments" _g4387_)))))))
  (define gx#core-apply-expander
    (let ((_opt-lambda35193539_
    ...
    (lambda (_self3492_ _stx3493_)
      (let ((_self34943500_ _self3492_))
        (let ((_E34963504_
          ...
          (let ((_K34973509_
                 (lambda (_K3507_)
                   (gx#core-apply-expander _K3507_ _stx3493_))))
      ...
      (if (gx#sealed-syntax? _stx3468_)
          ...
          (let ((_self34693475_ _self3467_))
            (let ((_E34713479_
              ...
              (let ((_K34723484_
                     (lambda (_K3482_)
                       (gx#core-apply-expander _K3482_ _stx3468_))))
                   ...
                   (if (struct-instance? gx#user-expander::t _self33453353_)
                       (let ((_e33493367_ (##vector-ref _self33453353_ '1)))
                         (let ((_K3370_ _e33493367_))
                           (let ((_e33503372_
                                  (##vector-ref _self33453353_ '2)))
                             (let ((_ctx3375_ _e33503372_))
                               (let ((_e33513377_
                                      (##vector-ref _self33453353_ '3)))
                        ...
                        (lambda (_bind3312_)
                          (if (##structure-direct-instance-of?
                              ...
                              (if (##structure-direct-instance-of?
                                  ...
                                  _bind3312_)))))
                _lp3310_)
              (gx#core-resolve-identifier _stx3306_ _phi3307_ _ctx3308_)))))
      (lambda _g4395_
          ...
          (cond ((fx= _g4394_ 1)
                ...
                ((fx= _g4394_ 3)
                 (apply (lambda (_stx3328_ _phi3329_ _ctx3330_)
                          (_opt-lambda33043314_ _stx3328_ _phi3329_ _ctx3330_))
                        _g4395_))
                (else (error "No clause matching arguments" _g4395_)))))))
  (define gx#bind-identifier!
    (let ((_opt-lambda32623272_
          ...
          (cond ((fx= _g4398_ 1)
                ...
                ((fx= _g4398_ 3)
                 (apply (lambda (_stx3259_ _phi3260_ _ctx3261_)
                          (_opt-lambda32343245_ _stx3259_ _phi3260_ _ctx3261_))
                        _g4399_))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                    ...
                    (begin
                      (##structure-set!
                       ...
                       gx#expander-mark::t
                       '#f)
                      (_gensubst3033_ _subst3073_ _id3057_)))
                  (let ((_$e3075_ (hash-get _subst3071_ _id3057_)))
                    (if _$e3075_
                        (values _$e3075_)
                        (_gensubst3033_ _subst3071_ _id3057_)))))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                               (if (struct-instance?
                                                    gx#expander-mark::t
                                                    _mark30583064_)
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                 ...
                 (apply (lambda ()
                          (let ((_ctx2860_ (gx#current-expander-context)))
                            (let ((_stop?2862_ gx#top-context?))
                              (_opt-lambda28472856_ _ctx2860_ _stop?2862_))))
                        _g4403_))
                ((fx= _g4402_ 1)
                 (apply (lambda (_ctx2864_)
                          (let ((_stop?2866_ gx#top-context?))
                            (_opt-lambda28472856_ _ctx2864_ _stop?2866_)))
                        _g4403_))
                ((fx= _g4402_ 2)
                 (apply (lambda (_ctx2868_ _stop?2869_)
                          (_opt-lambda28472856_ _ctx2868_ _stop?2869_))
                        _g4403_))
                (else (error "No clause matching arguments" _g4403_)))))))
  (define gx#core-context-root
    (let ((_opt-lambda28322840_
           (lambda (_ctx2834_)
             ((letrec ((_lp2836_
                        (lambda (_ctx2838_)
                          (if (##structure-instance-of?
          ...
          (cond ((fx= _g4404_ 0)
                 (apply (lambda ()
                          (let ((_ctx2844_ (gx#current-expander-context)))
                            (_opt-lambda28322840_ _ctx2844_)))
                        _g4405_))
                ((fx= _g4404_ 1)
                 (apply (lambda (_ctx2846_) (_opt-lambda28322840_ _ctx2846_))
                        _g4405_))
                (else (error "No clause matching arguments" _g4405_)))))))
  (define gx#core-context-rebind?
    (let ((_opt-lambda28162822_
          ...
          (cond ((fx= _g4406_ 0)
                 (apply (lambda ()
                          (let ((_ctx2826_ (gx#current-expander-context)))
                            (_opt-lambda28162822_ _ctx2826_)))
                        _g4407_))
                ((fx= _g4406_ 1)
                 (apply (lambda (_ctx2828_) (_opt-lambda28162822_ _ctx2828_))
                        _g4407_))
                ((fx>= _g4406_ 1)
                 (apply (lambda (_ctx2830_ . __28152831_)
                          (apply _opt-lambda28162822_ _ctx2830_ __28152831_))
                        _g4407_))
                (else (error "No clause matching arguments" _g4407_)))))))
  (define gx#core-context-namespace
    (let ((_opt-lambda27992808_
           (lambda (_ctx2801_)
             (let ((_$e2803_ (gx#core-context-top _ctx2801_)))
               (if _$e2803_
                   ((lambda (_ctx2806_)
                      (if (##structure-instance-of?
                           _ctx2806_
          ...
          (cond ((fx= _g4408_ 0)
                 (apply (lambda ()
                          (let ((_ctx2812_ (gx#current-expander-context)))
                            (_opt-lambda27992808_ _ctx2812_)))
                        _g4409_))
                ((fx= _g4408_ 1)
                 (apply (lambda (_ctx2814_) (_opt-lambda27992808_ _ctx2814_))
                        _g4409_))
                (else (error "No clause matching arguments" _g4409_)))))))
  (define gx#expander-binding?
    (let ((_opt-lambda27852790_
          ...
          (cond ((fx= _g4410_ 1)
                 (apply (lambda (_bind2793_)
                          (let ((_is?2795_ gx#expander?))
                            (_opt-lambda27852790_ _bind2793_ _is?2795_)))
                        _g4411_))
                ((fx= _g4410_ 2)
                 (apply (lambda (_bind2797_ _is?2798_)
                          (_opt-lambda27852790_ _bind2797_ _is?2798_))
                        _g4411_))
                (else (error "No clause matching arguments" _g4411_)))))))
  (define gx#core-expander-binding?
    (lambda (_bind2784_) (gx#expander-binding? _bind2784_ gx#core-expander?)))
  (define gx#expression-form-binding?
    (lambda (_bind2782_)
      (gx#expander-binding? _bind2782_ gx#expression-form?)))
  (define gx#special-form-binding?
    (lambda (_bind2780_) (gx#expander-binding? _bind2780_ gx#special-form?)))
               ...
               (let ((_$e2777_
                 ...
                 (if _$e2777_
                     ...
                     (##structure-instance-of?
                      _e2775_
                      'gx#module-context::t))))))
        (gx#expander-binding? _bind2771_ _feature?2773_))))
  (define gx#private-feature-binding?
    (lambda (_bind2769_)
      (gx#expander-binding? _bind2769_ gx#private-feature-expander?)))
  (define gx#core-bound-identifier?
    (let ((_opt-lambda27542759_
           (lambda (_id2756_ _bound?2757_)
             (if (gx#identifier? _id2756_)
                 (_bound?2757_ (gx#resolve-identifier _id2756_))
                 '#f))))
      (lambda _g4413_
          ...
          (cond ((fx= _g4412_ 1)
                 (apply (lambda (_id2762_)
                          (let ((_bound?2764_ gx#core-expander-binding?))
                            (_opt-lambda27542759_ _id2762_ _bound?2764_)))
                        _g4413_))
                ((fx= _g4412_ 2)
                 (apply (lambda (_id2766_ _bound?2767_)
                          (_opt-lambda27542759_ _id2766_ _bound?2767_))
                        _g4413_))
  ...
  (define gx#core-identifier=?
    (lambda (_x2746_ _y2747_)
      (let ((_y=?2749_
        ...
        (let ((_bind2751_ (gx#resolve-identifier _x2746_)))
  ...
  (define gx#core-cons
    (lambda (_hd2698_ _tl2699_)
      (cons (gx#core-quote-syntax _hd2698_) _tl2699_)))
  (define gx#core-list
    (lambda (_hd2695_ . _rest2696_)
      (cons (gx#core-quote-syntax _hd2695_) _rest2696_)))
  (define gx#core-cons*
    (lambda (_hd2692_ . _rest2693_)
      (apply cons* (gx#core-quote-syntax _hd2692_) _rest2693_)))
  (define gx#core-resolve-path
    (let ((_opt-lambda26642682_
        ...
        (let ((_g4416_ (length _g4417_)))
          (cond ((fx= _g4416_ 1)
                 (apply (lambda (_stx-path2685_)
                          (let ((_rel2687_ '#f))
                            (_opt-lambda26642682_ _stx-path2685_ _rel2687_)))
                        _g4417_))
                ((fx= _g4416_ 2)
                 (apply (lambda (_stx-path2689_ _rel2690_)
                          (_opt-lambda26642682_ _stx-path2689_ _rel2690_))
                        _g4417_))
  ...
  (define gx#syntax-local-unwrap
    (lambda (_stx2661_) (gx#stx-unwrap _stx2661_ (gx#current-expander-marks))))
  ...
  (define gx#syntax-local-e
    (let ((_opt-lambda26122619_
           (lambda (_stx2614_ _E2615_)
             (let ((_bind2617_ (gx#resolve-identifier _stx2614_)))
               (if (##structure-direct-instance-of?
                    _bind2617_
                    'gx#syntax-binding::t)
      ...
      (lambda _g4419_
        (let ((_g4418_ (length _g4419_)))
          (cond ((fx= _g4418_ 1)
                 (apply (lambda (_stx2622_)
                          (let ((_E2624_ gx#raise-syntax-ref-error))
                            (_opt-lambda26122619_ _stx2622_ _E2624_)))
                        _g4419_))
                ((fx= _g4418_ 2)
                 (apply (lambda (_stx2626_ _E2627_)
                          (_opt-lambda26122619_ _stx2626_ _E2627_))
                        _g4419_))
                (else (error "No clause matching arguments" _g4419_)))))))
  (define gx#syntax-local-value
    (let ((_opt-lambda25962603_
           (lambda (_stx2598_ _E2599_)
             (let ((_e2601_ (gx#syntax-local-e _stx2598_ _E2599_)))
          ...
          (cond ((fx= _g4420_ 1)
                 (apply (lambda (_stx2606_)
                          (let ((_E2608_ gx#raise-syntax-ref-error))
                            (_opt-lambda25962603_ _stx2606_ _E2608_)))
                        _g4421_))
                ((fx= _g4420_ 2)
                 (apply (lambda (_stx2610_ _E2611_)
                          (_opt-lambda25962603_ _stx2610_ _E2611_))
                        _g4421_))
