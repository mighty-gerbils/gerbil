                                        ...
                                        (___kont49354936_
                                         (lambda ()
                                           (gx#raise-syntax-error
                                            ...
                                            _stx104_
                                            _hd1171_))))
                                    (if (gx#stx-pair? ___stx49284929_)
                                        (let ((_e11811280_
                                               (gx#syntax-e ___stx49284929_)))
                                          (let ((_tl11831287_
                                                 (let ()
                                                   (declare (not safe))
                                                   (##cdr _e11811280_)))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                ...
                (___kont49774978_ _tl671958_ _hd670955_)))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                    (___kont49794980_)))))))
                                  (_recur656_
                                   _hd651_
                                         ...
                                         (_g399411_
                                          (lambda ()
                                            (gx#raise-syntax-error
                                             ...
                                             '"Bad syntax"
                                             ___stx50105011_))))
                                    (let ((___kont50135014_
                                           (lambda (_L476_ _L478_)
                                             (let* ((___stx49904991_ _L478_)
                                                    (_g490501_
                                                     (lambda ()
                                                       (gx#raise-syntax-error
                                                        '#f
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                 ...
                 (if (gx#identifier? _hd494624_)
                     (if (gx#free-identifier=? |gx[1]#_g5027_| _hd494624_)
                         (___kont49934994_ _tl495627_)
                         (___kont49954996_))
                     (___kont49954996_))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                     (___kont49954996_))))))
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                               (_g421455_ _tgt256_)))))
                                      (if (gx#stx-pair? ___stx50105011_)
                                          (let ((_e403466_
                                                 (gx#syntax-e
                                                  ___stx50105011_)))
                                            (let ((_tl405473_
                             ...
                             (_g268383_
                              (lambda (_g270290_)
                                (if (gx#stx-pair/null? _g270290_)
                                    (let ((_g5028_ (gx#syntax-split-splice
                                                    _g270290_
                                                    '0)))
                                      (begin
                                        (let ((_g5029_ (let ()
                                        ...
                                        (let ((_target272293_
                                               (let ()
                                                 (declare (not safe))
                                                 (##vector-ref _g5028_ 0)))
                                              (_tl274296_
                                               (let ()
                                                 (declare (not safe))
                                                 (##vector-ref _g5028_ 1))))
