...
(begin
  ...
  (declare-type
   ...
   (@case-lambda
    ...
    (2 gx#expander-context::bind-core-macro-expanders!__opt-lambda12774)))
  (declare-method
   gx#expander-context::t
