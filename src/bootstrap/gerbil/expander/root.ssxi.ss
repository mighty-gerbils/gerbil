...
(begin
  ...
  (declare-type
   ...
   (@case-lambda
    ...
    (2 gx#expander-context::bind-core-macro-expanders!__opt-lambda13507)))
  (declare-method
   gx#expander-context::t
