...
(begin
  ...
  (declare-type
   ...
   (@case-lambda
    ...
    (2 gx#expander-context::bind-core-macro-expanders!__opt-lambda15785)))
  (declare-method
   gx#expander-context::t
