...
(begin
  (define gerbil/expander/root::timestamp 1707738032)
  (begin
    (declare (not safe))
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
    ...
    (define gx#root-context:::init!::specialize
      (lambda (__t178827)
        (let ((__bind-core-syntax-expanders!178828
               (make-promise
                (lambda ()
                  (let ((__tmp178831
                         (direct-method-ref
          ...
          (let ((_opt-lambda174245174250_
                 (lambda (_self174247_ _bind?174248_)
                   ...
                   (if _bind?174248_
                       (begin
                         ((force __bind-core-syntax-expanders!178828)
                          _self174247_)
                         ((force __bind-core-macro-expanders!178829)
                          _self174247_)
                         ((force __bind-core-features!178830) _self174247_))
                       '#!void))))
            (lambda _g178873_
