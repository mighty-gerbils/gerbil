      ...
      (define gx#root-context:::init!
        (lambda _g18260_
          (let ((_g18259_ (length _g18260_)))
            (cond ((##fx= _g18259_ 1)
                   (apply gx#root-context:::init!__0 _g18260_))
                  ((##fx= _g18259_ 2)
                   (apply gx#root-context:::init!__% _g18260_))
                  (else
      ...
      (define gx#top-context:::init!
        (lambda _g18262_
          (let ((_g18261_ (length _g18262_)))
            (cond ((##fx= _g18261_ 1)
                   (apply gx#top-context:::init!__0 _g18262_))
                  ((##fx= _g18261_ 2)
                   (apply gx#top-context:::init!__% _g18262_))
                  (else
                   (##raise-wrong-number-of-arguments-exception
                    gx#top-context:::init!
                    _g18262_))))))))
                         ...
                         (let ((_K1760217641_
                           ...
                           (let ((_try-match1759617620_
                             ...
                             (if (##pair? _rest1759317608_)
                                 (let ((_tl1760417646_
                                        (##cdr _rest1759317608_))
                                       (_hd1760317644_
                                        (##car _rest1759317608_)))
