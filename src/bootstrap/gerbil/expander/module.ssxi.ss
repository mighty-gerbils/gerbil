...
(begin
  ...
  (declare-type
   ...
   (@case-lambda
    ...
    (3 gx#prelude-context:::init!__opt-lambda11437)))
  ...
  (declare-type
   ...
   (@case-lambda
    ...
    (3 gx#import-module__opt-lambda11385)))
  (declare-type
   gx#core-context-prelude
   (@case-lambda
    (0 gx#core-context-prelude__0)
    (1 gx#core-context-prelude__opt-lambda11350)))
  (declare-type
   gx#core-import-module
   (@case-lambda
    (1 gx#core-import-module__0)
    (2 gx#core-import-module__opt-lambda11294)))
  (declare-type
   gx#core-resolve-module-path
   (@case-lambda
    (1 gx#core-resolve-module-path__0)
    (2 gx#core-resolve-module-path__opt-lambda10967)))
  (declare-type
   gx#core-bind-import!
   (@case-lambda
    (1 gx#core-bind-import!__0)
    (2 gx#core-bind-import!__1)
    (3 gx#core-bind-import!__opt-lambda10805)))
  (declare-type
   gx#core-bind-weak-import!
   (@case-lambda
    (1 gx#core-bind-weak-import!__0)
    (2 gx#core-bind-weak-import!__opt-lambda10791)))
  (declare-type
   gx#core-module-export->import
   (@case-lambda
    (1 gx#core-module-export->import__0)
    (2 gx#core-module-export->import__1)
    (3 gx#core-module-export->import__opt-lambda10607)))
  (declare-type
   gx#core-expand-import%
   (@case-lambda
    (1 gx#core-expand-import%__0)
    (2 gx#core-expand-import%__opt-lambda9679)))
  (declare-type
   gx#core-expand-export%
   (@case-lambda
    (1 gx#core-expand-export%__0)
    (2 gx#core-expand-export%__opt-lambda9188)))
  (declare-type
   ...
   (@case-lambda
    ...
    (4 gx#core-bind-feature!__opt-lambda9121))))
