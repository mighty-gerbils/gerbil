...
(begin
  ...
  (declare-type
   ...
   (@case-lambda
    ...
    (3 gx#prelude-context:::init!__opt-lambda11108)))
  ...
  (declare-type
   ...
   (@case-lambda
    ...
    (3 gx#import-module__opt-lambda11056)))
  (declare-type
   gx#core-context-prelude
   (@case-lambda
    (0 gx#core-context-prelude__0)
    (1 gx#core-context-prelude__opt-lambda11021)))
  (declare-type
   gx#core-import-module
   (@case-lambda
    (1 gx#core-import-module__0)
    (2 gx#core-import-module__opt-lambda10965)))
  (declare-type
