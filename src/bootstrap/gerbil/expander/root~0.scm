...
(begin
  (define gerbil/expander/root::timestamp 1770336543)
  (begin
    (declare (not safe))
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
    ...
    (define gx#root-context:::init!::specialize
      (lambda (__klass155162 __method-table155163)
        (let ((__bind-core-syntax-expanders!155164
               (__make-promise
                (lambda ()
                  (let ((__method155167
                         (symbolic-table-ref
              ...
              (__bind-core-macro-expanders!155166
               (__make-promise
                (lambda ()
                  (let ((__method155169
                         (symbolic-table-ref
          ...
          (let ((_%opt-lambda155136155153%_
                 (lambda (_%self155138%_ _%bind?155139%_)
                   (let ((_%self155142%_ _%self155138%_))
                     ...
                     (if _%bind?155139%_
                         (begin
                           ((force __bind-core-syntax-expanders!155164)
                            _%self155142%_)
                           ((force __bind-core-macro-expanders!155166)
                            _%self155142%_)
                           ((force __bind-core-features!155165)
                            _%self155142%_))
                         '#!void)))))
            (lambda _g155214_
