      ...
      (|gerbil/core$<MOP>$<MOP:2>[1]#make-extended-struct-info|
       ...
       (cons '#f
             (cons |gx[1]#_g9442_|
                   (cons |gx[1]#_g9443_|
                         (cons |gx[1]#_g9444_|
                               (cons (cons |gx[1]#_g9445_|
                                           (cons |gx[1]#_g9446_|
                                                 (cons |gx[1]#_g9447_| '())))
                                     (cons (cons |gx[1]#_g9448_|
                                                 (cons |gx[1]#_g9449_|
                                                       (cons |gx[1]#_g9450_|
                                                             '())))
                                           '()))))))
      ...
      (|gerbil/core$<MOP>$<MOP:2>[1]#make-extended-struct-info|
       ...
       (cons '#f
             (cons |gx[1]#_g9490_|
                   (cons |gx[1]#_g9491_|
                         (cons |gx[1]#_g9492_|
                               (cons (cons |gx[1]#_g9493_| '())
                                     (cons (cons |gx[1]#_g9494_| '()) '()))))))
       'type-exhibitor:
       (|gerbil/core$<MOP>$<MOP:2>[1]#make-runtime-struct-exhibitor|
        'gx#expander::t
        '#f
      ...
      (|gerbil/core$<MOP>$<MOP:2>[1]#make-extended-struct-info|
       ...
       (cons |gx[1]#_g9490_|
             (cons |gx[1]#_g9495_|
                   (cons |gx[1]#_g9496_|
                         (cons |gx[1]#_g9497_|
                               (cons (cons |gx[1]#_g9498_|
                                           (cons |gx[1]#_g9499_| '()))
                                     (cons (cons |gx[1]#_g9500_|
                                                 (cons |gx[1]#_g9501_| '()))
                                           '()))))))
       'type-exhibitor:
       (|gerbil/core$<MOP>$<MOP:2>[1]#make-runtime-struct-exhibitor|
      ...
      (|gerbil/core$<MOP>$<MOP:2>[1]#make-extended-struct-info|
       ...
       (cons '#f
             (cons |gx[1]#_g9545_|
                   (cons |gx[1]#_g9546_|
                         (cons |gx[1]#_g9547_|
                               (cons (cons |gx[1]#_g9548_|
                                           (cons |gx[1]#_g9549_|
                                                 (cons |gx[1]#_g9550_|
                                                       (cons |gx[1]#_g9551_|
                                                             '()))))
                                     (cons (cons |gx[1]#_g9552_|
                                                 (cons |gx[1]#_g9553_|
                                                       (cons |gx[1]#_g9554_|
                                                             (cons |gx[1]#_g9555_|
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
      ...
      (|gerbil/core$<MOP>$<MOP:2>[1]#make-extended-struct-info|
       ...
       (cons |gx[1]#_g9557_|
             (cons |gx[1]#_g9556_|
                   (cons |gx[1]#_g9558_|
                         (cons |gx[1]#_g9559_|
                               (cons (cons |gx[1]#_g9560_|
                                           (cons |gx[1]#_g9561_|
                                                 (cons |gx[1]#_g9562_| '())))
                                     (cons (cons |gx[1]#_g9563_|
                                                 (cons |gx[1]#_g9564_|
                                                       (cons |gx[1]#_g9565_|
                                                             '())))
                                           '()))))))
    ...
    (define |gx[:0:]#&phi-context?|
      (lambda (_$stx6342_)
        (let* ((_g63466360_
                (lambda (_g63476356_)
                  (gx#raise-syntax-error '#f '"Bad syntax" _g63476356_)))
               (_g63456402_
                (lambda (_g63476364_)
                  (if (gx#stx-pair? _g63476364_)
                      (let ((_e63496367_ (gx#syntax-e _g63476364_)))
                        (let ((_hd63506371_ (##car _e63496367_))
                              (_tl63516374_ (##cdr _e63496367_)))
                          (if (gx#stx-pair? _tl63516374_)
                              (let ((_e63526377_ (gx#syntax-e _tl63516374_)))
                                (let ((_hd63536381_ (##car _e63526377_))
                                      (_tl63546384_ (##cdr _e63526377_)))
                                  (if (gx#stx-null? _tl63546384_)
                                      ((lambda (_L6387_)
                                         (cons (gx#datum->syntax__0 '#f 'fx>)
                                               (cons (cons (gx#datum->syntax__0
                                                     ...
                                                     (cons '3 '()))))
                                       _hd63536381_)
                                      (_g63466360_ _g63476364_))))
                              (_g63466360_ _g63476364_))))
                      (_g63466360_ _g63476364_)))))
          (_g63456402_ _$stx6342_))))))
