      ...
      (|gerbil/core$<MOP>$<MOP:2>[1]#make-extended-struct-info|
       ...
       (cons '#f
             (cons |gx[1]#_g9425_|
                   (cons |gx[1]#_g9426_|
                         (cons |gx[1]#_g9427_|
                               (cons (cons |gx[1]#_g9428_| '())
                                     (cons (cons |gx[1]#_g9429_| '()) '()))))))
       'type-exhibitor:
       (|gerbil/core$<MOP>$<MOP:2>[1]#make-runtime-struct-exhibitor|
        'gx#expander::t
        '#f
      ...
      (|gerbil/core$<MOP>$<MOP:2>[1]#make-extended-struct-info|
       ...
       (cons |gx[1]#_g9466_|
             (cons |gx[1]#_g9473_|
                   (cons |gx[1]#_g9474_|
                         (cons |gx[1]#_g9475_|
                               (cons (cons |gx[1]#_g9476_|
                                           (cons |gx[1]#_g9477_| '()))
                                     (cons (cons |gx[1]#_g9478_|
                                                 (cons |gx[1]#_g9479_| '()))
                                           '()))))))
       'type-exhibitor:
       (|gerbil/core$<MOP>$<MOP:2>[1]#make-runtime-struct-exhibitor|
      ...
      (|gerbil/core$<MOP>$<MOP:2>[1]#make-extended-struct-info|
       ...
       (cons '#f
             (cons |gx[1]#_g9480_|
                   (cons |gx[1]#_g9481_|
                         (cons |gx[1]#_g9482_|
                               (cons (cons |gx[1]#_g9483_|
                                           (cons |gx[1]#_g9484_|
                                                 (cons |gx[1]#_g9485_|
                                                       (cons |gx[1]#_g9486_|
                                                             '()))))
                                     (cons (cons |gx[1]#_g9487_|
                                                 (cons |gx[1]#_g9488_|
                                                       (cons |gx[1]#_g9489_|
                                                             (cons |gx[1]#_g9490_|
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
