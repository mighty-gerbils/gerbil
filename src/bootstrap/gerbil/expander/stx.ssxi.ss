...
(begin
  ...
  (declare-type
   ...
   (@case-lambda
    ...
    (4 gx#datum->syntax__opt-lambda3946)))
  (declare-type
   gx#stx-unwrap
  ...
  (declare-type
   gx#stx-plist?
   (@case-lambda (1 gx#stx-plist?__0) (2 gx#stx-plist?__opt-lambda2930)))
  (declare-type
   gx#stx-getq
   (@case-lambda (2 gx#stx-getq__0) (3 gx#stx-getq__opt-lambda2848))))
