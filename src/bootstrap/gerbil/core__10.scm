                        ...
                        (let* ((___match3932139322_
                                (lambda (_e2696527261_
                                  ...
                                  (let ((_L27281_ _hd2696927275_)
                                    ...
                                    (if (or (gx#stx-eq? 'values: _L27283_)
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                     ...
                     (if (and (equal? _hd-pat26043_ '(any:))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                         ...
                         (if (and _rtd23586_ (fx<= _len23781_ _fields23596_))
                             (cons 'if
                                   (cons _L23647_
                                       ...
                                       (_g2226522296_
                                        (gx#stx-wrap-source
                                         (cons (gx#datum->syntax '#f 'lambda)
                                               (cons (foldr (lambda (_g2229922302_
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                             _g2230022305_)
          ...
          (let ((___kont4034340344_
                ...
                (___kont4035140352_
                 (lambda (_L30423_ _L30425_ _L30426_)
                   (cons (gx#datum->syntax '#f 'match*)
                         (cons (foldr (lambda (_g3044830455_ _g3044930458_)
                                        (cons _g3044830455_ _g3044930458_))
                                      '()
                                      _L30425_)
                               (cons (cons (foldr (lambda (_g3045030461_
                                                           _g3045130464_)
                                                    (cons _g3045030461_
                                                          _g3045130464_))
                                                  '()
