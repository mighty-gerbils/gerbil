...
(begin
  ...
  (define |gerbil/core$<match>[1]#_g50797_|
    (##structure gx#syntax-quote::t '=> #f (gx#current-expander-context) '()))
  (define |gerbil/core$<match>[1]#_g51104_|
    (##structure gx#syntax-quote::t 'not #f (gx#current-expander-context) '()))
  (define |gerbil/core$<match>[1]#_g51105_|
    (##structure gx#syntax-quote::t 'or #f (gx#current-expander-context) '()))
  (define |gerbil/core$<match>[1]#_g51106_|
    (##structure gx#syntax-quote::t 'and #f (gx#current-expander-context) '()))
  (begin
        ...
        (let* ((___stx4702547026_ _$stx32778_)
          ...
          (let ((___kont4702847029_
                 (lambda (_L32921_ _L32923_ _L32924_)
                   (let ((__tmp51168 (gx#datum->syntax '#f 'defsyntax))
                         (__tmp51107
                          (let ((__tmp51108
                                 (let ((__tmp51109
                                        (let ((__tmp51167
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                             ...
                             (__tmp51119
                              (let ((__tmp51153 (gx#datum->syntax '#f '$stx))
                                    (__tmp51120
                                     (let ((__tmp51121
                                            (let ((__tmp51132
                                                   (let ((__tmp51151
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                          ...
                          (__tmp51145
                           (let ((__tmp51146 (gx#datum->syntax '#f 'body)))
                             (declare (not safe))
                             (cons __tmp51146 '()))))
                      (declare (not safe))
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                (declare (not safe))
                                                (cons __tmp51148 __tmp51138))))
                                         (declare (not safe))
                                         (cons __tmp51137 '()))))
                                  (declare (not safe))
                                  (cons __tmp51149 __tmp51136))))
                           (declare (not safe))
                           (cons __tmp51150 __tmp51135))))
                    (declare (not safe))
                    (cons __tmp51134 '()))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                     (declare (not safe))
                        ...
                        (__tmp51124
                         (let ((__tmp51125
                                (let ((__tmp51130
                                  ...
                                  (declare (not safe))
                                  (cons __tmp51130 __tmp51126))))
                           (declare (not safe))
                           (cons __tmp51125 '()))))
                    (declare (not safe))
                    (cons __tmp51131 __tmp51124))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                     (declare (not safe))
                                                     (cons __tmp51123 '()))))
                                              (declare (not safe))
                                              (cons __tmp51132 __tmp51122))))
                                       (declare (not safe))
                                       (cons '() __tmp51121))))
                                (declare (not safe))
                                (cons __tmp51153 __tmp51120))))
                         (declare (not safe))
                         (cons __tmp51154 __tmp51119))))
                  (declare (not safe))
                  (cons __tmp51118 '()))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                   (declare (not safe))
                                                   (cons __tmp51155
                                                         __tmp51117))))
                                            (declare (not safe))
                                            (cons __tmp51157 __tmp51116))))
                                     (declare (not safe))
                                     (cons __tmp51115 '()))))
                              (declare (not safe))
                              (cons __tmp51158 __tmp51114))))
                       (declare (not safe))
                       (cons __tmp51166 __tmp51113))))
                (declare (not safe))
                (cons __tmp51112 '()))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                 (declare (not safe))
                                                 (cons 'macro: __tmp51111))))
                                          (declare (not safe))
                                          (cons __tmp51167 __tmp51110))))
                                   (declare (not safe))
                                   (cons __tmp51109 '()))))
                            (declare (not safe))
                            (cons _L32924_ __tmp51108))))
                     (declare (not safe))
                     (cons __tmp51168 __tmp51107))))
                (___kont4703047031_
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                          ...
                                          (cons __tmp51172 '()))))
                                   (declare (not safe))
                                   (cons _L32854_ __tmp51171))))
                            (declare (not safe))
                            (cons _L32856_ __tmp51170))))
                     (declare (not safe))
                     (cons _L32857_ __tmp51169)))))
