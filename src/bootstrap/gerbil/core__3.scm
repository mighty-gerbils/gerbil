...
(begin
  (define |gerbil/core$<sugar>$<sugar:1>[1]#_g41755_|
    (##structure
     gx#syntax-quote::t
     'values
     #f
     ...
     '()))
  (define |gerbil/core$<sugar>$<sugar:1>[1]#_g41756_|
    (##structure
     gx#syntax-quote::t
     'values
     #f
     (gx#current-expander-context)
     '()))
  (define |gerbil/core$<sugar>$<sugar:1>[1]#_g41759_|
    (##structure
     gx#syntax-quote::t
     'else
     #f
     (gx#current-expander-context)
     '()))
  (define |gerbil/core$<sugar>$<sugar:1>[1]#_g41760_|
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                            2))
                (error "Context expects 2 values" _g41748_)))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
    ...
    (define |gerbil/core$<sugar>$<sugar:1>[:0:]#defsyntax%|
      (lambda (_$stx1822_)
        (let* ((___stx3647936480_ _$stx1822_)
               (_g18271866_
                (lambda ()
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
            ...
            (let* ((___match3653436535_
                    (lambda (_e18521873_
                      ...
                      (let ((_L1903_ _hd18591897_) (_L1905_ _hd18561887_))
                        (if (gx#identifier? _L1905_)
                            (___kont3648636487_ _L1903_ _L1905_)
                            (_g18271866_)))))
                   (___match3652636527_
                    (lambda (_e18521873_
                             _hd18531877_
              ...
              (if (gx#stx-pair? ___stx3647936480_)
                  (let ((_e18321928_ (gx#syntax-e ___stx3647936480_)))
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
    ...
    (define |gerbil/core$<sugar>$<sugar:1>[:0:]#define|
      (lambda (_$stx2105_)
        (let* ((___stx3653736538_ _$stx2105_)
               (_g21102149_
                (lambda ()
                  (gx#raise-syntax-error
                   '#f
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
            ...
            (let* ((___match3659236593_
                    (lambda (_e21352156_
                      ...
                      (let ((_L2186_ _hd21422180_) (_L2188_ _hd21392170_))
                        (if (gx#identifier? _L2188_)
                            (___kont3654436545_ _L2186_ _L2188_)
                            (_g21102149_)))))
                   (___match3658436585_
                    (lambda (_e21352156_
                             _hd21362160_
              ...
              (if (gx#stx-pair? ___stx3653736538_)
                  (let ((_e21152211_ (gx#syntax-e ___stx3653736538_)))
    ...
    (define |gerbil/core$<sugar>$<sugar:1>[:0:]#let*-values|
      (lambda (_$stx2307_)
        (let* ((___stx3659536596_ _$stx2307_)
               (_g23122357_
                (lambda ()
                  (gx#raise-syntax-error
                   '#f
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
            ...
            (let* ((___match3665436655_
              ...
              (if (gx#stx-pair? ___stx3659536596_)
                  (let ((_e23152465_ (gx#syntax-e ___stx3659536596_)))
    ...
    (define |gerbil/core$<sugar>$<sugar:1>[:0:]#let|
      (lambda (_$stx2546_)
        (let* ((___stx3665736658_ _$stx2546_)
               (_g25512615_
                (lambda ()
                  (gx#raise-syntax-error
                   '#f
                   ...
                   (___match3670636707_
                    (lambda (_e25952622_
                      ...
                      (if (gx#stx-pair/null? _tl26002639_)
                          (let ((___splice3666836669_
                                 (gx#syntax-split-splice _tl26002639_ '0)))
                            (let ((_tl26032645_
                                   (##vector-ref ___splice3666836669_ '1))
                                  (_target26012642_
                                   (##vector-ref ___splice3666836669_ '0)))
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                      ...
                                      (let ((_var25772788_
                                        ...
                                        (if (gx#stx-pair/null? _tl25662734_)
                                            (let ((___splice3666436665_
                                                   (gx#syntax-split-splice
                                                    _tl25662734_
                                                    '0)))
                                              (let ((_tl25862794_
                                                     (##vector-ref
                                                      ___splice3666436665_
                                                      '1))
                                                    (_target25842791_
                                                     (##vector-ref
                                                      ___splice3666436665_
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
              ...
              (if (gx#stx-pair? ___stx3665736658_)
                  (let ((_e25582707_ (gx#syntax-e ___stx3665736658_)))
                                  ...
                                  (if (gx#stx-pair/null? _tl28962935_)
                                      (let ((_g41749_
                                        ...
                                        (begin
                                          (let ((_g41750_
                                                 (if (##values? _g41749_)
                                                     (##vector-length _g41749_)
                                                     1)))
                                            (if (not (##fx= _g41750_ 2))
                                                (error "Context expects 2 values"
                                                       _g41750_)))
                                          (let ((_target28972938_
                                                 (##vector-ref _g41749_ 0))
                                                (_tl28992941_
                                                 (##vector-ref _g41749_ 1)))
                                  ...
                                  (if (gx#stx-pair/null? _tl30143053_)
                                      (let ((_g41751_
                                        ...
                                        (begin
                                          (let ((_g41752_
                                                 (if (##values? _g41751_)
                                                     (##vector-length _g41751_)
                                                     1)))
                                            (if (not (##fx= _g41752_ 2))
                                                (error "Context expects 2 values"
                                                       _g41752_)))
                                          (let ((_target30153056_
                                                 (##vector-ref _g41751_ 0))
                                                (_tl30173059_
                                                 (##vector-ref _g41751_ 1)))
                                      ...
                                      (let ((_g41753_
                                        ...
                                        (begin
                                          ...
                                          (let ((_target31333174_
                                                 (##vector-ref _g41753_ 0))
                                                (_tl31353177_
                                                 (##vector-ref _g41753_ 1)))
                           ...
                           (_g37243735_
                            (lambda ()
                              (gx#raise-syntax-error
                               ...
                               '"Bad syntax"
                               ___stx3671736718_))))
                      (let ((___kont3672036721_
                             (lambda (_L3763_)
                               (gx#stx-andmap gx#identifier? _L3763_)))
                            (___kont3672236723_
                             (lambda () (gx#identifier? _x3720_))))
                        (if (gx#stx-pair? ___stx3671736718_)
                            (let ((_e37273753_
                                   (gx#syntax-e ___stx3671736718_)))
                              (let ((_tl37293760_ (##cdr _e37273753_))
                                    (_hd37283757_ (##car _e37273753_)))
                                (if (gx#identifier? _hd37283757_)
                                    (if (gx#free-identifier=?
                                         |gerbil/core$<sugar>$<sugar:1>[1]#_g41755_|
                                         _hd37283757_)
                                        (___kont3672036721_ _tl37293760_)
                                        (___kont3672236723_))
                                    (___kont3672236723_))))
                            (___kont3672236723_))))))
                 (_let-head3242_
                  (lambda (_x3660_)
                    (let* ((___stx3673736738_ _x3660_)
                           (_g36643675_
                            (lambda ()
                              (gx#raise-syntax-error
                               '#f
                               '"Bad syntax"
                               ___stx3673736738_))))
                      (let ((___kont3674036741_ (lambda (_L3703_) _L3703_))
                            (___kont3674236743_ (lambda () (list _x3660_))))
                        (if (gx#stx-pair? ___stx3673736738_)
                            (let ((_e36673693_
                                   (gx#syntax-e ___stx3673736738_)))
                              (let ((_tl36693700_ (##cdr _e36673693_))
                                    (_hd36683697_ (##car _e36673693_)))
                                (if (gx#identifier? _hd36683697_)
                                    (if (gx#free-identifier=?
                                         |gerbil/core$<sugar>$<sugar:1>[1]#_g41756_|
                                         _hd36683697_)
                                        (___kont3674036741_ _tl36693700_)
                                        (___kont3674236743_))
                                    (___kont3674236743_))))
                            (___kont3674236743_)))))))
          (let* ((___stx3675736758_ _stx3237_)
                 (_g32453311_
                  (lambda ()
                    (gx#raise-syntax-error
                     '#f
                               ...
                               (if (gx#stx-pair/null? _g34723492_)
                                   (let ((_g41757_
                                     ...
                                     (begin
                                       (let ((_g41758_
                                              (if (##values? _g41757_)
                                                  (##vector-length _g41757_)
                                                  1)))
                                         (if (not (##fx= _g41758_ 2))
                                             (error "Context expects 2 values"
                                                    _g41758_)))
                                       (let ((_target34743495_
                                              (##vector-ref _g41757_ 0))
                                             (_tl34763498_
                                              (##vector-ref _g41757_ 1)))
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                        ...
                                        (let ((_hd32903399_
                                          ...
                                          (if (gx#stx-pair/null? _tl32793345_)
                                              (let ((___splice3676636767_
                                                     (gx#syntax-split-splice
                                                      _tl32793345_
                                                      '0)))
                                                (let ((_tl32993405_
                                                       (##vector-ref
                                                        ___splice3676636767_
                                                        '1))
                                                      (_target32973402_
                                                       (##vector-ref
                                                        ___splice3676636767_
                                  ...
                                  (let ((___splice3676436765_
                                    ...
                                    (let ((_tl32823351_
                                      ...
                                      (if (gx#stx-null? _tl32823351_)
                                          ...
                                          (_g32453311_))))
                                  (_g32453311_)))))))
                (if (gx#stx-pair? ___stx3675736758_)
                    (let ((_e32523579_ (gx#syntax-e ___stx3675736758_)))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                        ...
                        (let ((___splice3676436765_
                          ...
                          (let ((_tl32823351_
                                 (##vector-ref ___splice3676436765_ '1))
                                (_target32803348_
                                 (##vector-ref ___splice3676436765_ '0)))
                            (if (gx#stx-null? _tl32823351_)
                                (___match3682636827_
                                 _e32523579_
                                 _hd32533583_
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
    ...
    (define |gerbil/core$<sugar>$<sugar:1>[:0:]#and|
      (lambda (_$stx3783_)
        (let* ((___stx3682936830_ _$stx3783_)
               (_g37893815_
                (lambda ()
                  (gx#raise-syntax-error
                   '#f
                   '"Bad syntax"
                   ___stx3682936830_))))
          (let ((___kont3683236833_ (lambda () '#t))
                (___kont3683436835_ (lambda (_L3887_) _L3887_))
                (___kont3683636837_
                   ...
                   (cons (gx#datum->syntax '#f 'if)
                         (cons _L3844_
                               (cons (cons _L3845_ _L3842_)
                                     (cons '#f '())))))))
            (if (gx#stx-pair? ___stx3682936830_)
                (let ((_e37913907_ (gx#syntax-e ___stx3682936830_)))
                            ...
                            (let ((_e37983877_ (gx#syntax-e _tl37933914_)))
                              (let ((_tl38003884_ (##cdr _e37983877_))
                                ...
                                (if (gx#stx-null? _tl38003884_)
                                    (___kont3683436835_ _hd37993881_)
                                    (___kont3683636837_
                                     _tl38003884_
                                     _hd37993881_
                                     _hd37923911_))))
    ...
    (define |gerbil/core$<sugar>$<sugar:1>[:0:]#or|
      (lambda (_$stx3925_)
        (let* ((___stx3687536876_ _$stx3925_)
               (_g39313957_
                (lambda ()
                  (gx#raise-syntax-error
                   '#f
                   '"Bad syntax"
                   ___stx3687536876_))))
          (let ((___kont3687836879_ (lambda () '#f))
                (___kont3688036881_ (lambda (_L4029_) _L4029_))
                (___kont3688236883_
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                     '()))))))
            (if (gx#stx-pair? ___stx3687536876_)
                (let ((_e39334049_ (gx#syntax-e ___stx3687536876_)))
                            ...
                            (let ((_e39404019_ (gx#syntax-e _tl39354056_)))
                              (let ((_tl39424026_ (##cdr _e39404019_))
                                ...
                                (if (gx#stx-null? _tl39424026_)
                                    (___kont3688036881_ _hd39414023_)
                                    (___kont3688236883_
                                     _tl39424026_
                                     _hd39414023_
                                     _hd39344053_))))
    ...
    (define |gerbil/core$<sugar>$<sugar:1>[:0:]#cond|
      (lambda (_$stx4067_)
        (let* ((___stx3692136922_ _$stx4067_)
               (_g40764167_
                (lambda ()
                  (gx#raise-syntax-error
                   '#f
                   '"Bad syntax"
                   ___stx3692136922_))))
          (let ((___kont3692436925_ (lambda () '#!void))
                (___kont3692636927_
                 (lambda (_L4514_)
                                  ...
                                  (if (gx#stx-pair? _hd40924494_)
                                      ...
                                      (let ((_body40994510_
                                        ...
                                        (if (gx#stx-null? _tl40874471_)
                                            (___kont3692636927_ _body40994510_)
                                            (___kont3693036931_)))))))
                        (_loop40944490_ _target40914484_ '())))))
              (if (gx#stx-pair? ___stx3692136922_)
                  (let ((_e40784549_ (gx#syntax-e ___stx3692136922_)))
                                      ...
                                      (let ((_e40884474_
                                        ...
                                        (let ((_tl40904481_
                                          ...
                                          (if (gx#identifier? _hd40894478_)
                                              (if (gx#free-identifier=?
                                                   |gerbil/core$<sugar>$<sugar:1>[1]#_g41759_|
                                                   _hd40894478_)
                                                  (if (gx#stx-pair/null?
                                                       _tl40904481_)
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                    ...
                    (let ((_tl41364312_ (##cdr _e41344305_))
                      ...
                      (if (gx#identifier? _hd41354309_)
                          (if (gx#free-identifier=?
                               |gerbil/core$<sugar>$<sugar:1>[1]#_g41760_|
                               _hd41354309_)
                          ...
                          (if (gx#stx-pair/null? _tl40904481_)
                              (let ((___splice3693836939_
                                ...
                                (let ((_tl41554207_
                                       (##vector-ref ___splice3693836939_ '1))
                                      (_target41534204_
                                       (##vector-ref ___splice3693836939_ '0)))
                                  (if (gx#stx-null? _tl41554207_)
                                      (___match3708237083_
                                       _e40784549_
                                       _hd40794553_
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
              ...
              (if (gx#stx-pair/null? _tl40904481_)
                  (let ((___splice3693836939_
                         (gx#syntax-split-splice _tl40904481_ '0)))
                    (let ((_tl41554207_ (##vector-ref ___splice3693836939_ '1))
                          (_target41534204_
                           (##vector-ref ___splice3693836939_ '0)))
                      (if (gx#stx-null? _tl41554207_)
                          (___match3708237083_
                                  ...
                                  (if (gx#stx-pair/null? _tl45824621_)
                                      (let ((_g41761_
                                        ...
                                        (begin
                                          (let ((_g41762_
                                                 (if (##values? _g41761_)
                                                     (##vector-length _g41761_)
                                                     1)))
                                            (if (not (##fx= _g41762_ 2))
                                                (error "Context expects 2 values"
                                                       _g41762_)))
                                          (let ((_target45834624_
                                                 (##vector-ref _g41761_ 0))
                                                (_tl45854627_
                                                 (##vector-ref _g41761_ 1)))
                                  ...
                                  (if (gx#stx-pair/null? _tl47004739_)
                                      (let ((_g41763_
                                        ...
                                        (begin
                                          (let ((_g41764_
                                                 (if (##values? _g41763_)
                                                     (##vector-length _g41763_)
                                                     1)))
                                            (if (not (##fx= _g41764_ 2))
                                                (error "Context expects 2 values"
                                                       _g41764_)))
                                          (let ((_target47014742_
                                                 (##vector-ref _g41763_ 0))
                                                (_tl47034745_
                                                 (##vector-ref _g41763_ 1)))
                                  ...
                                  (if (gx#stx-pair/null? _tl48174856_)
                                      (let ((_g41765_
                                        ...
                                        (begin
                                          (let ((_g41766_
                                                 (if (##values? _g41765_)
                                                     (##vector-length _g41765_)
                                                     1)))
                                            (if (not (##fx= _g41766_ 2))
                                                (error "Context expects 2 values"
                                                       _g41766_)))
                                          (let ((_target48184859_
                                                 (##vector-ref _g41765_ 0))
                                                (_tl48204862_
                                                 (##vector-ref _g41765_ 1)))
