...
(begin
  (define |gerbil/core$<sugar>$<sugar:1>[1]#_g41582_|
    (##structure
     gx#syntax-quote::t
     'values
     #f
     ...
     '()))
  (define |gerbil/core$<sugar>$<sugar:1>[1]#_g41583_|
    (##structure
     gx#syntax-quote::t
     'values
     #f
     (gx#current-expander-context)
     '()))
  (define |gerbil/core$<sugar>$<sugar:1>[1]#_g41586_|
    (##structure
     gx#syntax-quote::t
     'else
     #f
     (gx#current-expander-context)
     '()))
  (define |gerbil/core$<sugar>$<sugar:1>[1]#_g41587_|
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                            2))
                (error "Context expects 2 values" _g41575_)))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
    ...
    (define |gerbil/core$<sugar>$<sugar:1>[:0:]#defsyntax%|
      (lambda (_$stx1822_)
        (let* ((___stx3634636347_ _$stx1822_)
               (_g18271866_
                (lambda ()
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
            ...
            (let* ((___match3640136402_
                    (lambda (_e18521873_
                      ...
                      (let ((_L1903_ _hd18591897_) (_L1905_ _hd18561887_))
                        (if (gx#identifier? _L1905_)
                            (___kont3635336354_ _L1903_ _L1905_)
                            (_g18271866_)))))
                   (___match3639336394_
                    (lambda (_e18521873_
                             _hd18531877_
              ...
              (if (gx#stx-pair? ___stx3634636347_)
                  (let ((_e18321928_ (gx#syntax-e ___stx3634636347_)))
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
    ...
    (define |gerbil/core$<sugar>$<sugar:1>[:0:]#define|
      (lambda (_$stx2105_)
        (let* ((___stx3640436405_ _$stx2105_)
               (_g21102149_
                (lambda ()
                  (gx#raise-syntax-error
                   '#f
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
            ...
            (let* ((___match3645936460_
                    (lambda (_e21352156_
                      ...
                      (let ((_L2186_ _hd21422180_) (_L2188_ _hd21392170_))
                        (if (gx#identifier? _L2188_)
                            (___kont3641136412_ _L2186_ _L2188_)
                            (_g21102149_)))))
                   (___match3645136452_
                    (lambda (_e21352156_
                             _hd21362160_
              ...
              (if (gx#stx-pair? ___stx3640436405_)
                  (let ((_e21152211_ (gx#syntax-e ___stx3640436405_)))
    ...
    (define |gerbil/core$<sugar>$<sugar:1>[:0:]#let*-values|
      (lambda (_$stx2307_)
        (let* ((___stx3646236463_ _$stx2307_)
               (_g23122357_
                (lambda ()
                  (gx#raise-syntax-error
                   '#f
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
            ...
            (let* ((___match3652136522_
              ...
              (if (gx#stx-pair? ___stx3646236463_)
                  (let ((_e23152465_ (gx#syntax-e ___stx3646236463_)))
    ...
    (define |gerbil/core$<sugar>$<sugar:1>[:0:]#let|
      (lambda (_$stx2546_)
        (let* ((___stx3652436525_ _$stx2546_)
               (_g25512615_
                (lambda ()
                  (gx#raise-syntax-error
                   '#f
                   ...
                   (___match3657336574_
                    (lambda (_e25952622_
                      ...
                      (if (gx#stx-pair/null? _tl26002639_)
                          (let ((___splice3653536536_
                                 (gx#syntax-split-splice _tl26002639_ '0)))
                            (let ((_tl26032645_
                                   (##vector-ref ___splice3653536536_ '1))
                                  (_target26012642_
                                   (##vector-ref ___splice3653536536_ '0)))
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                      ...
                                      (let ((_var25772788_
                                        ...
                                        (if (gx#stx-pair/null? _tl25662734_)
                                            (let ((___splice3653136532_
                                                   (gx#syntax-split-splice
                                                    _tl25662734_
                                                    '0)))
                                              (let ((_tl25862794_
                                                     (##vector-ref
                                                      ___splice3653136532_
                                                      '1))
                                                    (_target25842791_
                                                     (##vector-ref
                                                      ___splice3653136532_
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
              ...
              (if (gx#stx-pair? ___stx3652436525_)
                  (let ((_e25582707_ (gx#syntax-e ___stx3652436525_)))
                                  ...
                                  (if (gx#stx-pair/null? _tl28962935_)
                                      (let ((_g41576_
                                        ...
                                        (begin
                                          (let ((_g41577_
                                                 (if (##values? _g41576_)
                                                     (##vector-length _g41576_)
                                                     1)))
                                            (if (not (##fx= _g41577_ 2))
                                                (error "Context expects 2 values"
                                                       _g41577_)))
                                          (let ((_target28972938_
                                                 (##vector-ref _g41576_ 0))
                                                (_tl28992941_
                                                 (##vector-ref _g41576_ 1)))
                                  ...
                                  (if (gx#stx-pair/null? _tl30143053_)
                                      (let ((_g41578_
                                        ...
                                        (begin
                                          (let ((_g41579_
                                                 (if (##values? _g41578_)
                                                     (##vector-length _g41578_)
                                                     1)))
                                            (if (not (##fx= _g41579_ 2))
                                                (error "Context expects 2 values"
                                                       _g41579_)))
                                          (let ((_target30153056_
                                                 (##vector-ref _g41578_ 0))
                                                (_tl30173059_
                                                 (##vector-ref _g41578_ 1)))
                                  ...
                                  (if (gx#stx-pair/null? _tl31323171_)
                                      (let ((_g41580_
                                        ...
                                        (begin
                                          (let ((_g41581_
                                                 (if (##values? _g41580_)
                                                     (##vector-length _g41580_)
                                                     1)))
                                            (if (not (##fx= _g41581_ 2))
                                                (error "Context expects 2 values"
                                                       _g41581_)))
                                          (let ((_target31333174_
                                                 (##vector-ref _g41580_ 0))
                                                (_tl31353177_
                                                 (##vector-ref _g41580_ 1)))
                    ...
                    (let* ((___stx3658436585_ _x3720_)
                      ...
                      (let ((___kont3658736588_
                        ...
                        (if (gx#stx-pair? ___stx3658436585_)
                            (let ((_e37273753_
                                   (gx#syntax-e ___stx3658436585_)))
                              (let ((_tl37293760_ (##cdr _e37273753_))
                                    (_hd37283757_ (##car _e37273753_)))
                                (if (gx#identifier? _hd37283757_)
                                    (if (gx#free-identifier=?
                                         |gerbil/core$<sugar>$<sugar:1>[1]#_g41582_|
                                         _hd37283757_)
                                        (___kont3658736588_ _tl37293760_)
                                        (___kont3658936590_))
                                    (___kont3658936590_))))
                            (___kont3658936590_))))))
                 (_let-head3242_
                  (lambda (_x3660_)
                    (let* ((___stx3660436605_ _x3660_)
                           (_g36643675_
                            (lambda ()
                              (gx#raise-syntax-error
                               '#f
                               '"Bad syntax"
                               ___stx3660436605_))))
                      (let ((___kont3660736608_ (lambda (_L3703_) _L3703_))
                            (___kont3660936610_ (lambda () (list _x3660_))))
                        (if (gx#stx-pair? ___stx3660436605_)
                            (let ((_e36673693_
                                   (gx#syntax-e ___stx3660436605_)))
                              (let ((_tl36693700_ (##cdr _e36673693_))
                                    (_hd36683697_ (##car _e36673693_)))
                                (if (gx#identifier? _hd36683697_)
                                    (if (gx#free-identifier=?
                                         |gerbil/core$<sugar>$<sugar:1>[1]#_g41583_|
                                         _hd36683697_)
                                        (___kont3660736608_ _tl36693700_)
                                        (___kont3660936610_))
                                    (___kont3660936610_))))
                            (___kont3660936610_)))))))
          (let* ((___stx3662436625_ _stx3237_)
                 (_g32453311_
                  (lambda ()
                    (gx#raise-syntax-error
                     '#f
                               ...
                               (if (gx#stx-pair/null? _g34723492_)
                                   (let ((_g41584_
                                     ...
                                     (begin
                                       (let ((_g41585_
                                              (if (##values? _g41584_)
                                                  (##vector-length _g41584_)
                                                  1)))
                                         (if (not (##fx= _g41585_ 2))
                                             (error "Context expects 2 values"
                                                    _g41585_)))
                                       (let ((_target34743495_
                                              (##vector-ref _g41584_ 0))
                                             (_tl34763498_
                                              (##vector-ref _g41584_ 1)))
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                        ...
                                        (let ((_hd32903399_
                                          ...
                                          (if (gx#stx-pair/null? _tl32793345_)
                                              (let ((___splice3663336634_
                                                     (gx#syntax-split-splice
                                                      _tl32793345_
                                                      '0)))
                                                (let ((_tl32993405_
                                                       (##vector-ref
                                                        ___splice3663336634_
                                                        '1))
                                                      (_target32973402_
                                                       (##vector-ref
                                                        ___splice3663336634_
                                  ...
                                  (let ((___splice3663136632_
                                    ...
                                    (let ((_tl32823351_
                                      ...
                                      (if (gx#stx-null? _tl32823351_)
                                          ...
                                          (_g32453311_))))
                                  (_g32453311_)))))))
                (if (gx#stx-pair? ___stx3662436625_)
                    (let ((_e32523579_ (gx#syntax-e ___stx3662436625_)))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                        ...
                        (let ((___splice3663136632_
                          ...
                          (let ((_tl32823351_
                                 (##vector-ref ___splice3663136632_ '1))
                                (_target32803348_
                                 (##vector-ref ___splice3663136632_ '0)))
                            (if (gx#stx-null? _tl32823351_)
                                (___match3669336694_
                                 _e32523579_
                                 _hd32533583_
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
    ...
    (define |gerbil/core$<sugar>$<sugar:1>[:0:]#and|
      (lambda (_$stx3783_)
        (let* ((___stx3669636697_ _$stx3783_)
               (_g37893815_
                (lambda ()
                  (gx#raise-syntax-error
                   '#f
                   '"Bad syntax"
                   ___stx3669636697_))))
          (let ((___kont3669936700_ (lambda () '#t))
                (___kont3670136702_ (lambda (_L3887_) _L3887_))
                (___kont3670336704_
            ...
            (if (gx#stx-pair? ___stx3669636697_)
                (let ((_e37913907_ (gx#syntax-e ___stx3669636697_)))
                            ...
                            (let ((_e37983877_ (gx#syntax-e _tl37933914_)))
                              (let ((_tl38003884_ (##cdr _e37983877_))
                                ...
                                (if (gx#stx-null? _tl38003884_)
                                    (___kont3670136702_ _hd37993881_)
                                    (___kont3670336704_
                                     _tl38003884_
                                     _hd37993881_
                                     _hd37923911_))))
    ...
    (define |gerbil/core$<sugar>$<sugar:1>[:0:]#or|
      (lambda (_$stx3925_)
        (let* ((___stx3674236743_ _$stx3925_)
               (_g39313957_
                (lambda ()
                  (gx#raise-syntax-error
                   '#f
                   '"Bad syntax"
                   ___stx3674236743_))))
          (let ((___kont3674536746_ (lambda () '#f))
                (___kont3674736748_ (lambda (_L4029_) _L4029_))
                (___kont3674936750_
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                     '()))))))
            (if (gx#stx-pair? ___stx3674236743_)
                (let ((_e39334049_ (gx#syntax-e ___stx3674236743_)))
                            ...
                            (let ((_e39404019_ (gx#syntax-e _tl39354056_)))
                              (let ((_tl39424026_ (##cdr _e39404019_))
                                ...
                                (if (gx#stx-null? _tl39424026_)
                                    (___kont3674736748_ _hd39414023_)
                                    (___kont3674936750_
                                     _tl39424026_
                                     _hd39414023_
                                     _hd39344053_))))
    ...
    (define |gerbil/core$<sugar>$<sugar:1>[:0:]#cond|
      (lambda (_$stx4067_)
        (let* ((___stx3678836789_ _$stx4067_)
               (_g40764167_
                (lambda ()
                  (gx#raise-syntax-error
                   '#f
                   '"Bad syntax"
                   ___stx3678836789_))))
          (let ((___kont3679136792_ (lambda () '#!void))
                (___kont3679336794_
                 (lambda (_L4514_)
                                  ...
                                  (if (gx#stx-pair? _hd40924494_)
                                      ...
                                      (let ((_body40994510_
                                        ...
                                        (if (gx#stx-null? _tl40874471_)
                                            (___kont3679336794_ _body40994510_)
                                            (___kont3679736798_)))))))
                        (_loop40944490_ _target40914484_ '())))))
              (if (gx#stx-pair? ___stx3678836789_)
                  (let ((_e40784549_ (gx#syntax-e ___stx3678836789_)))
                                      ...
                                      (let ((_e40884474_
                                        ...
                                        (let ((_tl40904481_
                                          ...
                                          (if (gx#identifier? _hd40894478_)
                                              (if (gx#free-identifier=?
                                                   |gerbil/core$<sugar>$<sugar:1>[1]#_g41586_|
                                                   _hd40894478_)
                                                  (if (gx#stx-pair/null?
                                                       _tl40904481_)
                                                      (let ((___splice3679536796_
                                                             (gx#syntax-split-splice
                                                              _tl40904481_
                                                              '0)))
                                                        (let ((_tl40934487_
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                    ...
                    (let ((_tl41364312_ (##cdr _e41344305_))
                      ...
                      (if (gx#identifier? _hd41354309_)
                          (if (gx#free-identifier=?
                               |gerbil/core$<sugar>$<sugar:1>[1]#_g41587_|
                               _hd41354309_)
                          ...
                          (if (gx#stx-pair/null? _tl40904481_)
                              (let ((___splice3680536806_
                                ...
                                (let ((_tl41554207_
                                       (##vector-ref ___splice3680536806_ '1))
                                      (_target41534204_
                                       (##vector-ref ___splice3680536806_ '0)))
                                  (if (gx#stx-null? _tl41554207_)
                                      (___match3694936950_
                                       _e40784549_
                                       _hd40794553_
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
              ...
              (if (gx#stx-pair/null? _tl40904481_)
                  (let ((___splice3680536806_
                         (gx#syntax-split-splice _tl40904481_ '0)))
                    (let ((_tl41554207_ (##vector-ref ___splice3680536806_ '1))
                          (_target41534204_
                           (##vector-ref ___splice3680536806_ '0)))
                      (if (gx#stx-null? _tl41554207_)
                          (___match3694936950_
                                  ...
                                  (if (gx#stx-pair/null? _tl45824621_)
                                      (let ((_g41588_
                                        ...
                                        (begin
                                          (let ((_g41589_
                                                 (if (##values? _g41588_)
                                                     (##vector-length _g41588_)
                                                     1)))
                                            (if (not (##fx= _g41589_ 2))
                                                (error "Context expects 2 values"
                                                       _g41589_)))
                                          (let ((_target45834624_
                                                 (##vector-ref _g41588_ 0))
                                                (_tl45854627_
                                                 (##vector-ref _g41588_ 1)))
                                  ...
                                  (if (gx#stx-pair/null? _tl47004739_)
                                      (let ((_g41590_
                                        ...
                                        (begin
                                          (let ((_g41591_
                                                 (if (##values? _g41590_)
                                                     (##vector-length _g41590_)
                                                     1)))
                                            (if (not (##fx= _g41591_ 2))
                                                (error "Context expects 2 values"
                                                       _g41591_)))
                                          (let ((_target47014742_
                                                 (##vector-ref _g41590_ 0))
                                                (_tl47034745_
                                                 (##vector-ref _g41590_ 1)))
