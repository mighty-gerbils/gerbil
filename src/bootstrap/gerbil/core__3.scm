...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                            2))
                (error "Context expects 2 values" _g41213_)))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
    ...
    (define |gerbil/core$<sugar>$<sugar:1>[:0:]#defsyntax%|
      (lambda (_$stx1822_)
        (let* ((___stx3605036051_ _$stx1822_)
               (_g18271866_
                (lambda ()
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
            ...
            (let* ((___match3610536106_
                    (lambda (_e18521873_
                      ...
                      (let ((_L1903_ _hd18591897_) (_L1905_ _hd18561887_))
                        (if (gx#identifier? _L1905_)
                            (___kont3605736058_ _L1903_ _L1905_)
                            (_g18271866_)))))
                   (___match3609736098_
                    (lambda (_e18521873_
                             _hd18531877_
              ...
              (if (gx#stx-pair? ___stx3605036051_)
                  (let ((_e18321928_ (gx#syntax-e ___stx3605036051_)))
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
    ...
    (define |gerbil/core$<sugar>$<sugar:1>[:0:]#define|
      (lambda (_$stx2105_)
        (let* ((___stx3610836109_ _$stx2105_)
               (_g21102149_
                (lambda ()
                  (gx#raise-syntax-error
                   '#f
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
            ...
            (let* ((___match3616336164_
                    (lambda (_e21352156_
                      ...
                      (let ((_L2186_ _hd21422180_) (_L2188_ _hd21392170_))
                        (if (gx#identifier? _L2188_)
                            (___kont3611536116_ _L2186_ _L2188_)
                            (_g21102149_)))))
                   (___match3615536156_
                    (lambda (_e21352156_
                             _hd21362160_
              ...
              (if (gx#stx-pair? ___stx3610836109_)
                  (let ((_e21152211_ (gx#syntax-e ___stx3610836109_)))
    ...
    (define |gerbil/core$<sugar>$<sugar:1>[:0:]#let*-values|
      (lambda (_$stx2307_)
        (let* ((___stx3616636167_ _$stx2307_)
               (_g23122357_
                (lambda ()
                  (gx#raise-syntax-error
                   '#f
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
            ...
            (let* ((___match3622536226_
              ...
              (if (gx#stx-pair? ___stx3616636167_)
                  (let ((_e23152465_ (gx#syntax-e ___stx3616636167_)))
    ...
    (define |gerbil/core$<sugar>$<sugar:1>[:0:]#let|
      (lambda (_$stx2546_)
        (let* ((___stx3622836229_ _$stx2546_)
               (_g25512615_
                (lambda ()
                  (gx#raise-syntax-error
                   '#f
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                             '#!void
                             (foldr (lambda (_g28512858_ _g28522861_)
                   ...
                   (___match3627736278_
                    (lambda (_e25952622_
                      ...
                      (if (gx#stx-pair/null? _tl26002639_)
                          (let ((___splice3623936240_
                                 (gx#syntax-split-splice _tl26002639_ '0)))
                            (let ((_tl26032645_
                                   (##vector-ref ___splice3623936240_ '1))
                                  (_target26012642_
                                   (##vector-ref ___splice3623936240_ '0)))
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                      ...
                                      (let ((_var25772788_
                                        ...
                                        (if (gx#stx-pair/null? _tl25662734_)
                                            (let ((___splice3623536236_
                                                   (gx#syntax-split-splice
                                                    _tl25662734_
                                                    '0)))
                                              (let ((_tl25862794_
                                                     (##vector-ref
                                                      ___splice3623536236_
                                                      '1))
                                                    (_target25842791_
                                                     (##vector-ref
                                                      ___splice3623536236_
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
              ...
              (if (gx#stx-pair? ___stx3622836229_)
                  (let ((_e25582707_ (gx#syntax-e ___stx3622836229_)))
                                  ...
                                  (if (gx#stx-pair/null? _tl28962935_)
                                      (let ((_g41214_
                                        ...
                                        (begin
                                          (let ((_g41215_
                                                 (if (##values? _g41214_)
                                                     (##vector-length _g41214_)
                                                     1)))
                                            (if (not (##fx= _g41215_ 2))
                                                (error "Context expects 2 values"
                                                       _g41215_)))
                                          (let ((_target28972938_
                                                 (##vector-ref _g41214_ 0))
                                                (_tl28992941_
                                                 (##vector-ref _g41214_ 1)))
                                  ...
                                  (if (gx#stx-pair/null? _tl30143053_)
                                      (let ((_g41216_
                                        ...
                                        (begin
                                          (let ((_g41217_
                                                 (if (##values? _g41216_)
                                                     (##vector-length _g41216_)
                                                     1)))
                                            (if (not (##fx= _g41217_ 2))
                                                (error "Context expects 2 values"
                                                       _g41217_)))
                                          (let ((_target30153056_
                                                 (##vector-ref _g41216_ 0))
                                                (_tl30173059_
                                                 (##vector-ref _g41216_ 1)))
                                  ...
                                  (if (gx#stx-pair/null? _tl31323171_)
                                      (let ((_g41218_
                                        ...
                                        (begin
                                          (let ((_g41219_
                                                 (if (##values? _g41218_)
                                                     (##vector-length _g41218_)
                                                     1)))
                                            (if (not (##fx= _g41219_ 2))
                                                (error "Context expects 2 values"
                                                       _g41219_)))
                                          (let ((_target31333174_
                                                 (##vector-ref _g41218_ 0))
                                                (_tl31353177_
                                                 (##vector-ref _g41218_ 1)))
                           ...
                           (_g37243735_
                            (lambda ()
                              (gx#raise-syntax-error
                               ...
                               '"Bad syntax"
                               ___stx3628836289_))))
                      (let ((___kont3629136292_
                             (lambda (_L3763_)
                               (gx#stx-andmap gx#identifier? _L3763_)))
                            (___kont3629336294_
                             (lambda () (gx#identifier? _x3720_))))
                        (if (gx#stx-pair? ___stx3628836289_)
                            (let ((_e37273753_
                                   (gx#syntax-e ___stx3628836289_)))
                              (let ((_tl37293760_ (##cdr _e37273753_))
                                    (_hd37283757_ (##car _e37273753_)))
                                (if (gx#identifier? _hd37283757_)
                                    (if (gx#free-identifier=?
                                         |gerbil/core$<sugar>$<sugar:1>[1]#_g41220_|
                                         _hd37283757_)
                                        (___kont3629136292_ _tl37293760_)
                                        (___kont3629336294_))
                                    (___kont3629336294_))))
                            (___kont3629336294_))))))
                 (_let-head3242_
                  (lambda (_x3660_)
                    (let* ((___stx3630836309_ _x3660_)
                           (_g36643675_
                            (lambda ()
                              (gx#raise-syntax-error
                               '#f
                               '"Bad syntax"
                               ___stx3630836309_))))
                      (let ((___kont3631136312_ (lambda (_L3703_) _L3703_))
                            (___kont3631336314_ (lambda () (list _x3660_))))
                        (if (gx#stx-pair? ___stx3630836309_)
                            (let ((_e36673693_
                                   (gx#syntax-e ___stx3630836309_)))
                              (let ((_tl36693700_ (##cdr _e36673693_))
                                ...
                                (if (gx#identifier? _hd36683697_)
                                    (if (gx#free-identifier=?
                                         ...
                                         _hd36683697_)
                                        (___kont3631136312_ _tl36693700_)
                                        (___kont3631336314_))
                                    (___kont3631336314_))))
                            (___kont3631336314_)))))))
          (let* ((___stx3632836329_ _stx3237_)
                 (_g32453311_
                  (lambda ()
                    (gx#raise-syntax-error
                     '#f
                               ...
                               (if (gx#stx-pair/null? _g34723492_)
                                   (let ((_g41222_
                                     ...
                                     (begin
                                       (let ((_g41223_
                                              (if (##values? _g41222_)
                                                  (##vector-length _g41222_)
                                                  1)))
                                         (if (not (##fx= _g41223_ 2))
                                             (error "Context expects 2 values"
                                                    _g41223_)))
                                       (let ((_target34743495_
                                              (##vector-ref _g41222_ 0))
                                             (_tl34763498_
                                              (##vector-ref _g41222_ 1)))
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                        ...
                                        (let ((_hd32903399_
                                          ...
                                          (if (gx#stx-pair/null? _tl32793345_)
                                              (let ((___splice3633736338_
                                                     (gx#syntax-split-splice
                                                      _tl32793345_
                                                      '0)))
                                                (let ((_tl32993405_
                                                       (##vector-ref
                                                        ___splice3633736338_
                                                        '1))
                                                      (_target32973402_
                                                       (##vector-ref
                                                        ___splice3633736338_
                                  ...
                                  (let ((___splice3633536336_
                                    ...
                                    (let ((_tl32823351_
                                      ...
                                      (if (gx#stx-null? _tl32823351_)
                                          ...
                                          (_g32453311_))))
                                  (_g32453311_)))))))
                (if (gx#stx-pair? ___stx3632836329_)
                    (let ((_e32523579_ (gx#syntax-e ___stx3632836329_)))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                        ...
                        (let ((___splice3633536336_
                          ...
                          (let ((_tl32823351_
                                 (##vector-ref ___splice3633536336_ '1))
                                (_target32803348_
                                 (##vector-ref ___splice3633536336_ '0)))
                            (if (gx#stx-null? _tl32823351_)
                                (___match3639736398_
                                 _e32523579_
                                 _hd32533583_
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
    ...
    (define |gerbil/core$<sugar>$<sugar:1>[:0:]#and|
      (lambda (_$stx3783_)
        (let* ((___stx3640036401_ _$stx3783_)
               (_g37893815_
                (lambda ()
                  (gx#raise-syntax-error
                   '#f
                   '"Bad syntax"
                   ___stx3640036401_))))
          (let ((___kont3640336404_ (lambda () '#t))
                (___kont3640536406_ (lambda (_L3887_) _L3887_))
                (___kont3640736408_
                   ...
                   (cons (gx#datum->syntax '#f 'if)
                         (cons _L3844_
                               (cons (cons _L3845_ _L3842_)
                                     (cons '#f '())))))))
            (if (gx#stx-pair? ___stx3640036401_)
                (let ((_e37913907_ (gx#syntax-e ___stx3640036401_)))
                            ...
                            (let ((_e37983877_ (gx#syntax-e _tl37933914_)))
                              (let ((_tl38003884_ (##cdr _e37983877_))
                                ...
                                (if (gx#stx-null? _tl38003884_)
                                    (___kont3640536406_ _hd37993881_)
                                    (___kont3640736408_
                                     _tl38003884_
                                     _hd37993881_
                                     _hd37923911_))))
    ...
    (define |gerbil/core$<sugar>$<sugar:1>[:0:]#or|
      (lambda (_$stx3925_)
        (let* ((___stx3644636447_ _$stx3925_)
               (_g39313957_
                (lambda ()
                  (gx#raise-syntax-error
                   '#f
                   '"Bad syntax"
                   ___stx3644636447_))))
          (let ((___kont3644936450_ (lambda () '#f))
                (___kont3645136452_ (lambda (_L4029_) _L4029_))
                (___kont3645336454_
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                     '()))))))
            (if (gx#stx-pair? ___stx3644636447_)
                (let ((_e39334049_ (gx#syntax-e ___stx3644636447_)))
                            ...
                            (let ((_e39404019_ (gx#syntax-e _tl39354056_)))
                              (let ((_tl39424026_ (##cdr _e39404019_))
                                ...
                                (if (gx#stx-null? _tl39424026_)
                                    (___kont3645136452_ _hd39414023_)
                                    (___kont3645336454_
                                     _tl39424026_
                                     _hd39414023_
                                     _hd39344053_))))
    ...
    (define |gerbil/core$<sugar>$<sugar:1>[:0:]#cond|
      (lambda (_$stx4067_)
        (let* ((___stx3649236493_ _$stx4067_)
               (_g40764167_
                (lambda ()
                  (gx#raise-syntax-error
                   '#f
                   '"Bad syntax"
                   ___stx3649236493_))))
          (let ((___kont3649536496_ (lambda () '#!void))
                (___kont3649736498_
                 (lambda (_L4514_)
                                  ...
                                  (if (gx#stx-pair? _hd40924494_)
                                      ...
                                      (let ((_body40994510_
                                        ...
                                        (if (gx#stx-null? _tl40874471_)
                                            (___kont3649736498_ _body40994510_)
                                            (___kont3650136502_)))))))
                        (_loop40944490_ _target40914484_ '())))))
              (if (gx#stx-pair? ___stx3649236493_)
                  (let ((_e40784549_ (gx#syntax-e ___stx3649236493_)))
                                      ...
                                      (let ((_e40884474_
                                        ...
                                        (let ((_tl40904481_
                                          ...
                                          (if (gx#identifier? _hd40894478_)
                                              (if (gx#free-identifier=?
                                                   |gerbil/core$<sugar>$<sugar:1>[1]#_g41224_|
                                                   _hd40894478_)
                                                  (if (gx#stx-pair/null?
                                                       _tl40904481_)
                                                      (let ((___splice3649936500_
                                                             (gx#syntax-split-splice
                                                              _tl40904481_
                                                              '0)))
                                                        (let ((_tl40934487_
                      ...
                      (if (gx#identifier? _hd41354309_)
                          ...
                          (if (gx#stx-pair/null? _tl40904481_)
                              (let ((___splice3650936510_
                                ...
                                (let ((_tl41554207_
                                       (##vector-ref ___splice3650936510_ '1))
                                      (_target41534204_
                                       (##vector-ref ___splice3650936510_ '0)))
                                  (if (gx#stx-null? _tl41554207_)
                                      (___match3665336654_
                                       _e40784549_
                                       _hd40794553_
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
              ...
              (if (gx#stx-pair/null? _tl40904481_)
                  (let ((___splice3650936510_
                         (gx#syntax-split-splice _tl40904481_ '0)))
                    (let ((_tl41554207_ (##vector-ref ___splice3650936510_ '1))
                          (_target41534204_
                           (##vector-ref ___splice3650936510_ '0)))
                      (if (gx#stx-null? _tl41554207_)
                          (___match3665336654_
                                  ...
                                  (if (gx#stx-pair/null? _tl45824621_)
                                      (let ((_g41226_
                                        ...
                                        (begin
                                          (let ((_g41227_
                                                 (if (##values? _g41226_)
                                                     (##vector-length _g41226_)
                                                     1)))
                                            (if (not (##fx= _g41227_ 2))
                                                (error "Context expects 2 values"
                                                       _g41227_)))
                                          (let ((_target45834624_
                                                 (##vector-ref _g41226_ 0))
                                                (_tl45854627_
                                                 (##vector-ref _g41226_ 1)))
