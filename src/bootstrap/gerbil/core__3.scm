...
(begin
  (define |gerbil/core$<sugar>$<sugar:1>[1]#_g41811_|
    (##structure
     gx#syntax-quote::t
     'values
     #f
     ...
     '()))
  (define |gerbil/core$<sugar>$<sugar:1>[1]#_g41812_|
    (##structure
     gx#syntax-quote::t
     'values
     #f
     (gx#current-expander-context)
     '()))
  (define |gerbil/core$<sugar>$<sugar:1>[1]#_g41815_|
    (##structure
     gx#syntax-quote::t
     'else
     #f
     (gx#current-expander-context)
     '()))
  (define |gerbil/core$<sugar>$<sugar:1>[1]#_g41816_|
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                            2))
                (error "Context expects 2 values" _g41804_)))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
    ...
    (define |gerbil/core$<sugar>$<sugar:1>[:0:]#defsyntax%|
      (lambda (_$stx1822_)
        (let* ((___stx3651736518_ _$stx1822_)
               (_g18271866_
                (lambda ()
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
            ...
            (let* ((___match3657236573_
                    (lambda (_e18521873_
                      ...
                      (let ((_L1903_ _hd18591897_) (_L1905_ _hd18561887_))
                        (if (gx#identifier? _L1905_)
                            (___kont3652436525_ _L1903_ _L1905_)
                            (_g18271866_)))))
                   (___match3656436565_
                    (lambda (_e18521873_
                             _hd18531877_
              ...
              (if (gx#stx-pair? ___stx3651736518_)
                  (let ((_e18321928_ (gx#syntax-e ___stx3651736518_)))
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
    ...
    (define |gerbil/core$<sugar>$<sugar:1>[:0:]#define|
      (lambda (_$stx2105_)
        (let* ((___stx3657536576_ _$stx2105_)
               (_g21102149_
                (lambda ()
                  (gx#raise-syntax-error
                   '#f
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
            ...
            (let* ((___match3663036631_
                    (lambda (_e21352156_
                      ...
                      (let ((_L2186_ _hd21422180_) (_L2188_ _hd21392170_))
                        (if (gx#identifier? _L2188_)
                            (___kont3658236583_ _L2186_ _L2188_)
                            (_g21102149_)))))
                   (___match3662236623_
                    (lambda (_e21352156_
                             _hd21362160_
              ...
              (if (gx#stx-pair? ___stx3657536576_)
                  (let ((_e21152211_ (gx#syntax-e ___stx3657536576_)))
    ...
    (define |gerbil/core$<sugar>$<sugar:1>[:0:]#let*-values|
      (lambda (_$stx2307_)
        (let* ((___stx3663336634_ _$stx2307_)
               (_g23122357_
                (lambda ()
                  (gx#raise-syntax-error
                   '#f
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
            ...
            (let* ((___match3669236693_
              ...
              (if (gx#stx-pair? ___stx3663336634_)
                  (let ((_e23152465_ (gx#syntax-e ___stx3663336634_)))
    ...
    (define |gerbil/core$<sugar>$<sugar:1>[:0:]#let|
      (lambda (_$stx2546_)
        (let* ((___stx3669536696_ _$stx2546_)
               (_g25512615_
                (lambda ()
                  (gx#raise-syntax-error
                   '#f
                    ...
                    (lambda (_e25952622_
                      ...
                      (if (gx#stx-pair/null? _tl26002639_)
                          (let ((___splice3670636707_
                            ...
                            (let ((_tl26032645_
                                   (##vector-ref ___splice3670636707_ '1))
                                  (_target26012642_
                                   (##vector-ref ___splice3670636707_ '0)))
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                      ...
                                      (let ((_var25772788_
                                        ...
                                        (if (gx#stx-pair/null? _tl25662734_)
                                            (let ((___splice3670236703_
                                                   (gx#syntax-split-splice
                                                    _tl25662734_
                                                    '0)))
                                              (let ((_tl25862794_
                                                     (##vector-ref
                                                      ___splice3670236703_
                                                      '1))
                                                    (_target25842791_
                                                     (##vector-ref
                                                      ___splice3670236703_
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
              ...
              (if (gx#stx-pair? ___stx3669536696_)
                  (let ((_e25582707_ (gx#syntax-e ___stx3669536696_)))
                                  ...
                                  (if (gx#stx-pair/null? _tl31323171_)
                                      (let ((_g41809_
                                        ...
                                        (begin
                                          (let ((_g41810_
                                                 (if (##values? _g41809_)
                                                     (##vector-length _g41809_)
                                                     1)))
                                            (if (not (##fx= _g41810_ 2))
                                                (error "Context expects 2 values"
                                                       _g41810_)))
                                          (let ((_target31333174_
                                                 (##vector-ref _g41809_ 0))
                                                (_tl31353177_
                                                 (##vector-ref _g41809_ 1)))
                           ...
                           (_g37243735_
                            (lambda ()
                              (gx#raise-syntax-error
                               ...
                               '"Bad syntax"
                               ___stx3675536756_))))
                      (let ((___kont3675836759_
                             (lambda (_L3763_)
                               (gx#stx-andmap gx#identifier? _L3763_)))
                            (___kont3676036761_
                             (lambda () (gx#identifier? _x3720_))))
                        (if (gx#stx-pair? ___stx3675536756_)
                            (let ((_e37273753_
                                   (gx#syntax-e ___stx3675536756_)))
                              (let ((_tl37293760_ (##cdr _e37273753_))
                                    (_hd37283757_ (##car _e37273753_)))
                                (if (gx#identifier? _hd37283757_)
                                    (if (gx#free-identifier=?
                                         |gerbil/core$<sugar>$<sugar:1>[1]#_g41811_|
                                         _hd37283757_)
                                        (___kont3675836759_ _tl37293760_)
                                        (___kont3676036761_))
                                    (___kont3676036761_))))
                            (___kont3676036761_))))))
                 (_let-head3242_
                  (lambda (_x3660_)
                    (let* ((___stx3677536776_ _x3660_)
                           (_g36643675_
                            (lambda ()
                              (gx#raise-syntax-error
                               '#f
                               '"Bad syntax"
                               ___stx3677536776_))))
                      (let ((___kont3677836779_ (lambda (_L3703_) _L3703_))
                            (___kont3678036781_ (lambda () (list _x3660_))))
                        (if (gx#stx-pair? ___stx3677536776_)
                            (let ((_e36673693_
                                   (gx#syntax-e ___stx3677536776_)))
                              (let ((_tl36693700_ (##cdr _e36673693_))
                                    (_hd36683697_ (##car _e36673693_)))
                                (if (gx#identifier? _hd36683697_)
                                    (if (gx#free-identifier=?
                                         |gerbil/core$<sugar>$<sugar:1>[1]#_g41812_|
                                         _hd36683697_)
                                        (___kont3677836779_ _tl36693700_)
                                        (___kont3678036781_))
                                    (___kont3678036781_))))
                            (___kont3678036781_)))))))
          (let* ((___stx3679536796_ _stx3237_)
                 (_g32453311_
                  (lambda ()
                    (gx#raise-syntax-error
                     '#f
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                        ...
                                        (let ((_hd32903399_
                                          ...
                                          (if (gx#stx-pair/null? _tl32793345_)
                                              (let ((___splice3680436805_
                                                     (gx#syntax-split-splice
                                                      _tl32793345_
                                                      '0)))
                                                (let ((_tl32993405_
                                                       (##vector-ref
                                                        ___splice3680436805_
                                                        '1))
                                                      (_target32973402_
                                                       (##vector-ref
                                                        ___splice3680436805_
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                ...
                (if (gx#stx-pair? ___stx3679536796_)
                    (let ((_e32523579_ (gx#syntax-e ___stx3679536796_)))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                        ...
                        (let ((___splice3680236803_
                          ...
                          (let ((_tl32823351_
                                 (##vector-ref ___splice3680236803_ '1))
                                (_target32803348_
                                 (##vector-ref ___splice3680236803_ '0)))
                            (if (gx#stx-null? _tl32823351_)
                                (___match3686436865_
                                 _e32523579_
                                 _hd32533583_
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
    ...
    (define |gerbil/core$<sugar>$<sugar:1>[:0:]#and|
      (lambda (_$stx3783_)
        (let* ((___stx3686736868_ _$stx3783_)
               (_g37893815_
                (lambda ()
                  (gx#raise-syntax-error
                   '#f
                   '"Bad syntax"
                   ___stx3686736868_))))
          (let ((___kont3687036871_ (lambda () '#t))
                (___kont3687236873_ (lambda (_L3887_) _L3887_))
                (___kont3687436875_
                   ...
                   (cons (gx#datum->syntax '#f 'if)
                         (cons _L3844_
                               (cons (cons _L3845_ _L3842_)
                                     (cons '#f '())))))))
            (if (gx#stx-pair? ___stx3686736868_)
                (let ((_e37913907_ (gx#syntax-e ___stx3686736868_)))
                            ...
                            (let ((_e37983877_ (gx#syntax-e _tl37933914_)))
                              (let ((_tl38003884_ (##cdr _e37983877_))
                                ...
                                (if (gx#stx-null? _tl38003884_)
                                    (___kont3687236873_ _hd37993881_)
                                    (___kont3687436875_
                                     _tl38003884_
                                     _hd37993881_
                                     _hd37923911_))))
    ...
    (define |gerbil/core$<sugar>$<sugar:1>[:0:]#or|
      (lambda (_$stx3925_)
        (let* ((___stx3691336914_ _$stx3925_)
               (_g39313957_
                (lambda ()
                  (gx#raise-syntax-error
                   '#f
                   '"Bad syntax"
                   ___stx3691336914_))))
          (let ((___kont3691636917_ (lambda () '#f))
                (___kont3691836919_ (lambda (_L4029_) _L4029_))
                (___kont3692036921_
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                     '()))))))
            (if (gx#stx-pair? ___stx3691336914_)
                (let ((_e39334049_ (gx#syntax-e ___stx3691336914_)))
                            ...
                            (let ((_e39404019_ (gx#syntax-e _tl39354056_)))
                              (let ((_tl39424026_ (##cdr _e39404019_))
                                ...
                                (if (gx#stx-null? _tl39424026_)
                                    (___kont3691836919_ _hd39414023_)
                                    (___kont3692036921_
                                     _tl39424026_
                                     _hd39414023_
                                     _hd39344053_))))
    ...
    (define |gerbil/core$<sugar>$<sugar:1>[:0:]#cond|
      (lambda (_$stx4067_)
        (let* ((___stx3695936960_ _$stx4067_)
               (_g40764167_
                (lambda ()
                  (gx#raise-syntax-error
                   '#f
                   '"Bad syntax"
                   ___stx3695936960_))))
          (let ((___kont3696236963_ (lambda () '#!void))
                (___kont3696436965_
                 (lambda (_L4514_)
                                  ...
                                  (if (gx#stx-pair? _hd40924494_)
                                      ...
                                      (let ((_body40994510_
                                        ...
                                        (if (gx#stx-null? _tl40874471_)
                                            (___kont3696436965_ _body40994510_)
                                            (___kont3696836969_)))))))
                        (_loop40944490_ _target40914484_ '())))))
              (if (gx#stx-pair? ___stx3695936960_)
                  (let ((_e40784549_ (gx#syntax-e ___stx3695936960_)))
                                      ...
                                      (let ((_e40884474_
                                        ...
                                        (let ((_tl40904481_
                                          ...
                                          (if (gx#identifier? _hd40894478_)
                                              (if (gx#free-identifier=?
                                                   |gerbil/core$<sugar>$<sugar:1>[1]#_g41815_|
                                                   _hd40894478_)
                                                  (if (gx#stx-pair/null?
                                                       _tl40904481_)
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                    ...
                    (let ((_tl41364312_ (##cdr _e41344305_))
                      ...
                      (if (gx#identifier? _hd41354309_)
                          (if (gx#free-identifier=?
                               |gerbil/core$<sugar>$<sugar:1>[1]#_g41816_|
                               _hd41354309_)
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
              ...
              (if (gx#stx-pair/null? _tl40904481_)
                  (let ((___splice3697636977_
                         (gx#syntax-split-splice _tl40904481_ '0)))
                    (let ((_tl41554207_ (##vector-ref ___splice3697636977_ '1))
                          (_target41534204_
                           (##vector-ref ___splice3697636977_ '0)))
                      (if (gx#stx-null? _tl41554207_)
                          (___match3712037121_
                                  ...
                                  (if (gx#stx-pair/null? _tl47004739_)
                                      (let ((_g41819_
                                        ...
                                        (begin
                                          (let ((_g41820_
                                                 (if (##values? _g41819_)
                                                     (##vector-length _g41819_)
                                                     1)))
                                            (if (not (##fx= _g41820_ 2))
                                                (error "Context expects 2 values"
                                                       _g41820_)))
                                          (let ((_target47014742_
                                                 (##vector-ref _g41819_ 0))
                                                (_tl47034745_
                                                 (##vector-ref _g41819_ 1)))
