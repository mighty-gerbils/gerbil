...
(begin
  (define |gerbil/core$<MOP>$<MOP:3>[2]#_g31682_|
    (gx#make-syntax-quote
     'runtime-type-info::t
     #f
     (gx#current-expander-context)
     '()))
  (define |gerbil/core$<MOP>$<MOP:3>[2]#_g31683_|
    (gx#make-syntax-quote
     'runtime-struct-info::t
     #f
     (gx#current-expander-context)
     '()))
  (define |gerbil/core$<MOP>$<MOP:3>[2]#_g31684_|
    (gx#make-syntax-quote
  ...
  (begin
    ...
    (define |gerbil/core$<MOP>$<MOP:3>[:1:]#macro-object|
      (|gerbil/core$<MOP>$<MOP:2>[1]#make-extended-class-info|
       ...
       (cons '()
             (cons |gerbil/core$<MOP>$<MOP:3>[2]#_g31693_|
                   (cons |gerbil/core$<MOP>$<MOP:3>[2]#_g31694_|
                         (cons |gerbil/core$<MOP>$<MOP:3>[2]#_g31695_|
                               (cons (cons |gerbil/core$<MOP>$<MOP:3>[2]#_g31696_|
                                           '())
                                     (cons (cons |gerbil/core$<MOP>$<MOP:3>[2]#_g31697_|
                                                 '())
                                           '()))))))
       'type-exhibitor:
