...
(begin
  ...
  (declare-type
   ...
   (@class gerbil/runtime/hash#locked-hash-table::t
           ...
           #t
           #f
           ((ref . _locked-hash-table::ref68470_)
            (delete! . _locked-hash-table::delete!68476_)
            (set! . _locked-hash-table::set!68472_)
            (copy . _locked-hash-table::copy68482_)
            (length . _locked-hash-table::length68480_)
            (clear! . _locked-hash-table::clear!68484_)
            (for-each . _locked-hash-table::for-each68478_)
            (update! . _locked-hash-table::update!68474_))))
  ...
  (declare-type
   ...
   (@class gerbil/runtime/hash#checked-hash-table::t
           ...
           #t
           #f
           ((ref . _checked-hash-table::ref68762_)
            (delete! . _checked-hash-table::delete!68768_)
            (set! . _checked-hash-table::set!68764_)
            (length . _checked-hash-table::length68772_)
            (copy . _checked-hash-table::copy68774_)
            (clear! . _checked-hash-table::clear!68776_)
            (update! . _checked-hash-table::update!68766_)
            (for-each . _checked-hash-table::for-each68770_))))
  ...
  (declare-type _locked-hash-table::ref68470_ (@lambda 3 #f))
  (declare-type locked-hash-table::ref::specialize (@lambda 1 #f))
  (declare-type _locked-hash-table::set!68472_ (@lambda 3 #f))
  (declare-type locked-hash-table::set!::specialize (@lambda 1 #f))
  (declare-type _locked-hash-table::update!68474_ (@lambda 4 #f))
  (declare-type locked-hash-table::update!::specialize (@lambda 1 #f))
  (declare-type _locked-hash-table::delete!68476_ (@lambda 2 #f))
  (declare-type locked-hash-table::delete!::specialize (@lambda 1 #f))
  (declare-type _locked-hash-table::for-each68478_ (@lambda 2 #f))
  (declare-type locked-hash-table::for-each::specialize (@lambda 1 #f))
  (declare-type _locked-hash-table::length68480_ (@lambda 1 #f))
  (declare-type locked-hash-table::length::specialize (@lambda 1 #f))
  (declare-type _locked-hash-table::copy68482_ (@lambda 1 #f))
  (declare-type locked-hash-table::copy::specialize (@lambda 1 #f))
  (declare-type _locked-hash-table::clear!68484_ (@lambda 1 #f))
  (declare-type locked-hash-table::clear!::specialize (@lambda 1 #f))
  (declare-type _checked-hash-table::ref68762_ (@lambda 3 #f))
  (declare-type checked-hash-table::ref::specialize (@lambda 1 #f))
  (declare-type _checked-hash-table::set!68764_ (@lambda 3 #f))
  (declare-type checked-hash-table::set!::specialize (@lambda 1 #f))
  (declare-type _checked-hash-table::update!68766_ (@lambda 4 #f))
  (declare-type checked-hash-table::update!::specialize (@lambda 1 #f))
  (declare-type _checked-hash-table::delete!68768_ (@lambda 2 #f))
  (declare-type checked-hash-table::delete!::specialize (@lambda 1 #f))
  (declare-type _checked-hash-table::for-each68770_ (@lambda 2 #f))
  (declare-type checked-hash-table::for-each::specialize (@lambda 1 #f))
  (declare-type _checked-hash-table::length68772_ (@lambda 1 #f))
  (declare-type checked-hash-table::length::specialize (@lambda 1 #f))
  (declare-type _checked-hash-table::copy68774_ (@lambda 1 #f))
  (declare-type checked-hash-table::copy::specialize (@lambda 1 #f))
  (declare-type _checked-hash-table::clear!68776_ (@lambda 1 #f))
