...
(begin
  ...
  (declare-type
   ...
   (@class gerbil/runtime/hash#locked-hash-table::t
           ...
           #t
           #f
           ((for-each . _locked-hash-table::for-each69574_)
            (set! . _locked-hash-table::set!69568_)
            (copy . _locked-hash-table::copy69578_)
            (length . _locked-hash-table::length69576_)
            (clear! . _locked-hash-table::clear!69580_)
            (delete! . _locked-hash-table::delete!69572_)
            (ref . _locked-hash-table::ref69566_)
            (update! . _locked-hash-table::update!69570_))))
  ...
  (declare-type
   ...
   (@class gerbil/runtime/hash#checked-hash-table::t
           ...
           #t
           #f
           ((for-each . _checked-hash-table::for-each69866_)
            (set! . _checked-hash-table::set!69860_)
            (copy . _checked-hash-table::copy69870_)
            (length . _checked-hash-table::length69868_)
            (clear! . _checked-hash-table::clear!69872_)
            (delete! . _checked-hash-table::delete!69864_)
            (ref . _checked-hash-table::ref69858_)
            (update! . _checked-hash-table::update!69862_))))
  ...
  (declare-type _locked-hash-table::ref69566_ (@lambda 3 #f))
  (declare-type _locked-hash-table::set!69568_ (@lambda 3 #f))
  (declare-type _locked-hash-table::update!69570_ (@lambda 4 #f))
  (declare-type _locked-hash-table::delete!69572_ (@lambda 2 #f))
  (declare-type _locked-hash-table::for-each69574_ (@lambda 2 #f))
  (declare-type _locked-hash-table::length69576_ (@lambda 1 #f))
  (declare-type _locked-hash-table::copy69578_ (@lambda 1 #f))
  (declare-type _locked-hash-table::clear!69580_ (@lambda 1 #f))
  (declare-type _checked-hash-table::ref69858_ (@lambda 3 #f))
  (declare-type _checked-hash-table::set!69860_ (@lambda 3 #f))
  (declare-type _checked-hash-table::update!69862_ (@lambda 4 #f))
  (declare-type _checked-hash-table::delete!69864_ (@lambda 2 #f))
  (declare-type _checked-hash-table::for-each69866_ (@lambda 2 #f))
  (declare-type _checked-hash-table::length69868_ (@lambda 1 #f))
  (declare-type _checked-hash-table::copy69870_ (@lambda 1 #f))
  (declare-type _checked-hash-table::clear!69872_ (@lambda 1 #f))
