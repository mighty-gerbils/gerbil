...
(begin
  ...
  (declare-type
   ...
   (@class gerbil/runtime/hash#locked-hash-table::t
           ...
           #t
           #f
           ((update! . _locked-hash-table::update!68952_)
            (for-each . _locked-hash-table::for-each68956_)
            (clear! . _locked-hash-table::clear!68962_)
            (length . _locked-hash-table::length68958_)
            (copy . _locked-hash-table::copy68960_)
            (set! . _locked-hash-table::set!68950_)
            (delete! . _locked-hash-table::delete!68954_)
            (ref . _locked-hash-table::ref68948_))))
  ...
  (declare-type
   ...
   (@class gerbil/runtime/hash#checked-hash-table::t
           ...
           #t
           #f
           ((set! . _checked-hash-table::set!69242_)
            (copy . _checked-hash-table::copy69252_)
            (length . _checked-hash-table::length69250_)
            (ref . _checked-hash-table::ref69240_)
            (delete! . _checked-hash-table::delete!69246_)
            (for-each . _checked-hash-table::for-each69248_)
            (update! . _checked-hash-table::update!69244_)
            (clear! . _checked-hash-table::clear!69254_))))
  ...
  (declare-type _locked-hash-table::ref68948_ (@lambda 3 #f))
  (declare-type _locked-hash-table::set!68950_ (@lambda 3 #f))
  (declare-type _locked-hash-table::update!68952_ (@lambda 4 #f))
  (declare-type _locked-hash-table::delete!68954_ (@lambda 2 #f))
  (declare-type _locked-hash-table::for-each68956_ (@lambda 2 #f))
  (declare-type _locked-hash-table::length68958_ (@lambda 1 #f))
  (declare-type _locked-hash-table::copy68960_ (@lambda 1 #f))
  (declare-type _locked-hash-table::clear!68962_ (@lambda 1 #f))
  (declare-type _checked-hash-table::ref69240_ (@lambda 3 #f))
  (declare-type _checked-hash-table::set!69242_ (@lambda 3 #f))
  (declare-type _checked-hash-table::update!69244_ (@lambda 4 #f))
  (declare-type _checked-hash-table::delete!69246_ (@lambda 2 #f))
  (declare-type _checked-hash-table::for-each69248_ (@lambda 2 #f))
  (declare-type _checked-hash-table::length69250_ (@lambda 1 #f))
  (declare-type _checked-hash-table::copy69252_ (@lambda 1 #f))
  (declare-type _checked-hash-table::clear!69254_ (@lambda 1 #f))
