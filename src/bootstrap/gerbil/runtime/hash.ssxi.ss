...
(begin
  ...
  (declare-type
   ...
   (@class gerbil/runtime/hash#locked-hash-table::t
           ...
           #t
           #f
           ((ref . _locked-hash-table::ref68539_)
            (delete! . _locked-hash-table::delete!68545_)
            (set! . _locked-hash-table::set!68541_)
            (copy . _locked-hash-table::copy68551_)
            (length . _locked-hash-table::length68549_)
            (clear! . _locked-hash-table::clear!68553_)
            (for-each . _locked-hash-table::for-each68547_)
            (update! . _locked-hash-table::update!68543_))))
  ...
  (declare-type
   ...
   (@class gerbil/runtime/hash#checked-hash-table::t
           ...
           #t
           #f
           ((delete! . _checked-hash-table::delete!68837_)
            (ref . _checked-hash-table::ref68831_)
            (length . _checked-hash-table::length68841_)
            (copy . _checked-hash-table::copy68843_)
            (set! . _checked-hash-table::set!68833_)
            (clear! . _checked-hash-table::clear!68845_)
            (update! . _checked-hash-table::update!68835_)
            (for-each . _checked-hash-table::for-each68839_))))
  ...
  (declare-type _locked-hash-table::ref68539_ (@lambda 3 #f))
  (declare-type locked-hash-table::ref::specialize (@lambda 1 #f))
  (declare-type _locked-hash-table::set!68541_ (@lambda 3 #f))
  (declare-type locked-hash-table::set!::specialize (@lambda 1 #f))
  (declare-type _locked-hash-table::update!68543_ (@lambda 4 #f))
  (declare-type locked-hash-table::update!::specialize (@lambda 1 #f))
  (declare-type _locked-hash-table::delete!68545_ (@lambda 2 #f))
  (declare-type locked-hash-table::delete!::specialize (@lambda 1 #f))
  (declare-type _locked-hash-table::for-each68547_ (@lambda 2 #f))
  (declare-type locked-hash-table::for-each::specialize (@lambda 1 #f))
  (declare-type _locked-hash-table::length68549_ (@lambda 1 #f))
  (declare-type locked-hash-table::length::specialize (@lambda 1 #f))
  (declare-type _locked-hash-table::copy68551_ (@lambda 1 #f))
  (declare-type locked-hash-table::copy::specialize (@lambda 1 #f))
  (declare-type _locked-hash-table::clear!68553_ (@lambda 1 #f))
  (declare-type locked-hash-table::clear!::specialize (@lambda 1 #f))
  (declare-type _checked-hash-table::ref68831_ (@lambda 3 #f))
  (declare-type checked-hash-table::ref::specialize (@lambda 1 #f))
  (declare-type _checked-hash-table::set!68833_ (@lambda 3 #f))
  (declare-type checked-hash-table::set!::specialize (@lambda 1 #f))
  (declare-type _checked-hash-table::update!68835_ (@lambda 4 #f))
  (declare-type checked-hash-table::update!::specialize (@lambda 1 #f))
  (declare-type _checked-hash-table::delete!68837_ (@lambda 2 #f))
  (declare-type checked-hash-table::delete!::specialize (@lambda 1 #f))
  (declare-type _checked-hash-table::for-each68839_ (@lambda 2 #f))
  (declare-type checked-hash-table::for-each::specialize (@lambda 1 #f))
  (declare-type _checked-hash-table::length68841_ (@lambda 1 #f))
  (declare-type checked-hash-table::length::specialize (@lambda 1 #f))
  (declare-type _checked-hash-table::copy68843_ (@lambda 1 #f))
  (declare-type checked-hash-table::copy::specialize (@lambda 1 #f))
  (declare-type _checked-hash-table::clear!68845_ (@lambda 1 #f))
