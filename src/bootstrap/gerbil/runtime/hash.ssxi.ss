...
(begin
  ...
  (declare-type
   ...
   (@class gerbil/runtime/hash#locked-hash-table::t
           ...
           #t
           #f
           ((copy . _locked-hash-table::copy68470_)
            (length . _locked-hash-table::length68468_)
            (set! . _locked-hash-table::set!68460_)
            (delete! . _locked-hash-table::delete!68464_)
            (ref . _locked-hash-table::ref68458_)
            (for-each . _locked-hash-table::for-each68466_)
            (update! . _locked-hash-table::update!68462_)
            (clear! . _locked-hash-table::clear!68472_))))
  ...
  (declare-type _locked-hash-table::ref68458_ (@lambda 3 #f))
  (declare-type locked-hash-table::ref::specialize (@lambda 1 #f))
  (declare-type _locked-hash-table::set!68460_ (@lambda 3 #f))
  (declare-type locked-hash-table::set!::specialize (@lambda 1 #f))
  (declare-type _locked-hash-table::update!68462_ (@lambda 4 #f))
  (declare-type locked-hash-table::update!::specialize (@lambda 1 #f))
  (declare-type _locked-hash-table::delete!68464_ (@lambda 2 #f))
  (declare-type locked-hash-table::delete!::specialize (@lambda 1 #f))
  (declare-type _locked-hash-table::for-each68466_ (@lambda 2 #f))
  (declare-type locked-hash-table::for-each::specialize (@lambda 1 #f))
  (declare-type _locked-hash-table::length68468_ (@lambda 1 #f))
  (declare-type locked-hash-table::length::specialize (@lambda 1 #f))
  (declare-type _locked-hash-table::copy68470_ (@lambda 1 #f))
  (declare-type locked-hash-table::copy::specialize (@lambda 1 #f))
  (declare-type _locked-hash-table::clear!68472_ (@lambda 1 #f))
  (declare-type locked-hash-table::clear!::specialize (@lambda 1 #f))
  (declare-type _checked-hash-table::ref68750_ (@lambda 3 #f))
  (declare-type checked-hash-table::ref::specialize (@lambda 1 #f))
  (declare-type _checked-hash-table::set!68752_ (@lambda 3 #f))
  (declare-type checked-hash-table::set!::specialize (@lambda 1 #f))
  (declare-type _checked-hash-table::update!68754_ (@lambda 4 #f))
  (declare-type checked-hash-table::update!::specialize (@lambda 1 #f))
  (declare-type _checked-hash-table::delete!68756_ (@lambda 2 #f))
  (declare-type checked-hash-table::delete!::specialize (@lambda 1 #f))
  (declare-type _checked-hash-table::for-each68758_ (@lambda 2 #f))
  (declare-type checked-hash-table::for-each::specialize (@lambda 1 #f))
  (declare-type _checked-hash-table::length68760_ (@lambda 1 #f))
  (declare-type checked-hash-table::length::specialize (@lambda 1 #f))
  (declare-type _checked-hash-table::copy68762_ (@lambda 1 #f))
  (declare-type checked-hash-table::copy::specialize (@lambda 1 #f))
  (declare-type _checked-hash-table::clear!68764_ (@lambda 1 #f))
