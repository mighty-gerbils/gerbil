...
(begin
  ...
  (declare-type
   ...
   (@class gerbil/runtime/hash#locked-hash-table::t
           ...
           #f
           #f
           ((copy . _locked-hash-table::copy68026_)
            (clear! . _locked-hash-table::clear!68028_)
            (ref . _locked-hash-table::ref68014_)
            (set! . _locked-hash-table::set!68016_)
            (update! . _locked-hash-table::update!68018_)
            (for-each . _locked-hash-table::for-each68022_)
            (delete! . _locked-hash-table::delete!68020_)
            (length . _locked-hash-table::length68024_))))
  ...
  (declare-type
   ...
   (@class gerbil/runtime/hash#checked-hash-table::t
           ...
           #f
           #f
           ((copy . _checked-hash-table::copy68318_)
            (clear! . _checked-hash-table::clear!68320_)
            (ref . _checked-hash-table::ref68306_)
            (set! . _checked-hash-table::set!68308_)
            (update! . _checked-hash-table::update!68310_)
            (for-each . _checked-hash-table::for-each68314_)
            (delete! . _checked-hash-table::delete!68312_)
            (length . _checked-hash-table::length68316_))))
  ...
  (declare-type _locked-hash-table::ref68014_ (@lambda 3 #f))
  (declare-type _locked-hash-table::set!68016_ (@lambda 3 #f))
  (declare-type _locked-hash-table::update!68018_ (@lambda 4 #f))
  (declare-type _locked-hash-table::delete!68020_ (@lambda 2 #f))
  (declare-type _locked-hash-table::for-each68022_ (@lambda 2 #f))
  (declare-type _locked-hash-table::length68024_ (@lambda 1 #f))
  (declare-type _locked-hash-table::copy68026_ (@lambda 1 #f))
  (declare-type _locked-hash-table::clear!68028_ (@lambda 1 #f))
  (declare-type _checked-hash-table::ref68306_ (@lambda 3 #f))
  (declare-type _checked-hash-table::set!68308_ (@lambda 3 #f))
  (declare-type _checked-hash-table::update!68310_ (@lambda 4 #f))
  (declare-type _checked-hash-table::delete!68312_ (@lambda 2 #f))
  (declare-type _checked-hash-table::for-each68314_ (@lambda 2 #f))
  (declare-type _checked-hash-table::length68316_ (@lambda 1 #f))
  (declare-type _checked-hash-table::copy68318_ (@lambda 1 #f))
  (declare-type _checked-hash-table::clear!68320_ (@lambda 1 #f))
