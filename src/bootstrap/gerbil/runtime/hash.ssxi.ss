...
(begin
  ...
  (declare-type
   ...
   (@class gerbil/runtime/hash#locked-hash-table::t
           ...
           #t
           #f
           ((set! . _locked-hash-table::set!66512_)
            (for-each . _locked-hash-table::for-each66518_)
            (update! . _locked-hash-table::update!66514_)
            (clear! . _locked-hash-table::clear!66524_)
            (length . _locked-hash-table::length66520_)
            (ref . _locked-hash-table::ref66510_)
            (delete! . _locked-hash-table::delete!66516_)
            (copy . _locked-hash-table::copy66522_))))
  ...
  (declare-type
   ...
   (@class gerbil/runtime/hash#checked-hash-table::t
           ...
           #t
           #f
           ((set! . _checked-hash-table::set!66804_)
            (for-each . _checked-hash-table::for-each66810_)
            (update! . _checked-hash-table::update!66806_)
            (clear! . _checked-hash-table::clear!66816_)
            (length . _checked-hash-table::length66812_)
            (ref . _checked-hash-table::ref66802_)
            (delete! . _checked-hash-table::delete!66808_)
            (copy . _checked-hash-table::copy66814_))))
  ...
  (declare-type _locked-hash-table::ref66510_ (@lambda 3 #f))
  (declare-type _locked-hash-table::set!66512_ (@lambda 3 #f))
  (declare-type _locked-hash-table::update!66514_ (@lambda 4 #f))
  (declare-type _locked-hash-table::delete!66516_ (@lambda 2 #f))
  (declare-type _locked-hash-table::for-each66518_ (@lambda 2 #f))
  (declare-type _locked-hash-table::length66520_ (@lambda 1 #f))
  (declare-type _locked-hash-table::copy66522_ (@lambda 1 #f))
  (declare-type _locked-hash-table::clear!66524_ (@lambda 1 #f))
  (declare-type _checked-hash-table::ref66802_ (@lambda 3 #f))
  (declare-type _checked-hash-table::set!66804_ (@lambda 3 #f))
  (declare-type _checked-hash-table::update!66806_ (@lambda 4 #f))
  (declare-type _checked-hash-table::delete!66808_ (@lambda 2 #f))
  (declare-type _checked-hash-table::for-each66810_ (@lambda 2 #f))
  (declare-type _checked-hash-table::length66812_ (@lambda 1 #f))
  (declare-type _checked-hash-table::copy66814_ (@lambda 1 #f))
  (declare-type _checked-hash-table::clear!66816_ (@lambda 1 #f))
