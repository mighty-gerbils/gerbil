  ...
  (declare-class
   ...
   (@class gerbil/runtime/hash#locked-hash-table::t
           ...
           ((HashTable::update!
            ...
            (HashTable::ref . _%locked-hash-table::HashTable::ref148600%_)
            (HashTable::for-each
             .
             _%locked-hash-table::HashTable::for-each148608%_)
            (HashTable::copy . _%locked-hash-table::HashTable::copy148612%_)
            (HashTable::clear!
             .
             _%locked-hash-table::HashTable::clear!148614%_)
            (HashTable::set! . _%locked-hash-table::HashTable::set!148602%_)
            (HashTable::length
             .
  ...
  (declare-class
   ...
   (@class gerbil/runtime/hash#checked-hash-table::t
           ...
           ((HashTable::update!
            ...
            (HashTable::ref . _%checked-hash-table::HashTable::ref148825%_)
            (HashTable::for-each
             .
             _%checked-hash-table::HashTable::for-each148833%_)
            (HashTable::copy . _%checked-hash-table::HashTable::copy148837%_)
            (HashTable::clear!
             .
             _%checked-hash-table::HashTable::clear!148839%_)
            (HashTable::set! . _%checked-hash-table::HashTable::set!148827%_)
            (HashTable::length
             .
