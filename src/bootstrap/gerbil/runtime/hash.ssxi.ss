...
(begin
  ...
  (declare-type
   ...
   (@class gerbil/runtime/hash#locked-hash-table::t
           ...
           #t
           #f
           ((clear! . _locked-hash-table::clear!102424_)
            (update! . _locked-hash-table::update!102414_)
            (for-each . _locked-hash-table::for-each102418_)
            (delete! . _locked-hash-table::delete!102416_)
            (ref . _locked-hash-table::ref102410_)
            (length . _locked-hash-table::length102420_)
            (copy . _locked-hash-table::copy102422_)
            (set! . _locked-hash-table::set!102412_))))
  ...
  (declare-type _locked-hash-table::ref102410_ (@lambda 3 #f))
  (declare-type locked-hash-table::ref::specialize (@lambda 1 #f))
  (declare-type _locked-hash-table::set!102412_ (@lambda 3 #f))
  (declare-type locked-hash-table::set!::specialize (@lambda 1 #f))
  (declare-type _locked-hash-table::update!102414_ (@lambda 4 #f))
  (declare-type locked-hash-table::update!::specialize (@lambda 1 #f))
  (declare-type _locked-hash-table::delete!102416_ (@lambda 2 #f))
  (declare-type locked-hash-table::delete!::specialize (@lambda 1 #f))
  (declare-type _locked-hash-table::for-each102418_ (@lambda 2 #f))
  (declare-type locked-hash-table::for-each::specialize (@lambda 1 #f))
  (declare-type _locked-hash-table::length102420_ (@lambda 1 #f))
  (declare-type locked-hash-table::length::specialize (@lambda 1 #f))
  (declare-type _locked-hash-table::copy102422_ (@lambda 1 #f))
  (declare-type locked-hash-table::copy::specialize (@lambda 1 #f))
  (declare-type _locked-hash-table::clear!102424_ (@lambda 1 #f))
