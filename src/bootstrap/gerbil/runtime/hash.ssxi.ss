...
(begin
  ...
  (declare-class
   ...
   (@class gerbil/runtime/hash#locked-hash-table::t
           ...
           #f
           #f
           ((HashTable::copy . _%locked-hash-table::HashTable::copy113498%_)
            (HashTable::ref . _%locked-hash-table::HashTable::ref113486%_)
            (HashTable::update!
             .
             _%locked-hash-table::HashTable::update!113490%_)
            (HashTable::set! . _%locked-hash-table::HashTable::set!113488%_)
            (HashTable::length
             .
  ...
  (declare-class
   ...
   (@class gerbil/runtime/hash#checked-hash-table::t
           ...
           #f
           #f
           ((HashTable::copy . _%checked-hash-table::HashTable::copy113725%_)
            (HashTable::ref . _%checked-hash-table::HashTable::ref113713%_)
            (HashTable::update!
             .
             _%checked-hash-table::HashTable::update!113717%_)
            (HashTable::set! . _%checked-hash-table::HashTable::set!113715%_)
            (HashTable::length
             .
