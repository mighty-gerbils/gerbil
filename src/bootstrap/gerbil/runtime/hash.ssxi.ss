...
(begin
  ...
  (declare-type
   ...
   (@class gerbil/runtime/hash#locked-hash-table::t
           ...
           #t
           #f
           ((copy . _locked-hash-table::copy66199_)
            (length . _locked-hash-table::length66197_)
            (set! . _locked-hash-table::set!66189_)
            (delete! . _locked-hash-table::delete!66193_)
            (ref . _locked-hash-table::ref66187_)
            (for-each . _locked-hash-table::for-each66195_)
            (update! . _locked-hash-table::update!66191_)
            (clear! . _locked-hash-table::clear!66201_))))
  ...
  (declare-type
   ...
   (@class gerbil/runtime/hash#checked-hash-table::t
           ...
           #t
           #f
           ((clear! . _checked-hash-table::clear!66493_)
            (update! . _checked-hash-table::update!66483_)
            (for-each . _checked-hash-table::for-each66487_)
            (delete! . _checked-hash-table::delete!66485_)
            (ref . _checked-hash-table::ref66479_)
            (length . _checked-hash-table::length66489_)
            (copy . _checked-hash-table::copy66491_)
            (set! . _checked-hash-table::set!66481_))))
  ...
  (declare-type _locked-hash-table::ref66187_ (@lambda 3 #f))
  (declare-type _locked-hash-table::set!66189_ (@lambda 3 #f))
  (declare-type _locked-hash-table::update!66191_ (@lambda 4 #f))
  (declare-type _locked-hash-table::delete!66193_ (@lambda 2 #f))
  (declare-type _locked-hash-table::for-each66195_ (@lambda 2 #f))
  (declare-type _locked-hash-table::length66197_ (@lambda 1 #f))
  (declare-type _locked-hash-table::copy66199_ (@lambda 1 #f))
  (declare-type _locked-hash-table::clear!66201_ (@lambda 1 #f))
  (declare-type _checked-hash-table::ref66479_ (@lambda 3 #f))
  (declare-type _checked-hash-table::set!66481_ (@lambda 3 #f))
  (declare-type _checked-hash-table::update!66483_ (@lambda 4 #f))
  (declare-type _checked-hash-table::delete!66485_ (@lambda 2 #f))
  (declare-type _checked-hash-table::for-each66487_ (@lambda 2 #f))
  (declare-type _checked-hash-table::length66489_ (@lambda 1 #f))
  (declare-type _checked-hash-table::copy66491_ (@lambda 1 #f))
  (declare-type _checked-hash-table::clear!66493_ (@lambda 1 #f))
