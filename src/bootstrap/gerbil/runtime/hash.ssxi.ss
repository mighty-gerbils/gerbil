...
(begin
  ...
  (declare-type
   ...
   (@class gerbil/runtime/hash#locked-hash-table::t
           ...
           #t
           #f
           ((delete! . _locked-hash-table::delete!69564_)
            (ref . _locked-hash-table::ref69558_)
            (length . _locked-hash-table::length69568_)
            (copy . _locked-hash-table::copy69570_)
            (set! . _locked-hash-table::set!69560_)
            (clear! . _locked-hash-table::clear!69572_)
            (update! . _locked-hash-table::update!69562_)
            (for-each . _locked-hash-table::for-each69566_))))
  ...
  (declare-type
   ...
   (@class gerbil/runtime/hash#checked-hash-table::t
           ...
           #t
           #f
           ((clear! . _checked-hash-table::clear!69864_)
            (update! . _checked-hash-table::update!69854_)
            (for-each . _checked-hash-table::for-each69858_)
            (delete! . _checked-hash-table::delete!69856_)
            (ref . _checked-hash-table::ref69850_)
            (length . _checked-hash-table::length69860_)
            (copy . _checked-hash-table::copy69862_)
            (set! . _checked-hash-table::set!69852_))))
  ...
  (declare-type _locked-hash-table::ref69558_ (@lambda 3 #f))
  (declare-type _locked-hash-table::set!69560_ (@lambda 3 #f))
  (declare-type _locked-hash-table::update!69562_ (@lambda 4 #f))
  (declare-type _locked-hash-table::delete!69564_ (@lambda 2 #f))
  (declare-type _locked-hash-table::for-each69566_ (@lambda 2 #f))
  (declare-type _locked-hash-table::length69568_ (@lambda 1 #f))
  (declare-type _locked-hash-table::copy69570_ (@lambda 1 #f))
  (declare-type _locked-hash-table::clear!69572_ (@lambda 1 #f))
  (declare-type _checked-hash-table::ref69850_ (@lambda 3 #f))
  (declare-type _checked-hash-table::set!69852_ (@lambda 3 #f))
  (declare-type _checked-hash-table::update!69854_ (@lambda 4 #f))
  (declare-type _checked-hash-table::delete!69856_ (@lambda 2 #f))
  (declare-type _checked-hash-table::for-each69858_ (@lambda 2 #f))
  (declare-type _checked-hash-table::length69860_ (@lambda 1 #f))
  (declare-type _checked-hash-table::copy69862_ (@lambda 1 #f))
  (declare-type _checked-hash-table::clear!69864_ (@lambda 1 #f))
