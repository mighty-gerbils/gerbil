...
(begin
  ...
  (declare-type
   ...
   (@class gerbil/runtime/hash#locked-hash-table::t
           ...
           #f
           #f
           ((copy . _locked-hash-table::copy71044_)
            (set! . _locked-hash-table::set!71034_)
            (for-each . _locked-hash-table::for-each71040_)
            (length . _locked-hash-table::length71042_)
            (clear! . _locked-hash-table::clear!71046_)
            (delete! . _locked-hash-table::delete!71038_)
            (ref . _locked-hash-table::ref71032_)
            (update! . _locked-hash-table::update!71036_))))
  ...
  (declare-type
   ...
   (@class gerbil/runtime/hash#checked-hash-table::t
           ...
           #f
           #f
           ((copy . _checked-hash-table::copy71336_)
            (set! . _checked-hash-table::set!71326_)
            (for-each . _checked-hash-table::for-each71332_)
            (length . _checked-hash-table::length71334_)
            (clear! . _checked-hash-table::clear!71338_)
            (delete! . _checked-hash-table::delete!71330_)
            (ref . _checked-hash-table::ref71324_)
            (update! . _checked-hash-table::update!71328_))))
  ...
  (declare-type _locked-hash-table::ref71032_ (@lambda 3 #f))
  (declare-type _locked-hash-table::set!71034_ (@lambda 3 #f))
  (declare-type _locked-hash-table::update!71036_ (@lambda 4 #f))
  (declare-type _locked-hash-table::delete!71038_ (@lambda 2 #f))
  (declare-type _locked-hash-table::for-each71040_ (@lambda 2 #f))
  (declare-type _locked-hash-table::length71042_ (@lambda 1 #f))
  (declare-type _locked-hash-table::copy71044_ (@lambda 1 #f))
  (declare-type _locked-hash-table::clear!71046_ (@lambda 1 #f))
  (declare-type _checked-hash-table::ref71324_ (@lambda 3 #f))
  (declare-type _checked-hash-table::set!71326_ (@lambda 3 #f))
  (declare-type _checked-hash-table::update!71328_ (@lambda 4 #f))
  (declare-type _checked-hash-table::delete!71330_ (@lambda 2 #f))
  (declare-type _checked-hash-table::for-each71332_ (@lambda 2 #f))
  (declare-type _checked-hash-table::length71334_ (@lambda 1 #f))
  (declare-type _checked-hash-table::copy71336_ (@lambda 1 #f))
  (declare-type _checked-hash-table::clear!71338_ (@lambda 1 #f))
