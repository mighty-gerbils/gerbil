...
(begin
  (define gerbil/runtime/util::timestamp 1707772763)
  (begin
    (define displayln
      (lambda _args59115_
    ...
    (define drop
      (lambda (_l58531_ _k58532_)
        (if (let () (declare (not safe)) (##fxpositive? _k58532_))
            (let ((__tmp64174 (cdr _l58531_))
                  (__tmp64173 (let () (declare (not safe)) (fx- _k58532_ '1))))
              (declare (not safe))
