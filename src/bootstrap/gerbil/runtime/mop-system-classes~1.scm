             ...
             (_%g9796498172%_
              (lambda (_%g9796698007%_)
                (if (gx#stx-pair? _%g9796698007%_)
                    (let ((_%e9797198010%_ (gx#syntax-e _%g9796698007%_)))
                      (let ((_%hd9797298014%_
                            ...
                            (_%tl9797398017%_
                             (let ()
                               (declare (not safe))
                               (##cdr _%e9797198010%_))))
                        (if (gx#stx-pair? _%tl9797398017%_)
                            (let ((_%e9797498020%_
                                   (gx#syntax-e _%tl9797398017%_)))
                                      ...
                                      (let ((_%hd9797898034%_
                                            ...
                                            (_%tl9797998037%_
                                             (let ()
                                               (declare (not safe))
                                               (##cdr _%e9797798030%_))))
                                        (if (gx#stx-pair? _%tl9797998037%_)
                                            (let ((_%e9798098040%_
                                                   (gx#syntax-e
                                                    _%tl9797998037%_)))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                         (let () (declare (not safe)) (##car _%e9798398050%_)))
                        (_%tl9798598057%_
                         (let ()
                           (declare (not safe))
                           (##cdr _%e9798398050%_))))
                    (if (gx#identifier? _%hd9798498054%_)
                        (if (gx#free-identifier=?
                             |[1]#_g98335_|
                             _%hd9798498054%_)
                            (if (gx#stx-pair? _%tl9798598057%_)
                                (let ((_%e9798698060%_
                                       (gx#syntax-e _%tl9798598057%_)))
                                  (let ((_%hd9798798064%_
                                        ...
                                        (_%tl9798898067%_
                                         (let ()
                                           (declare (not safe))
                                           (##cdr _%e9798698060%_))))
                                    (if (gx#stx-pair/null? _%tl9798898067%_)
                                        (let ((_g98336_
