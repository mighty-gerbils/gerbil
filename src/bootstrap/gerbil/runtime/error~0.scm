...
(begin
  (define gerbil/runtime/error::timestamp 1712269044)
  (begin
    (define Exception::t
          ...
          (let ((_%tmp-port100084%_ (open-output-string))
            ...
            (let ((__tmp100602
              ...
              (__call-with-parameters
               ...
               current-output-port
               _%tmp-port100084%_))
            (let ((__tmp100606 (get-output-string _%tmp-port100084%_)))
              (declare (not safe))
              (##write-string __tmp100606 _%port100071%_))))))
    (let ()
      (declare (not safe))
      (__bind-method!
       Error::t
        ...
        (let ()
          (let* ((_%self99930%_ _%self99926%_)
            ...
            (let ((__tmp100607
              ...
              (declare (not safe))
              (##default-display-exception __tmp100607 _%tmp-port99940%_))
            (if (let () (declare (not safe)) (dump-stack-trace?))
                (let ((_%cont9994199943%_
                  ...
                  (if _%cont9994199943%_
                      ...
                      '#f))
                '#!void)
            (let ((__tmp100608 (get-output-string _%tmp-port99940%_)))
              (declare (not safe))
              (##write-string __tmp100608 _%port99927%_))))))
    (let ()
      (declare (not safe))
      (__bind-method!
       RuntimeException::t
              ...
              (if (macro-error-exception? _%e99721%_)
                  ...
                  (let ((__tmp100627
                         (cons 'error-exception-message
                               (cons _%e99721%_ '()))))
                    (declare (not safe))
                    (error '"not an instance" 'error-exception? __tmp100627))))
            ...
            (let ((_%e99431%_
              ...
              (if (macro-os-exception? _%e99431%_)
                  ...
                  (let ((__tmp100709
                    ...
                    (declare (not safe))
                    (error '"not an instance" 'os-exception? __tmp100709))))
            ...
            (let ((_%e99395%_
              ...
              (if (macro-range-exception? _%e99395%_)
                  ...
                  (let ((__tmp100721
                    ...
                    (declare (not safe))
                    (error '"not an instance" 'range-exception? __tmp100721))))
            ...
            (let ((_%e99293%_
              ...
              (if (macro-type-exception? _%e99293%_)
                  ...
                  (let ((__tmp100751
                    ...
                    (declare (not safe))
                    (error '"not an instance" 'type-exception? __tmp100751))))
