...
(begin
  (define gerbil/runtime/mop::timestamp 1708271166)
  (begin
                         ...
                         (let ((_alist85315_
                           ...
                           (if (or (let ()
                               ...
                               (let ((__tmp89627
                                 ...
                                 (declare (not safe))
                                 (_put-slots!85310_ _ht85309_ __tmp89627))
                               (let ()
                                 (declare (not safe))
                                 (_put-alist!85311_
                                  _ht85309_
          ...
          (let _lp85093_ ((_super-struct85095_ _maybe-sub-struct85088_))
            (if (let () (declare (not safe)) (not _super-struct85095_))
                ...
                (if (let ((__tmp89647
                      ...
                      (declare (not safe))
                      (eq? _maybe-super-struct-id85091_ __tmp89647))
                    '#t
                    (let ((__tmp89648
                           (let ()
                             (declare (not safe))
                      ...
                      (begin
                        (let ()
                          ...
                          (symbolic-table-set!
                           ...
                           _slot84893_
                           _next-slot84887_))
                        (let ((__tmp89654 (symbol->keyword _slot84893_)))
                          (declare (not safe))
                          (symbolic-table-set!
                           _slot-table84889_
                           __tmp89654
                  ...
                  (if (let ((__tmp89700
                      ...
                      (if (let ((__tmp89702
                                 (let ((__tmp89703
                                   ...
                                   (declare (not safe))
                                   (##fx- __tmp89703 '1)))
                                (__tmp89701 (length _args84578_)))
                            (declare (not safe))
                            (##fx= __tmp89702 __tmp89701))
                        ...
                        (if (let ((__tmp89726
                                   (let ()
                                     ...
                                     (##unchecked-structure-ref
                                      ...
                                      '#f))))
                              (declare (not safe))
                              (find class-type-metaclass? __tmp89726))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                 ...
                 (declare (not safe))
                 (make-symbol__1 __tmp89728 '"::[" _id84273_ '"]"))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                  (eval (let ((__tmp89729
                                                               (let ((__tmp89730
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                              (let ((__tmp89731
                                     (let ((__tmp89732
                                            (let ()
                                              ...
                                              (cons _proc84281_ '()))))
                                       (declare (not safe))
                                       (cons 'quote __tmp89732))))
                                (declare (not safe))
                                (cons __tmp89731 '()))))
                         (declare (not safe))
                         (cons _gid84282_ __tmp89730))))
                  (declare (not safe))
                  (cons 'def __tmp89729)))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                  (let ()
                                             ...
                                             (let ()
                                               ...
                                               (symbolic-table-set!
                                                ...
                                                _proc84274_)))))))
                                (declare (not safe))
                                (raw-table-for-each _mtab84271_ __tmp89727))
                              (let ()
                                (declare (not safe))
                                (##unchecked-structure-set!
                                 _klass84266_
