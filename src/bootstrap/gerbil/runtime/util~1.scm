...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                           ...
                           (cons (cons (gx#datum->syntax '#f 'quote)
                                       (cons (__foldr1
                                              (lambda (_%g8619286197%_
                                                       _%g8619386200%_)
                                                (cons _%g8619286197%_
                                                      _%g8619386200%_))
                                              '()
                                              _%L86159%_)
                                             '()))
                                                ...
                                                (let ((_%tl8599886095%_
                                                  ...
                                                  (if (gx#stx-pair?
                                                      ...
                                                      (let ((_%e8599986098%_
                                                             (gx#syntax-e
                                                              _%tl8599886095%_)))
                                                        (let ((_%tl8600186105%_
                                                               (let ()
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                         (declare (not safe))
                         (##cdr _%e8599986098%_)))
                      (_%hd8600086102%_
                       (let () (declare (not safe)) (##car _%e8599986098%_))))
                  (if (gx#stx-null? _%tl8600186105%_)
                      (_%loop8598886066%_
                       _%lp-tl8599186085%_
                       (cons _%hd8600086102%_ _%exprs8599286073%_)
                       (cons _%hd8599786092%_ _%names8599386075%_))
                                                ...
                                                (if (gx#stx-null?
                                                    ...
                                                    (if (gx#stx-pair?
                                                        ...
                                                        (let ((_%e8600586124%_
                                                               (gx#syntax-e
                                                                _%tl8600486121%_)))
                                                          (let ((_%tl8600786131%_
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                         (let () (declare (not safe)) (##cdr _%e8600586124%_)))
                        (_%hd8600686128%_
                         (let ()
                           (declare (not safe))
                           (##car _%e8600586124%_))))
                    (if (gx#stx-pair? _%tl8600786131%_)
                        (let ((_%e8600886134%_ (gx#syntax-e _%tl8600786131%_)))
                          (let ((_%tl8601086141%_
                                 (let ()
                                   (declare (not safe))
                                   (##cdr _%e8600886134%_)))
                                (_%hd8600986138%_
                                 (let ()
                                   (declare (not safe))
                                   (##car _%e8600886134%_))))
                            (if (gx#stx-pair? _%tl8601086141%_)
                                (let ((_%e8601186144%_
                                       (gx#syntax-e _%tl8601086141%_)))
                                  (let ((_%tl8601386151%_
                                         (let ()
                                           (declare (not safe))
                                           (##cdr _%e8601186144%_)))
                                        (_%hd8601286148%_
                                         (let ()
                                           (declare (not safe))
                                           (##car _%e8601186144%_))))
                                    (if (gx#stx-null? _%tl8601386151%_)
                                        (_%__kont9186891869%_
                                         _%hd8601286148%_
                                         _%hd8600986138%_
                                         _%hd8600686128%_
