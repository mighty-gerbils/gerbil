...
(begin
  (define gerbil/runtime/eval::timestamp 1708271169)
  (begin
    (define __context::t
        ...
        (if (or (let () (declare (not safe)) (pair? _e121072_))
            ...
            (let ((__tmp125594
                   (if (let ()
                       ...
                       '#f)))
              (declare (not safe))
              (##make-source _e121072_ __tmp125594))
            (if (let ()
                  (declare (not safe))
                ...
                (let ((__tmp125598
                      ...
                      (__tmp125596
                       (let ((__tmp125597
                         ...
                         (__locat __tmp125597))))
                  (declare (not safe))
                  (##make-source __tmp125598 __tmp125596))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                      ...
                      (_tmp120856_
                       (let ((__tmp125613 (gensym)))
                         (declare (not safe))
                         (__SRC__0 __tmp125613))))
                 (let ((__tmp125614
                        (let ((__tmp125615
                               (let ((__tmp125632
                                      (let ((__tmp125633
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                     ...
                     (cons __tmp125636 '()))))
              (declare (not safe))
              (cons _tmp120856_ __tmp125635))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                               (declare (not safe))
                                               (cons 'define __tmp125634))))
                                        (declare (not safe))
                                        (__SRC__% __tmp125633 _stx120781_)))
                                     (__tmp125616
                                      (let ((__tmp125628
                                             (let ((__tmp125629
                                                    (let ((__tmp125630
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                          (let ()
                            ...
                            (cons _len120854_ '()))))
                     (declare (not safe))
                     (cons _tmp120856_ __tmp125631))))
              (declare (not safe))
              (cons '__check-values __tmp125630))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                               (declare (not safe))
                                               (__SRC__%
                                                __tmp125629
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                      ...
                      (declare (not safe))
                      (cons _tmp120856_ __tmp125626))))
               (declare (not safe))
               (cons '##vector-ref __tmp125625))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                (declare (not safe))
                                                (cons __tmp125624 '()))))
                                         (declare (not safe))
                                         (cons __tmp125627 __tmp125623))))
                                  (declare (not safe))
                                  (cons 'define __tmp125622))))
                           (declare (not safe))
                           (__SRC__% __tmp125621 _stx120781_))
                         '#f)))
                  (__tmp125619
                   (let () (declare (not safe)) (iota _len120854_))))
              (declare (not safe))
              (filter-map2 __tmp125620 _ids120852_ __tmp125619))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                               (declare (not safe))
                                               (foldr1 cons '() __tmp125618))))
                                        (declare (not safe))
                                        (cons __tmp125628 __tmp125617))))
                                 (declare (not safe))
                                 (cons __tmp125632 __tmp125616))))
                          (declare (not safe))
                          (cons 'begin __tmp125615))))
                   (declare (not safe))
                   (__SRC__% __tmp125614 _stx120781_))))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                (if (let ()
                                                      (declare (not safe))
                                  ...
                                  (let ((__tmp125642
                                        ...
                                        (__tmp125640
                                         (let ((__tmp125641
                                           ...
                                           (cons __tmp125641 '()))))
                                    (declare (not safe))
                                    (cons __tmp125642 __tmp125640))))
                             (declare (not safe))
                             (cons 'define __tmp125639))))
                      (declare (not safe))
                      (__SRC__% __tmp125638 _stx120781_))
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                    ...
                                                    (cons __tmp125654
                                                          __tmp125652))))
                                             (declare (not safe))
                                             (cons 'lambda __tmp125651))))
                                      (declare (not safe))
                                      (__SRC__% __tmp125650 _stx120683_))
                                    (let ()
                                      (declare (not safe))
                                      (_$E120687120699_)))))
                               ...
                               (let ((__tmp125673
                                      (let ((__tmp125674
                                             (let ()
                                               ...
                                               (cons _clen120610_ '()))))
                                        (declare (not safe))
                                        (cons _len120542_ __tmp125674))))
                                 (declare (not safe))
                                 (cons _cmp120611_ __tmp125673)))
                              (__tmp125663
                               (let ((__tmp125666
                                      (let ((__tmp125667
                                             (let ((__tmp125668
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                     ...
                     (declare (not safe))
                     (__compile-lambda% __tmp125671)))
                  (__tmp125669
                   (let () (declare (not safe)) (cons _args120541_ '()))))
              (declare (not safe))
              (cons __tmp125670 __tmp125669))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                               (declare (not safe))
                                               (cons '##apply __tmp125668))))
                                        (declare (not safe))
                                        (__SRC__% __tmp125667 _stx120475_)))
                                     (__tmp125664
                                      (let ((__tmp125665
                                             (let ()
                                               (declare (not safe))
                                        ...
                                        (cons __tmp125665 '()))))
                                 (declare (not safe))
                                 (cons __tmp125666 __tmp125664))))
                          (declare (not safe))
                          (cons __tmp125672 __tmp125663))))
                   (declare (not safe))
                   (cons 'if __tmp125662))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                    (declare (not safe))
                              ...
                              (_K120173120205_
                               (lambda (_rest120194_ _hd120195_)
                                 (if (let ()
                                       (declare (not safe))
                                       (__AST-id? _hd120195_))
                                     (let ((__tmp125720 (cdr _exprs120165_))
                                           (__tmp125713
                                            (let ((__tmp125714
                                                   (let ((__tmp125719
                                                          (let ()
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                         (let ((__tmp125717
                                (let ((__tmp125718 (car _exprs120165_)))
                                  (declare (not safe))
                                  (cons __tmp125718 '()))))
                           (declare (not safe))
                           (cons 'values->list __tmp125717))))
                    (declare (not safe))
                    (cons __tmp125716 '()))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                     (declare (not safe))
                                     ...
                                     (if (let ()
                                         ...
                                         (let* ((_len120197_
                                                 (length _hd120195_))
                                                (_tmp120199_
                                                 (let ((__tmp125721 (gensym)))
                                                   (declare (not safe))
                                                   (__SRC__0 __tmp125721))))
                                           (let ((__tmp125733
                                                  (cdr _exprs120165_))
                                                 (__tmp125729
                                                  (let ((__tmp125730
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                               (let ((__tmp125727
                                 ...
                                 (filter-map2
                                  ...
                                  __tmp125726))))
                          (declare (not safe))
                          (cons _len120197_ __tmp125725))))
                   (declare (not safe))
                   (cons _tmp120199_ __tmp125724))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                    (declare (not safe))
                                                    (cons __tmp125723
                                                          _post120167_))))
                              ...
                              (_K119985120020_
                               (lambda (_rest120006_ _hd120007_)
                                 (if (let ()
                                       (declare (not safe))
                                       (__AST-id? _hd120007_))
                                     (let ((__tmp125770 (cdr _exprs119976_))
                                           (__tmp125763
                                            (let ((__tmp125764
                                                   (let ((__tmp125769
                                                          (let ()
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                         (let ((__tmp125767
                                (let ((__tmp125768 (car _exprs119976_)))
                                  (declare (not safe))
                                  (cons __tmp125768 '()))))
                           (declare (not safe))
                           (cons 'values->list __tmp125767))))
                    (declare (not safe))
                    (cons __tmp125766 '()))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                     (declare (not safe))
                                     ...
                                     (if (let ()
                                         ...
                                         (let* ((_len120009_
                                                 (length _hd120007_))
                                                (_tmp120011_
                                                 (let ((__tmp125771 (gensym)))
                                                   (declare (not safe))
                                                   (__SRC__0 __tmp125771))))
                                           (let ((__tmp125790
                                                  (cdr _exprs119976_))
                                                 (__tmp125783
                                                  (let ((__tmp125784
                                     ...
                                     (let ((__tmp125787
                                            (let ((__tmp125788
                                                   (let ()
                                                     ...
                                                     (cons '#!void '()))))
                                              (declare (not safe))
                                              (cons 'quote __tmp125788))))
                                       (declare (not safe))
                                       (cons __tmp125787 '()))))
                                (declare (not safe))
                                (cons __tmp125789 __tmp125786))))
                         (declare (not safe))
                         (cons __tmp125785 _r120015_))
                       _r120015_))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                    (declare (not safe))
                                                    (foldl1 __tmp125784
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                               (let ((__tmp125777
                                 ...
                                 (filter-map2
                                  ...
                                  __tmp125776))))
                          (declare (not safe))
                          (cons _len120009_ __tmp125775))))
                   (declare (not safe))
                   (cons _tmp120011_ __tmp125774))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                    (declare (not safe))
                                                    (cons __tmp125773
                                                          _post119979_))))
                                 ...
                                 (if (let ()
                                     ...
                                     (let ((_id119836_
                                            (let ()
                                              (declare (not safe))
                                              (__SRC__0 _hd119834_))))
                                       (let ((__tmp125831 (cdr _exprs119773_))
                                             (__tmp125826
                                              (let ((__tmp125827
                                                     (let ((__tmp125828
                                                            (let ((__tmp125829
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                           (let ((__tmp125830
                                  (let ()
                                    ...
                                    (cons '#!void '()))))
                             (declare (not safe))
                             (cons 'quote __tmp125830))))
                      (declare (not safe))
                      (cons __tmp125829 '()))))
               (declare (not safe))
               (cons _id119836_ __tmp125828))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                (declare (not safe))
                                                (cons __tmp125827
                                                      _bind119774_)))
                                 ...
                                 (if (let ()
                                     ...
                                     (let ((_id119805_
                                            (let ()
                                              (declare (not safe))
                                              (__SRC__0 _hd119803_))))
                                       (let ((__tmp125848 (cdr _exprs119773_))
                                             (__tmp125843
                                              (let ((__tmp125844
                                                     (let ((__tmp125845
                                                            (let ((__tmp125846
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                           (let ((__tmp125847
                                  (let ()
                                    ...
                                    (cons '#!void '()))))
                             (declare (not safe))
                             (cons 'quote __tmp125847))))
                      (declare (not safe))
                      (cons __tmp125846 '()))))
               (declare (not safe))
               (cons _id119805_ __tmp125845))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                (declare (not safe))
                                                (cons __tmp125844
                                                      _bind119774_)))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                           (let ((__tmp125841
                                  (let ((__tmp125842 (car _exprs119773_)))
                                    (declare (not safe))
                                    (cons __tmp125842 '()))))
                             (declare (not safe))
                             (cons 'values->list __tmp125841))))
                      (declare (not safe))
                      (cons __tmp125840 '()))))
               (declare (not safe))
               (cons _id119805_ __tmp125839))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                (declare (not safe))
                                                (cons __tmp125838
                                                      _post119775_))))
                                         ...
                                         (let ((__tmp125869
                                                (let ((__tmp125870
                                                       (let ()
                                                         ...
                                                         (cons '#!void '()))))
                                                  (declare (not safe))
                                                  (cons 'quote __tmp125870))))
                                           (declare (not safe))
                                           (cons __tmp125869 '()))))
                                    (declare (not safe))
                                    (cons __tmp125871 __tmp125868))))
                             (declare (not safe))
                             (cons __tmp125867 _r119813_))
                           _r119813_))))
                (declare (not safe))
                (foldl1 __tmp125866 _bind119774_ _hd119803_)))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                     (__tmp125856
                                                      (let ((__tmp125857
                                                             (let ((__tmp125858
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                            (let ((__tmp125864 (car _exprs119773_))
                                  (__tmp125859
                                   (let ((__tmp125860
                                          (let ((__tmp125862
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                            ...
                                            (filter-map2
                                             ...
                                             __tmp125861))))
                                     (declare (not safe))
                                     (cons _len119807_ __tmp125860))))
                              (declare (not safe))
                              (cons __tmp125864 __tmp125859))))
                       (declare (not safe))
                       (cons _tmp119809_ __tmp125858))))
                (declare (not safe))
                (cons __tmp125857 _post119775_))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                 (declare (not safe))
                                                 (_lp119770_
                                                  _rest119802_
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                    ...
                                                    (cons __tmp125915
                                                          __tmp125913))))
                                             (declare (not safe))
                                             (cons 'set! __tmp125912))))
                                      (declare (not safe))
                                      (__SRC__% __tmp125911 _stx119483_))
                                    (let ()
                                      (declare (not safe))
                                      (_$E119487119499_)))))
                         ...
                         (let ((__tmp125922
                               ...
                               (__tmp125920
                                (let ((__tmp125921
                                  ...
                                  (cons __tmp125921 '()))))
                           (declare (not safe))
                           (cons __tmp125922 __tmp125920))))
                    (declare (not safe))
                    (cons __tmp125923 __tmp125919))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                     (declare (not safe))
                                                     (cons 'if __tmp125918))))
                                              (declare (not safe))
                            ...
                            (let ((__tmp125925
                                   (let ((__tmp125926
                                          (let ((__tmp125927
                                            ...
                                            (cons __tmp125927 '()))))
                                     (declare (not safe))
                                     (cons 'quote __tmp125926))))
                              (declare (not safe))
                              (__SRC__% __tmp125925 _stx119377_))
                            ...
                            (let ((__tmp125929
                                   (let ((__tmp125930
                                          (let ()
                                            ...
                                            (cons _e119375_ '()))))
                                     (declare (not safe))
                                     (cons 'quote __tmp125930))))
                              (declare (not safe))
                              (__SRC__% __tmp125929 _stx119339_))
