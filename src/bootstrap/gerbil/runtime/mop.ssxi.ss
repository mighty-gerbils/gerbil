...
(begin
  ...
  (declare-type type-descriptor-mixin (@lambda 1 #f))
  ...
  (declare-type make-struct-type__0 (@lambda 6 #f))
  (declare-type make-struct-type (@case-lambda (6 #f) (7 #f)))
  (declare-type make-struct-type* (@lambda 6 #f))
  ...
  (declare-type make-struct-field-unchecked-mutator* (@lambda 2 #f))
  (declare-type struct-field-offset* (@lambda 2 #f))
  ...
  (declare-type base-struct (@lambda (0) base-struct/list))
  ...
  (declare-type if-class-slot-field (@lambda 5 #f))
  (declare-type make-class-slot-accessor (@lambda 2 #f))
  (declare-type make-struct-subclass-field-accessor (@lambda 2 #f))
  (declare-type make-class-cached-slot-accessor (@lambda 3 #f))
  (declare-type make-class-slot-mutator (@lambda 2 #f))
  (declare-type make-struct-subclass-field-mutator (@lambda 2 #f))
  ...
  (declare-type direct-struct-instance? (@lambda 2 direct-instance?))
  (declare-type class-instance? (@lambda 2 #f))
  (declare-type direct-class-instance? (@lambda 2 direct-instance?))
  (declare-type make-object (@lambda 2 #f))
  (declare-type make-object*__% (@lambda 2 #f))
  (declare-type make-object*__0 (@lambda 1 #f))
  (declare-type
   make-object*
   (@case-lambda (1 make-object*__0) (2 make-object*__%)))
  ...
  (declare-type struct-find-method (@lambda 2 #f))
