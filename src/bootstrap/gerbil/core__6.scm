               ...
               (_class-opt?17798_
                (lambda (_key19042_)
                  (memq (gx#stx-e _key19042_)
                        '(slots: id: name: alist: constructor: unchecked:))))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                         (not safe))
                       (##fx= _g42721_ 2)))
                (error "Context expects 2 values" _g42721_)))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                 ...
                                 (let ((_g42722_
                                   ...
                                   (begin
                                     ...
                                     (let ((_target1836218391_
                                            (let ()
                                              (declare (not safe))
                                              (##vector-ref _g42722_ 0)))
                                           (_tl1836418394_
                                            (let ()
                                              (declare (not safe))
                                              (##vector-ref _g42722_ 1))))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                         ...
                         (cons _L17887_
                               (cons (cons _L18030_ (cons _L17890_ '()))
                                     '())))))
              (declare (not safe))
              (_wrap17794_ __tmp42739))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                              (declare (not safe))
                                              (_g1832618845_ __tmp42738))))
                                        _g1830018311_)))
                                    (__tmp42740
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                           (declare (not safe))
                                           (_wrap17794_ __tmp42741)))))
                               (declare (not safe))
                               (_g1829818849_ __tmp42740))))
                         _g1827218283_)))
                     (__tmp42742
                      (let ((__tmp42743
                             (cons (gx#datum->syntax '#f 'def)
                        ...
                        (declare (not safe))
                        (_wrap17794_ __tmp42743))))
                (declare (not safe))
                (_g1827018853_ __tmp42742))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                  _g1824418255_)))
                                              (__tmp42744
                                               (if _struct?17792_
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                      _g1886218873_)))
                  (__tmp42748 (gx#stx-length _slots17924_)))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                     (declare (not safe))
                                                     (_g1886018896_
                                                      __tmp42748))
                         ...
                         (let ((_g42745_
                           ...
                           (begin
                             ...
                             (let ((_target1890318924_
                                    (let ()
                                      (declare (not safe))
                                      (##vector-ref _g42745_ 0)))
                                   (_tl1890518927_
                                    (let ()
                                      (declare (not safe))
                                      (##vector-ref _g42745_ 1))))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                            _super1891018937_)))
                 (declare (not safe))
                 (_loop1890618930_ _lp-tl1890918947_ __tmp42747))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                       ...
                                       (__tmp42750
                                        (gx#stx-map
                                         ...
                                         _slots17924_)))
                                  (declare (not safe))
                                  (_g1817118989_ __tmp42750))))
                            _g1814518156_)))
                        (__tmp42751 (gx#stx-getq 'constructor: _L17885_)))
                   (declare (not safe))
                   (_g1814318993_ __tmp42751))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                     _g1811718128_)))
                                                 (__tmp42752
                                                  (let ((_$e19001_
