                          ...
                          (let ((_g48644_
                            ...
                            (begin
                              ...
                              (let ((_target1859318622_
                                     (let ()
                                       (declare (not safe))
                                       (##vector-ref _g48644_ 0)))
                                    (_tl1859518625_
                                     (let ()
                                       (declare (not safe))
                                       (##vector-ref _g48644_ 1))))
                                    ...
                                    (__tmp48654
                                     (let ((__tmp48657
                                       ...
                                       (foldr1 __tmp48657
                                               ...
                                               _L18784_))))
                                (declare (not safe))
                                (foldr1 __tmp48658 __tmp48654 _L18676_))))
                         (declare (not safe))
                         (foldr1 __tmp48659 __tmp48653 _L18678_))))
                  (declare (not safe))
                  (cons _L18548_ __tmp48652))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                   (declare (not safe))
                                                   (cons _L18576_
                                                         __tmp48651))))
                                            (declare (not safe))
                                            (cons _L18520_ __tmp48650))))
                                     (declare (not safe))
                                     (cons __tmp48660 __tmp48649))))
                              (declare (not safe))
                              (_wrap17800_ __tmp48648)))))
                                          ...
                                          (let ((__tmp48700
                                                 (let ((__tmp48701
                                                   ...
                                                   (cons _L18901_
                                                         __tmp48701))))
                                            (declare (not safe))
                                            (cons _L18268_ __tmp48700))))
                                     (declare (not safe))
                                     (cons __tmp48702 __tmp48699)))
                                  (__tmp48691
                                   (let ((__tmp48692
                                          (let ((__tmp48693
                                                 (let ((__tmp48694
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                   ...
                                                   (cons _L17894_
                                                         __tmp48694))))
                                            (declare (not safe))
                                            (cons _L18132_ __tmp48693))))
                                     (declare (not safe))
                                     (cons __tmp48692 '()))))
                              (declare (not safe))
                              (cons __tmp48698 __tmp48691))))
                       (declare (not safe))
                       (cons __tmp48703 __tmp48690))))
                (declare (not safe))
                (cons __tmp48689 '()))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                 (declare (not safe))
                                                 (cons _L18963_ __tmp48688))))
                                          (declare (not safe))
                                          (cons __tmp48704 __tmp48687))))
                                   (declare (not safe))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                         ...
                         (cons '#f '()))))
                  (declare (not safe))
                  (cons _L18901_ __tmp48681))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                   (declare (not safe))
                                                   (cons _L18268_
                                                         __tmp48680))))
                                            (declare (not safe))
                                            (cons __tmp48682 __tmp48679)))
                                         (__tmp48671
                                          (let ((__tmp48672
                                                 (let ((__tmp48673
                                                        (let ((__tmp48674
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                              ...
                              (declare (not safe))
                              (cons __tmp48683 __tmp48670))))
                       (declare (not safe))
                       (cons __tmp48669 '()))))
                (declare (not safe))
                (cons _L18961_ __tmp48668))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                 (declare (not safe))
                                                 (cons __tmp48684
                                                       __tmp48667))))
                                          (declare (not safe))
                                          (_wrap17800_ __tmp48666))))
                                   (declare (not safe))
                                   (cons __tmp48665 '()))))
                            (declare (not safe))
                            (cons __tmp48685 __tmp48664))))
                      _hd1892718955_
                      _hd1892418945_)
                     (let ()
                       (declare (not safe))
                                        ...
                                        (let ((__tmp48745
                                               (let ((__tmp48746
                                                      (let ()
                                                        ...
                                                        (cons '#t '()))))
                                                 (declare (not safe))
                                                 (cons _L19053_ __tmp48746))))
                                          (declare (not safe))
                                          (cons _L18268_ __tmp48745))))
                                   (declare (not safe))
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                 (declare (not safe))
                                                 (cons _L17894_ __tmp48739))))
                                          (declare (not safe))
                                          (cons _L18134_ __tmp48738))))
                                   (declare (not safe))
                                   (cons __tmp48737 '()))))
                            (declare (not safe))
                            (cons __tmp48743 __tmp48736))))
                     (declare (not safe))
                     (cons __tmp48748 __tmp48735))))
              (declare (not safe))
              (cons __tmp48734 '()))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                               (declare (not safe))
                                               (cons _L19052_ __tmp48733))))
                                        (declare (not safe))
                                        (cons __tmp48749 __tmp48732))))
                                 (declare (not safe))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                       ...
                       (cons '#t '()))))
                (declare (not safe))
                (cons _L19053_ __tmp48726))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                 (declare (not safe))
                                                 (cons _L18268_ __tmp48725))))
                                          (declare (not safe))
                                          (cons __tmp48727 __tmp48724)))
                                       (__tmp48716
                                        (let ((__tmp48717
                                               (let ((__tmp48718
                                                      (let ((__tmp48719
                                                             (let ((__tmp48720
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                            (let ((__tmp48722 (gx#datum->syntax '#f 'quote))
                                  (__tmp48721
                                   (let ()
                                     (declare (not safe))
                                     (cons _L19053_ '()))))
                       ...
                       (cons __tmp48720 '()))))
                (declare (not safe))
                (cons _L17894_ __tmp48719))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                 (declare (not safe))
                                                 (cons _L18133_ __tmp48718))))
                                          (declare (not safe))
                                          (cons __tmp48717 '()))))
                                   (declare (not safe))
                                   (cons __tmp48723 __tmp48716))))
                            (declare (not safe))
                            (cons __tmp48728 __tmp48715))))
                     (declare (not safe))
                     (cons __tmp48714 '()))))
              (declare (not safe))
              (cons _L19050_ __tmp48713))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                               (declare (not safe))
                                               (cons __tmp48729 __tmp48712))))
                                        (declare (not safe))
                                        (_wrap17800_ __tmp48711))))
                                 (declare (not safe))
                                 (cons __tmp48710 '()))))
                          (declare (not safe))
                          (cons __tmp48730 __tmp48709)))
                      _hd1900619044_
                      _hd1900319034_
                      _hd1900019024_)
                     (let ()
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                   ...
                                   (declare (not safe))
                                   (cons __tmp48762 __tmp48755))))
                            (declare (not safe))
                            (cons __tmp48754 '()))))
                     (declare (not safe))
                     (cons _L17891_ __tmp48753))))
              (declare (not safe))
              (cons __tmp48763 __tmp48752))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                               (declare (not safe))
                                               (_wrap17800_ __tmp48751))))
                                       (declare (not safe))
                                       (_g1856019075_ __tmp48750))))
                                 _g1853418545_)))
                             (__tmp48764
                               ...
                               (let ((__tmp48776
                                      (let ((__tmp48777
                                             (let ((__tmp48778
                                               ...
                                               (cons __tmp48778 '()))))
                                        (declare (not safe))
                                        (cons _L17894_ __tmp48777))))
                                 (declare (not safe))
                                 (cons _L18136_ __tmp48776))))
                          (declare (not safe))
                          (cons __tmp48779 __tmp48775))))
                   (declare (not safe))
                   (cons __tmp48774 '()))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                    (declare (not safe))
                                                    (cons __tmp48780
                                                          __tmp48773))))
                                             (declare (not safe))
                                             (cons __tmp48781 __tmp48772))))
                                      (declare (not safe))
                                      (cons __tmp48771 '()))))
                               (declare (not safe))
                               (cons __tmp48782 __tmp48770))))
                        (declare (not safe))
                        (cons __tmp48785 __tmp48769))))
                 (declare (not safe))
                 (cons __tmp48768 '()))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                  (declare (not safe))
                                                  (cons _L17892_ __tmp48767))))
                                           (declare (not safe))
                                           (cons __tmp48786 __tmp48766))))
                                    (declare (not safe))
                                    (_wrap17800_ __tmp48765)))))
                        (declare (not safe))
                        (_g1853219079_ __tmp48764))))
                  _g1850618517_)))
              (__tmp48788
               (let ((__tmp48789
                      (let ((__tmp48806 (gx#datum->syntax '#f 'def))
                            (__tmp48790
                             (let ((__tmp48791
                                    (let ((__tmp48792
                                           (let ((__tmp48805
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                           '()))))
              (declare (not safe))
              (cons _L18324_ __tmp48801))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                               (declare (not safe))
                                               (cons _L18240_ __tmp48800))))
                                        (declare (not safe))
                                        (cons __tmp48802 __tmp48799))))
                                 (declare (not safe))
                                 (cons _L18296_ __tmp48798))))
                          (declare (not safe))
                          (cons _L18184_ __tmp48797))))
                   (declare (not safe))
                   (cons __tmp48804 __tmp48796)))
                (__tmp48794 (let () (declare (not safe)) (cons _L18492_ '()))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                    (declare (not safe))
                                                    (cons __tmp48795
                                                          __tmp48794))))
                                             (declare (not safe))
                                             (cons __tmp48805 __tmp48793))))
                                      (declare (not safe))
                                      (cons __tmp48792 '()))))
                               (declare (not safe))
                               (cons _L17894_ __tmp48791))))
                        (declare (not safe))
                        (cons __tmp48806 __tmp48790))))
                 (declare (not safe))
                 (_wrap17800_ __tmp48789))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                 (declare (not safe))
                                                 (_g1850419083_ __tmp48788))))
                                           _g1847818489_)))
                                       (__tmp48807
                                        (let ((__tmp48808
                                               (let ((__tmp48825
                                  ...
                                  (__tmp48812
                                   (let ((__tmp48813
                                          (let ((__tmp48814
                                            ...
                                            (cons __tmp48814 '()))))
                                     (declare (not safe))
                                     (cons _L18436_ __tmp48813))))
                              (declare (not safe))
                              (cons __tmp48817 __tmp48812))))
                       (declare (not safe))
                       (cons _L18464_ __tmp48811))))
                (declare (not safe))
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                 ...
                                                 (cons __tmp48825
                                                       __tmp48809))))
                                          (declare (not safe))
                                          (cons _L18137_ __tmp48808))))
                                  (declare (not safe))
                                  (_g1847619095_ __tmp48807))))
                            _g1845018461_)))
                        (__tmp48828
                         (if _struct?17798_
                             _L17893_
                             (let ((__tmp48829 (gx#datum->syntax '#f 'list)))
                               (declare (not safe))
                               (cons __tmp48829 _L17893_)))))
                   (declare (not safe))
                   (_g1844819107_ __tmp48828))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                     _g1842218433_)))
                                                 (__tmp48830
                                                  (if _struct?17798_
                                                      (let ((__tmp48837
                                                            ...
                                                            (__tmp48831
                                                             (let ((__tmp48834
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                            (let ((__tmp48836 (gx#datum->syntax '#f '@list))
                                  (__tmp48835
                                   (let ()
                                     (declare (not safe))
                                     (cons 'struct: '#t))))
                           ...
                           (__tmp48832
                            (let ((__tmp48833
                              ...
                              (cons ':: __tmp48833))))
                       (declare (not safe))
                       (cons __tmp48834 __tmp48832))))
                (declare (not safe))
                (cons __tmp48837 __tmp48831))
              _L18408_)))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                            (declare (not safe))
                                            (_g1842019111_ __tmp48830))))
                                      _g1839418405_)))
                                  (__tmp48838
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                (declare (not safe))
                                                (cons __tmp48842 __tmp48840))))
                                         (declare (not safe))
                                         (cons __tmp48845 __tmp48839))
                                       _L18380_)))
                             (declare (not safe))
                             (_g1839219115_ __tmp48838))))
                       _g1836618377_)))
                   (__tmp48846
                    (let ((_$e19123_ (gx#stx-getq 'properties: _L17889_)))
                      (if _$e19123_
                          _$e19123_
                          (let ((__tmp48847 (gx#datum->syntax '#f '@list)))
                            (declare (not safe))
                            (cons __tmp48847 '()))))))
              (declare (not safe))
              (_g1836419119_ __tmp48846))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                _g1833818349_)))
                                            (__tmp48848
                                             (gx#stx-getq 'final: _L17889_)))
                                       (declare (not safe))
                                       (_g1833619127_ __tmp48848))))
                                 _g1831018321_))))
                        (declare (not safe))
              ...
              (__tmp48849
               (if _struct?17798_
                   (if (gx#stx-e _L17893_)
                       (let ((__tmp48850 (gx#core-quote-syntax _L17893_)))
                         (declare (not safe))
                         (cons __tmp48850 '()))
                       '())
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                 (declare (not safe))
                                                 (_g1828019135_ __tmp48849))))
                                           _g1825418265_)))
                                       (__tmp48851
                                        (gx#core-quote-syntax _L17894_)))
                                  (declare (not safe))
                                  (_g1825219139_ __tmp48851))))
                            _g1822618237_)))
                        (__tmp48852 (gx#stx-getq 'constructor: _L17889_)))
                   (declare (not safe))
                   (_g1822419143_ __tmp48852))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                     _g1819818209_)))
                                                 (__tmp48853
                                                  (let ((_$e19151_
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                        ...
                        (__tmp48871
                         (let ((__tmp48878
                           ...
                           (declare (not safe))
                           (cons __tmp48878 __tmp48872))))
                    (declare (not safe))
                    (cons __tmp48879 __tmp48871))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                     (declare (not safe))
                                                     (cons __tmp48880
                                                           __tmp48870))))
                                              (declare (not safe))
                                              (cons __tmp48881 __tmp48869))
                                            (let ((__tmp48868
                                                   (gx#datum->syntax
                                                    '#f
                                                    'make-class-type*))
                         ...
                         (let ((__tmp48865
                               ...
                               (__tmp48859
                                (let ((__tmp48864
                                  ...
                                  (declare (not safe))
                                  (cons __tmp48864 __tmp48860))))
                           (declare (not safe))
                           (cons __tmp48865 __tmp48859))))
                    (declare (not safe))
                    (cons __tmp48866 __tmp48858))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                     (declare (not safe))
                                                     (cons __tmp48867
                                                           __tmp48857))))
                                              (declare (not safe))
                                              (cons __tmp48868 __tmp48856)))))
                                  (declare (not safe))
                                  (_g1801719163_ __tmp48855))))
                            _slot1795617995_))))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                   (let ()
                                                     (declare (not safe))
