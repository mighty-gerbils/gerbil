                                 ...
                                 (let ((_g42703_
                                   ...
                                   (begin
                                     ...
                                     (let ((_target1836218391_
                                            (let ()
                                              (declare (not safe))
                                              (##vector-ref _g42703_ 0)))
                                           (_tl1836418394_
                                            (let ()
                                              (declare (not safe))
                                              (##vector-ref _g42703_ 1))))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                         ...
                         (cons _L17887_
                               (cons (cons _L18030_ (cons _L17890_ '()))
                                     '())))))
              (declare (not safe))
              (_wrap17794_ __tmp42720))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                              (declare (not safe))
                                              (_g1832618845_ __tmp42719))))
                                        _g1830018311_)))
                                    (__tmp42721
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                           (declare (not safe))
                                           (_wrap17794_ __tmp42722)))))
                               (declare (not safe))
                               (_g1829818849_ __tmp42721))))
                         _g1827218283_)))
                     (__tmp42723
                      (let ((__tmp42724
                             (cons (gx#datum->syntax '#f 'def)
                        ...
                        (declare (not safe))
                        (_wrap17794_ __tmp42724))))
                (declare (not safe))
                (_g1827018853_ __tmp42723))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                  _g1824418255_)))
                                              (__tmp42725
                                               (if _struct?17792_
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                      _g1886218873_)))
                  (__tmp42729 (gx#stx-length _slots17924_)))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                     (declare (not safe))
                                                     (_g1886018896_
                                                      __tmp42729))
                         ...
                         (let ((_g42726_
                           ...
                           (begin
                             ...
                             (let ((_target1890318924_
                                    (let ()
                                      (declare (not safe))
                                      (##vector-ref _g42726_ 0)))
                                   (_tl1890518927_
                                    (let ()
                                      (declare (not safe))
                                      (##vector-ref _g42726_ 1))))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                            _super1891018937_)))
                 (declare (not safe))
                 (_loop1890618930_ _lp-tl1890918947_ __tmp42728))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                       ...
                                       (__tmp42731
                                        (gx#stx-map
                                         ...
                                         _slots17924_)))
                                  (declare (not safe))
                                  (_g1817118989_ __tmp42731))))
                            _g1814518156_)))
                        (__tmp42732 (gx#stx-getq 'constructor: _L17885_)))
                   (declare (not safe))
                   (_g1814318993_ __tmp42732))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                     _g1811718128_)))
                                                 (__tmp42733
                                                  (let ((_$e19001_
