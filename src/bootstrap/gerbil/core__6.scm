                                 ...
                                 (let ((_g48922_
                                   ...
                                   (begin
                                     ...
                                     (let ((_target1869918728_
                                            (let ()
                                              (declare (not safe))
                                              (##vector-ref _g48922_ 0)))
                                           (_tl1870118731_
                                            (let ()
                                              (declare (not safe))
                                              (##vector-ref _g48922_ 1))))
                                    ...
                                    (__tmp48930
                                     (let ((__tmp48933
                                       ...
                                       (foldr1 __tmp48933
                                               ...
                                               _L18784_))))
                                (declare (not safe))
                                (foldr1 __tmp48934 __tmp48930 _L18676_))))
                         (declare (not safe))
                         (foldr1 __tmp48935 __tmp48929 _L18678_))))
                  (declare (not safe))
                  (cons _L18548_ __tmp48928))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                   (declare (not safe))
                                                   (cons _L18576_
                                                         __tmp48927))))
                                            (declare (not safe))
                                            (cons _L18520_ __tmp48926))))
                                     (declare (not safe))
                                     (cons __tmp48936 __tmp48925))))
                              (declare (not safe))
                              (_wrap17800_ __tmp48924)))))
                                          ...
                                          (let ((__tmp48976
                                                 (let ((__tmp48977
                                                   ...
                                                   (cons _L18901_
                                                         __tmp48977))))
                                            (declare (not safe))
                                            (cons _L18268_ __tmp48976))))
                                     (declare (not safe))
                                     (cons __tmp48978 __tmp48975)))
                                  (__tmp48967
                                   (let ((__tmp48968
                                          (let ((__tmp48969
                                                 (let ((__tmp48970
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                   ...
                                                   (cons _L17894_
                                                         __tmp48970))))
                                            (declare (not safe))
                                            (cons _L18132_ __tmp48969))))
                                     (declare (not safe))
                                     (cons __tmp48968 '()))))
                              (declare (not safe))
                              (cons __tmp48974 __tmp48967))))
                       (declare (not safe))
                       (cons __tmp48979 __tmp48966))))
                (declare (not safe))
                (cons __tmp48965 '()))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                 (declare (not safe))
                                                 (cons _L18963_ __tmp48964))))
                                          (declare (not safe))
                                          (cons __tmp48980 __tmp48963))))
                                   (declare (not safe))
                                   (_wrap17800_ __tmp48962)))
                                (__tmp48940
                                 (let ((__tmp48941
                                        (let ((__tmp48942
                                               (let ((__tmp48960
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                         ...
                         (cons '#f '()))))
                  (declare (not safe))
                  (cons _L18901_ __tmp48957))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                   (declare (not safe))
                                                   (cons _L18268_
                                                         __tmp48956))))
                                            (declare (not safe))
                                            (cons __tmp48958 __tmp48955)))
                                         (__tmp48947
                                          (let ((__tmp48948
                                                 (let ((__tmp48949
                                                        (let ((__tmp48950
                                                               (let ((__tmp48951
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                              (let ((__tmp48953 (gx#datum->syntax '#f 'quote))
                                    (__tmp48952
                                     (let ()
                                       (declare (not safe))
                                       (cons _L18901_ '()))))
                                (declare (not safe))
                                (cons __tmp48953 __tmp48952))))
                         (declare (not safe))
                         (cons __tmp48951 '()))))
                  (declare (not safe))
                  (cons _L17894_ __tmp48950))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                   (declare (not safe))
                                                   (cons _L18130_
                                                         __tmp48949))))
                                            ...
                                            (cons __tmp48948 '()))))
                                     (declare (not safe))
                                     (cons __tmp48954 __tmp48947))))
                              (declare (not safe))
                              (cons __tmp48959 __tmp48946))))
                       (declare (not safe))
                       (cons __tmp48945 '()))))
                (declare (not safe))
                (cons _L18961_ __tmp48944))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                 (declare (not safe))
                                                 (cons __tmp48960
                                                       __tmp48943))))
                                          (declare (not safe))
                                          (_wrap17800_ __tmp48942))))
                                   (declare (not safe))
                                   (cons __tmp48941 '()))))
                            (declare (not safe))
                            (cons __tmp48961 __tmp48940))))
                      _hd1892718955_
                      _hd1892418945_)
                     (let ()
                       (declare (not safe))
                                        ...
                                        (let ((__tmp49021
                                               (let ((__tmp49022
                                                      (let ()
                                                        ...
                                                        (cons '#t '()))))
                                                 (declare (not safe))
                                                 (cons _L19053_ __tmp49022))))
                                          (declare (not safe))
                                          (cons _L18268_ __tmp49021))))
                                   (declare (not safe))
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                          ...
                                          (declare (not safe))
                                          (cons _L18134_ __tmp49014))))
                                   (declare (not safe))
                                   (cons __tmp49013 '()))))
                            (declare (not safe))
                            (cons __tmp49019 __tmp49012))))
                     (declare (not safe))
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                               (declare (not safe))
                                               (cons _L19052_ __tmp49009))))
                                        (declare (not safe))
                                        (cons __tmp49025 __tmp49008))))
                                 (declare (not safe))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                       ...
                       (cons '#t '()))))
                (declare (not safe))
                (cons _L19053_ __tmp49002))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                 (declare (not safe))
                                                 (cons _L18268_ __tmp49001))))
                                          (declare (not safe))
                                          (cons __tmp49003 __tmp49000)))
                                       (__tmp48992
                                        (let ((__tmp48993
                                               (let ((__tmp48994
                                                      (let ((__tmp48995
                                                             (let ((__tmp48996
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                            (let ((__tmp48998 (gx#datum->syntax '#f 'quote))
                                  (__tmp48997
                                   (let ()
                                     (declare (not safe))
                                     (cons _L19053_ '()))))
                              (declare (not safe))
                              (cons __tmp48998 __tmp48997))))
                       (declare (not safe))
                       (cons __tmp48996 '()))))
                (declare (not safe))
                (cons _L17894_ __tmp48995))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                 (declare (not safe))
                                                 (cons _L18133_ __tmp48994))))
                                          (declare (not safe))
                                          (cons __tmp48993 '()))))
                                   (declare (not safe))
                                   (cons __tmp48999 __tmp48992))))
                            (declare (not safe))
                            (cons __tmp49004 __tmp48991))))
                     (declare (not safe))
                     (cons __tmp48990 '()))))
              (declare (not safe))
              (cons _L19050_ __tmp48989))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                               (declare (not safe))
                                               (cons __tmp49005 __tmp48988))))
                                        (declare (not safe))
                                        (_wrap17800_ __tmp48987))))
                                 (declare (not safe))
                                 (cons __tmp48986 '()))))
                          (declare (not safe))
                          (cons __tmp49006 __tmp48985)))
                      _hd1900619044_
                      _hd1900319034_
                      _hd1900019024_)
                     (let ()
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                   ...
                                   (declare (not safe))
                                   (cons __tmp49038 __tmp49031))))
                            (declare (not safe))
                            (cons __tmp49030 '()))))
                     (declare (not safe))
                     (cons _L17891_ __tmp49029))))
              (declare (not safe))
              (cons __tmp49039 __tmp49028))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                               (declare (not safe))
                                               (_wrap17800_ __tmp49027))))
                                       (declare (not safe))
                                       (_g1856019075_ __tmp49026))))
                                 _g1853418545_)))
                             (__tmp49040
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                              ...
                              (__tmp49051
                               (let ((__tmp49052
                                 ...
                                 (declare (not safe))
                                 (cons _L18136_ __tmp49052))))
                          (declare (not safe))
                          (cons __tmp49055 __tmp49051))))
                   (declare (not safe))
                   (cons __tmp49050 '()))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                    (declare (not safe))
                                                    (cons __tmp49056
                                                          __tmp49049))))
                                             (declare (not safe))
                                             (cons __tmp49057 __tmp49048))))
                                      (declare (not safe))
                                      (cons __tmp49047 '()))))
                               (declare (not safe))
                               (cons __tmp49058 __tmp49046))))
                        (declare (not safe))
                        (cons __tmp49061 __tmp49045))))
                 (declare (not safe))
                 (cons __tmp49044 '()))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                  (declare (not safe))
                                                  (cons _L17892_ __tmp49043))))
                                           (declare (not safe))
                                           (cons __tmp49062 __tmp49042))))
                                    (declare (not safe))
                                    (_wrap17800_ __tmp49041)))))
                        (declare (not safe))
                        (_g1853219079_ __tmp49040))))
                  _g1850618517_)))
              (__tmp49064
               (let ((__tmp49065
                      (let ((__tmp49082 (gx#datum->syntax '#f 'def))
                            (__tmp49066
                             (let ((__tmp49067
                                    (let ((__tmp49068
                                           (let ((__tmp49081
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                           '()))))
              (declare (not safe))
              (cons _L18324_ __tmp49077))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                               (declare (not safe))
                                               (cons _L18240_ __tmp49076))))
                                        (declare (not safe))
                                        (cons __tmp49078 __tmp49075))))
                                 (declare (not safe))
                                 (cons _L18296_ __tmp49074))))
                          (declare (not safe))
                          (cons _L18184_ __tmp49073))))
                   (declare (not safe))
                   (cons __tmp49080 __tmp49072)))
                (__tmp49070 (let () (declare (not safe)) (cons _L18492_ '()))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                    (declare (not safe))
                                                    (cons __tmp49071
                                                          __tmp49070))))
                                      ...
                                      (cons __tmp49068 '()))))
                               (declare (not safe))
                               (cons _L17894_ __tmp49067))))
                        (declare (not safe))
                        (cons __tmp49082 __tmp49066))))
                 (declare (not safe))
                 (_wrap17800_ __tmp49065))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                 (declare (not safe))
                                                 (_g1850419083_ __tmp49064))))
                                           _g1847818489_)))
                                       (__tmp49083
                                        (let ((__tmp49084
                                               (let ((__tmp49101
                                  ...
                                  (__tmp49088
                                   (let ((__tmp49089
                                          (let ((__tmp49090
                                            ...
                                            (cons __tmp49090 '()))))
                                     (declare (not safe))
                                     (cons _L18436_ __tmp49089))))
                              (declare (not safe))
                              (cons __tmp49093 __tmp49088))))
                       (declare (not safe))
                       (cons _L18464_ __tmp49087))))
                (declare (not safe))
                (cons __tmp49098 __tmp49086))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                 (declare (not safe))
                                                 (cons __tmp49101
                                                       __tmp49085))))
                                          (declare (not safe))
                                          (cons _L18137_ __tmp49084))))
                                  (declare (not safe))
                                  (_g1847619095_ __tmp49083))))
                            _g1845018461_)))
                        (__tmp49104
                         (if _struct?17798_
                             _L17893_
                             (let ((__tmp49105 (gx#datum->syntax '#f 'list)))
                               (declare (not safe))
                               (cons __tmp49105 _L17893_)))))
                   (declare (not safe))
                   (_g1844819107_ __tmp49104))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                     _g1842218433_)))
                                                 (__tmp49106
                                                  (if _struct?17798_
                                                      (let ((__tmp49113
                                                            ...
                                                            (__tmp49107
                                                             (let ((__tmp49110
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                            (let ((__tmp49112 (gx#datum->syntax '#f '@list))
                                  (__tmp49111
                                   (let ()
                                     (declare (not safe))
                                     (cons 'struct: '#t))))
                           ...
                           (__tmp49108
                            (let ((__tmp49109
                              ...
                              (cons ':: __tmp49109))))
                       (declare (not safe))
                       (cons __tmp49110 __tmp49108))))
                (declare (not safe))
                (cons __tmp49113 __tmp49107))
              _L18408_)))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                            (declare (not safe))
                                            (_g1842019111_ __tmp49106))))
                                      _g1839418405_)))
                                  (__tmp49114
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                         ...
                                         (declare (not safe))
                                         (cons __tmp49121 __tmp49115))
                                       _L18380_)))
                             (declare (not safe))
                             (_g1839219115_ __tmp49114))))
                       _g1836618377_)))
                   (__tmp49122
                    (let ((_$e19123_ (gx#stx-getq 'properties: _L17889_)))
                      (if _$e19123_
                          _$e19123_
                          (let ((__tmp49123 (gx#datum->syntax '#f '@list)))
                            (declare (not safe))
                            (cons __tmp49123 '()))))))
              (declare (not safe))
              (_g1836419119_ __tmp49122))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                _g1833818349_)))
                                            (__tmp49124
                                             (gx#stx-getq 'final: _L17889_)))
                                       (declare (not safe))
                                       (_g1833619127_ __tmp49124))))
                                 _g1831018321_))))
                        (declare (not safe))
              ...
              (__tmp49125
               (if _struct?17798_
                   (if (gx#stx-e _L17893_)
                       (let ((__tmp49126 (gx#core-quote-syntax _L17893_)))
                         (declare (not safe))
                         (cons __tmp49126 '()))
                       '())
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                 (declare (not safe))
                                                 (_g1828019135_ __tmp49125))))
                                           _g1825418265_)))
                                       (__tmp49127
                                        (gx#core-quote-syntax _L17894_)))
                                  (declare (not safe))
                                  (_g1825219139_ __tmp49127))))
                            _g1822618237_)))
                        (__tmp49128 (gx#stx-getq 'constructor: _L17889_)))
                   (declare (not safe))
                   (_g1822419143_ __tmp49128))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                     _g1819818209_)))
                                                 (__tmp49129
                                                  (let ((_$e19151_
                                       ...
                                       (let ((__tmp49152
                                             ...
                                             (__tmp49150
                                              (let ((__tmp49151
                                                ...
                                                (cons __tmp49151 '()))))
                                         (declare (not safe))
                                         (cons __tmp49152 __tmp49150))))
                                  (declare (not safe))
                                  (cons __tmp49153 __tmp49149))))
                           (declare (not safe))
                           (cons __tmp49154 __tmp49148))))
                    (declare (not safe))
                    (cons __tmp49155 __tmp49147))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                     (declare (not safe))
                                                     (cons __tmp49156
                                                           __tmp49146))))
                                       ...
                                       (let ((__tmp49139
                                             ...
                                             (__tmp49137
                                              (let ((__tmp49138
                                                ...
                                                (cons __tmp49138 '()))))
                                         (declare (not safe))
                                         (cons __tmp49139 __tmp49137))))
                                  (declare (not safe))
                                  (cons __tmp49140 __tmp49136))))
                           (declare (not safe))
                           (cons __tmp49141 __tmp49135))))
                    (declare (not safe))
                    (cons __tmp49142 __tmp49134))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                     (declare (not safe))
                                                     (cons __tmp49143
                                                           __tmp49133))))
                                              (declare (not safe))
                                              (cons __tmp49144 __tmp49132)))))
                                  (declare (not safe))
                                  (_g1801719163_ __tmp49131))))
                            _slot1795617995_))))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                   (let ()
                                                     (declare (not safe))
