                          ...
                          (let ((_g49195_
                            ...
                            (begin
                              ...
                              (let ((_target1859318622_
                                     (let ()
                                       (declare (not safe))
                                       (##vector-ref _g49195_ 0)))
                                    (_tl1859518625_
                                     (let ()
                                       (declare (not safe))
                                       (##vector-ref _g49195_ 1))))
                                 ...
                                 (let ((_g49197_
                                   ...
                                   (begin
                                     ...
                                     (let ((_target1869918728_
                                            (let ()
                                              (declare (not safe))
                                              (##vector-ref _g49197_ 0)))
                                           (_tl1870118731_
                                            (let ()
                                              (declare (not safe))
                                              (##vector-ref _g49197_ 1))))
                                    ...
                                    (__tmp49205
                                     (let ((__tmp49208
                                       ...
                                       (foldr1 __tmp49208
                                               ...
                                               _L18784_))))
                                (declare (not safe))
                                (foldr1 __tmp49209 __tmp49205 _L18676_))))
                         (declare (not safe))
                         (foldr1 __tmp49210 __tmp49204 _L18678_))))
                  (declare (not safe))
                  (cons _L18548_ __tmp49203))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                   (declare (not safe))
                                                   (cons _L18576_
                                                         __tmp49202))))
                                            (declare (not safe))
                                            (cons _L18520_ __tmp49201))))
                                     (declare (not safe))
                                     (cons __tmp49211 __tmp49200))))
                              (declare (not safe))
                              (_wrap17800_ __tmp49199)))))
                                          ...
                                          (let ((__tmp49251
                                                 (let ((__tmp49252
                                                   ...
                                                   (cons _L18901_
                                                         __tmp49252))))
                                            (declare (not safe))
                                            (cons _L18268_ __tmp49251))))
                                     (declare (not safe))
                                     (cons __tmp49253 __tmp49250)))
                                  (__tmp49242
                                   (let ((__tmp49243
                                          (let ((__tmp49244
                                                 (let ((__tmp49245
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                   ...
                                                   (cons _L17894_
                                                         __tmp49245))))
                                            (declare (not safe))
                                            (cons _L18132_ __tmp49244))))
                                     (declare (not safe))
                                     (cons __tmp49243 '()))))
                              (declare (not safe))
                              (cons __tmp49249 __tmp49242))))
                       (declare (not safe))
                       (cons __tmp49254 __tmp49241))))
                (declare (not safe))
                (cons __tmp49240 '()))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                 (declare (not safe))
                                                 (cons _L18963_ __tmp49239))))
                                          (declare (not safe))
                                          (cons __tmp49255 __tmp49238))))
                                   (declare (not safe))
                                   (_wrap17800_ __tmp49237)))
                                (__tmp49215
                                 (let ((__tmp49216
                                        (let ((__tmp49217
                                               (let ((__tmp49235
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                         ...
                         (cons '#f '()))))
                  (declare (not safe))
                  (cons _L18901_ __tmp49232))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                   (declare (not safe))
                                                   (cons _L18268_
                                                         __tmp49231))))
                                            (declare (not safe))
                                            (cons __tmp49233 __tmp49230)))
                                         (__tmp49222
                                          (let ((__tmp49223
                                                 (let ((__tmp49224
                                                        (let ((__tmp49225
                                                               (let ((__tmp49226
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                              (let ((__tmp49228 (gx#datum->syntax '#f 'quote))
                                    (__tmp49227
                                     (let ()
                                       (declare (not safe))
                                       (cons _L18901_ '()))))
                                (declare (not safe))
                                (cons __tmp49228 __tmp49227))))
                         (declare (not safe))
                         (cons __tmp49226 '()))))
                  (declare (not safe))
                  (cons _L17894_ __tmp49225))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                   (declare (not safe))
                                                   (cons _L18130_
                                                         __tmp49224))))
                                            ...
                                            (cons __tmp49223 '()))))
                                     (declare (not safe))
                                     (cons __tmp49229 __tmp49222))))
                              (declare (not safe))
                              (cons __tmp49234 __tmp49221))))
                       (declare (not safe))
                       (cons __tmp49220 '()))))
                (declare (not safe))
                (cons _L18961_ __tmp49219))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                 (declare (not safe))
                                                 (cons __tmp49235
                                                       __tmp49218))))
                                          (declare (not safe))
                                          (_wrap17800_ __tmp49217))))
                                   (declare (not safe))
                                   (cons __tmp49216 '()))))
                            (declare (not safe))
                            (cons __tmp49236 __tmp49215))))
                      _hd1892718955_
                      _hd1892418945_)
                     (let ()
                       (declare (not safe))
                                        ...
                                        (let ((__tmp49296
                                               (let ((__tmp49297
                                                      (let ()
                                                        ...
                                                        (cons '#t '()))))
                                                 (declare (not safe))
                                                 (cons _L19053_ __tmp49297))))
                                          (declare (not safe))
                                          (cons _L18268_ __tmp49296))))
                                   (declare (not safe))
                                   (cons __tmp49298 __tmp49295)))
                                (__tmp49287
                                 (let ((__tmp49288
                                        (let ((__tmp49289
                                               (let ((__tmp49290
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                       ...
                       (declare (not safe))
                       (cons __tmp49293 __tmp49292))))
                (declare (not safe))
                (cons __tmp49291 '()))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                 (declare (not safe))
                                                 (cons _L17894_ __tmp49290))))
                                          (declare (not safe))
                                          (cons _L18134_ __tmp49289))))
                                   (declare (not safe))
                                   (cons __tmp49288 '()))))
                            (declare (not safe))
                            (cons __tmp49294 __tmp49287))))
                     (declare (not safe))
                     (cons __tmp49299 __tmp49286))))
              (declare (not safe))
              (cons __tmp49285 '()))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                               (declare (not safe))
                                               (cons _L19052_ __tmp49284))))
                                        (declare (not safe))
                                        (cons __tmp49300 __tmp49283))))
                                 (declare (not safe))
                                 (_wrap17800_ __tmp49282)))
                              (__tmp49260
                               (let ((__tmp49261
                                      (let ((__tmp49262
                                             (let ((__tmp49280
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                       ...
                       (cons '#t '()))))
                (declare (not safe))
                (cons _L19053_ __tmp49277))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                 (declare (not safe))
                                                 (cons _L18268_ __tmp49276))))
                                          (declare (not safe))
                                          (cons __tmp49278 __tmp49275)))
                                       (__tmp49267
                                        (let ((__tmp49268
                                               (let ((__tmp49269
                                                      (let ((__tmp49270
                                                             (let ((__tmp49271
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                            (let ((__tmp49273 (gx#datum->syntax '#f 'quote))
                                  (__tmp49272
                                   (let ()
                                     (declare (not safe))
                                     (cons _L19053_ '()))))
                       ...
                       (cons __tmp49271 '()))))
                (declare (not safe))
                (cons _L17894_ __tmp49270))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                 (declare (not safe))
                                                 (cons _L18133_ __tmp49269))))
                                          (declare (not safe))
                                          (cons __tmp49268 '()))))
                                   (declare (not safe))
                                   (cons __tmp49274 __tmp49267))))
                            (declare (not safe))
                            (cons __tmp49279 __tmp49266))))
                     (declare (not safe))
                     (cons __tmp49265 '()))))
              (declare (not safe))
              (cons _L19050_ __tmp49264))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                               (declare (not safe))
                                               (cons __tmp49280 __tmp49263))))
                                        (declare (not safe))
                                        (_wrap17800_ __tmp49262))))
                                 (declare (not safe))
                                 (cons __tmp49261 '()))))
                          (declare (not safe))
                          (cons __tmp49281 __tmp49260)))
                      _hd1900619044_
                      _hd1900319034_
                      _hd1900019024_)
                     (let ()
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                       ...
                       (cons _L17894_ '()))))
                (declare (not safe))
                (cons _L18135_ __tmp49309))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                 (declare (not safe))
                                                 (cons __tmp49308 '()))))
                                          (declare (not safe))
                                          (cons __tmp49310 __tmp49307))))
                                   (declare (not safe))
                                   (cons __tmp49313 __tmp49306))))
                            (declare (not safe))
                            (cons __tmp49305 '()))))
                     (declare (not safe))
                     (cons _L17891_ __tmp49304))))
              (declare (not safe))
              (cons __tmp49314 __tmp49303))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                               (declare (not safe))
                                               (_wrap17800_ __tmp49302))))
                                       (declare (not safe))
                                       (_g1856019075_ __tmp49301))))
                                 _g1853418545_)))
                             (__tmp49315
                               ...
                               (let ((__tmp49327
                                      (let ((__tmp49328
                                             (let ((__tmp49329
                                               ...
                                               (cons __tmp49329 '()))))
                                        (declare (not safe))
                                        (cons _L17894_ __tmp49328))))
                                 (declare (not safe))
                                 (cons _L18136_ __tmp49327))))
                          (declare (not safe))
                          (cons __tmp49330 __tmp49326))))
                   (declare (not safe))
                   (cons __tmp49325 '()))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                    (declare (not safe))
                        ...
                        (declare (not safe))
                        (cons __tmp49336 __tmp49320))))
                 (declare (not safe))
                 (cons __tmp49319 '()))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                  (declare (not safe))
                                                  (cons _L17892_ __tmp49318))))
                                           (declare (not safe))
                                           (cons __tmp49337 __tmp49317))))
                                    (declare (not safe))
                                    (_wrap17800_ __tmp49316)))))
                        (declare (not safe))
                        (_g1853219079_ __tmp49315))))
                  _g1850618517_)))
              (__tmp49339
               (let ((__tmp49340
                      (let ((__tmp49357 (gx#datum->syntax '#f 'def))
                            (__tmp49341
                             (let ((__tmp49342
                                    (let ((__tmp49343
                                           (let ((__tmp49356
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                           '()))))
              (declare (not safe))
              (cons _L18324_ __tmp49352))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                               (declare (not safe))
                                               (cons _L18240_ __tmp49351))))
                                        (declare (not safe))
                                        (cons __tmp49353 __tmp49350))))
                                 (declare (not safe))
                                 (cons _L18296_ __tmp49349))))
                          (declare (not safe))
                          (cons _L18184_ __tmp49348))))
                   (declare (not safe))
                   (cons __tmp49355 __tmp49347)))
                (__tmp49345 (let () (declare (not safe)) (cons _L18492_ '()))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                    (declare (not safe))
                                                    (cons __tmp49346
                                                          __tmp49345))))
                                             (declare (not safe))
                                             (cons __tmp49356 __tmp49344))))
                                      (declare (not safe))
                                      (cons __tmp49343 '()))))
                               (declare (not safe))
                               (cons _L17894_ __tmp49342))))
                        (declare (not safe))
                        (cons __tmp49357 __tmp49341))))
                 (declare (not safe))
                 (_wrap17800_ __tmp49340))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                 (declare (not safe))
                                                 (_g1850419083_ __tmp49339))))
                                           _g1847818489_)))
                                       (__tmp49358
                                        (let ((__tmp49359
                                               (let ((__tmp49376
                                  ...
                                  (__tmp49363
                                   (let ((__tmp49364
                                          (let ((__tmp49365
                                            ...
                                            (cons __tmp49365 '()))))
                                     (declare (not safe))
                                     (cons _L18436_ __tmp49364))))
                              (declare (not safe))
                              (cons __tmp49368 __tmp49363))))
                       (declare (not safe))
                       (cons _L18464_ __tmp49362))))
                (declare (not safe))
                (cons __tmp49373 __tmp49361))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                 (declare (not safe))
                                                 (cons __tmp49376
                                                       __tmp49360))))
                                          (declare (not safe))
                                          (cons _L18137_ __tmp49359))))
                                  (declare (not safe))
                                  (_g1847619095_ __tmp49358))))
                            _g1845018461_)))
                        (__tmp49379
                         (if _struct?17798_
                             _L17893_
                             (let ((__tmp49380 (gx#datum->syntax '#f 'list)))
                               (declare (not safe))
                               (cons __tmp49380 _L17893_)))))
                   (declare (not safe))
                   (_g1844819107_ __tmp49379))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                     _g1842218433_)))
                                                 (__tmp49381
                                                  (if _struct?17798_
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                           ...
                           (__tmp49383
                            (let ((__tmp49384
                              ...
                              (cons ':: __tmp49384))))
                       (declare (not safe))
                       (cons __tmp49385 __tmp49383))))
                (declare (not safe))
                (cons __tmp49388 __tmp49382))
              _L18408_)))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                            (declare (not safe))
                                            (_g1842019111_ __tmp49381))))
                                      _g1839418405_)))
                                  (__tmp49389
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                (declare (not safe))
                                                (cons __tmp49393 __tmp49391))))
                                         (declare (not safe))
                                         (cons __tmp49396 __tmp49390))
                                       _L18380_)))
                             (declare (not safe))
                             (_g1839219115_ __tmp49389))))
                       _g1836618377_)))
                   (__tmp49397
                    (let ((_$e19123_ (gx#stx-getq 'properties: _L17889_)))
                      (if _$e19123_
                          _$e19123_
                          (let ((__tmp49398 (gx#datum->syntax '#f '@list)))
                            (declare (not safe))
                            (cons __tmp49398 '()))))))
              (declare (not safe))
              (_g1836419119_ __tmp49397))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                _g1833818349_)))
                                            (__tmp49399
                                             (gx#stx-getq 'final: _L17889_)))
                                       (declare (not safe))
                                       (_g1833619127_ __tmp49399))))
                                 _g1831018321_))))
                        (declare (not safe))
              ...
              (__tmp49400
               (if _struct?17798_
                   (if (gx#stx-e _L17893_)
                       (let ((__tmp49401 (gx#core-quote-syntax _L17893_)))
                         (declare (not safe))
                         (cons __tmp49401 '()))
                       '())
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                 (declare (not safe))
                                                 (_g1828019135_ __tmp49400))))
                                           _g1825418265_)))
                                       (__tmp49402
                                        (gx#core-quote-syntax _L17894_)))
                                  (declare (not safe))
                                  (_g1825219139_ __tmp49402))))
                            _g1822618237_)))
                        (__tmp49403 (gx#stx-getq 'constructor: _L17889_)))
                   (declare (not safe))
                   (_g1822419143_ __tmp49403))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                     _g1819818209_)))
                                                 (__tmp49404
                                                  (let ((_$e19151_
                                       ...
                                       (let ((__tmp49427
                                             ...
                                             (__tmp49425
                                              (let ((__tmp49426
                                                ...
                                                (cons __tmp49426 '()))))
                                         (declare (not safe))
                                         (cons __tmp49427 __tmp49425))))
                                  (declare (not safe))
                                  (cons __tmp49428 __tmp49424))))
                           (declare (not safe))
                           (cons __tmp49429 __tmp49423))))
                    (declare (not safe))
                    (cons __tmp49430 __tmp49422))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                     (declare (not safe))
                                                     (cons __tmp49431
                                                           __tmp49421))))
                                              (declare (not safe))
                                              (cons __tmp49432 __tmp49420))
                                            (let ((__tmp49419
                                                   (gx#datum->syntax
                                                    '#f
                                                    'make-class-type))
                                       ...
                                       (let ((__tmp49414
                                             ...
                                             (__tmp49412
                                              (let ((__tmp49413
                                                ...
                                                (cons __tmp49413 '()))))
                                         (declare (not safe))
                                         (cons __tmp49414 __tmp49412))))
                                  (declare (not safe))
                                  (cons __tmp49415 __tmp49411))))
                           (declare (not safe))
                           (cons __tmp49416 __tmp49410))))
                    (declare (not safe))
                    (cons __tmp49417 __tmp49409))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                     (declare (not safe))
                                                     (cons __tmp49418
                                                           __tmp49408))))
                                              (declare (not safe))
                                              (cons __tmp49419 __tmp49407)))))
                                  (declare (not safe))
                                  (_g1801719163_ __tmp49406))))
                            _slot1795617995_))))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                   (let ()
                                                     (declare (not safe))
