...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                          (gx#datum->syntax '#f 'quote))
                         (__tmp49068
                          (let () (declare (not safe)) (cons _L18039_ '()))))
                     (declare (not safe))
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                      ...
                                      _g1816718178_))))
                             (declare (not safe))
                             (_g1816518988_ _type-struct?18021_))))
                       _g1813918150_)))
