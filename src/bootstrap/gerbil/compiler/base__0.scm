...
(begin
  ...
  (define gxc#make-symbol-table
    (lambda _$args680_
      (apply make-struct-instance gxc#symbol-table::t _$args680_)))
  ...
  (define gxc#raise-compile-error
    (lambda (_message674_ _stx675_ . _details676_)
  ...
  (define gxc#verbose
    (lambda _args672_
      (if (gxc#current-compile-verbose) (apply displayln _args672_) '#!void))))
