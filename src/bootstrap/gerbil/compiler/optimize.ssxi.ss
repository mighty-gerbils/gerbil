...
(begin
  ...
  (declare-method gxc#!class-type::t typedecl gxc#!class-type::typedecl #f)
  (declare-type gxc#!class-pred::typedecl (@lambda 1 #f))
  (declare-method gxc#!class-pred::t typedecl gxc#!class-pred::typedecl #f)
  (declare-type gxc#!class-cons::typedecl (@lambda 1 #f))
  (declare-method gxc#!class-cons::t typedecl gxc#!class-cons::typedecl #f)
  (declare-type gxc#!class-getf::typedecl (@lambda 1 #f))
  (declare-method gxc#!class-getf::t typedecl gxc#!class-getf::typedecl #f)
  (declare-type gxc#!class-setf::typedecl (@lambda 1 #f))
  (declare-method gxc#!class-setf::t typedecl gxc#!class-setf::typedecl #f)
