                                ...
                                (let ((_hd403440_ (##car _e402436_))
                                  ...
                                  (if (gx#stx-pair/null? _tl404443_)
                                      (if (fx>= (gx#stx-length _tl404443_) '0)
                                          (let ((_g3383_ (gx#syntax-split-splice
                                                          _tl404443_
                                                          '0)))
                                            (begin
                                              (let ((_g3384_ (if (##values?
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                          _g3383_)
                         (##vector-length _g3383_)
                         1)))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                (if (not (##fx= _g3384_ 2))
                                                    (error "Context expects 2 values"
                                                           _g3384_)))
                                              (let ((_target405446_
                                                     (##vector-ref _g3383_ 0))
                                                    (_tl407449_
                                                     (##vector-ref _g3383_ 1)))
                                             ...
                                             (lambda (_g499519_)
                                               (if (gx#stx-pair/null?
                                                   ...
                                                   (if (fx>= (gx#stx-length
                                                              _g499519_)
                                                             '0)
                                                       (let ((_g3385_ (gx#syntax-split-splice
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                               _g499519_
                               '0)))
                 (begin
                   (let ((_g3386_ (if (##values? _g3385_)
                                      (##vector-length _g3385_)
                                      1)))
                     (if (not (##fx= _g3386_ 2))
                         (error "Context expects 2 values" _g3386_)))
                   (let ((_target501522_ (##vector-ref _g3385_ 0))
                         (_tl503525_ (##vector-ref _g3385_ 1)))
      ...
      (|gerbil/core$<MOP>$<MOP:2>[1]#make-extended-struct-info|
       ...
       (cons '#f
             (cons |gxc[1]#_g3388_|
                   (cons |gxc[1]#_g3389_|
                         (cons |gxc[1]#_g3390_|
                               (cons (cons |gxc[1]#_g3391_|
                                           (cons |gxc[1]#_g3392_| '()))
                                     (cons (cons |gxc[1]#_g3393_|
                                                 (cons |gxc[1]#_g3394_| '()))
                                           '()))))))
       'type-exhibitor:
