                              ...
                              (let ((_e5993_ (gx#syntax-e _tl5890_)))
                                (let ((_hd6097_
                                  ...
                                  (if (gx#stx-pair/null? _tl61100_)
                                      (let ((_g4773_ (gx#syntax-split-splice
                                                      _tl61100_
                                                      '0)))
                                        (begin
                                          (let ((_g4774_ (let ()
                                          ...
                                          (let ((_target62103_
                                                 (let ()
                                                   (declare (not safe))
                                                   (##vector-ref _g4773_ 0)))
                                                (_tl64106_
                                                 (let ()
                                                   (declare (not safe))
                                                   (##vector-ref _g4773_ 1))))
                                        ...
                                        (_g154233_
                                         (lambda (_g156176_)
                                           (if (gx#stx-pair/null? _g156176_)
                                               (let ((_g4775_ (gx#syntax-split-splice
                                                               _g156176_
                                                               '0)))
                                                 (begin
                                                   (let ((_g4776_ (let ()
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                          (not safe))
                        (##fx= _g4776_ 2)))
                 (error "Context expects 2 values" _g4776_)))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                   (let ((_target158179_
                                                          (let ()
                                                            (declare
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                   ...
                                   (_g154233_
                                    (gx#stx-map1
                                     (lambda (_clause237_)
                                       (let* ((___stx47274728_ _clause237_)
                                              (_g241268_
                                               (lambda ()
                                                 (gx#raise-syntax-error
                                                  '#f
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                            ...
                            '()))))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                           (if (gx#stx-pair? ___stx47274728_)
                                               (let ((_e245333_
                                                      (gx#syntax-e
                                                       ___stx47274728_)))
                                                 (let ((_tl247340_
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                   ...
                   (if (gx#stx-null? _tl250350_)
                       (___kont47304731_ _hd249347_ _hd246337_)
      ...
      (|gerbil/core$<MOP>$<MOP:2>[1]#make-extended-struct-info|
       ...
       (cons '#f
             (cons |gxc[1]#_g4777_|
                   (cons |gxc[1]#_g4778_|
                         (cons |gxc[1]#_g4779_|
                               (cons (cons |gxc[1]#_g4780_|
                                           (cons |gxc[1]#_g4781_| '()))
                                     (cons (cons |gxc[1]#_g4782_|
                                                 (cons |gxc[1]#_g4783_| '()))
                                           '()))))))
       'type-exhibitor:
