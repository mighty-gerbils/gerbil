                ...
                (if (let ()
                    ...
                    (let ((_e294818294834_
                      ...
                      (let ((_hd294817294838_
                        ...
                        (if (let ()
                              (declare (not safe))
                              (gx#stx-pair? _tl294816294841_))
                            (let ((_e294821294844_
                                   (let ()
                                     (declare (not safe))
                                     (gx#syntax-e _tl294816294841_))))
                ...
                (if (let ()
                    ...
                    (let ((_e294882294898_
                      ...
                      (let ((_hd294881294902_
                        ...
                        (if (let ()
                              (declare (not safe))
                              (gx#stx-pair? _tl294880294905_))
                            (let ((_e294885294908_
                                   (let ()
                                     (declare (not safe))
                                     (gx#syntax-e _tl294880294905_))))
