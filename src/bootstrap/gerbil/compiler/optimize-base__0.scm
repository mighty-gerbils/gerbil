...
(begin
  (define gerbil/compiler/optimize-base::timestamp 1707738034)
  (begin
        ...
        (let ((__fields219971
              ...
              (__super219972
               (let ((__tmp219981
                 ...
                 (if __tmp219981 __tmp219981 (error '"Unknown slot" 'super))))
              (__final?219973
               (let ((__tmp219982
                      (let ()
                        (declare (not safe))
              ...
              (__slots219978
               (let ((__tmp219987
                 ...
                 (if __tmp219987 __tmp219987 (error '"Unknown slot" 'slots))))
              (__struct?219979
               (let ((__tmp219988
                      (let ()
                        (declare (not safe))
