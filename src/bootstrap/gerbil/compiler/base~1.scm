...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                          (not safe))
                        (##fx= _g129923_ 2)))
                 (error "Context expects 2 values" _g129923_)))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                  ...
                                  (let ((__tmp129924
                                         (lambda (_%g129192129195%_
                                           ...
                                           (cons _%g129192129195%_
                                                 _%g129193129198%_))))
                                    (declare (not safe))
                                    (__foldr1 __tmp129924 '() _%L129177%_)))))
                '()))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                     ...
                                                     (lambda ()
                                                       (let ()
                                                         ...
                                                         (gx#raise-syntax-error
                                                          '#f
                                                          '"Bad syntax; invalid match target"
                                                          _%__stx129840129841%_)))))
                                               (let ((_%__kont129843129844%_
                                                      (lambda (_%L129321%_
                                                               _%L129323%_)
                                                        (cons _%L129323%_
                                                              (cons (cons (let ()
                                          ...
                                          (__tmp129925
                                           (let ((__tmp129926
                                             ...
                                             (__foldr1
                                              ...
                                              _%L129102%_))))
                                      (declare (not safe))
                                      (gx#stx-map1 __tmp129927 __tmp129925))))
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
    ...
    (define |gxc[:0:]#symbol-table|
      (let ((__obj129890
        ...
        (let ()
          (declare (not safe))
          (##unchecked-structure-set! __obj129890 'symbol-table '2 '#f '#f))
        (let ()
          (declare (not safe))
          (##unchecked-structure-set!
           __obj129890
        ...
        (let ()
          (declare (not safe))
          (##unchecked-structure-set! __obj129890 '() '3 '#f '#f))
        (let ()
          (declare (not safe))
          (##unchecked-structure-set! __obj129890 '#t '7 '#f '#f))
        (let ()
          (declare (not safe))
          (##unchecked-structure-set! __obj129890 '#f '8 '#f '#f))
        (let ()
          (declare (not safe))
          (##unchecked-structure-set! __obj129890 '#f '10 '#f '#f))
        (let ()
          (declare (not safe))
          (##unchecked-structure-set! __obj129890 ':init! '11 '#f '#f))
        (let ((__tmp129928 |gxc[1]#_g129929_|))
          (declare (not safe))
          (##unchecked-structure-set! __obj129890 __tmp129928 '12 '#f '#f))
        (let ((__tmp129930 |gxc[1]#_g129931_|))
          (declare (not safe))
          (##unchecked-structure-set! __obj129890 __tmp129930 '13 '#f '#f))
        (let ((__tmp129932 |gxc[1]#_g129933_|))
          (declare (not safe))
          (##unchecked-structure-set! __obj129890 __tmp129932 '14 '#f '#f))
        (let ((__tmp129934
               (cons (cons 'gensyms |gxc[1]#_g129935_|)
                     (cons (cons 'bindings |gxc[1]#_g129936_|) '()))))
          (declare (not safe))
          (##unchecked-structure-set! __obj129890 __tmp129934 '15 '#f '#f))
        (let ((__tmp129937
               (cons (cons 'gensyms |gxc[1]#_g129938_|)
                     (cons (cons 'bindings |gxc[1]#_g129939_|) '()))))
          (declare (not safe))
          (##unchecked-structure-set! __obj129890 __tmp129937 '16 '#f '#f))
        (let ((__tmp129940
               (cons (cons 'gensyms |gxc[1]#_g129941_|)
                     (cons (cons 'bindings |gxc[1]#_g129942_|) '()))))
          (declare (not safe))
          (##unchecked-structure-set! __obj129890 __tmp129940 '17 '#f '#f))
        (let ((__tmp129943
               (cons (cons 'gensyms |gxc[1]#_g129944_|)
                     (cons (cons 'bindings |gxc[1]#_g129945_|) '()))))
          (declare (not safe))
          (##unchecked-structure-set! __obj129890 __tmp129943 '18 '#f '#f))
        (let ()
          (declare (not safe))
          (##unchecked-structure-set! __obj129890 '() '19 '#f '#f))
        (let ()
          (declare (not safe))
          (##unchecked-structure-set! __obj129890 '() '21 '#f '#f))
        (let ()
          (declare (not safe))
          (##unchecked-structure-set! __obj129890 '() '20 '#f '#f))
        __obj129890))
