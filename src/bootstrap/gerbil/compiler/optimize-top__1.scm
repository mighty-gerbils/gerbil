                ...
                (if (let ()
                    ...
                    (let ((_e235516235546_
                      ...
                      (let ((_hd235515235550_
                        ...
                        (if (let ()
                              (declare (not safe))
                              (gx#stx-pair/null? _tl235514235553_))
                            (let ((_g250516_
                                   (let ()
                                     (declare (not safe))
                  ...
                  (if (let ()
                      ...
                      (let ((_e235530235584_
                        ...
                        (let ((_hd235529235588_
                          ...
                          (if (let ()
                                (declare (not safe))
                                (gx#stx-pair? _tl235528235591_))
                              (let ((_e235533235594_
                                     (let ()
                                       (declare (not safe))
                                       (gx#syntax-e _tl235528235591_))))
                ...
                (if (let ()
                    ...
                    (let ((_e235655235685_
                      ...
                      (let ((_hd235654235689_
                        ...
                        (if (let ()
                              (declare (not safe))
                              (gx#stx-pair/null? _tl235653235692_))
                            (let ((_g250530_
                                   (let ()
                                     (declare (not safe))
                                     (gx#syntax-split-splice
                  ...
                  (if (let ()
                      ...
                      (let ((_e235669235723_
                        ...
                        (let ((_hd235668235727_
                          ...
                          (if (let ()
                                (declare (not safe))
                                (gx#stx-pair? _tl235667235730_))
                              (let ((_e235672235733_
                                     (let ()
                                       (declare (not safe))
                                       (gx#syntax-e _tl235667235730_))))
