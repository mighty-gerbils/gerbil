...
(begin
  ...
  (define |gxc[1]#_g12897_|
    (gx#make-syntax-quote
     ...
     (gx#current-expander-context)
     '()))
  (define |gxc[1]#_g12898_|
    (gx#make-syntax-quote
     'meta-state-block-phi-set!
     #f
     (gx#current-expander-context)
     '()))
  (define |gxc[1]#_g12899_|
    (gx#make-syntax-quote
     'meta-state-block-n-set!
     #f
     (gx#current-expander-context)
     '()))
  (define |gxc[1]#_g12900_|
    (gx#make-syntax-quote
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                          ...
                          (let ((_g12873_
                            ...
                            (begin
                              (let ((_g12874_
                                     (if (##values? _g12873_)
                                         (##vector-length _g12873_)
                                         1)))
                                (if (not (##fx= _g12874_ 2))
                                    (error "Context expects 2 values"
                                           _g12874_)))
                              (let ((_target34343603_
                                     (##vector-ref _g12873_ 0))
                                    (_tl34363606_ (##vector-ref _g12873_ 1)))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                      ...
                      (let ((_g12875_
                        ...
                        (begin
                          (let ((_g12876_
                                 (if (##values? _g12875_)
                                     (##vector-length _g12875_)
                                     1)))
                            (if (not (##fx= _g12876_ 2))
                                (error "Context expects 2 values" _g12876_)))
                          (let ((_target34433633_ (##vector-ref _g12875_ 0))
                                (_tl34453636_ (##vector-ref _g12875_ 1)))
      ...
      (|gerbil/core$<MOP>$<MOP:2>[1]#make-extended-struct-info|
       ...
       (cons '#f
             (cons |gxc[1]#_g12878_|
                   (cons |gxc[1]#_g12879_|
                         (cons |gxc[1]#_g12880_|
                               (cons (cons |gxc[1]#_g12881_|
                                           (cons |gxc[1]#_g12882_|
                                                 (cons |gxc[1]#_g12883_|
                                                       (cons |gxc[1]#_g12884_|
                                                             '()))))
                                     (cons (cons |gxc[1]#_g12885_|
                                                 (cons |gxc[1]#_g12886_|
                                                       (cons |gxc[1]#_g12887_|
                                                             (cons |gxc[1]#_g12888_|
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
      ...
      (|gerbil/core$<MOP>$<MOP:2>[1]#make-extended-struct-info|
       ...
       (cons '#f
             (cons |gxc[1]#_g12890_|
                   (cons |gxc[1]#_g12891_|
                         (cons |gxc[1]#_g12892_|
                               (cons (cons |gxc[1]#_g12893_|
                                           (cons |gxc[1]#_g12894_|
                                                 (cons |gxc[1]#_g12895_|
                                                       (cons |gxc[1]#_g12896_|
                                                             '()))))
                                     (cons (cons |gxc[1]#_g12897_|
                                                 (cons |gxc[1]#_g12898_|
                                                       (cons |gxc[1]#_g12899_|
                                                             (cons |gxc[1]#_g12900_|
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
