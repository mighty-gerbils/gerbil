...
(begin
  ...
  (begin
    (define |gxc[:0:]#defcompile-method|
      (lambda (_$stx4800_)
        (let* ((___stx1445414455_ _$stx4800_)
               (_g48064886_
                (lambda ()
                                    ...
                                    (let ((_e48784923_
                                      ...
                                      (let ((_tl48804930_ (##cdr _e48784923_))
                                        ...
                                        (___match1454714548_
                                         ...
                                         _tl48804930_)))
                                    (_g48064886_))))))))
              (if (gx#stx-pair? ___stx1445414455_)
                  (let ((_e48125153_ (gx#syntax-e ___stx1445414455_)))
