  ...
  (begin
    ...
    (begin
      ...
      (declare-type
       ...
       (@case-lambda
        (2 gxc#compile-scm-file__0)
        (3 gxc#compile-scm-file__%)))))
  (begin
    ...
    (begin
      ...
      (declare-type
       ...
       (@case-lambda
        (0 gxc#gsc-debug-options__0)
        (1 gxc#gsc-debug-options__%)))))
