...
(begin
  ...
  (define |gxc[1]#_g14951_|
    (gx#make-syntax-quote
     ...
     (gx#current-expander-context)
     '()))
  (define |gxc[1]#_g14952_|
    (gx#make-syntax-quote
     '!kw-lambda-dispatch-set!
     #f
     (gx#current-expander-context)
     '()))
  (define |gxc[1]#_g14953_|
    (gx#make-syntax-quote '!procedure #f (gx#current-expander-context) '()))
  (define |gxc[1]#_g14954_|
    (gx#make-syntax-quote
     '!kw-lambda-primary::t
     #f
     (gx#current-expander-context)
     '()))
  (define |gxc[1]#_g14955_|
    (gx#make-syntax-quote '!procedure::t #f (gx#current-expander-context) '()))
  (define |gxc[1]#_g14956_|
    (gx#make-syntax-quote
     '!kw-lambda-primary::t
     #f
     (gx#current-expander-context)
     '()))
  (define |gxc[1]#_g14957_|
    (gx#make-syntax-quote
     'make-!kw-lambda-primary
     #f
     (gx#current-expander-context)
     '()))
  (define |gxc[1]#_g14958_|
    (gx#make-syntax-quote
     '!kw-lambda-primary?
     #f
     (gx#current-expander-context)
     '()))
  (define |gxc[1]#_g14959_|
    (gx#make-syntax-quote
     '!kw-lambda-primary-keys
     #f
     (gx#current-expander-context)
     '()))
  (define |gxc[1]#_g14960_|
    (gx#make-syntax-quote
     '!kw-lambda-primary-main
     #f
     (gx#current-expander-context)
     '()))
  (define |gxc[1]#_g14961_|
    (gx#make-syntax-quote
     '!kw-lambda-primary-keys-set!
     #f
     (gx#current-expander-context)
     '()))
  (define |gxc[1]#_g14962_|
    (gx#make-syntax-quote
     '!kw-lambda-primary-main-set!
     #f
     (gx#current-expander-context)
     '()))
  (define |gxc[1]#_g14963_|
    (gx#make-syntax-quote '!procedure #f (gx#current-expander-context) '()))
  (begin
      ...
      (|gerbil/core$<MOP>$<MOP:2>[1]#make-extended-struct-info|
       ...
       (cons '#f
             (cons |gxc[1]#_g14847_|
                   (cons |gxc[1]#_g14848_|
                         (cons |gxc[1]#_g14849_|
                               (cons (cons |gxc[1]#_g14850_|
                                           (cons |gxc[1]#_g14851_| '()))
                                     (cons (cons |gxc[1]#_g14852_|
                                                 (cons |gxc[1]#_g14853_| '()))
                                           '()))))))
       'type-exhibitor:
      ...
      (|gerbil/core$<MOP>$<MOP:2>[1]#make-extended-struct-info|
       ...
       (cons '#f
             (cons |gxc[1]#_g14855_|
                   (cons |gxc[1]#_g14856_|
                         (cons |gxc[1]#_g14857_|
                               (cons (cons |gxc[1]#_g14858_| '())
                                     (cons (cons |gxc[1]#_g14859_| '())
                                           '()))))))
       'type-exhibitor:
       (|gerbil/core$<MOP>$<MOP:2>[1]#make-runtime-struct-exhibitor|
        '#f
      ...
      (|gerbil/core$<MOP>$<MOP:2>[1]#make-extended-struct-info|
       ...
       (cons |gxc[1]#_g14913_|
             (cons |gxc[1]#_g14914_|
                   (cons |gxc[1]#_g14915_|
                         (cons |gxc[1]#_g14916_|
                               (cons (cons |gxc[1]#_g14917_|
                                           (cons |gxc[1]#_g14918_| '()))
                                     (cons (cons |gxc[1]#_g14919_|
                                                 (cons |gxc[1]#_g14920_| '()))
                                           '()))))))
       'type-exhibitor:
       (|gerbil/core$<MOP>$<MOP:2>[1]#make-runtime-struct-exhibitor|
      ...
      (|gerbil/core$<MOP>$<MOP:2>[1]#make-extended-struct-info|
       ...
       (cons |gxc[1]#_g14945_|
             (cons |gxc[1]#_g14946_|
                   (cons |gxc[1]#_g14947_|
                         (cons |gxc[1]#_g14948_|
                               (cons (cons |gxc[1]#_g14949_|
                                           (cons |gxc[1]#_g14950_| '()))
                                     (cons (cons |gxc[1]#_g14951_|
                                                 (cons |gxc[1]#_g14952_| '()))
                                           '()))))))
       'type-exhibitor:
       (|gerbil/core$<MOP>$<MOP:2>[1]#make-runtime-struct-exhibitor|
      ...
      (|gerbil/core$<MOP>$<MOP:2>[1]#make-extended-struct-info|
       ...
       (cons |gxc[1]#_g14955_|
             (cons |gxc[1]#_g14956_|
                   (cons |gxc[1]#_g14957_|
                         (cons |gxc[1]#_g14958_|
                               (cons (cons |gxc[1]#_g14959_|
                                           (cons |gxc[1]#_g14960_| '()))
                                     (cons (cons |gxc[1]#_g14961_|
                                                 (cons |gxc[1]#_g14962_| '()))
                                           '()))))))
       'type-exhibitor:
       (|gerbil/core$<MOP>$<MOP:2>[1]#make-runtime-struct-exhibitor|
