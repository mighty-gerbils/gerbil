...
(begin
  (define |gxc[1]#_g14801_|
    (gx#make-syntax-quote
     'optimizer-info::t
     #f
     (gx#current-expander-context)
     '()))
  (define |gxc[1]#_g14802_|
    (gx#make-syntax-quote
     'optimizer-info::t
     #f
     (gx#current-expander-context)
     '()))
  (define |gxc[1]#_g14803_|
    (gx#make-syntax-quote
     'make-optimizer-info
     #f
     (gx#current-expander-context)
     '()))
  (define |gxc[1]#_g14804_|
    (gx#make-syntax-quote
     'optimizer-info?
     #f
     (gx#current-expander-context)
     '()))
  (define |gxc[1]#_g14805_|
    (gx#make-syntax-quote
     'optimizer-info-type
     #f
     (gx#current-expander-context)
     '()))
  (define |gxc[1]#_g14806_|
    (gx#make-syntax-quote
     'optimizer-info-ssxi
     #f
     (gx#current-expander-context)
     '()))
  (define |gxc[1]#_g14807_|
    (gx#make-syntax-quote
     'optimizer-info-type-set!
     #f
     (gx#current-expander-context)
     '()))
  (define |gxc[1]#_g14808_|
    (gx#make-syntax-quote
     'optimizer-info-ssxi-set!
     #f
     (gx#current-expander-context)
     '()))
  (define |gxc[1]#_g14809_|
    (gx#make-syntax-quote '!type::t #f (gx#current-expander-context) '()))
  (define |gxc[1]#_g14810_|
    (gx#make-syntax-quote '!type::t #f (gx#current-expander-context) '()))
  (define |gxc[1]#_g14811_|
    (gx#make-syntax-quote 'make-!type #f (gx#current-expander-context) '()))
  (define |gxc[1]#_g14812_|
    (gx#make-syntax-quote '!type? #f (gx#current-expander-context) '()))
  (define |gxc[1]#_g14813_|
    (gx#make-syntax-quote '!type-id #f (gx#current-expander-context) '()))
  (define |gxc[1]#_g14814_|
    (gx#make-syntax-quote '!type-id-set! #f (gx#current-expander-context) '()))
  (define |gxc[1]#_g14815_|
    (gx#make-syntax-quote '!alias::t #f (gx#current-expander-context) '()))
  (define |gxc[1]#_g14816_|
    (gx#make-syntax-quote '!type::t #f (gx#current-expander-context) '()))
  (define |gxc[1]#_g14817_|
    (gx#make-syntax-quote '!alias::t #f (gx#current-expander-context) '()))
  (define |gxc[1]#_g14818_|
    (gx#make-syntax-quote 'make-!alias #f (gx#current-expander-context) '()))
  (define |gxc[1]#_g14819_|
    (gx#make-syntax-quote '!alias? #f (gx#current-expander-context) '()))
  (define |gxc[1]#_g14820_|
    (gx#make-syntax-quote '!type #f (gx#current-expander-context) '()))
  (define |gxc[1]#_g14821_|
    (gx#make-syntax-quote
     '!struct-type::t
     #f
     (gx#current-expander-context)
     '()))
  (define |gxc[1]#_g14822_|
    (gx#make-syntax-quote '!type::t #f (gx#current-expander-context) '()))
  (define |gxc[1]#_g14823_|
    (gx#make-syntax-quote
     '!struct-type::t
     #f
     (gx#current-expander-context)
     '()))
  (define |gxc[1]#_g14824_|
    (gx#make-syntax-quote
     'make-!struct-type
     #f
     (gx#current-expander-context)
     '()))
  (define |gxc[1]#_g14825_|
    (gx#make-syntax-quote '!struct-type? #f (gx#current-expander-context) '()))
  (define |gxc[1]#_g14826_|
    (gx#make-syntax-quote
     '!struct-type-super
     #f
     (gx#current-expander-context)
     '()))
  (define |gxc[1]#_g14827_|
    (gx#make-syntax-quote
     '!struct-type-fields
     #f
     (gx#current-expander-context)
     '()))
  (define |gxc[1]#_g14828_|
    (gx#make-syntax-quote
     '!struct-type-xfields
     #f
     (gx#current-expander-context)
     '()))
  (define |gxc[1]#_g14829_|
    (gx#make-syntax-quote
     '!struct-type-ctor
     #f
     (gx#current-expander-context)
     '()))
  (define |gxc[1]#_g14830_|
    (gx#make-syntax-quote
     '!struct-type-plist
     #f
     (gx#current-expander-context)
     '()))
  (define |gxc[1]#_g14831_|
    (gx#make-syntax-quote
     '!struct-type-methods
     #f
     (gx#current-expander-context)
     '()))
  (define |gxc[1]#_g14832_|
    (gx#make-syntax-quote
     '!struct-type-super-set!
     #f
     (gx#current-expander-context)
     '()))
  (define |gxc[1]#_g14833_|
    (gx#make-syntax-quote
     '!struct-type-fields-set!
     #f
     (gx#current-expander-context)
     '()))
  (define |gxc[1]#_g14834_|
    (gx#make-syntax-quote
     '!struct-type-xfields-set!
     #f
     (gx#current-expander-context)
     '()))
  (define |gxc[1]#_g14835_|
    (gx#make-syntax-quote
     '!struct-type-ctor-set!
     #f
     (gx#current-expander-context)
     '()))
  (define |gxc[1]#_g14836_|
    (gx#make-syntax-quote
     '!struct-type-plist-set!
     #f
     (gx#current-expander-context)
     '()))
  (define |gxc[1]#_g14837_|
    (gx#make-syntax-quote
     '!struct-type-methods-set!
     #f
     (gx#current-expander-context)
     '()))
  (define |gxc[1]#_g14838_|
    (gx#make-syntax-quote '!type #f (gx#current-expander-context) '()))
  (define |gxc[1]#_g14839_|
    (gx#make-syntax-quote '!procedure::t #f (gx#current-expander-context) '()))
  (define |gxc[1]#_g14840_|
    (gx#make-syntax-quote '!type::t #f (gx#current-expander-context) '()))
  (define |gxc[1]#_g14841_|
    (gx#make-syntax-quote '!procedure::t #f (gx#current-expander-context) '()))
  (define |gxc[1]#_g14842_|
    (gx#make-syntax-quote
     'make-!procedure
     #f
     (gx#current-expander-context)
     '()))
  (define |gxc[1]#_g14843_|
    (gx#make-syntax-quote '!procedure? #f (gx#current-expander-context) '()))
  (define |gxc[1]#_g14844_|
    (gx#make-syntax-quote '!type #f (gx#current-expander-context) '()))
  (define |gxc[1]#_g14845_|
    (gx#make-syntax-quote
     '!struct-pred::t
     #f
     (gx#current-expander-context)
     '()))
  (define |gxc[1]#_g14846_|
    (gx#make-syntax-quote '!procedure::t #f (gx#current-expander-context) '()))
  (define |gxc[1]#_g14847_|
    (gx#make-syntax-quote
     '!struct-pred::t
     #f
     (gx#current-expander-context)
     '()))
  (define |gxc[1]#_g14848_|
    (gx#make-syntax-quote
     'make-!struct-pred
     #f
     (gx#current-expander-context)
     '()))
  (define |gxc[1]#_g14849_|
    (gx#make-syntax-quote '!struct-pred? #f (gx#current-expander-context) '()))
  (define |gxc[1]#_g14850_|
    (gx#make-syntax-quote '!procedure #f (gx#current-expander-context) '()))
      ...
      (|gerbil/core$<MOP>$<MOP:2>[1]#make-extended-struct-info|
       ...
       (cons '#f
             (cons |gxc[1]#_g14802_|
                   (cons |gxc[1]#_g14803_|
                         (cons |gxc[1]#_g14804_|
                               (cons (cons |gxc[1]#_g14805_|
                                           (cons |gxc[1]#_g14806_| '()))
                                     (cons (cons |gxc[1]#_g14807_|
                                                 (cons |gxc[1]#_g14808_| '()))
                                           '()))))))
       'type-exhibitor:
      ...
      (|gerbil/core$<MOP>$<MOP:2>[1]#make-extended-struct-info|
       ...
       (cons '#f
             (cons |gxc[1]#_g14810_|
                   (cons |gxc[1]#_g14811_|
                         (cons |gxc[1]#_g14812_|
                               (cons (cons |gxc[1]#_g14813_| '())
                                     (cons (cons |gxc[1]#_g14814_| '())
                                           '()))))))
       'type-exhibitor:
       (|gerbil/core$<MOP>$<MOP:2>[1]#make-runtime-struct-exhibitor|
        '#f
      ...
      (|gerbil/core$<MOP>$<MOP:2>[1]#make-extended-struct-info|
       ...
       (cons |gxc[1]#_g14910_|
             (cons |gxc[1]#_g14911_|
                   (cons |gxc[1]#_g14912_|
                         (cons |gxc[1]#_g14913_|
                               (cons (cons |gxc[1]#_g14914_|
                                           (cons |gxc[1]#_g14915_| '()))
                                     (cons (cons |gxc[1]#_g14916_|
                                                 (cons |gxc[1]#_g14917_| '()))
                                           '()))))))
       'type-exhibitor:
       (|gerbil/core$<MOP>$<MOP:2>[1]#make-runtime-struct-exhibitor|
