...
(begin
  ...
  (define |gxc[1]#_g16310_|
    (gx#make-syntax-quote
     ...
     (gx#current-expander-context)
     '()))
  (define |gxc[1]#_g16311_|
    (gx#make-syntax-quote
     '!kw-lambda-primary-keys-set!
     #f
     (gx#current-expander-context)
     '()))
  (define |gxc[1]#_g16312_|
    (gx#make-syntax-quote
      ...
      (|gerbil/core$<MOP>$<MOP:2>[1]#make-extended-struct-info|
       ...
       (cons '#f
             (cons |gxc[1]#_g16235_|
                   (cons |gxc[1]#_g16236_|
                         (cons |gxc[1]#_g16237_|
                               (cons (cons |gxc[1]#_g16238_| '())
                                     (cons (cons |gxc[1]#_g16239_| '())
                                           '()))))))
       'type-exhibitor:
       (|gerbil/core$<MOP>$<MOP:2>[1]#make-runtime-struct-exhibitor|
        '#f
      ...
      (|gerbil/core$<MOP>$<MOP:2>[1]#make-extended-struct-info|
       ...
       (cons |gxc[1]#_g16259_|
             (cons |gxc[1]#_g16283_|
                   (cons |gxc[1]#_g16284_|
                         (cons |gxc[1]#_g16285_|
                               (cons (cons |gxc[1]#_g16286_|
                                           (cons |gxc[1]#_g16287_|
                                                 (cons |gxc[1]#_g16288_|
                                                       (cons |gxc[1]#_g16289_|
                                                             '()))))
                                     (cons (cons |gxc[1]#_g16290_|
                                                 (cons |gxc[1]#_g16291_|
                                                       (cons |gxc[1]#_g16292_|
                                                             (cons |gxc[1]#_g16293_|
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
      ...
      (|gerbil/core$<MOP>$<MOP:2>[1]#make-extended-struct-info|
       ...
       (cons |gxc[1]#_g16259_|
             (cons |gxc[1]#_g16294_|
                   (cons |gxc[1]#_g16295_|
                         (cons |gxc[1]#_g16296_|
                               (cons (cons |gxc[1]#_g16297_| '())
                                     (cons (cons |gxc[1]#_g16298_| '())
                                           '()))))))
       'type-exhibitor:
       (|gerbil/core$<MOP>$<MOP:2>[1]#make-runtime-struct-exhibitor|
        '#f
