...
(begin
  (declare-type
   ...
   (@case-lambda
    ...
    (1 gxc#generate-runtime-temporary__opt-lambda8473)))
  (declare-type
   gxc#generate-runtime-let-values%
   (@case-lambda
    (1 gxc#generate-runtime-let-values%__0)
    (2 gxc#generate-runtime-let-values%__opt-lambda6216)))
  (declare-type
   gxc#generate-runtime-letrec-values%
   (@case-lambda
    (1 gxc#generate-runtime-letrec-values%__0)
    (2 gxc#generate-runtime-letrec-values%__opt-lambda5795)))
  (declare-type
   gxc#meta-state::t
