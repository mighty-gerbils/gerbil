...
(begin
  (define |gerbil/core$<MOP>$<MOP:4>[1]#_g49668_|
    (##structure
     gx#syntax-quote::t
     '@method
     #f
                  ...
                  (_get-mixin-slots19270_
                   (lambda (_super21366_ _slots21368_)
                     (letrec* ((_tab21370_
                       ...
                       (gx#stx-for-each
                        (lambda (_slot21374_)
                          (let ((__tmp49333 (gx#stx-e _slot21374_)))
                            (declare (not safe))
                            (table-set! _tab21370_ __tmp49333 '#t)))
                        _slots21368_)
                               ...
                               (let ((__tmp49335
                                      (let ()
                                        ...
                                        (_get-mixin-slots-r19271_
                                         _super21366_))))
                                 (declare (not safe))
                                 (_dedup21372_ __tmp49335))
                               (let ((__tmp49334
                                      (concatenate
                                       (map _get-mixin-slots-r19271_
                                            _super21366_))))
                                 (declare (not safe))
                                 (_dedup21372_ __tmp49334)))))))
                  (_get-mixin-slots-r19271_
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                ...
                (let ((__tmp49605
                  ...
                  (declare (not safe))
                  (_loop1950219526_ _lp-tl1950519543_ __tmp49605))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                     ...
                     (let ((_lp-hd1957519611_
                       ...
                       (let ((__tmp49603
                         ...
                         (declare (not safe))
                         (_loop1957319597_ _lp-tl1957619614_ __tmp49603))))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                  ...
                  (let ((__tmp49592
                    ...
                    (declare (not safe))
                    (_loop1993219956_ _lp-tl1993519973_ __tmp49592))))
                         ...
                         (let ((__tmp49589
                                (let ()
                                  ...
                                  (cons _lp-hd2000520041_
                                        _mixin-ugetf2000720034_))))
                           (declare (not safe))
                           (_loop2000320027_ _lp-tl2000620044_ __tmp49589))))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                           _g49382_)
                          (##vector-length _g49382_)
                          1))))
               (if (not (let () (declare (not safe)) (##fx= _g49383_ 2)))
                   (error "Context expects 2 values" _g49383_)))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                    ...
                    (declare (not safe))
                    (cons _L20374_ __tmp49386))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                     (declare (not safe))
                                                     (cons __tmp49387
                                                           __tmp49385))))
                                              (declare (not safe))
                                              (_wrap19267_ __tmp49384)))))
                                      _g2078020791_)))
                                  (__tmp49388
                                   (let ((__tmp49389
                                          (let ((__tmp49422
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                           '()))))
              (declare (not safe))
              (cons 'unchecked-mutators: __tmp49420))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                               (declare (not safe))
                                               (cons _L20738_ __tmp49419))))
                                        (declare (not safe))
                                        (cons 'unchecked-accessors:
                                              __tmp49418))))
                                 (declare (not safe))
                                 (cons _L20710_ __tmp49417))))
                          (declare (not safe))
                          (cons 'mutators: __tmp49416))))
                   (declare (not safe))
                   (cons _L20682_ __tmp49415))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                    (declare (not safe))
                                                    (cons 'accessors:
                                                          __tmp49414))))
                                             (declare (not safe))
                                             (cons _L20654_ __tmp49413))))
                                      (declare (not safe))
                                      (cons 'predicate: __tmp49412))))
                               (declare (not safe))
                               (cons _L20626_ __tmp49411))))
                        (declare (not safe))
                        (cons 'constructor: __tmp49410))))
                 (declare (not safe))
                 (cons _L20598_ __tmp49409))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                  (declare (not safe))
                                                  (cons 'type-descriptor:
                                                        __tmp49408))))
                                           (declare (not safe))
                                           (cons _L20570_ __tmp49407))))
                                    (declare (not safe))
                                    (cons 'constructor-method: __tmp49406))))
                             (declare (not safe))
                             (cons _L20542_ __tmp49405))))
                      (declare (not safe))
                      (cons 'final?: __tmp49404))))
               (declare (not safe))
               (cons _L20514_ __tmp49403))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                (declare (not safe))
                                                (cons 'struct?: __tmp49402))))
                                         (declare (not safe))
                                         (cons _L20458_ __tmp49401))))
                                  (declare (not safe))
                                  (cons 'super: __tmp49400))))
                           (declare (not safe))
                           (cons _L20486_ __tmp49399))))
                    (declare (not safe))
                    (cons 'slots: __tmp49398))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                     (declare (not safe))
                                                     (cons _L20430_
                                                           __tmp49397))))
                                              (declare (not safe))
                                              (cons 'name: __tmp49396))))
                                       (declare (not safe))
                                       (cons _L20402_ __tmp49395))))
                                (declare (not safe))
                                (cons 'id: __tmp49394))))
                         (declare (not safe))
                         (cons __tmp49421 __tmp49393))))
                  (declare (not safe))
                  (cons __tmp49392 '()))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                   (declare (not safe))
                                                   (cons _L19297_
                                                         __tmp49391))))
                                            (declare (not safe))
                                            (cons __tmp49422 __tmp49390))))
                                     (declare (not safe))
                                     (_wrap19267_ __tmp49389))))
                             (declare (not safe))
                             (_g2077820809_ __tmp49388))))
                       _g2075220763_)))
                   (__tmp49423
                    (let ((__tmp49450 (gx#datum->syntax '#f '@list))
                          (__tmp49424
                           (begin
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                  ...
                  (__tmp49441
                   (let ((__tmp49442
                     ...
                     (cons ':: __tmp49442))))
              (declare (not safe))
              (cons __tmp49446 __tmp49441))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                               (declare (not safe))
                                               (cons __tmp49449 __tmp49440))))
                                        (declare (not safe))
                                        (cons __tmp49439 _g2081820828_))))
                                   (__tmp49425
                                    (begin
                                      (gx#syntax-check-splice-targets
                                       _L20122_
                                               ...
                                               (let ((__tmp49427
                                                      (let ((__tmp49437
                                                            ...
                                                            (__tmp49428
                                                             (let ((__tmp49434
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                            (let ((__tmp49436 (gx#datum->syntax '#f 'quote))
                                  (__tmp49435
                                   (let ()
                                     (declare (not safe))
                                     (cons _g2082020834_ '()))))
                                          ...
                                          (let ((__tmp49433
                                                ...
                                                (__tmp49432
                                                 (let ()
                                                   ...
                                                   (cons _g2081920831_ '()))))
                                            (declare (not safe))
                                            (cons __tmp49433 __tmp49432))))
                                     (declare (not safe))
                                     (cons __tmp49431 '()))))
                              (declare (not safe))
                              (cons ':: __tmp49430))))
                       (declare (not safe))
                       (cons __tmp49434 __tmp49429))))
                (declare (not safe))
                (cons __tmp49437 __tmp49428))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                 (declare (not safe))
                                                 (cons __tmp49427
                                                       _g2082120836_)))))
                               ...
                               (foldr2 __tmp49438
                                       ...
                                       _L19479_)))))
                      (declare (not safe))
                      (cons __tmp49450 __tmp49424))))
              (declare (not safe))
              (_g2075020813_ __tmp49423))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                _g2072420735_)))
                                            (__tmp49451
                                             (let ((__tmp49478
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                              ...
                              _g2084420854_)
                       (let ((__tmp49467
                              (let ((__tmp49477 (gx#datum->syntax '#f '@list))
                                    (__tmp49468
                                     (let ((__tmp49474
                                            (let ((__tmp49476
                                                   (gx#datum->syntax
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                              ...
                                              (cons ':: __tmp49470))))
                                       (declare (not safe))
                                       (cons __tmp49474 __tmp49469))))
                                (declare (not safe))
                                (cons __tmp49477 __tmp49468))))
                         (declare (not safe))
                         (cons __tmp49467 _g2084420854_))))
                    (__tmp49453
                     (begin
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                (declare (not safe))
                                                (cons __tmp49462 __tmp49457))))
                                         (declare (not safe))
                                         (cons __tmp49465 __tmp49456))))
                                  (declare (not safe))
                                  (cons __tmp49455 _g2084720862_)))))
                         (declare (not safe))
                         (foldr2 __tmp49454 '() _L20051_ _L19695_)))))
                (declare (not safe))
                (foldr2 __tmp49466 __tmp49453 _L19909_ _L19479_)))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                               (declare (not safe))
                                               (cons __tmp49478 __tmp49452))))
                                       (declare (not safe))
                                       (_g2072220839_ __tmp49451))))
                                 _g2069620707_)))
                             (__tmp49479
                              (let ((__tmp49506 (gx#datum->syntax '#f '@list))
                                    (__tmp49480
                                     (begin
                                       (gx#syntax-check-splice-targets
                                        _L19621_
                                                ...
                                                (let ((__tmp49495
                                                       (let ((__tmp49505
                                                             ...
                                                             (__tmp49496
                                                              (let ((__tmp49502
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                             (let ((__tmp49504 (gx#datum->syntax '#f 'quote))
                                   (__tmp49503
                                    (let ()
                                      (declare (not safe))
                                      (cons _g2086920878_ '()))))
                            ...
                            (__tmp49497
                             (let ((__tmp49498
                               ...
                               (cons ':: __tmp49498))))
                        (declare (not safe))
                        (cons __tmp49502 __tmp49497))))
                 (declare (not safe))
                 (cons __tmp49505 __tmp49496))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                  (declare (not safe))
                                                  (cons __tmp49495
                                                        _g2087020880_))))
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                        ...
                                        (cons ':: __tmp49486))))
                                 (declare (not safe))
                                 (cons __tmp49490 __tmp49485))))
                          (declare (not safe))
                          (cons __tmp49493 __tmp49484))))
                   (declare (not safe))
                   (cons __tmp49483 _g2087320888_)))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                  (declare (not safe))
                                                  (foldr2 __tmp49482
                                                          '()
                                         ...
                                         (foldr2 __tmp49494
                                                 ...
                                                 _L19479_)))))
                                (declare (not safe))
                                (cons __tmp49506 __tmp49480))))
                        (declare (not safe))
                        (_g2069420865_ __tmp49479))))
                  _g2066820679_)))
              (__tmp49507
               (let ((__tmp49534 (gx#datum->syntax '#f '@list))
                     (__tmp49508
                      (begin
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                 ...
                                                 (cons __tmp49530
                                                       __tmp49525))))
                                          (declare (not safe))
                                          (cons __tmp49533 __tmp49524))))
                                   (declare (not safe))
                                   (cons __tmp49523 _g2089620906_))))
                              (__tmp49509
                               (begin
                                 (gx#syntax-check-splice-targets
                                  _L19767_
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                      ...
                      (__tmp49513
                       (let ((__tmp49514
                         ...
                         (cons ':: __tmp49514))))
                  (declare (not safe))
                  (cons __tmp49518 __tmp49513))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                   (declare (not safe))
                                                   (cons __tmp49521
                                                         __tmp49512))))
                                            (declare (not safe))
                                            (cons __tmp49511 _g2089920914_)))))
                                   (declare (not safe))
                                   (foldr2 __tmp49510
                                           '()
                                           _L19767_
                                           _L19695_)))))
                          (declare (not safe))
                          (foldr2 __tmp49522 __tmp49509 _L19550_ _L19479_)))))
                 (declare (not safe))
                 (cons __tmp49534 __tmp49508))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                 (declare (not safe))
                                                 (_g2066620891_ __tmp49507))))
                                           _g2064020651_)))
                                       (__tmp49535
                                        (let ((__tmp49537
                                               (gx#datum->syntax
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                 ...
                                 _g2047220483_)))
                             (__tmp49547
                              (let ((__tmp49551 (gx#datum->syntax '#f 'quote))
                                    (__tmp49548
                                     (let ((__tmp49549
                                            (let ((__tmp49550
                             ...
                             (let ((_g49553_
                               ...
                               (begin
                                 ...
                                 (let ((_target2102721048_
                                        (let ()
                                          (declare (not safe))
                                          (##vector-ref _g49553_ 0)))
                                       (_tl2102921051_
                                        (let ()
                                          (declare (not safe))
                                          (##vector-ref _g49553_ 1))))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                   ...
                   (let ((__tmp49561
                     ...
                     (declare (not safe))
                     (_loop2103021054_ _lp-tl2103321071_ __tmp49561))))
                             ...
                             (let ((__tmp49556
                                    (lambda (_g2109321096_ _g2109421099_)
                                      (let ((__tmp49557
                                        ...
                                        (declare (not safe))
                                        (cons __tmp49557 _g2109421099_)))))
                               (declare (not safe))
                               (foldr1 __tmp49556 '() _L21078_))))
                        (declare (not safe))
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                          ...
                                          (declare (not safe))
                                          (_g2110921137_ __tmp49565))))
                                  (declare (not safe))
                                  (_g2041421106_ __tmp49562))))
                            _g2038820399_)))
                        (__tmp49566
                         (let* ((_g2114521160_
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                   ...
                   (let ((_hd2115321185_
                     ...
                     (if (gx#stx-null? _tl2115221188_)
                         ((lambda (_L21191_)
                            (let ()
                              (let ((__tmp49568 (gx#datum->syntax '#f 'quote))
                                    (__tmp49567
                                     (let ()
                                       (declare (not safe))
                                       (cons _L21191_ '()))))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
              ...
              (declare (not safe))
              (foldr1 __tmp49576 '() _L20340_))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                               (declare (not safe))
                                               (cons _L19384_ __tmp49575))))
                                        (declare (not safe))
                                        (cons _L19356_ __tmp49574))))
                                 (declare (not safe))
                                 (cons _L19412_ __tmp49573))))
                          (declare (not safe))
                          (cons _L19328_ __tmp49572))))
                   (declare (not safe))
                   (cons __tmp49577 __tmp49571))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                    (declare (not safe))
                                                    (_wrap19267_ __tmp49570))))
                                            (declare (not safe))
                                            (_g2035821212_ __tmp49569))))
                               ...
                               (let ((__tmp49584
                                      (let ((__tmp49585
                                        ...
                                        (foldr1 cons
                                                ...
                                                _type-properties20274_))))
                                 (declare (not safe))
                                 (foldr1 cons __tmp49584 _type-final20283_))))
                          (declare (not safe))
                          (foldr1 cons __tmp49583 _type-struct20280_))))
                   (declare (not safe))
                   (foldr1 cons __tmp49582 _type-constructor20199_))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                    (declare (not safe))
                                                    (foldr1 cons
                                                            __tmp49581
                                            ...
                                            (lambda (_g2123621239_
                                              ...
                                              (let ()
                                                ...
                                                (cons _g2123621239_
                                                      _g2123721242_)))))
                                       (declare (not safe))
                                       (foldr1 __tmp49588 '() _L19838_)))))
                              (declare (not safe))
                              (_g2006721228_ __tmp49587))))
                            ...
                            (__tmp49590
                             (gx#stx-map
                              ...
                              (let ((__tmp49591
                                ...
                                (declare (not safe))
                                (foldr1 __tmp49591 '() _L19767_)))))
                       (declare (not safe))
                       (_g1999621245_ __tmp49590))))
                 _usetf1993719976_))))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                        (let ()
                                          (declare (not safe))
                     ...
                     (__tmp49593
                      (gx#stx-map
                       ...
                       (let ((__tmp49594
                         ...
                         (declare (not safe))
                         (foldr1 __tmp49594 '() _L19621_)))))
                (declare (not safe))
                (_g1992521262_ __tmp49593))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                  _ugetf1986619905_))))))
                                 (let ()
                                   (declare (not safe))
              ...
              (__tmp49596
               (gx#stx-map
                ...
                (let ((__tmp49597
                  ...
                  (declare (not safe))
                  (foldr1 __tmp49597 '() _L19550_)))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                 (declare (not safe))
                                                 (_g1985421279_ __tmp49596))))
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                     ...
                                     (__tmp49608
                                      (map gerbil/core$<MOP>$<MOP:2>#!class-type-descriptor
                                           _super19276_)))
                                (declare (not safe))
                                (_g1939621340_ __tmp49608))))
                          _g1937019381_)))
                      (__tmp49609 (_make-id19269_ _name19273_ '"?")))
                 (declare (not safe))
                 (_g1936821344_ __tmp49609))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                   _g1934219353_)))
                                               (__tmp49610
                                                (_make-id19269_
                                                 ...
                                                 _name19273_)))
                                          (declare (not safe))
                                          (_g1934021348_ __tmp49610))))
                                    _g1931419325_)))
                                (__tmp49611
                                 (_make-id19269_ _name19273_ '"::t")))
                           (declare (not safe))
                           (_g1931221352_ __tmp49611))))
                     _g1928319294_))))
            (declare (not safe))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                          (let ((__tmp49615
                                 (let ()
                                   ...
                                   (cons '#t _L21480_))))
                            (declare (not safe))
                            (cons 'struct: __tmp49615))))
                     (declare (not safe))
                     (cons _L21482_ __tmp49614))))
              (declare (not safe))
              (cons _L21483_ __tmp49613))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                               (declare (not safe))
                                               (cons __tmp49616 __tmp49612)))
                                           _tl2143521477_
                                           _hd2143621474_
                                           _hd2143321464_)))
                    ...
                    (let* ((___stx4431044311_ _hd21591_)
                      ...
                      (let ((___kont4431344314_
                             (lambda (_L21637_ _L21639_)
                               (let ((__tmp49617 (gx#syntax->list _L21637_)))
                                 (declare (not safe))
                                          ...
                                          (let ((_hd2167621723_
                                            ...
                                            (if (gx#identifier? _hd2167621723_)
                                                (if (gx#free-identifier=?
                                                     |gerbil/core$<MOP>$<MOP:4>[1]#_g49668_|
                                                     _hd2167621723_)
                                                    (if (gx#stx-pair?
                                                         _tl2167521726_)
                                                        (let ((_e2168021729_
                          ...
                          (__tmp49625
                           (let ((__tmp49626
                                  (let ()
                                    ...
                                    (cons _L21922_ '()))))
                             (declare (not safe))
                             (cons _L21838_ __tmp49626))))
                      (declare (not safe))
                      (cons __tmp49627 __tmp49625))))
               (declare (not safe))
               (cons _L21809_ __tmp49624))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                (declare (not safe))
                                                (cons __tmp49630
                                                      __tmp49623)))))))
              ...
              (_g2187821973_
               (_wrap21659_
                (let ((__tmp49667 (gx#datum->syntax '#f 'def))
                      (__tmp49631
                       (let ((__tmp49632
                              (let ((__tmp49633
                                     (let ((__tmp49666
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                           (gx#datum->syntax '#f '_))
                          (__tmp49658
                           (let ((__tmp49663 (gx#datum->syntax '#f 'obj))
                                 (__tmp49659
                                  (let ((__tmp49662
                                        ...
                                        (__tmp49660
                                         (let ((__tmp49661
                                           ...
                                           (cons __tmp49661 '()))))
                                    (declare (not safe))
                                    (cons __tmp49662 __tmp49660))))
                             (declare (not safe))
                             (cons __tmp49663 __tmp49659))))
                      (declare (not safe))
                      (cons __tmp49664 __tmp49658)))
                   (__tmp49643
                    (let ((__tmp49644
                           (let ((__tmp49656
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
              ...
              (__tmp49648
               (let ((__tmp49651 (gx#datum->syntax '#f 'arg))
                     (__tmp49649
                      (let ((__tmp49650 (gx#datum->syntax '#f '...)))
                        (declare (not safe))
                        (cons __tmp49650 '()))))
                 (declare (not safe))
                 (cons __tmp49651 __tmp49649))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                  (declare (not safe))
                                                  (cons __tmp49652
                                                        __tmp49648))))
                                           (declare (not safe))
                                           (cons __tmp49655 __tmp49647))))
                                    (declare (not safe))
                                    (cons _L21809_ __tmp49646))))
                             (declare (not safe))
                             (cons __tmp49656 __tmp49645))))
                      (declare (not safe))
                      (cons __tmp49644 '()))))
               (declare (not safe))
               (cons __tmp49657 __tmp49643))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                (declare (not safe))
                                                (cons __tmp49642 '()))))
                                         (declare (not safe))
                                         (cons '() __tmp49641))))
                                  (declare (not safe))
                                  (cons __tmp49665 __tmp49640))))
                           (declare (not safe))
                           (cons __tmp49639 '()))))
                    (declare (not safe))
                    (cons _L21866_ __tmp49638))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                     (declare (not safe))
                                                     (cons __tmp49637 '())))
                                                  (__tmp49635
                                                   (let ()
                                                     ...
                                                     (cons _L21761_ '()))))
                                              (declare (not safe))
                                              (cons __tmp49636 __tmp49635))))
                                       (declare (not safe))
                                       (cons __tmp49666 __tmp49634))))
                                (declare (not safe))
                                (cons __tmp49633 '()))))
                         (declare (not safe))
                         (cons _L21838_ __tmp49632))))
                  (declare (not safe))
                  (cons __tmp49667 __tmp49631)))))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                _g2185221863_))))
                                       (_g2185021977_
                                        (gx#stx-identifier
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                              ...
                                              (cons __tmp49676 '()))))
                                       (declare (not safe))
                                       (cons __tmp49680 __tmp49675))))
                                (declare (not safe))
                                (cons _L22592_ __tmp49674))))
                         (declare (not safe))
                         (cons __tmp49683 __tmp49673))))
                  (declare (not safe))
                  (cons __tmp49684 __tmp49672))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                    _hd2255622584_
                                                    _hd2255322574_)
                                                   (_g2254822563_
                                            ...
                                            (lambda (_g2243722440_
                                              ...
                                              (let ()
                                                ...
                                                (cons _g2243722440_
                                                      _g2243822443_)))))
                                       (declare (not safe))
                                       (foldr1 __tmp49688 '() _L22359_))))
                                (declare (not safe))
                                (cons __tmp49689 __tmp49687))))
                         (declare (not safe))
                         (cons _L22422_ __tmp49686))))
                  (declare (not safe))
                  (cons __tmp49692 __tmp49685))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                    _hd2238622414_
                                                    _hd2238322404_)
                                                   (_g2237822393_
                  ...
                  (___kont4433744338_
                   (lambda (_L22263_ _L22265_ _L22266_)
                     (let ((__tmp49705 (gx#datum->syntax '#f 'apply))
                           (__tmp49693
                            (let ((__tmp49704
                                   (gx#datum->syntax '#f 'call-method))
                                  (__tmp49694
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                         ...
                         (declare (not safe))
                         (foldr1 __tmp49699 '() _L22263_))))
                  (declare (not safe))
                  (cons __tmp49700 __tmp49698))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                   (declare (not safe))
                                                   (cons __tmp49697 '()))))
                                            (declare (not safe))
                                            (cons __tmp49701 __tmp49696))))
                                     (declare (not safe))
                                     (cons _L22265_ __tmp49695))))
                              (declare (not safe))
                              (cons __tmp49704 __tmp49694))))
                       (declare (not safe))
                       (cons __tmp49705 __tmp49693))))
                  (___kont4434144342_
                   (lambda (_L22163_ _L22165_ _L22166_)
                     (let ((__tmp49713 (gx#datum->syntax '#f 'call-method))
                           (__tmp49706
                            (let ((__tmp49707
                                   (let ((__tmp49710
                                          (let ((__tmp49712
                                                 ...
                                                 (lambda (_g2218722190_
                                                   ...
                                                   (let ()
                                                     ...
                                                     (cons _g2218722190_
                                                           _g2218822193_)))))
                                            (declare (not safe))
                                            (foldr1 __tmp49709 '() _L22163_))))
                                     (declare (not safe))
                                     (cons __tmp49710 __tmp49708))))
                              (declare (not safe))
                              (cons _L22165_ __tmp49707))))
                       (declare (not safe))
                       (cons __tmp49713 __tmp49706)))))
        ...
        (let* ((___stx4444844449_ _$stx22648_)
          ...
          (let ((___kont4445144452_
                 (lambda (_L22831_ _L22833_)
                   (let ((__tmp49721 (gx#datum->syntax '#f 'slot-ref))
                         (__tmp49716
                          (let ((__tmp49717
                                 (let ((__tmp49718
                                        (let ((__tmp49720
                                   ...
                                   (cons __tmp49718 '()))))
                            (declare (not safe))
                            (cons _L22833_ __tmp49717))))
                     (declare (not safe))
                     (cons __tmp49721 __tmp49716))))
                (___kont4445344454_
                                 ...
                                 (let ((__tmp49726
                                        (let ((__tmp49727
                                               (let ()
                                                 ...
                                                 (cons _L22762_ '()))))
                                          (declare (not safe))
                                          (cons _L22763_ __tmp49727))))
                                   (declare (not safe))
                                   (cons _L22764_ __tmp49726)))
                                (__tmp49723
                                 (let ((__tmp49724
                                        (lambda (_g2278522788_ _g2278622791_)
                                          (let ()
                                            ...
                                            (cons _g2278522788_
                                                  _g2278622791_)))))
                                   (declare (not safe))
                                   (foldr1 __tmp49724 '() _L22760_))))
                            (declare (not safe))
                            (cons __tmp49725 __tmp49723))))
                     (declare (not safe))
                     (cons _L22764_ __tmp49722)))))
        ...
        (let* ((___stx4450644507_ _$stx22853_)
          ...
          (let ((___kont4450944510_
                 (lambda (_L23086_ _L23088_ _L23089_)
                   (let ((__tmp49734 (gx#datum->syntax '#f 'slot-set!))
                         (__tmp49728
                          (let ((__tmp49729
                                 (let ((__tmp49731
                                        (let ((__tmp49733
                            ...
                            (declare (not safe))
                            (cons _L23089_ __tmp49729))))
                     (declare (not safe))
                     (cons __tmp49734 __tmp49728))))
                (___kont4451144512_
                 (lambda (_L22997_
                          _L22999_
                          _L23000_
                   ...
                   (let ((__tmp49735
                          (let ((__tmp49738
                                 (let ((__tmp49743 (gx#datum->syntax '#f '@))
                                       (__tmp49739
                                        (let ((__tmp49740
                                               (let ((__tmp49741
                                                      (let ((__tmp49742
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                ...
                (declare (not safe))
                (foldr1 __tmp49742 '() _L23000_))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                 (declare (not safe))
                                                 (cons _L23001_ __tmp49741))))
                                          (declare (not safe))
                                          (cons _L23002_ __tmp49740))))
                                   (declare (not safe))
                                   (cons __tmp49743 __tmp49739)))
                                (__tmp49736
                                 (let ((__tmp49737
                                        (let ()
                                          (declare (not safe))
                                          (cons _L22997_ '()))))
                                   (declare (not safe))
                                   (cons _L22999_ __tmp49737))))
                            (declare (not safe))
                            (cons __tmp49738 __tmp49736))))
                     (declare (not safe))
                     (cons _L23003_ __tmp49735)))))
