...
(begin
  (define |gerbil/core::<match>[2]#_g29594_|
  ...
  (define |gerbil/core::<match>[:1:]#match-macro|
    (|gerbil/core::<MOP>::<MOP:2>[1]#make-extended-class-info|
     'runtime-identifier:
     |gerbil/core::<match>[2]#_g29594_|
     'expander-identifiers:
     (cons (cons |gerbil/core::<match>[2]#_g29595_| '())
           (cons |gerbil/core::<match>[2]#_g29596_|
     ...
     (|gerbil/core::<MOP>::<MOP:2>[1]#make-runtime-class-exhibitor|
      ...
      (list |gerbil/core::<match>[2]#_g29599_|)
      'match-macro
      '#f
      '()
      '()))))
