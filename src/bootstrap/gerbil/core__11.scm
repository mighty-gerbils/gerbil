...
(begin
  ...
  (define |gerbil/core$<match>[:1:]#match-macro|
    (|gerbil/core$<MOP>$<MOP:2>[1]#make-extended-class-info|
     'runtime-identifier:
     |gerbil/core$<match>[2]#_g30816_|
     'expander-identifiers:
     (cons (cons |gerbil/core$<match>[2]#_g30817_| '())
           (cons |gerbil/core$<match>[2]#_g30818_|
                 (cons |gerbil/core$<match>[2]#_g30819_|
                       (cons |gerbil/core$<match>[2]#_g30820_|
                             (cons '() (cons '() '()))))))
     'type-exhibitor:
     (|gerbil/core$<MOP>$<MOP:2>[1]#make-runtime-class-exhibitor|
      'gerbil.core#match-macro::t
      (list |gerbil/core$<match>[2]#_g30821_|)
      'match-macro
      '#f
      '()
      '()))))
