...
(begin
  (define |gerbil/core/sugar~Sugar-3[1]#_g21059_|
    (##structure
     gx#syntax-quote::t
     'quote
     #f
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                         (not safe))
                       (##fx= _g21054_ 2)))
                (error "Context expects 2 values" _g21054_)))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                      ...
                                      (let ((_g21055_
                                        ...
                                        (begin
                                          ...
                                          (let ((_%target1796818049%_
                                                 (let ()
                                                   (declare (not safe))
                                                   (##vector-ref _g21055_ 0)))
                                                (_%tl1797018052%_
                                                 (let ()
                                                   (declare (not safe))
                                                   (##vector-ref _g21055_ 1))))
                        ...
                        (begin
                          (let ((_g21058_
                                 (let ()
                                   (declare (not safe))
                                   (if (##values? _g21057_)
                                       (##vector-length _g21057_)
                                       1))))
                            (if (not (let ()
                                       (declare (not safe))
                                       (##fx= _g21058_ 2)))
                                (error "Context expects 2 values" _g21058_)))
                          (let ((_%target1814518166%_
                                 (let ()
                                   (declare (not safe))
                                   (##vector-ref _g21057_ 0)))
                                (_%tl1814718169%_
                                 (let ()
                                   (declare (not safe))
                                   (##vector-ref _g21057_ 1))))
                                            ...
                                            (let ((_%tl1836818492%_
                                              ...
                                              (if (gx#identifier?
                                                  ...
                                                  (if (gx#free-identifier=?
                                                       |gerbil/core/sugar~Sugar-3[1]#_g21059_|
                                                       _%hd1836918489%_)
                                                      (if (gx#stx-pair?
                                                           _%tl1836818492%_)
                                                          (let ((_%e1837318495%_
