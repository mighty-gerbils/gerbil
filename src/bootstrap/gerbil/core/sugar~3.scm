                           ...
                           (gx#stx-wrap-source
                            (cons (gx#datum->syntax '#f 'def)
                                  (cons (cons _%L18143%_
                                              (foldr (lambda (_%g1828718292%_
                                                              _%g1828818295%_)
                                                       (cons _%g1828718292%_
                                                             _%g1828818295%_))
                                                     '()
                                                     _%L18094%_))
                                        (foldr (lambda (_%g1828918298%_
                                                        _%g1829018301%_)
                                                 (cons _%g1828918298%_
                                                       _%g1829018301%_))
                                               '()
                                               _%L18092%_)))
                            (gx#stx-source _%stx17955%_)))))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                           (cons '()
                                 (cons (cons (cons (gx#datum->syntax '#f '_)
                                                   (foldr (lambda (_%g1830718316%_
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                           _%g1830818319%_)
                    (cons _%g1830718316%_ _%g1830818319%_))
                  '()
                  _%L18209%_))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                             (cons (cons (cons (gx#datum->syntax
                                                                '#f
                                                                'lambda)
                                                               (cons (foldr (lambda (_%g1830918322%_
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                                             _%g1831018325%_)
                                      (cons _%g1830918322%_ _%g1831018325%_))
                                    '()
                                    _%L18094%_)
                             (foldr (lambda (_%g1831118328%_ _%g1831218331%_)
                                      (cons _%g1831118328%_ _%g1831218331%_))
                                    '()
                                    _%L18092%_)))
                 (foldr (lambda (_%g1831318334%_ _%g1831418337%_)
                          (cons _%g1831318334%_ _%g1831418337%_))
                        '()
                        _%L18209%_))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                   '()))
