...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                ...
                (_%__kont2082320824%_
                 (lambda (_%$%g1776117814%_ _%$%g1776217816%_)
                   (cons (gx#datum->syntax '#f 'define-syntax)
                         (cons _%$%g1776217816%_
                               (cons _%$%g1776117814%_ '()))))))
