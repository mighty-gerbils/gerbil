                             ...
                             (let* ((_%g1809518103%_
                                    ...
                                    (_%g1809418138%_
                                     (lambda (_%g1809618107%_)
                                       ((lambda (_%g1809718110%_)
                                          (cons (gx#datum->syntax
                                                 '#f
                                                 'defsyntax)
                                                (cons _%g1794118070%_
                                                      (cons (cons (gx#datum->syntax
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                           '#f
                           'lambda)
                          (cons (cons _%g1809718110%_ '())
                                (cons (cons (gx#datum->syntax '#f 'syntax-case)
                                            (cons _%g1809718110%_
                                                  (cons (foldr (lambda (_%g1812118126%_
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                                _%g1812218129%_)
                         (cons _%g1812118126%_ _%g1812218129%_))
                       '()
                       _%g1794018069%_)
                (foldr (lambda (_%g1812318132%_ _%g1812418135%_)
                         (cons _%g1812318132%_ _%g1812418135%_))
                       '()
                       _%g1793918067%_))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                      '())))
