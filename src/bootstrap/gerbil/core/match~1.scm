...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                    ...
                    (let* ((_%$%var-r3041930457%_
                            (reverse _%$%var-r3041830445%_))
                           (_%$%g3047730494%_
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                    ...
                    (let* ((_%$%init3048830526%_
                            (reverse _%$%init3048730514%_))
                           (_%$%g3054630554%_
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                              (foldr (lambda (_%$%g3083530862%_
                                              _%$%g3083630865%_)
                                       (cons _%$%g3083530862%_
                                             _%$%g3083630865%_))
                                     '()
                                     _%$%init3048830526%_)))
                  '()))))))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                              _%$%g3630636312%_
                              _%$%g3630736314%_)
                       (cons (cons _%$%g3630636312%_
                                   (cons _%$%g3630536309%_ '()))
                             _%$%g3630736314%_))
                     '()
                     _%$%e3612736185%_
                     _%$%$e3621936257%_))
        ...
        (let* ((_%__stx3991139912%_ _%$stx36347%_)
          ...
          (let ((_%__kont3991439915%_
                 (lambda (_%$%g3635536756%_)
                   (cons (gx#datum->syntax '#f 'let)
                         (cons '()
                               (foldr (lambda (_%$%g3677236775%_
                                               _%$%g3677336778%_)
                                        (cons _%$%g3677236775%_
                                              _%$%g3677336778%_))
                                      '()
                                      _%$%g3635536756%_)))))
                 ...
                 (lambda (_%$%g3637136666%_
                   ...
                   (cons _%$%g3637436670%_
                         (cons (cons (cons _%$%g3637336669%_
                                     ...
                                     '())
                               (foldr (lambda (_%$%g3669236695%_
                                               _%$%g3669336698%_)
                                        (cons _%$%g3669236695%_
                                              _%$%g3669336698%_))
                                      '()
                                      _%$%g3637136666%_)))))
                (_%__kont3992239923%_
                 (lambda (_%$%g3639636541%_
                          _%$%g3639736543%_
                          _%$%g3639836544%_)
                   (cons (gx#datum->syntax '#f 'match*)
                         (cons (foldr (lambda (_%$%g3656636573%_
                                               _%$%g3656736576%_)
                                        (cons _%$%g3656636573%_
                                              _%$%g3656736576%_))
                                      '()
                                      _%$%g3639736543%_)
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                ...
                (_%__kont4001440015%_
                 (lambda (_%$%g3682536901%_)
                   (cons (gx#datum->syntax '#f 'let)
                         (cons '()
                               (foldr (lambda (_%$%g3691836921%_
                                               _%$%g3691936924%_)
                                        (cons _%$%g3691836921%_
                                              _%$%g3691936924%_))
                                      '()
                                      _%$%g3682536901%_))))))
