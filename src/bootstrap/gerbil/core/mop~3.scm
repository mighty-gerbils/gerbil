...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                    ...
                    (let* ((_%slot2281222850%_ (reverse _%slot2281122838%_))
                           (_%g2287022887%_
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                    ...
                    (let* ((_%getf2288122919%_ (reverse _%getf2288022907%_))
                           (_%g2293922956%_
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                    ...
                    (let* ((_%setf2295022988%_ (reverse _%setf2294922976%_))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                      ...
                      (let ((_%lp-hd2301923054%_
                        ...
                        (_%loop2301723041%_
                         _%lp-tl2302023057%_
                         (cons _%lp-hd2301923054%_ _%mixin-slot2302123048%_))))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                    ...
                    (let* ((_%ugetf2323023268%_ (reverse _%ugetf2322923256%_))
                           (_%g2328823305%_
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                    ...
                    (let* ((_%usetf2329923337%_ (reverse _%usetf2329823325%_))
                           (_%g2335723374%_
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                           (cons _%g2349923506%_ (cons _%g2349823503%_ '())))
                     _%g2350123510%_))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                     '()
                                                     _%setf2295022988%_
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                           (cons _%g2352023527%_ (cons _%g2351923524%_ '())))
                     _%g2352223531%_))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                     '()
                                                     _%mixin-setf2316123199%_
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                      ...
                      (let ((_%lp-hd2368823723%_
                        ...
                        (_%loop2368623710%_
                         _%lp-tl2368923726%_
                         (cons _%lp-hd2368823723%_ _%type-body2369023717%_))))
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                 (_%g2435524370%_
                                                  _%g2435624374%_))))
                                         (_%g2435524370%_ _%g2435624374%_)))))
                             (_%g2435424418%_ _%type-constructor23562%_))))))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                    (_%g2394824422%_
                                                     (if _%metaclass23665%_
                                                         (let* ((_%g2442624434%_
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                 ...
                 '#f))))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                          (_%g2392024457%_ _%final?23671%_)))))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                            _%g2448224502%_)
                           (let ((_g27705_
                                  (gx#syntax-split-splice _%g2448224502%_ '0)))
                             (begin
                               (let ((_g27706_
                                      (let ()
                                        (declare (not safe))
               ...
               (_%g2488124958%_
                (lambda (_%g2488324905%_)
                  (if (gx#stx-pair? _%g2488324905%_)
                      (let ((_%e2488724908%_ (gx#syntax-e _%g2488324905%_)))
                 ...
                 (_%g2496725045%_
                  (lambda (_%g2496924991%_)
                    (if (gx#stx-pair? _%g2496924991%_)
                        (let ((_%e2497324994%_ (gx#syntax-e _%g2496924991%_)))
                 ...
                 (_%g2512025456%_
                  (lambda (_%g2512225154%_)
                    (if (gx#stx-pair? _%g2512225154%_)
                        (let ((_%e2512725157%_ (gx#syntax-e _%g2512225154%_)))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                         (let () (declare (not safe)) (##car _%e2513625187%_)))
                        (_%tl2513825194%_
                         (let ()
                           (declare (not safe))
                           (##cdr _%e2513625187%_))))
                    (if (gx#stx-pair? _%tl2513825194%_)
                        (let ((_%e2513925197%_ (gx#syntax-e _%tl2513825194%_)))
        ...
        (letrec ((_%dotted-identifier?25469%_
          ...
          (let* ((_%__stx2717227173%_ _%stx25466%_)
            ...
            (let ((_%__kont2717527176%_
                   (lambda (_%g2547825976%_ _%g2547925978%_ _%g2548025979%_)
                     (let* ((_%g2600726022%_
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                             ...
                             (foldr (lambda (_%g2589825901%_ _%g2589925904%_)
                                      (cons _%g2589825901%_ _%g2589925904%_))
                                    '()
                                    _%g2549925820%_))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                   (_%g2583925854%_
                  ...
                  (_%__kont2718327184%_
                   (lambda (_%g2551625726%_ _%g2551725728%_ _%g2551825729%_)
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                  ...
                  (_%__kont2718727188%_
                   (lambda (_%g2553725628%_ _%g2553825630%_ _%g2553925631%_)
                     (cons (gx#datum->syntax '#f 'call-method)
              ...
              (let* ((_%__match2729127292%_
                      (lambda (_%e2554025570%_
                        ...
                        (letrec ((_%loop2555225606%_
                                  (lambda (_%hd2555025610%_ _%arg2555625613%_)
                                    (if (gx#stx-pair? _%hd2555025610%_)
                                        (let ((_%e2555325615%_
                                               (gx#syntax-e _%hd2555025610%_)))
                     ...
                     (_%__match2726527266%_
                      (lambda (_%e2551925668%_
                        ...
                        (letrec ((_%loop2553125704%_
                                  (lambda (_%hd2552925708%_ _%arg2553525711%_)
                                    (if (gx#stx-pair? _%hd2552925708%_)
                                        (let ((_%e2553225713%_
                                               (gx#syntax-e _%hd2552925708%_)))
                     ...
                     (_%__match2723927240%_
                      (lambda (_%e2550125772%_
                        ...
                        (letrec ((_%loop2551025798%_
                                  (lambda (_%hd2550825802%_ _%arg2551425805%_)
                                    (if (gx#stx-pair? _%hd2550825802%_)
                                        (let ((_%e2551125807%_
                                               (gx#syntax-e _%hd2550825802%_)))
                     ...
                     (_%__match2721927220%_
                      (lambda (_%e2548125918%_
                        ...
                        (letrec ((_%loop2549025954%_
                                  (lambda (_%hd2548825958%_ _%arg2549425961%_)
                                    (if (gx#stx-pair? _%hd2548825958%_)
                                        (let ((_%e2549125963%_
                                               (gx#syntax-e _%hd2548825958%_)))
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                ...
                (if (gx#stx-pair? _%__stx2717227173%_)
                    (let ((_%e2548125918%_ (gx#syntax-e _%__stx2717227173%_)))
                                                ...
                                                (_%target2548725938%_
                                                 (let ()
                                                   ...
                                                   (##vector-ref
                                                    _%__splice2717727178%_
                                                    '0))))
                                            (if (gx#stx-pair? _%tl2548925941%_)
                                                (let ((_%e2549625944%_
                                                       (gx#syntax-e
                                                        _%tl2548925941%_)))
                 ...
                 (lambda (_%g2612526217%_
                   ...
                   (cons _%g2612826221%_
                         (cons (cons _%g2612826221%_
                               ...
                               (foldr (lambda (_%g2624226245%_ _%g2624326248%_)
                                        (cons _%g2624226245%_ _%g2624326248%_))
                                      '()
                                      _%g2612526217%_))))))
            (let* ((_%__match2734927350%_
                    (lambda (_%e2612926159%_
                      ...
                      (letrec ((_%loop2614126195%_
                                (lambda (_%hd2613926199%_ _%rest2614526202%_)
      ...
      (lambda (_%$stx26310%_)
        (let* ((_%__stx2735227353%_ _%$stx26310%_)
          ...
          (let ((_%__kont2735527356%_
                 (lambda (_%g2631726541%_ _%g2631826543%_ _%g2631926544%_)
            ...
            (let* ((_%__match2742727428%_
                    (lambda (_%e2633826374%_
                      ...
                      (letrec ((_%loop2635026430%_
                                (lambda (_%hd2634826434%_ _%path2635426437%_)
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                    ...
                    (##fx>= __tmp27712 '2))
                  (let ((_%__splice2735927360%_
                         (gx#syntax-split-splice->vector _%tl2632826528%_ '2)))
                    (let ((_%tl2634926407%_
                           (let ()
                             (declare (not safe))
