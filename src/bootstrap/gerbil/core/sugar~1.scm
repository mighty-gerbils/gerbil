...
(begin
  (define |gerbil/core/sugar~Sugar-1[1]#_g20706_|
    (##structure
     gx#syntax-quote::t
     'values
     #f
     ...
     '()))
  (define |gerbil/core/sugar~Sugar-1[1]#_g20707_|
    (##structure
     gx#syntax-quote::t
     'values
     #f
     (gx#current-expander-context)
     '()))
  (define |gerbil/core/sugar~Sugar-1[1]#_g20710_|
    (##structure
     gx#syntax-quote::t
     'else
     #f
     (gx#current-expander-context)
     '()))
  (define |gerbil/core/sugar~Sugar-1[1]#_g20711_|
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                         (not safe))
                       (##fx= _g20699_ 2)))
                (error "Context expects 2 values" _g20699_)))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
    ...
    (define |gerbil/core/sugar~Sugar-1[:0:]#defrule|
      (lambda (_%$stx2040%_)
        (let* ((_%__stx1817318174%_ _%$stx2040%_)
               (_%g20452086%_
                (lambda ()
                  (gx#raise-syntax-error
                   '#f
                    ...
                    (lambda (_%e20502176%_
                      ...
                      (let ((_%g20472216%_ _%hd20602210%_)
                        ...
                        (if (gx#identifier? _%g20492219%_)
                            (_%__kont1817618177%_
                             _%g20472216%_
                             _%g20482218%_
                             _%g20492219%_)
                            (let () (declare (not safe)) (_%g20452086%_)))))))
              (if (gx#stx-pair? _%__stx1817318174%_)
                  (let ((_%e20502176%_ (gx#syntax-e _%__stx1817318174%_)))
                    (let ((_%tl20522183%_
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
    ...
    (define |gerbil/core/sugar~Sugar-1[:0:]#defsyntax%|
      (lambda (_%$stx2241%_)
        (let* ((_%__stx1824118242%_ _%$stx2241%_)
               (_%g22462285%_
                (lambda ()
                  (gx#raise-syntax-error
                   '#f
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
            ...
            (let* ((_%__match1829618297%_
                    (lambda (_%e22712292%_
                      ...
                      (let ((_%g22692322%_ _%hd22782316%_)
                        ...
                        (if (gx#identifier? _%g22702324%_)
                            (_%__kont1824818249%_ _%g22692322%_ _%g22702324%_)
                            (let () (declare (not safe)) (_%g22462285%_))))))
                   (_%__match1828818289%_
                    (lambda (_%e22712292%_
                             _%hd22722296%_
                             _%tl22732299%_
                             _%e22742302%_
              ...
              (if (gx#stx-pair? _%__stx1824118242%_)
                  (let ((_%e22512347%_ (gx#syntax-e _%__stx1824118242%_)))
                    (let ((_%tl22532354%_
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
    ...
    (define |gerbil/core/sugar~Sugar-1[:0:]#define|
      (lambda (_%$stx2441%_)
        (let* ((_%__stx1829918300%_ _%$stx2441%_)
               (_%g24462485%_
                (lambda ()
                  (gx#raise-syntax-error
                   '#f
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
            ...
            (let* ((_%__match1835418355%_
                    (lambda (_%e24712492%_
                      ...
                      (let ((_%g24692522%_ _%hd24782516%_)
                        ...
                        (if (gx#identifier? _%g24702524%_)
                            (_%__kont1830618307%_ _%g24692522%_ _%g24702524%_)
                            (let () (declare (not safe)) (_%g24462485%_))))))
                   (_%__match1834618347%_
                    (lambda (_%e24712492%_
                             _%hd24722496%_
                             _%tl24732499%_
                             _%e24742502%_
              ...
              (if (gx#stx-pair? _%__stx1829918300%_)
                  (let ((_%e24512547%_ (gx#syntax-e _%__stx1829918300%_)))
                    (let ((_%tl24532554%_
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
    ...
    (define |gerbil/core/sugar~Sugar-1[:0:]#let*-values|
      (lambda (_%$stx2641%_)
        (let* ((_%__stx1835718358%_ _%$stx2641%_)
               (_%g26462691%_
                (lambda ()
                  (gx#raise-syntax-error
                   '#f
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                ...
                                (lambda (_%hd26562827%_ _%body26622830%_)
                                  (if (gx#stx-pair? _%hd26562827%_)
                                      ...
                                      (let ((_%body26632842%_
                                        ...
                                        (_%__kont1836018361%_
                                         _%body26632842%_))))))
                        (_%loop26582823%_ _%target26552817%_ '())))))
              (if (gx#stx-pair? _%__stx1835718358%_)
                  (let ((_%e26492797%_ (gx#syntax-e _%__stx1835718358%_)))
                    (let ((_%tl26512804%_
    ...
    (define |gerbil/core/sugar~Sugar-1[:0:]#let|
      (lambda (_%$stx2876%_)
        (let* ((_%__stx1841918420%_ _%$stx2876%_)
               (_%g28812945%_
                (lambda ()
                  (gx#raise-syntax-error
                   '#f
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                                           _%g31743183%_)
                                    (cons _%g31733180%_ _%g31743183%_))
                                  _%g28843145%_
                                  _%g28863147%_)
                           (foldr (lambda (_%g31753186%_ _%g31763189%_)
                                    (cons _%g31753186%_ _%g31763189%_))
                                  '()
                                  _%g28833143%_)))
               '()))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                           '())
                                     (cons _%g28873148%_ '())))
                         (foldr (lambda (_%g31773192%_ _%g31783195%_)
                                  (cons _%g31773192%_ _%g31783195%_))
                                '()
                                _%g28853146%_))))
                (_%__kont1842818429%_
                      ...
                      (if (gx#stx-pair/null? _%tl29302969%_)
                          (let ((_%__splice1843018431%_
                            ...
                            (let ((_%tl29332975%_
                                   (let ()
                                     (declare (not safe))
                                     (##vector-ref _%__splice1843018431%_ '1)))
                                  (_%target29312972%_
                                   (let ()
                                     (declare (not safe))
                                     (##vector-ref
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
              ...
              (if (gx#stx-pair? _%__stx1841918420%_)
                  (let ((_%e28883035%_ (gx#syntax-e _%__stx1841918420%_)))
                    (let ((_%tl28903042%_
                                      ...
                                      (let ((_g20700_
                                        ...
                                        (begin
                                          ...
                                          (let ((_%target32193260%_
                                                 (let ()
                                                   (declare (not safe))
                                                   (##values-ref _g20700_ 0)))
                                                (_%tl32213263%_
                                                 (let ()
                                                   (declare (not safe))
                                                   (##values-ref _g20700_ 1))))
                                      ...
                                      (let ((_g20702_
                                        ...
                                        (begin
                                          ...
                                          (let ((_%target33353376%_
                                                 (let ()
                                                   (declare (not safe))
                                                   (##values-ref _g20702_ 0)))
                                                (_%tl33373379%_
                                                 (let ()
                                                   (declare (not safe))
                                                   (##values-ref _g20702_ 1))))
                                      ...
                                      (let ((_g20704_
                                        ...
                                        (begin
                                          ...
                                          (let ((_%target34513492%_
                                                 (let ()
                                                   (declare (not safe))
                                                   (##values-ref _g20704_ 0)))
                                                (_%tl34533495%_
                                                 (let ()
                                                   (declare (not safe))
                                                   (##values-ref _g20704_ 1))))
                           ...
                           (_%g40324043%_
                            (lambda ()
                              (gx#raise-syntax-error
                               ...
                               '"Bad syntax; invalid match target"
                               _%__stx1847918480%_))))
                      (let ((_%__kont1848218483%_
                             (lambda (_%g40344071%_)
                               (gx#stx-andmap gx#identifier? _%g40344071%_)))
                            (_%__kont1848418485%_
                             (lambda () (gx#identifier? _%x4028%_))))
                        (if (gx#stx-pair? _%__stx1847918480%_)
                            (let ((_%e40354061%_
                                   (gx#syntax-e _%__stx1847918480%_)))
                              (let ((_%tl40374068%_
                                     (let ()
                                       (declare (not safe))
                                       (##cdr _%e40354061%_)))
                                ...
                                (if (gx#identifier? _%hd40364065%_)
                                    (if (gx#free-identifier=?
                                         |gerbil/core/sugar~Sugar-1[1]#_g20706_|
                                         _%hd40364065%_)
                                        (_%__kont1848218483%_ _%tl40374068%_)
                                        (_%__kont1848418485%_))
                                    (_%__kont1848418485%_))))
                            (_%__kont1848418485%_))))))
                 (_%let-head3558%_
                  (lambda (_%x3968%_)
                    (let* ((_%__stx1849918500%_ _%x3968%_)
                           (_%g39723983%_
                            (lambda ()
                              (gx#raise-syntax-error
                               '#f
                               '"Bad syntax; invalid match target"
                               _%__stx1849918500%_))))
                      (let ((_%__kont1850218503%_
                             (lambda (_%g39744011%_) _%g39744011%_))
                            (_%__kont1850418505%_
                             (lambda () (list _%x3968%_))))
                        (if (gx#stx-pair? _%__stx1849918500%_)
                            (let ((_%e39754001%_
                                   (gx#syntax-e _%__stx1849918500%_)))
                              (let ((_%tl39774008%_
                                     (let ()
                                       (declare (not safe))
                                       (##cdr _%e39754001%_)))
                                ...
                                (if (gx#identifier? _%hd39764005%_)
                                    (if (gx#free-identifier=?
                                         |gerbil/core/sugar~Sugar-1[1]#_g20707_|
                                         _%hd39764005%_)
                                        (_%__kont1850218503%_ _%tl39774008%_)
                                        (_%__kont1850418505%_))
                                    (_%__kont1850418505%_))))
                            (_%__kont1850418505%_)))))))
          (let* ((_%__stx1851918520%_ _%stx3553%_)
                 (_%g35613627%_
                  (lambda ()
                    (gx#raise-syntax-error
                     '#f
                                   ...
                                   (let ((_g20708_
                                     ...
                                     (begin
                                       ...
                                       (let ((_%target37843805%_
                                              (let ()
                                                (declare (not safe))
                                                (##values-ref _g20708_ 0)))
                                             (_%tl37863808%_
                                              (let ()
                                                (declare (not safe))
                                                (##values-ref _g20708_ 1))))
                          ...
                          (if (_%let-head?3556%_ _%g35653940%_)
                              ...
                              (if (gx#stx-pair/null? _%hd35753911%_)
                                  ...
                                  (let ()
                                    (declare (not safe))
                                    (_%g35613627%_))))))))
                (if (gx#stx-pair? _%__stx1851918520%_)
                    (let ((_%e35683887%_ (gx#syntax-e _%__stx1851918520%_)))
                      (let ((_%tl35703894%_
                             (let ()
                               (declare (not safe))
                               (##cdr _%e35683887%_)))
                    ...
                    (if (gx#stx-pair/null? _%hd35753911%_)
                        (let ((_%__splice1852618527%_
                          ...
                          (let ((_%tl35983667%_
                                 (let ()
                                   (declare (not safe))
                                   (##vector-ref _%__splice1852618527%_ '1)))
                                (_%target35963664%_
                                 (let ()
                                   (declare (not safe))
                                   (##vector-ref _%__splice1852618527%_ '0))))
                            (if (gx#stx-null? _%tl35983667%_)
                                (_%__match1858818589%_
                                 _%e35683887%_
                                 _%hd35693891%_
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
    ...
    (define |gerbil/core/sugar~Sugar-1[:0:]#and|
      (lambda (_%$stx4091%_)
        (let* ((_%__stx1859118592%_ _%$stx4091%_)
               (_%g40974123%_
                (lambda ()
                  (gx#raise-syntax-error
                   '#f
                   '"Bad syntax; invalid match target"
                   _%__stx1859118592%_))))
          (let ((_%__kont1859418595%_ (lambda () '#t))
                (_%__kont1859618597%_ (lambda (_%g41024195%_) _%g41024195%_))
                   ...
                   (cons (gx#datum->syntax '#f 'if)
                         (cons _%g41104152%_
                               (cons (cons _%g41114153%_ _%g41094150%_)
                                     (cons '#f '())))))))
            (if (gx#stx-pair? _%__stx1859118592%_)
                (let ((_%e40994215%_ (gx#syntax-e _%__stx1859118592%_)))
                  (let ((_%tl41014222%_
                            ...
                            (let ((_%e41064185%_ (gx#syntax-e _%tl41014222%_)))
                              (let ((_%tl41084192%_
                                ...
                                (if (gx#stx-null? _%tl41084192%_)
                                    (_%__kont1859618597%_ _%hd41074189%_)
                                    (_%__kont1859818599%_
                                     _%tl41084192%_
                                     _%hd41074189%_
                                     _%hd41004219%_))))
    ...
    (define |gerbil/core/sugar~Sugar-1[:0:]#or|
      (lambda (_%$stx4233%_)
        (let* ((_%__stx1863718638%_ _%$stx4233%_)
               (_%g42394265%_
                (lambda ()
                  (gx#raise-syntax-error
                   '#f
                   '"Bad syntax; invalid match target"
                   _%__stx1863718638%_))))
          (let ((_%__kont1864018641%_ (lambda () '#f))
                (_%__kont1864218643%_ (lambda (_%g42444337%_) _%g42444337%_))
                (_%__kont1864418645%_
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                     '()))))))
            (if (gx#stx-pair? _%__stx1863718638%_)
                (let ((_%e42414357%_ (gx#syntax-e _%__stx1863718638%_)))
                  (let ((_%tl42434364%_
                            ...
                            (let ((_%e42484327%_ (gx#syntax-e _%tl42434364%_)))
                              (let ((_%tl42504334%_
                                ...
                                (if (gx#stx-null? _%tl42504334%_)
                                    (_%__kont1864218643%_ _%hd42494331%_)
                                    (_%__kont1864418645%_
                                     _%tl42504334%_
                                     _%hd42494331%_
                                     _%hd42424361%_))))
    ...
    (define |gerbil/core/sugar~Sugar-1[:0:]#cond|
      (lambda (_%$stx4375%_)
        (let* ((_%__stx1868318684%_ _%$stx4375%_)
               (_%g43844475%_
                (lambda ()
                  (gx#raise-syntax-error
                   '#f
                   '"Bad syntax; invalid match target"
                   _%__stx1868318684%_))))
          (let ((_%__kont1868618687%_ (lambda () '#!void))
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
            ...
            (let* ((_%__match1884418845%_
              ...
              (if (gx#stx-pair? _%__stx1868318684%_)
                  (let ((_%e43864853%_ (gx#syntax-e _%__stx1868318684%_)))
                    (let ((_%tl43884860%_
                                      ...
                                      (let ((_%e43964780%_
                                        ...
                                        (let ((_%tl43984787%_
                                          ...
                                          (if (gx#identifier? _%hd43974784%_)
                                              (if (gx#free-identifier=?
                                                   |gerbil/core/sugar~Sugar-1[1]#_g20710_|
                                                   _%hd43974784%_)
                                                  (if (gx#stx-pair/null?
                                                       _%tl43984787%_)
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                    ...
                    (let ((_%tl44444618%_
                      ...
                      (if (gx#identifier? _%hd44434615%_)
                          (if (gx#free-identifier=?
                               |gerbil/core/sugar~Sugar-1[1]#_g20711_|
                               _%hd44434615%_)
                  ...
                  (if (gx#stx-pair/null? _%tl43984787%_)
                      (let ((_%__splice1870018701%_
                        ...
                        (let ((_%tl44634515%_
                               (let ()
                                 (declare (not safe))
                                 (##vector-ref _%__splice1870018701%_ '1)))
                              (_%target44614512%_
                               (let ()
                                 (declare (not safe))
                                 (##vector-ref _%__splice1870018701%_ '0))))
                          (if (gx#stx-null? _%tl44634515%_)
                              (_%__match1884418845%_
                               _%e43864853%_
                               _%hd43874857%_
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                         (not safe))
                       (##fx= _g20713_ 2)))
                (error "Context expects 2 values" _g20713_)))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                         (not safe))
                       (##fx= _g20715_ 2)))
                (error "Context expects 2 values" _g20715_)))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                      ...
                                      (let ((_g20716_
                                        ...
                                        (begin
                                          ...
                                          (let ((_%target51545195%_
                                                 (let ()
                                                   (declare (not safe))
                                                   (##values-ref _g20716_ 0)))
                                                (_%tl51565198%_
                                                 (let ()
                                                   (declare (not safe))
                                                   (##values-ref _g20716_ 1))))
