                          ...
                          (lambda (_%$%hd20032063%_ _%$%clauses20092066%_)
                            (if (gx#stx-pair? _%$%hd20032063%_)
                                ...
                                (let ((_%$%clauses20102078%_
                                  ...
                                  (if (gx#identifier? _%$%hd19972037%_)
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                    ...
                    (if (gx#stx-pair? _%$%hd33003350%_)
                        ...
                        (let ((_%$%body33073365%_
                               (reverse _%$%body33063353%_)))
                          (cons (gx#datum->syntax '#f '~let)
                                (cons (gx#datum->syntax '#f 'let*-values)
                                      (cons _%$%hd32973334%_
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                    ...
                    (if (gx#stx-pair? _%$%hd34163466%_)
                        ...
                        (let ((_%$%body34233481%_
                               (reverse _%$%body34223469%_)))
                          (cons (gx#datum->syntax '#f '~let)
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                    ...
                    (if (gx#stx-pair? _%$%hd35323582%_)
                        ...
                        (let ((_%$%body35393597%_
                               (reverse _%$%body35383585%_)))
                          (cons (gx#datum->syntax '#f '~let)
                                (cons (gx#datum->syntax '#f 'letrec*-values)
                                      (cons _%$%hd35293566%_
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                     ...
                     (let ((_%$%hd-bind38723910%_
                            (reverse _%$%hd-bind38713898%_)))
                       (cons _%$%g36663826%_
                             (cons (begin
      ...
      (lambda (_%$stx4171%_)
        (let* ((_%__stx1874618747%_ _%$stx4171%_)
          ...
          (let ((_%__kont1874918750%_ (lambda () '#t))
                (_%__kont1875118752%_
                 (lambda (_%$%g41824275%_) _%$%g41824275%_))
        ...
        (let* ((_%__stx1879218793%_ _%$stx4313%_)
          ...
          (let ((_%__kont1879518796%_ (lambda () '#f))
                (_%__kont1879718798%_
                 (lambda (_%$%g43244417%_) _%$%g43244417%_))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                    ...
                    (if (gx#stx-pair? _%$%hd52355285%_)
                        ...
                        (let ((_%$%detail52425300%_
                          ...
                          (if (gx#stx-string? _%$%hd52325269%_)
                              (apply gx#raise-syntax-error
                                     '#f
                                     (gx#stx-e _%$%hd52325269%_)
                                     _%stx5221%_
                                     (gx#syntax->list
