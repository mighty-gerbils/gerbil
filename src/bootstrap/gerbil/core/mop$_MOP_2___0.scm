...
(begin
  (define gerbil/core/mop$<MOP:2>::timestamp 1710237309)
  (begin
               ...
               (_g2728127364_
                (lambda (_g2728327304_)
                  (if (gx#stx-pair? _g2728327304_)
                      (let ((_e2728727306_ (gx#syntax-e _g2728327304_)))
                        (let ((_hd2728627309_
                               (let ()
                                 (declare (not safe))
                                 (##car _e2728727306_)))
                              (_tl2728527311_
                               (let ()
                                 (declare (not safe))
                                 (##cdr _e2728727306_))))
                          (if (gx#stx-pair/null? _tl2728527311_)
                              (let ((_g31584_
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                    ...
                    (let ((__tmp31587
                      ...
                      (declare (not safe))
                      (_loop2729127319_ _lp-tl2729427332_ __tmp31587))))
