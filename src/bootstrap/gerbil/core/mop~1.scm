...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
               ...
               (_%class-opt?20986%_
                (lambda (_%key22312%_)
                  (let ((__tmp27131 (gx#stx-e _%key22312%_)))
                    (declare (not safe))
                    (##memq __tmp27131
                            '(struct:
                              slots:
                         ...
                         (let ((_g27134_
                           ...
                           (begin
                             ...
                             (let ((_%target2169521724%_
                                    (let ()
                                      (declare (not safe))
                                      (##values-ref _g27134_ 0)))
                                   (_%tl2169721727%_
                                    (let ()
                                      (declare (not safe))
                                      (##values-ref _g27134_ 1))))
                              ...
                              (let ((_g27136_
                                ...
                                (begin
                                  ...
                                  (let ((_%target2180121830%_
                                         (let ()
                                           (declare (not safe))
                                           (##values-ref _g27136_ 0)))
                                        (_%tl2180321833%_
                                         (let ()
                                           (declare (not safe))
                                           (##values-ref _g27136_ 1))))
