...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
               ...
               (_%class-opt?21065%_
                (lambda (_%key22381%_)
                  (let ((__tmp27521 (gx#stx-e _%key22381%_)))
                    (declare (not safe))
                    (##memq __tmp27521
                            '(struct:
                              slots:
                         ...
                         (let ((_g27524_
                           ...
                           (begin
                             ...
                             (let ((_%target2177221801%_
                                    (let ()
                                      (declare (not safe))
                                      (##values-ref _g27524_ 0)))
                                   (_%tl2177421804%_
                                    (let ()
                                      (declare (not safe))
                                      (##values-ref _g27524_ 1))))
                              ...
                              (let ((_g27526_
                                ...
                                (begin
                                  ...
                                  (let ((_%target2187421903%_
                                         (let ()
                                           (declare (not safe))
                                           (##values-ref _g27526_ 0)))
                                        (_%tl2187621906%_
                                         (let ()
                                           (declare (not safe))
                                           (##values-ref _g27526_ 1))))
