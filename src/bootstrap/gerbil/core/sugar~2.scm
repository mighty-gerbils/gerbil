                                      ...
                                      (let ((_g28168_
                                        ...
                                        (begin
                                          ...
                                          (let ((_target1880218843_
                                                 (let ()
                                                   (declare (not safe))
                                                   (##vector-ref _g28168_ 0)))
                                                (_tl1880418846_
                                                 (let ()
                                                   (declare (not safe))
                                                   (##vector-ref _g28168_ 1))))
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                    ...
                                                    (foldr1 __tmp28173
                                                            ...
                                                            _L18873_))))
                                             (declare (not safe))
                                             (cons _L18875_ __tmp28172))))
                                      (declare (not safe))
                                      (cons '0 __tmp28171))))
                               (declare (not safe))
                               (cons __tmp28174 __tmp28170)))
                           _K1881018869_
                           _hd1880018837_))))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                  (_loop1880518849_
        ...
        (let* ((___stx2591125912_ _stx18906_)
          ...
          (let ((___kont2591425915_
                 (lambda (_L19486_ _L19488_)
                   (let ((__tmp28176 (gx#datum->syntax '#f 'quote))
                         (__tmp28175
                          (let () (declare (not safe)) (cons '#!void '()))))
                     (declare (not safe))
                     (cons __tmp28176 __tmp28175))))
                (___kont2591625917_
                   ...
                   (let* ((_g1935019358_
                          ...
                          (_g1934919377_
                           (lambda (_g1935119362_)
                             ((lambda (_L19365_)
                                (let ()
                                  (let ((__tmp28184 (gx#datum->syntax '#f 'if))
                                        (__tmp28177
                                         (let ((__tmp28180
                                                (let ((__tmp28183
                                                       (gx#datum->syntax
                                               ...
                                               (__tmp28178
                                                (let ((__tmp28179
                                                       (let ()
                                                         ...
                                                         (cons _L19325_ '()))))
                                                  (declare (not safe))
                                                  (cons _L19327_ __tmp28179))))
                                           (declare (not safe))
                                           (cons __tmp28180 __tmp28178))))
                                    (declare (not safe))
                                    (cons __tmp28184 __tmp28177))))
                              _g1935119362_))))
                                                    ...
                                                    (let ()
                                                      (let ((__tmp28201
                                                            ...
                                                            (__tmp28185
                                                             (let ((__tmp28197
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                            (let ((__tmp28200 (gx#datum->syntax '#f '##fx=))
                                  (__tmp28198
                                   (let ((__tmp28199
                                          (let ()
                                            (declare (not safe))
                                            (cons _L19248_ '()))))
                                     (declare (not safe))
                                     (cons _L19179_ __tmp28199))))
                              (declare (not safe))
                              (cons __tmp28200 __tmp28198)))
                           (__tmp28186
                            (let ((__tmp28187
                                   (let ((__tmp28188
                                          (let ((__tmp28196
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                              (let ()
                                ...
                                (cons _L19246_ '()))))
                         (declare (not safe))
                         (cons _L19179_ __tmp28194))))
                  (declare (not safe))
                  (cons __tmp28195 __tmp28193)))
               (__tmp28190
                (let ((__tmp28191
                       (let () (declare (not safe)) (cons _L19175_ '()))))
                  (declare (not safe))
                  (cons _L19177_ __tmp28191))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                   (declare (not safe))
                                                   (cons __tmp28192
                                                         __tmp28190))))
                                            (declare (not safe))
                                            (cons __tmp28196 __tmp28189))))
                                     (declare (not safe))
                                     (cons __tmp28188 '()))))
                              (declare (not safe))
                              (cons _L19178_ __tmp28187))))
                       (declare (not safe))
                       (cons __tmp28197 __tmp28186))))
                (declare (not safe))
                (cons __tmp28201 __tmp28185))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                  _hd1921219240_
                                                  _hd1920919230_)
                                                 (_g1920419219_
                     ...
                     (_g1920319264_
                      (list (gx#stx-e _L19180_)
                            (let ((__tmp28202 (gx#stx-e _L19180_)))
                              (declare (not safe))
                              (fx+ __tmp28202 '1)))))))
                (___kont2592225923_
                                               ...
                                               (lambda (_g1909919102_
                                                 ...
                                                 (let ()
                                                   ...
                                                   (cons _g1909919102_
                                                         _g1910019105_)))))
                                          (declare (not safe))
                                          (foldr1 __tmp28206 '() _L19076_))))
                                   (declare (not safe))
                                   (cons _L19078_ __tmp28205))))
                            (declare (not safe))
                            (cons _L19079_ __tmp28204))))
                     (declare (not safe))
                     (cons __tmp28207 __tmp28203)))))
                    ...
                    (let _lp19876_ ((_i19879_ '0)
                      ...
                      (if (fx< _i19879_ _mid19874_)
                          (_lp19876_
                           ...
                           (cdr _rest19881_)
                           (let ((__tmp28208 (car _rest19881_)))
                             (declare (not safe))
                             (cons __tmp28208 _left19882_)))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                          _g28209_)
                         (##vector-length _g28209_)
                         1))))
              (if (not (let () (declare (not safe)) (##fx= _g28210_ 2)))
                  (error "Context expects 2 values" _g28210_)))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                     ...
                                     (let ((_g28215_
                                       ...
                                       (begin
                                         ...
                                         (let ((_target1967419730_
                                                (let ()
                                                  (declare (not safe))
                                                  (##vector-ref _g28215_ 0)))
                                               (_tl1967619733_
                                                (let ()
                                                  (declare (not safe))
                                                  (##vector-ref _g28215_ 1))))
                                     ...
                                     (let ((_g28217_
                                       ...
                                       (begin
                                         ...
                                         (let ((_target1968619770_
                                                (let ()
                                                  (declare (not safe))
                                                  (##vector-ref _g28217_ 0)))
                                               (_tl1968819773_
                                                (let ()
                                                  (declare (not safe))
                                                  (##vector-ref _g28217_ 1))))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                              (let ()
                                ...
                                (cons _L19810_ '()))))
                         (declare (not safe))
                         (cons _L19611_ __tmp28236))))
                  (declare (not safe))
                  (cons __tmp28237 __tmp28235)))
               (__tmp28220
                (let ((__tmp28228
                       (let ((__tmp28233
                              (gx#datum->syntax '#f '~case-dispatch*))
                                     ...
                                     (let ((__tmp28231
                                            (let ((__tmp28232
                                              ...
                                              (foldr1 __tmp28232
                                                      ...
                                                      _L19813_))))
                                       (declare (not safe))
                                       (cons _L19611_ __tmp28231))))
                                (declare (not safe))
                                (cons _L19612_ __tmp28230))))
                         (declare (not safe))
                         (cons __tmp28233 __tmp28229)))
                      (__tmp28221
                       (let ((__tmp28222
                              (let ((__tmp28227
                                     (gx#datum->syntax '#f '~case-dispatch*))
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                     ...
                                                     (foldr1 __tmp28226
                                                             ...
                                                             _L19812_))))
                                              (declare (not safe))
                                              (cons _L19611_ __tmp28225))))
                                       (declare (not safe))
                                       (cons _L19810_ __tmp28224))))
                                (declare (not safe))
                                (cons __tmp28227 __tmp28223))))
                         (declare (not safe))
                         (cons __tmp28222 '()))))
                  (declare (not safe))
                  (cons __tmp28228 __tmp28221))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                   (declare (not safe))
                                                   (cons __tmp28234
                                                         __tmp28220))))
                                            (declare (not safe))
                                            (cons __tmp28238 __tmp28219))))
                                      _hd1969619804_
                                      _K-right1969419796_
                                      _K-left1968219756_
                                      _hd1966919714_)
                                      ...
                                      (let ((_g28239_
                                        ...
                                        (begin
                                          ...
                                          (let ((_target1990619990_
                                                 (let ()
                                                   (declare (not safe))
                                                   (##vector-ref _g28239_ 0)))
                                                (_tl1990819993_
                                                 (let ()
                                                   (declare (not safe))
                                                   (##vector-ref _g28239_ 1))))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                          _g28279_)
                         (##vector-length _g28279_)
                         1))))
              (if (not (let () (declare (not safe)) (##fx= _g28280_ 2)))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                         (not safe))
                       (##fx= _g28242_ 2)))
                (error "Context expects 2 values" _g28242_)))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                      ...
                                      (let ((_g28243_
                                        ...
                                        (begin
                                          ...
                                          (let ((_target1994920128_
                                                 (let ()
                                                   (declare (not safe))
                                                   (##vector-ref _g28243_ 0)))
                                                (_tl1995120131_
                                                 (let ()
                                                   (declare (not safe))
                                                   (##vector-ref _g28243_ 1))))
                                         ...
                                         (lambda (_g2019720200_ _g2019820203_)
                                           (let ()
                                             ...
                                             (cons _g2019720200_
                                                   _g2019820203_)))))
                                    (declare (not safe))
                                    (foldr1 __tmp28278 '() _L20164_)))
                                 (let ((__tmp28277 (gx#datum->syntax '#f 'let))
                                       (__tmp28245
                                        (let ((__tmp28276
                         ...
                         (let ((__tmp28274
                                (let ((__tmp28275
                                       (let ()
                                         ...
                                         (cons _g2021420218_ '()))))
                                  (declare (not safe))
                                  (cons _g2021520221_ __tmp28275))))
                           (declare (not safe))
                           (cons __tmp28274 _g2021620223_)))))
                  (declare (not safe))
                  (foldr2 __tmp28273 '() _L20163_ _L20164_))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                     (__tmp28247
                                                      (let ((__tmp28248
                                                             (let ((__tmp28271
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                  ...
                  (declare (not safe))
                  (foldr1 __tmp28269 '() _L20160_))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                   (declare (not safe))
                                                   (cons '#!void __tmp28268))))
                                            (declare (not safe))
                                            (cons __tmp28270 __tmp28267)))
                                         (__tmp28251
                                          (let ((__tmp28252
                                                 (let ((__tmp28265
                                                        (gx#datum->syntax
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                      ...
                      (__tmp28254
                       (let ((__tmp28255
                              (let ((__tmp28263 (gx#datum->syntax '#f '$loop))
                                    (__tmp28256
                                     (begin
                                       (gx#syntax-check-splice-targets
                                        _L20162_
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                             (let ((__tmp28261
                               ...
                               (declare (not safe))
                               (foldr1 __tmp28261 '() _g2020720238_))))
                        (declare (not safe))
                        (cons _g2020820241_ __tmp28260))))
                 (declare (not safe))
                 (cons __tmp28262 __tmp28259))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                  (declare (not safe))
                                                  (cons __tmp28258
                                                        _g2020920243_)))))
                                         ...
                                         (foldr2 __tmp28257
                                                 ...
                                                 _L20164_)))))
                                (declare (not safe))
                                (cons __tmp28263 __tmp28256))))
                         (declare (not safe))
                         (cons __tmp28255 '()))))
                  (declare (not safe))
                  (foldr1 __tmp28264 __tmp28254 _L20158_))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                   (declare (not safe))
                                                   (cons __tmp28265
                                                         __tmp28253))))
                                            ...
                                            (cons __tmp28252 '()))))
                                     (declare (not safe))
                                     (cons __tmp28266 __tmp28251))))
                              (declare (not safe))
                              (cons _L20161_ __tmp28250))))
                       (declare (not safe))
                       (cons __tmp28271 __tmp28249))))
                (declare (not safe))
                (cons __tmp28248 '()))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                 (declare (not safe))
                                                 (cons __tmp28272
                                                       __tmp28247))))
                                          (declare (not safe))
                                          (cons __tmp28276 __tmp28246))))
                                   (declare (not safe))
                                   (cons __tmp28277 __tmp28245))
                                 (_g1989219963_ _g1989319967_)))
                           _body1995720154_
                           _fini1994820124_
                           _hd1993820092_
                                         ...
                                         (let ((__tmp28286
                                               ...
                                               (__tmp28285
                                                (let ()
                                                  ...
                                                  (cons _L20337_ '()))))
                                           (declare (not safe))
                                           (cons __tmp28286 __tmp28285))))
                                    (declare (not safe))
                                    (cons __tmp28284 _L20336_))))
                             (declare (not safe))
                             (cons __tmp28283 _L20334_))))
                      (declare (not safe))
                      (cons _L20338_ __tmp28282))))
               (declare (not safe))
               (cons __tmp28287 __tmp28281)))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                   _tl2027620321_
                                                   _tl2027920331_
                                                   _hd2028020328_
          ...
          (let ((___kont2607426075_ (lambda (_L20510_) _L20510_))
                (___kont2607626077_
                 (lambda (_L20455_ _L20457_)
                   (let ((__tmp28302 (gx#datum->syntax '#f 'let))
                         (__tmp28288
                          (let ((__tmp28299
                                 (let ((__tmp28301 (gx#datum->syntax '#f '$r))
                                       (__tmp28300
                                        (let ()
                                          (declare (not safe))
                                          (cons _L20457_ '()))))
                                   (declare (not safe))
                                   (cons __tmp28301 __tmp28300)))
                                (__tmp28289
                                 (let ((__tmp28292
                                        (let ((__tmp28298
                                               (gx#datum->syntax
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                       ...
                       (declare (not safe))
                       (foldr1 __tmp28296 '() _L20455_))))
                (declare (not safe))
                (cons __tmp28297 __tmp28295))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                 (declare (not safe))
                                                 (cons __tmp28294 '()))))
                                          (declare (not safe))
                                          (cons __tmp28298 __tmp28293)))
                                       (__tmp28290
                                        (let ((__tmp28291
                                               (gx#datum->syntax '#f '$r)))
                                          (declare (not safe))
                                          (cons __tmp28291 '()))))
                                   (declare (not safe))
                                   (cons __tmp28292 __tmp28290))))
                            (declare (not safe))
                            (cons __tmp28299 __tmp28289))))
                     (declare (not safe))
                     (cons __tmp28302 __tmp28288)))))
        ...
        (let* ((___stx2611726118_ _$stx20528_)
          ...
          (let ((___kont2612026121_
                 (lambda (_L20789_ _L20791_)
                   (let ((__tmp28308 (gx#datum->syntax '#f 'letrec))
                         (__tmp28303
                          (let ((__tmp28305
                                 (let ((__tmp28306
                                        (let ((__tmp28307
                                ...
                                (__tmp28304
                                 (let ()
                                   ...
                                   (cons _L20791_ '()))))
                            (declare (not safe))
                            (cons __tmp28305 __tmp28304))))
                     (declare (not safe))
                     (cons __tmp28308 __tmp28303))))
                (___kont2612226123_
                 (lambda (_L20733_ _L20735_)
                   (let ((__tmp28316 (gx#datum->syntax '#f 'letrec-values))
                         (__tmp28309
                          (let ((__tmp28313
                                 (let ((__tmp28314
                                        (let ((__tmp28315
                                ...
                                (__tmp28310
                                 (let ((__tmp28311
                                        (let ((__tmp28312
                                          ...
                                          (declare (not safe))
                                          (cons __tmp28312 _L20735_))))
                                   (declare (not safe))
                                   (cons __tmp28311 '()))))
                            (declare (not safe))
                            (cons __tmp28313 __tmp28310))))
                     (declare (not safe))
                     (cons __tmp28316 __tmp28309))))
                (___kont2612426125_
                 (lambda (_L20654_ _L20656_ _L20657_)
                   (let ((__tmp28327 (gx#datum->syntax '#f 'letrec))
                         (__tmp28317
                          (let ((__tmp28319
                                 (let ((__tmp28320
                                        (let ((__tmp28321
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                            (let ((__tmp28325
                              ...
                              (declare (not safe))
                              (foldr1 __tmp28325 '() _L20654_))))
                       (declare (not safe))
                       (cons _L20656_ __tmp28324))))
                (declare (not safe))
                (cons __tmp28326 __tmp28323))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                 (declare (not safe))
                                                 (cons __tmp28322 '()))))
                                          (declare (not safe))
                                          (cons _L20657_ __tmp28321))))
                                   (declare (not safe))
                                   (cons __tmp28320 '())))
                                (__tmp28318
                                 (let ()
                                   ...
                                   (cons _L20657_ '()))))
                            (declare (not safe))
                            (cons __tmp28319 __tmp28318))))
                     (declare (not safe))
                     (cons __tmp28327 __tmp28317)))))
