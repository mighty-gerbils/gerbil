                              ...
                              (let ((__tmp25592
                                     (let ((__tmp25593
                                            (foldr (lambda (_g1721817221_
                                                   ...
                                                   _L17182_)))
                                       (declare (not safe))
                                       (cons _L16980_ __tmp25593))))
                                (declare (not safe))
                                (cons _L16981_ __tmp25592))))
                         (declare (not safe))
                         (cons __tmp25594 __tmp25591)))
                      (__tmp25584
                       (let ((__tmp25585
                              (let ((__tmp25589
                                     (gx#datum->syntax '#f '~case-dispatch*))
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                              (declare (not safe))
                                              (cons _L16980_ __tmp25588))))
                                       (declare (not safe))
                                       (cons _L17179_ __tmp25587))))
                                (declare (not safe))
                                (cons __tmp25589 __tmp25586))))
                         (declare (not safe))
                         (cons __tmp25585 '()))))
                  (declare (not safe))
                  (cons __tmp25590 __tmp25584))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                   (declare (not safe))
                                                   (cons __tmp25595
                                                         __tmp25583))))
                                            (declare (not safe))
                                            (cons __tmp25599 __tmp25582))))
                                      _hd1706517173_
                                      _K-right1706317165_
                                      _K-left1705117125_
                                      _hd1703817083_)
                                      ...
                                      (let ((_g25600_
                                        ...
                                        (begin
                                          ...
                                          (let ((_target1727517359_
                                                 (let ()
                                                   (declare (not safe))
                                                   (##vector-ref _g25600_ 0)))
                                                (_tl1727717362_
                                                 (let ()
                                                   (declare (not safe))
                                                   (##vector-ref _g25600_ 1))))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                          _g25633_)
                         (##vector-length _g25633_)
                         1))))
              (if (not (let () (declare (not safe)) (##fx= _g25634_ 2)))
                  (error "Context expects 2 values" _g25634_)))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                         (not safe))
                       (##fx= _g25603_ 2)))
                (error "Context expects 2 values" _g25603_)))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                      ...
                                      (let ((_g25604_
                                        ...
                                        (begin
                                          ...
                                          (let ((_target1731817497_
                                                 (let ()
                                                   (declare (not safe))
                                                   (##vector-ref _g25604_ 0)))
                                                (_tl1732017500_
                                                 (let ()
                                                   (declare (not safe))
                                                   (##vector-ref _g25604_ 1))))
                          ...
                          ((lambda (_L17527_
                             ...
                             (if (gx#stx-andmap
                                  ...
                                  (foldr (lambda (_g1756617569_ _g1756717572_)
                                         ...
                                         '()
                                         _L17533_))
                                 (let ((__tmp25632 (gx#datum->syntax '#f 'let))
                                       (__tmp25606
                                        (let ((__tmp25631
                         ...
                         (let ((__tmp25629
                                (let ((__tmp25630
                                       (let ()
                                         ...
                                         (cons _g1758317587_ '()))))
                                  (declare (not safe))
                                  (cons _g1758417590_ __tmp25630))))
                           (declare (not safe))
                           (cons __tmp25629 _g1758517592_)))
                       '()
                       _L17532_
                       _L17533_)))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                   (declare (not safe))
                                                   (cons '#!void __tmp25625))))
                                            (declare (not safe))
                                            (cons __tmp25626 __tmp25624)))
                                         (__tmp25612
                                          (let ((__tmp25613
                                                 (let ((__tmp25622
                                                        (gx#datum->syntax
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                       ...
                       (let ((__tmp25615
                              (let ((__tmp25621 (gx#datum->syntax '#f '$loop))
                                    (__tmp25616
                                     (begin
                                       (gx#syntax-check-splice-targets
                                        _L17531_
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                             (foldr (lambda (_g1757917615_ _g1758017618_)
                                    ...
                                    _g1757617607_)))
                        (declare (not safe))
                        (cons _g1757717610_ __tmp25619))))
                 (declare (not safe))
                 (cons __tmp25620 __tmp25618))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                  (declare (not safe))
                                                  (cons __tmp25617
                                                        _g1757817612_)))
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                            ...
                                            (cons __tmp25613 '()))))
                                     (declare (not safe))
                                     (cons __tmp25623 __tmp25612))))
                              (declare (not safe))
                              (cons _L17530_ __tmp25611))))
                       (declare (not safe))
                       (cons __tmp25627 __tmp25610))))
                (declare (not safe))
                (cons __tmp25609 '()))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                 (declare (not safe))
                                                 (cons __tmp25628
                                                       __tmp25608))))
                                          (declare (not safe))
                                          (cons __tmp25631 __tmp25607))))
                                   (declare (not safe))
                                   (cons __tmp25632 __tmp25606))
                                 (_g1726117332_ _g1726217336_)))
                           _body1732617523_
                           _fini1731717493_
                           _hd1730717461_
                                         ...
                                         (let ((__tmp25640
                                               ...
                                               (__tmp25639
                                                (let ()
                                                  ...
                                                  (cons _L17706_ '()))))
                                           (declare (not safe))
                                           (cons __tmp25640 __tmp25639))))
                                    (declare (not safe))
                                    (cons __tmp25638 _L17705_))))
                             (declare (not safe))
                             (cons __tmp25637 _L17703_))))
                      (declare (not safe))
                      (cons _L17707_ __tmp25636))))
               (declare (not safe))
               (cons __tmp25641 __tmp25635)))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                   _tl1764517690_
                                                   _tl1764817700_
                                                   _hd1764917697_
          ...
          (let ((___kont2344323444_ (lambda (_L17879_) _L17879_))
                (___kont2344523446_
                 (lambda (_L17824_ _L17826_)
                   (let ((__tmp25655 (gx#datum->syntax '#f 'let))
                         (__tmp25642
                          (let ((__tmp25652
                                 (let ((__tmp25654 (gx#datum->syntax '#f '$r))
                                       (__tmp25653
                                        (let ()
                                          (declare (not safe))
                                          (cons _L17826_ '()))))
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                       ...
                                       (__tmp25644
                                        (let ((__tmp25645
                                          ...
                                          (cons __tmp25645 '()))))
                                   (declare (not safe))
                                   (cons __tmp25646 __tmp25644))))
                            (declare (not safe))
                            (cons __tmp25652 __tmp25643))))
                     (declare (not safe))
                     (cons __tmp25655 __tmp25642)))))
        ...
        (let* ((___stx2348623487_ _$stx17897_)
          ...
          (let ((___kont2348923490_
                 (lambda (_L18158_ _L18160_)
                   (let ((__tmp25661 (gx#datum->syntax '#f 'letrec))
                         (__tmp25656
                          (let ((__tmp25658
                                 (let ((__tmp25659
                                        (let ((__tmp25660
                     ...
                     (declare (not safe))
                     (cons __tmp25661 __tmp25656))))
                (___kont2349123492_
                 (lambda (_L18102_ _L18104_)
                   (let ((__tmp25669 (gx#datum->syntax '#f 'letrec-values))
                         (__tmp25662
                          (let ((__tmp25666
                                 (let ((__tmp25667
                                        (let ((__tmp25668
                                ...
                                (__tmp25663
                                 (let ((__tmp25664
                                        (let ((__tmp25665
                                          ...
                                          (declare (not safe))
                                          (cons __tmp25665 _L18104_))))
                                   (declare (not safe))
                                   (cons __tmp25664 '()))))
                            (declare (not safe))
                            (cons __tmp25666 __tmp25663))))
                     (declare (not safe))
                     (cons __tmp25669 __tmp25662))))
                (___kont2349323494_
                 (lambda (_L18023_ _L18025_ _L18026_)
                   (let ((__tmp25679 (gx#datum->syntax '#f 'letrec))
                         (__tmp25670
                          (let ((__tmp25672
                                 (let ((__tmp25673
                                        (let ((__tmp25674
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                ...
                                (__tmp25671
                                 (let ()
                                   ...
                                   (cons _L18026_ '()))))
                            (declare (not safe))
                            (cons __tmp25672 __tmp25671))))
                     (declare (not safe))
                     (cons __tmp25679 __tmp25670)))))
                               ...
                               (let ((__tmp25710
                                      (let ((__tmp25711
                                             (let ()
                                               ...
                                               (cons _g1863518656_ '()))))
                                        (declare (not safe))
                                        (cons _g1863618659_ __tmp25711))))
                                 (declare (not safe))
                                 (cons __tmp25710 _g1863718661_)))
                             '()
                             _L18542_
                             _L18613_)))
                   (__tmp25708
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                         ...
                         (cons '() '()))))
                  (declare (not safe))
                  (cons __tmp25775 __tmp25774)))
               (__tmp25772 (let () (declare (not safe)) (cons _L20465_ '()))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                   (declare (not safe))
                                                   (cons __tmp25773
                                                         __tmp25772))))
                                            (declare (not safe))
                                            (cons __tmp25776 __tmp25771))))
                                     (declare (not safe))
                                     (cons __tmp25777 __tmp25770))
                                   (let* ((_g2047820486_
                            ...
                            ((lambda (_L21040_)
                               (if (and (gx#stx-list? _L21040_)
                                        (let ((__tmp25818
                                          ...
                                          (declare (not safe))
                                          (not __tmp25818)))
                                   (let ((_g25808_ (_generate21009_ _L21040_)))
                                     (begin
                                       (let ((_g25809_
                                              (let ()
                                                (declare (not safe))
                                                (if (##values? _g25808_)
                                                    (##vector-length _g25808_)
                                                    1))))
                                         (if (not (let ()
                                                    (declare (not safe))
                                                    (##fx= _g25809_ 3)))
                                       ...
                                       (let ((_hd21053_
                                              (let ()
                                                (declare (not safe))
                                                (##vector-ref _g25808_ 0)))
                                             (_body21055_
                                              (let ()
                                                (declare (not safe))
                                                (##vector-ref _g25808_ 1)))
                                             (_tail?21056_
                                              (let ()
                                                (declare (not safe))
                                                (##vector-ref _g25808_ 2))))
                                         (let* ((_g2105821066_
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                         (gx#datum->syntax '#f 'apply)))
                    (declare (not safe))
                    (cons __tmp25816 _L21101_))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                     (declare (not safe))
                                                     (cons __tmp25815 '()))))
                                              (declare (not safe))
                                              (cons _L21073_ __tmp25814))))
                                       (declare (not safe))
                                       (cons __tmp25817 __tmp25813))
                                     (let ((__tmp25812
                                            (gx#datum->syntax '#f 'lambda%))
                                           (__tmp25810
                                            (let ((__tmp25811
                                                   (let ()
                                                     ...
                                                     (cons _L21101_ '()))))
                                              (declare (not safe))
                                              (cons _L21073_ __tmp25811))))
                                       (declare (not safe))
                                       (cons __tmp25812 __tmp25810))))))
                           _g2108721098_))))
