...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                     ...
                     (let ((_%hd77237741%_
                       ...
                       ((lambda (_%g77207747%_ _%g77217749%_)
                          (let* ((_%__stx1925419255%_ _%g77217749%_)
                                 (_%g77627776%_
                                  (lambda ()
                                    (gx#raise-syntax-error
                                     '#f
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                             2)))
               (error "Context expects 2 values" _g20968_)))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                    ...
                    (if (gx#stx-pair? _%hd94189468%_)
                        ...
                        (let ((_%clauses94259483%_
                          ...
                          ((lambda (_%g94099486%_ _%g94109488%_)
                             (if (gx#identifier? _%g94109488%_)
                                 (cons (gx#datum->syntax '#f 'define-values)
                                       (cons (cons _%g94109488%_ '())
                                             (cons (cons (gx#datum->syntax
                                                          '#f
                                                          'case-lambda)
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                    ...
                    (if (gx#stx-pair? _%hd96159665%_)
                        ...
                        (let ((_%clause96229680%_
                          ...
                          ((lambda (_%g96069683%_ _%g96079685%_)
                                                ...
                                                (let* ((_%g1254012548%_
                                                       ...
                                                       (_%g1253912575%_
                                                        (lambda (_%g1254112552%_)
                                                          ((lambda (_%g1254212555%_)
                                                             (_%lp12180%_
                                                              _%g1219212234%_
                                                              (cons (map gx#stx-e
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                                 (foldr (lambda (_%g1256612569%_
                                                 _%g1256712572%_)
                                          (cons _%g1256612569%_
                                                _%g1256712572%_))
                                        '()
                                        _%g1228012513%_))
                            _%datums12185%_)
                      (cons (cons _%g1227912511%_ (cons _%g1254212555%_ '()))
                            _%dispatch12186%_)
                      _%default12187%_))
                   _%g1254112552%_))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                      ...
                      (let ((_%hd1203312051%_
                            ...
                            (_%tl1203412054%_
                             (let ()
                               (declare (not safe))
                               (##cdr _%e1203212047%_))))
                        ((lambda (_%g1203012057%_ _%g1203112059%_)
                           (let* ((_%g1207112079%_
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                           ...
                           (cons (cons (gx#datum->syntax '#f '~case-test)
                                       (cons _%g1209712100%_
                                             (cons _%g1189611909%_ '())))
                                 _%g1209812103%_))
                         '()
                         _%g1193212008%_))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                    (cons _%g1203112059%_
                                                          (cons _%g1207312086%_
                                                                '())))))
                                      _%g1207212083%_))))
                             (_%g1207012106%_
                              (_%recur11921%_
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                           _%datum1194311991%_)
                    (if (gx#stx-pair? _%hd1193711988%_)
                        (let ((_%e1194011993%_ (gx#syntax-e _%hd1193711988%_)))
                        ...
                        (let ((_%datum1194412003%_
                               (reverse _%datum1194311991%_)))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                          (not safe))
                        (##vector-ref _%__splice1964319644%_ '1)))
                     (_%target1193611978%_
                      (let ()
                        (declare (not safe))
                        (##vector-ref _%__splice1964319644%_ '0))))
                 (if (gx#stx-null? _%tl1193811981%_)
                      ...
                      (let ((_%hd1136811456%_
                        ...
                        (if (gx#stx-null? _%tl1136911459%_)
                            ((lambda (_%g1133911462%_
                                      ...
                                      _%g1134511469%_)
                               (cons (gx#datum->syntax '#f 'let)
                                     (cons (cons (cons _%g1134411468%_
                                                       (cons (cons (gx#datum->syntax
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                            '#f
                            'lambda)
                           (cons '() (cons _%g1134111465%_ '())))
                     '()))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                 (cons (cons _%g1134311467%_
                                                             (cons (cons (gx#datum->syntax
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                                  '#f
                                  'quote)
                                 (cons _%g1134011464%_ '()))
                           '()))
               '()))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                           (cons (cons (gx#datum->syntax
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                              ...
                              'q)
                             (cons _%g1134511469%_ '())))
                 (cons _%g1134211466%_ (cons (cons _%g1134411468%_ '()) '()))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                             '())))
                                            ...
                                            (if (gx#stx-null? _%tl1154811656%_)
                                                ((lambda (_%g1151211659%_
                                                   ...
                                                   (cons (gx#datum->syntax
                                                          '#f
                                                          'let)
                                                         (cons (cons (cons _%g1151711665%_
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                                   (cons (cons (gx#datum->syntax '#f 'lambda)
                                               (cons '()
                                                     (cons _%g1151411662%_
                                                           '())))
                                         '()))
                             (cons (cons _%g1151611664%_
                                         (cons (cons (gx#datum->syntax
                                                      '#f
                                                      'quote)
                                                     (cons _%g1151311661%_
                                                           '()))
                                               '()))
                                   '()))
                       (cons (cons (gx#datum->syntax '#f 'if)
                                   (cons (cons (gx#datum->syntax '#f 'symbol?)
                                               (cons _%g1151811666%_ '()))
                                         (cons (cons (gx#datum->syntax
                                                      '#f
                                                      'let*)
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                           _%g1170011705%_)
                    (cons _%g1169911702%_ _%g1170011705%_))
                  '()
                  _%g1151511663%_)))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                       '())))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                                  ...
                                  '##fx>=)
                                 (cons (gx#datum->syntax '#f 'ix)
                                       (cons _%g1089811008%_ '())))
                           (cons (cons (gx#datum->syntax '#f '##fx<)
                                       (cons (gx#datum->syntax '#f 'ix)
                                             (cons _%g1089711006%_ '())))
                                 '())))
               (cons _%g1090011010%_ (cons (cons _%g1090111011%_ '()) '()))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                           '())))
                         (cons (cons _%g1090111011%_ '()) '()))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                ...
                                                (if (gx#stx-null?
                                                    ...
                                                    ((lambda (_%g1105211199%_
                                                       ...
                                                       (cons (gx#datum->syntax
                                                              '#f
                                                              'let)
                                                             (cons (cons (cons _%g1105711205%_
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                                       (cons (cons (gx#datum->syntax
                                                    '#f
                                                    'lambda)
                                                   (cons '()
                                                         (cons _%g1105411202%_
                                                               '())))
                                             '()))
                                 (cons (cons _%g1105611204%_
                                             (cons (cons (gx#datum->syntax
                                                          '#f
                                                          'quote)
                                                         (cons _%g1105311201%_
                                                               '()))
                                                   '()))
                                       '()))
                           (cons (cons (gx#datum->syntax '#f 'if)
                                    ...
                                    (let ((_%hd1070810814%_
                                      ...
                                      (if (gx#stx-null? _%tl1070910817%_)
                                          ((lambda (_%g1067310820%_
                                                    ...
                                                    _%g1067910827%_)
                                             (cons (gx#datum->syntax '#f 'let)
                                                   (cons (cons (cons _%g1067810826%_
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                             (cons (cons (gx#datum->syntax '#f 'lambda)
                                         (cons '() (cons _%g1067510823%_ '())))
                                   '()))
                       (cons (cons _%g1067710825%_
                                   (cons (cons (gx#datum->syntax '#f 'quote)
                                               (cons _%g1067410822%_ '()))
                                         '()))
                             '()))
                 (cons (cons (gx#datum->syntax '#f 'if)
                             (cons (cons (gx#datum->syntax '#f 'char?)
                                         (cons _%g1067910827%_ '()))
                                   (cons (cons (gx#datum->syntax '#f 'let*)
                                               (cons (cons (cons (gx#datum->syntax
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                          '#f
                   ...
                   (cons (cons (gx#datum->syntax '#f 'ix)
                               (cons (cons (gx#datum->syntax '#f '##fxmodulo)
                                           (cons (gx#datum->syntax '#f 'h)
                                                 (cons _%g1067310820%_ '())))
                                     '()))
                         (cons (cons (gx#datum->syntax '#f 'q)
                                     (cons (cons (gx#datum->syntax
                                                  '#f
                                                  '##vector-ref)
                                                 (cons _%g1067710825%_
                                                       (cons (gx#datum->syntax
                                                              '#f
                                                              'ix)
                                                             '())))
                                                 ...
                                                 (let* ((_%g1057310581%_
                                                        ...
                                                        (_%g1057210601%_
                                                         (lambda (_%g1057410585%_)
                                                           ((lambda (_%g1057510588%_)
                                                              (cons (gx#datum->syntax
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                             '#f
                             'let)
                            (cons (cons (cons _%g1038510533%_
                                              (cons (cons (gx#datum->syntax
                                                           '#f
                                                           'lambda)
                                                          (cons '()
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                    '()))
                                        (cons (cons _%g1038410532%_
                                                    (cons (cons (gx#datum->syntax
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                         '#f
                         'quote)
                        (cons _%g1038110529%_ '()))
                  '()))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                              '()))
                                  (cons (cons (gx#datum->syntax '#f 'if)
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                           '#f
                           '##vector-ref)
                          (cons _%g1038410532%_ (cons _%g1038610534%_ '())))
                    '()))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                (cons _%g1057510588%_ '())))
                                    ...
                                    (let ((_%hd1019210298%_
                                      ...
                                      (if (gx#stx-null? _%tl1019310301%_)
                                          ((lambda (_%g1015710304%_
                                                    ...
                                                    _%g1016310311%_)
                                             (cons (gx#datum->syntax '#f 'let)
                                                   (cons (cons (cons _%g1016210310%_
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                             (cons (cons (gx#datum->syntax '#f 'lambda)
                                         (cons '() (cons _%g1015910307%_ '())))
                                   '()))
                       (cons (cons _%g1016110309%_
                                   (cons (cons (gx#datum->syntax '#f 'quote)
                                               (cons _%g1015810306%_ '()))
                                         '()))
                             '()))
                 (cons (cons (gx#datum->syntax '#f 'if)
                             (cons (cons (gx#datum->syntax '#f 'fixnum?)
                                         (cons _%g1016310311%_ '()))
                                   (cons (cons (gx#datum->syntax '#f 'let*)
                                               (cons (cons (cons (gx#datum->syntax
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                          '#f
                         ...
                         (cons (cons (gx#datum->syntax '#f '##fxmodulo)
                                     (cons _%g1016310311%_
                                           (cons _%g1015710304%_ '())))
                               '()))
                   (cons (cons (gx#datum->syntax '#f 'q)
                               (cons (cons (gx#datum->syntax '#f '##vector-ref)
                                           (cons _%g1016110309%_
                                                 (cons (gx#datum->syntax
                                                        '#f
                                                        'ix)
                                                       '())))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                         _%g1012910134%_)
                  (cons _%g1012810131%_ _%g1012910134%_))
                '()
                _%g990510081%_)))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                     '())))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                      ...
                      (if (gx#stx-pair? _%hd97569806%_)
                          ...
                          (let ((_%clause97639821%_
                            ...
                            ((lambda (_%g97479824%_ _%g97489826%_)
                               (let ((_g21014_
                                      (_%parse-clauses9719%_
                                       _%g97489826%_
                                       (foldr (lambda (_%g98449847%_
                                                       _%g98459850%_)
                                                (cons _%g98449847%_
                                                      _%g98459850%_))
                                              '()
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                                  '#f
                                  'quote)
                                 (cons _%g1275912813%_ '()))
                           (cons _%g1275812811%_ '())))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                    ...
                    (if (gx#stx-pair? _%hd1286512915%_)
                        ...
                        (let ((_%K1287212930%_ (reverse _%K1287112918%_)))
                          ((lambda (_%g1285612933%_ _%g1285712935%_)
                             (cons (gx#datum->syntax '#f '~case-dispatch*)
                                   (cons '0
                                         (cons _%g1285712935%_
                   ...
                   (let* ((_%g1340813416%_
                          ...
                          (_%g1340713435%_
                           (lambda (_%g1340913420%_)
                             ((lambda (_%g1341013423%_)
                                (cons (gx#datum->syntax '#f 'if)
                                      (cons (cons (gx#datum->syntax '#f '##fx=)
                                                  (cons _%g1300313386%_
                                                        (cons _%g1341013423%_
                                                              '())))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                     ...
                     (let ((_%K-left1373813811%_
                            (reverse _%K-left1373713799%_)))
                       (if (gx#stx-pair? _%tl1372913783%_)
                           (let ((_%e1373913814%_
                                  (gx#syntax-e _%tl1372913783%_)))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                     ...
                     (let ((_%K-right1375013849%_
                            (reverse _%K-right1374913837%_)))
                       (if (gx#stx-pair? _%tl1374113821%_)
                           (let ((_%e1375113852%_
                                  (gx#syntax-e _%tl1374113821%_)))
                                   ...
                                   ((lambda (_%g1372013862%_
                                      ...
                                      (cons (gx#datum->syntax '#f 'if)
                                            (cons (cons (gx#datum->syntax
                                                         '#f
                                                         '##fx<)
                                                        (cons _%g1357513667%_
                                                              (cons _%g1372013862%_
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                            '())))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                  (cons (cons (gx#datum->syntax
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                            (cons _%g1357513667%_
                                  (foldr (lambda (_%g1389913904%_
                                                  _%g1390013907%_)
                                           (cons _%g1389913904%_
                                                 _%g1390013907%_))
                                         '()
                                         _%g1372213865%_))))
                (cons (cons (gx#datum->syntax '#f '~case-dispatch*)
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                     ...
                     (let ((_%e1459714663%_ (reverse _%e1459514630%_))
                       ...
                       ((lambda (_%g1458614667%_ _%g1458714669%_)
                          (let* ((_%g1468514702%_
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                         (lambda (_%hd1475814788%_ _%hd-bind1476414791%_)
                           (if (gx#stx-pair? _%hd1475814788%_)
                               (let ((_%e1476114793%_
                                      (gx#syntax-e _%hd1475814788%_)))
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                 ...
                 (_%loop1476014784%_ _%target1475714778%_ '()))
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                 ...
                                 (_%g1475314863%_
                                  (gx#stx-map
                                   _%let-head14392%_
                                   (foldr (lambda (_%g1486614869%_
                                                   _%g1486714872%_)
                                            (cons _%g1486614869%_
                                                  _%g1486714872%_))
                                          '()
                                          _%g1458714669%_)))))
                             _%$e1469614734%_))))))
                               ...
                               (let* ((_%g1659216600%_
                                      ...
                                      (_%g1659116619%_
                                       (lambda (_%g1659316604%_)
                                         ((lambda (_%g1659416607%_)
                                            (cons (gx#datum->syntax '#f 'foldr)
                                                  (cons (gx#datum->syntax
                                                         '#f
                                                         'cons)
                                                        (cons _%g1659416607%_
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                 ...
                 (if (gx#stx-null? _%tl1648316513%_)
                     ((lambda (_%g1647616516%_ _%g1647716518%_)
                        (cons (gx#datum->syntax '#f 'cons)
                              (cons _%g1647716518%_
                                    (cons _%g1647616516%_ '()))))
                      _%hd1648216510%_
                      _%hd1647916500%_)
                               ...
                               (let* ((_%g1640516413%_
                                      ...
                                      (_%g1640416432%_
                                       (lambda (_%g1640616417%_)
                                         ((lambda (_%g1640716420%_)
                                            (cons (gx#datum->syntax
                                                   '#f
                                                   'list->vector)
                                                  (cons _%g1640716420%_ '())))
                                          _%g1640616417%_))))
                                 (_%g1640416432%_
                                  (_%generate16152%_
                               ...
                               (let* ((_%g1632116329%_
                                      ...
                                      (_%g1632016348%_
                                       (lambda (_%g1632216333%_)
                                         ((lambda (_%g1632316336%_)
                                            (cons (gx#datum->syntax '#f 'box)
                                                  (cons _%g1632316336%_ '())))
                                          _%g1632216333%_))))
                                 (_%g1632016348%_
                                  (_%generate16152%_
                                   _%g1627516311%_
                                ...
                                (let ((_%e1616016185%_
                                  ...
                                  (let ((_%hd1616116189%_
                                    ...
                                    (if (gx#stx-null? _%tl1616216192%_)
                                        ((lambda (_%g1615616195%_)
                                           (if (_%simple-quote?16150%_
                                                _%g1615616195%_)
                                               (cons (gx#datum->syntax
                                                      '#f
                                                      'quote)
                                                     (cons _%g1615616195%_
                                                           '()))
                                               (_%generate16152%_
                                                _%g1615616195%_
                                                '0)))
                          ...
                          (let ((_%hd1746617484%_
                                ...
                                (_%tl1746717487%_
                                 (let ()
                                   (declare (not safe))
                                   (##cdr _%e1746517480%_))))
                            ((lambda (_%g1746417490%_)
                               (if (and (gx#stx-list? _%g1746417490%_)
                                        (not (gx#stx-null? _%g1746417490%_)))
                                   (let ((_g21047_
                                          (_%generate17459%_ _%g1746417490%_)))
                                     (begin
                                       (let ((_g21048_
                                              (let ()
                                                (declare (not safe))
