                        ...
                        (if (gx#stx-pair? _%$%hd73967454%_)
                            (let ((_%$%e73997459%_
                              ...
                              (let ((_%$%lp-hd74007463%_
                                ...
                                (_%$%loop73987450%_
                                 _%$%lp-tl74017466%_
                                 (cons _%$%lp-hd74007463%_
                                       _%$%pre74027457%_))))
                            (let ((_%$%pre74037469%_
                                   (reverse _%$%pre74027457%_)))
                        ...
                        (if (gx#stx-pair? _%$%hd74087492%_)
                            (let ((_%$%e74117497%_
                              ...
                              (let ((_%$%lp-hd74127501%_
                                ...
                                (_%$%loop74107488%_
                                 _%$%lp-tl74137504%_
                                 (cons _%$%lp-hd74127501%_
                                       _%$%opt74147495%_))))
                            (let ((_%$%opt74157507%_
                                   (reverse _%$%opt74147495%_)))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                ...
                (if (gx#stx-null? _%$%tl71957301%_)
                    (list (list (foldr (lambda (_%$%g73377342%_
                                                _%$%g73387345%_)
                                         (cons _%$%g73377342%_
                                               _%$%g73387345%_))
            ...
            (let ((_%__kont1929719298%_
                  ...
                  (_%__kont1929919300%_
                   (lambda (_%$%g54305655%_ _%$%g54315657%_)
                     (let ((_g20986_
                            (_%opt-lambda-split5406%_ _%$%g54315657%_)))
                       (begin
                         (let ((_g20987_
                                (let ()
                                  (declare (not safe))
                   ...
                   (if (gx#stx-pair? _%$%hd1227112606%_)
                       (let ((_%$%e1227412611%_
                         ...
                         (let ((_%$%lp-tl1227612618%_
                           ...
                           (_%$%loop1227312602%_
                            _%$%lp-tl1227612618%_
                            (cons _%$%lp-hd1227512615%_
                                  _%$%body1227712609%_))))
                       (let ((_%$%body1227812621%_
                              (reverse _%$%body1227712609%_)))
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                ...
                (if (gx#stx-pair? _%__stx2009220093%_)
                    (let ((_%$%e1440215012%_
                           (gx#syntax-e _%__stx2009220093%_)))
          ...
          (let ((_%__kont2019520196%_ (lambda () '#t))
                (_%__kont2019720198%_
                 (lambda (_%$%g1542815625%_)
                   (cons (gx#datum->syntax '#f 'let)
                         (cons '()
                               (foldr (lambda (_%$%g1564115644%_
                                               _%$%g1564215647%_)
                                        (cons _%$%g1564115644%_
                                              _%$%g1564215647%_))
                                      '()
                                      _%$%g1542815625%_)))))
        ...
        (let* ((_%__stx2027220273%_ _%$stx15687%_)
          ...
          (let ((_%__kont2027520276%_
                ...
                (_%__kont2028320284%_
                 (lambda (_%$%g1573415944%_ _%$%g1573515946%_)
                   _%$%g1573515946%_))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                 ...
                 (if (gx#stx-null? _%$%tl1648316513%_)
                     (cons (gx#datum->syntax '#f 'cons)
                           (cons _%$%hd1647916500%_
                                 (cons _%$%hd1648216510%_ '())))
