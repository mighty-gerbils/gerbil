                                                  ...
                                                  (let ((_%e65106532%_
                                                    ...
                                                    (let ((_%hd65096536%_
                                                      ...
                                                      (if (gx#stx-pair?
                                                          ...
                                                          (let ((_%e65136542%_
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                         (gx#syntax-e _%tl65086539%_)))
                    (let ((_%hd65126546%_
                           (let () (declare (not safe)) (##car _%e65136542%_)))
                          (_%tl65116549%_
                           (let ()
                             (declare (not safe))
                             (##cdr _%e65136542%_))))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                         ...
                         (##car _%e1013810192%_)))
                      (_%tl1013610199%_
                       (let () (declare (not safe)) (##cdr _%e1013810192%_))))
                                                  ...
                                                  (let ((_%e99139967%_
                                                    ...
                                                    (let ((_%hd99129971%_
                                                      ...
                                                      (if (gx#stx-pair?
                                                          ...
                                                          (let ((_%e99169977%_
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                         (gx#syntax-e _%tl99119974%_)))
                    (let ((_%hd99159981%_
                           (let () (declare (not safe)) (##car _%e99169977%_)))
                          (_%tl99149984%_
                           (let ()
                             (declare (not safe))
                             (##cdr _%e99169977%_))))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                    ...
                    (let ((_%hd992710021%_
                      ...
                      (if (gx#stx-pair? _%tl992610024%_)
                          (let ((_%e993110027%_ (gx#syntax-e _%tl992610024%_)))
                            (let ((_%hd993010031%_
                                   (let ()
                                     (declare (not safe))
                                     (##car _%e993110027%_)))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                        ...
                        (_%tl96549723%_
                         (let () (declare (not safe)) (##cdr _%e96569716%_))))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                        ...
                        (_%tl96819813%_
                         (let () (declare (not safe)) (##cdr _%e96839806%_))))
