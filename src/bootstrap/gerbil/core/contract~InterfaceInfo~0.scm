...
(begin
  (define gerbil/core/contract~InterfaceInfo::timestamp 1712773521)
  (begin
    (define gerbil/core/contract~InterfaceInfo#_g81116_
      (##structure
       gx#syntax-quote::t
       'cast
       #f
       ...
       '()))
    (define gerbil/core/contract~InterfaceInfo#_g81117_
      (##structure
       gx#syntax-quote::t
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                            ...
                            (_%g4500045018%_ _%g4500145021%_)))))
                (_%g4499945066%_
                 (list (let ((__obj81041 _%self44914%_))
                         (if (let ()
                               (declare (not safe))
                ...
                (_%g4493744965%_
                 (let ((__obj81044 _%self44914%_))
                   (if (let ()
                       ...
                       (let ()
                         (declare (not safe))
                         (##unchecked-structure-ref __obj81044 '5 '#f '#f))
                       (class-slot-ref
                        gerbil/core/contract~InterfaceInfo#interface-info::t
                        __obj81044
                        'interface-descriptor))))))))
                     ...
                     (let ((_%e4492444981%_ (gx#syntax-e _%tl4492344978%_)))
                       (let ((_%tl4492644986%_
                         ...
                         (if (gx#stx-null? _%tl4492644986%_)
                             (_%__kont7598975990%_ _%hd4492544984%_)
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                      ...
                      (_%g4486444878%_ _%g4486544881%_)))))
          (_%g4486345072%_
           (list gerbil/core/contract~InterfaceInfo#_g81116_
                 gerbil/core/contract~InterfaceInfo#_g81117_))))
      (bind-method!
       gerbil/core/contract~InterfaceInfo#interface-info::t
      ...
      (define gerbil/core/contract~InterfaceInfo#syntax-local-interface-info?
        (lambda _g81119_
          (let ((_g81118_ (let () (declare (not safe)) (##length _g81119_))))
            (cond ((let () (declare (not safe)) (##fx= _g81118_ 1))
                   (apply gerbil/core/contract~InterfaceInfo#syntax-local-interface-info?__0
                          _g81119_))
                  ((let () (declare (not safe)) (##fx= _g81118_ 2))
