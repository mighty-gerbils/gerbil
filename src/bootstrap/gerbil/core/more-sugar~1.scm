                   ...
                   (let* ((_%g4074140749%_
                          ...
                          (_%g4074040776%_
                           (lambda (_%g4074240753%_)
                             ((lambda (_%g4074340756%_)
                                (cons _%g4074340756%_
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                        ...
                        (if (gx#stx-pair? _%hd4087940932%_)
                            ...
                            (let ((_%tgt4088640947%_
                              ...
                              ((lambda (_%g4087340950%_ _%g4087440952%_)
                                 (let* ((_%g4097040987%_
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                          (not safe))
                        (##fx= _g45496_ 2)))
                 (error "Context expects 2 values" _g45496_)))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                           (lambda (_%hd4097441004%_ _%$e4098041007%_)
                             (if (gx#stx-pair? _%hd4097441004%_)
                                 (let ((_%e4097741009%_
                                   ...
                                   (let ((_%lp-hd4097841013%_
                                     ...
                                     (_%loop4097641000%_
                                      _%lp-tl4097941016%_
                                      (cons _%lp-hd4097841013%_
                                            _%$e4098041007%_))))
                                 (let ((_%$e4098141019%_
                                        (reverse _%$e4098041007%_)))
                                   ((lambda (_%g4097241022%_)
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                     ...
                     (cons (cons (gx#datum->syntax '#f 'set!)
                                 (cons _%g4104041052%_
                                       (cons _%g4103941049%_ '())))
                           _%g4104141054%_))
                   '()
                   _%g4097241022%_
                   _%g4087440952%_)))))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                    ...
                    (if (gx#stx-pair? _%hd4155741607%_)
                        ...
                        (let ((_%body4156441622%_
                          ...
                          ((lambda (_%g4154841625%_ _%g4154941627%_)
                             (if (gx#identifier? _%g4154941627%_)
                                 (cons (gx#datum->syntax '#f 'call/cc)
                                       (cons (cons (gx#datum->syntax
                                                    '#f
                                                    'lambda)
                                                   (cons (cons _%g4154941627%_
                                                               '())
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                 (cons (cons (gx#datum->syntax
                                                             ...
                                                             (cons '()
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                           (cons _%g4166541757%_
                                 (foldr (lambda (_%g4177841781%_
                                                 _%g4177941784%_)
                                          (cons _%g4177841781%_
                                                _%g4177941784%_))
                                        '()
                                        _%g4166441755%_))))
               '()))))
                    ...
                    (if (gx#stx-pair? _%hd4185442032%_)
                        ...
                        (let ((_%body4186142047%_
                          ...
                          ((lambda (_%g4179842050%_
                             ...
                             (if (gx#stx-andmap
                                  gx#identifier?
                                  (foldr (lambda (_%g4208942092%_
                                                  _%g4209042095%_)
                                           (cons _%g4208942092%_
                                                 _%g4209042095%_))
                                         '()
                                         _%g4180342056%_))
                                 (cons (gx#datum->syntax '#f 'let)
                    ...
                    (if (gx#stx-pair? _%hd4221442392%_)
                        ...
                        (let ((_%body4222142407%_
                          ...
                          ((lambda (_%g4215842410%_
                             ...
                             (if (gx#stx-andmap
                                  gx#identifier?
                                  (foldr (lambda (_%g4244942452%_
                                                  _%g4245042455%_)
                                           (cons _%g4244942452%_
                                                 _%g4245042455%_))
                                         '()
                                         _%g4216342416%_))
                                 (cons (gx#datum->syntax '#f 'let)
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                           _%g4246142481%_)
                    (cons _%g4246042478%_ _%g4246142481%_))
                  (cons (cons (gx#datum->syntax '#f 'if)
                              (cons _%g4216042413%_
                                    (cons (cons (gx#datum->syntax '#f '$loop)
                                                (begin
                                                  (gx#syntax-check-splice-targets
                                                   _%g4216142414%_
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                    ...
                    (if (gx#stx-pair? _%hd4252742577%_)
                        ...
                        (let ((_%body4253442592%_
                          ...
                          ((lambda (_%g4251842595%_ _%g4251942597%_)
                             (cons (gx#datum->syntax '#f 'let)
                                   (cons (gx#datum->syntax '#f 'lp)
                                         (cons '()
                                               (cons (cons (gx#datum->syntax
                                                            '#f
                                                            'when)
                                                           (cons _%g4251942597%_
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                         (foldr (lambda (_%g4261442617%_ _%g4261542620%_)
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                    ...
                    (if (gx#stx-pair? _%hd4264342693%_)
                        ...
                        (let ((_%body4265042708%_
                          ...
                          ((lambda (_%g4263442711%_ _%g4263542713%_)
                             (cons (gx#datum->syntax '#f 'let)
                                   (cons (gx#datum->syntax '#f 'lp)
                                         (cons '()
                                               (cons (cons (gx#datum->syntax
                                                            '#f
                                                            'unless)
                                                           (cons _%g4263542713%_
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                         (foldr (lambda (_%g4273042733%_ _%g4273142736%_)
                                ...
                                (if (gx#stx-pair? _%hd4399244042%_)
                                    ...
                                    (let ((_%e4399944057%_
                                      ...
                                      (if (gx#stx-null? _%tl4399044029%_)
                                          ((lambda (_%g4398344060%_
                                                    _%g4398444062%_)
                                             (cons (gx#datum->syntax
                                                    '#f
                                                    'with-unwind-protect)
                                                   (cons _%g4398444062%_
                                                         (cons (cons (gx#datum->syntax
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                              '#f
                              'lambda)
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                        ...
                        (##car _%e4346043505%_)))
                     (_%lp-tl4346243512%_
                      (let () (declare (not safe)) (##cdr _%e4346043505%_))))
                 (_%loop4345943496%_
                  _%lp-tl4346243512%_
                  (cons _%lp-hd4346143509%_ _%clause4346343503%_))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                     ...
                     (let ((_%hd4346643522%_
                       ...
                       (if (gx#stx-null? _%tl4346743525%_)
                           ((lambda (_%g4345143528%_ _%g4345243530%_)
                              (cons (gx#datum->syntax '#f 'with-catch)
                                    (cons (cons (gx#datum->syntax '#f 'lambda)
                                                (cons (cons _%g4339843411%_
                                                            '())
                                                      (cons (cons (gx#datum->syntax
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                           '#f
                           'cond)
                          (foldr (lambda (_%g4355543558%_ _%g4355643561%_)
                                   (cons _%g4355543558%_ _%g4355643561%_))
                                 (cons (cons (gx#datum->syntax '#f 'else)
                                             (cons (cons (gx#datum->syntax
                                                          '#f
                                                          'raise)
                                                         (cons _%g4339843411%_
                                                               '()))
                                                   '()))
                                       '())
                                 _%g4345243530%_))
                                 ...
                                 (let ((_%tl4360643843%_
                                   ...
                                   (if (gx#stx-null? _%tl4360643843%_)
                                       ...
                                       (let ()
                                         (declare (not safe))
                                         (_%g4357943649%_)))))
                               (let () (declare (not safe)) (_%g4357943649%_)))
                           (if (gx#stx-pair/null? _%tl4358543913%_)
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                    ...
                    (_%lp43035%_
                     _%g4304643265%_
                     (cons (foldr (lambda (_%g4328343286%_ _%g4328443289%_)
                    ...
                    (let* ((_%g4317143179%_
                           ...
                           (_%g4317043206%_
                            (lambda (_%g4317243183%_)
                              ((lambda (_%g4317343186%_)
                                 (_%generate-fini42777%_
                                  (cons (gx#datum->syntax '#f 'lambda)
                                        (cons '() (cons _%g4317343186%_ '())))
                                  (foldr (lambda (_%g4319743200%_
                                                  _%g4319843203%_)
                                           (cons _%g4319743200%_
                                                 _%g4319843203%_))
                                         '()
                                         _%g4306343150%_)))
                               _%g4317243183%_))))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                            _%__stx4535345354%_)
                           (_%__kont4536445365%_)
                           (let () (declare (not safe)) (_%g4304443084%_)))))
               ...
               (if (gx#stx-pair? _%__stx4535345354%_)
                   (let ((_%e4304843217%_ (gx#syntax-e _%__stx4535345354%_)))
                             ...
                             (let ((_%tl4305343234%_
                               ...
                               (if (gx#identifier? _%hd4305243231%_)
                                   ...
                                   (let ()
                                     ...
                                     (_%g4304443084%_)))))
                           (let () (declare (not safe)) (_%g4304443084%_)))))
                   (let () (declare (not safe)) (_%g4304343095%_)))))))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                      ...
                      (if (gx#stx-pair? _%hd4293643331%_)
                          ...
                          (let ((_%fini4294343346%_
                                 (reverse _%fini4294243334%_)))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                ...
                (let ((_%val4420844284%_ (reverse _%val4420644251%_))
                  ...
                  ((lambda (_%g4419444288%_ _%g4419544290%_)
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                ...
                (let ((_%val4434244418%_ (reverse _%val4434044385%_))
                  ...
                  ((lambda (_%g4432844422%_ _%g4432944424%_)
                     (cons (gx#datum->syntax '#f '~hash-table)
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                ...
                (let ((_%val4447644552%_ (reverse _%val4447444519%_))
                  ...
                  ((lambda (_%g4446244556%_ _%g4446344558%_)
                     (cons (gx#datum->syntax '#f '~hash-table)
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                    ...
                    (if (gx#stx-pair? _%hd4460444654%_)
                        ...
                        (let ((_%entry4461144669%_
                          ...
                          ((lambda (_%g4459544672%_ _%g4459644674%_)
                             (let* ((_%g4469244700%_
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                    ...
                    (let ((_%target4472344752%_
                      ...
                      (if (gx#stx-null? _%tl4472544755%_)
                    ...
                    (let ((_%hd4473844792%_
                          ...
                          (_%tl4473944795%_
                           (let ()
                             (declare (not safe))
                             (##cdr _%e4473744788%_))))
                      (if (gx#stx-null? _%tl4473944795%_)
                          (_%loop4472644758%_
                           _%lp-tl4472944775%_
                           (cons _%hd4473844792%_ _%val4473044765%_)
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                          '#f
                          'ht)
                         (cons (cons _%g4459644674%_
                                     (cons 'size: (cons _%g4469444707%_ '())))
                               '()))
                   (begin
                     (gx#syntax-check-splice-targets
                      _%g4472144802%_
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                               ...
                               (_%g4469144846%_
                                (gx#stx-length
                                 (foldr (lambda (_%g4484944852%_
                                                 _%g4485044855%_)
                                          (cons _%g4484944852%_
                                                _%g4485044855%_))
                                        '()
                                        _%g4459544672%_)))))
                           _%entry4461144669%_
                              ...
                              (let ((_%e4487344898%_
                                ...
                                (let ((_%hd4487444902%_
                                  ...
                                  (if (gx#stx-null? _%tl4487544905%_)
                                      ((lambda (_%g4486944908%_)
                                         (if (gx#stx-string? _%g4486944908%_)
                                             (let* ((_%g4492244930%_
                                                    ...
                                                    (_%g4492144949%_
                                                     (lambda (_%g4492344934%_)
                                                       ((lambda (_%g4492444937%_)
                                                          (cons (gx#datum->syntax
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                         '#f
                         'quote)
                        (cons _%g4492444937%_ '())))
                _%g4492344934%_))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                               (_%g4492144949%_
                                                (string->bytes
                                                 (gx#stx-e _%g4486944908%_))))
                                             (_%g4486744881%_
                                              _%g4486844885%_)))
                                       _%hd4487444902%_)
                              ...
                              (let ((_%e4496644991%_
                                ...
                                (let ((_%hd4496744995%_
                                  ...
                                  (if (gx#stx-null? _%tl4496844998%_)
                                      ((lambda (_%g4496245001%_)
                                         (if (gx#current-expander-compiling?)
                                             (gx#eval-syntax _%g4496245001%_)
                                             '#!void)
