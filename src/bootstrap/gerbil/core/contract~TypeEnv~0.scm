...
(begin
  (define gerbil/core/contract~TypeEnv::timestamp 1712084081)
  (begin
    ...
    (define gerbil/core/contract~TypeEnv#type-env-lookup
      (lambda (_%var46598%_)
        (let _%loop46600%_ ((_%te46602%_
                             (let ()
                               (declare (not safe))
                               (gerbil/core/contract~TypeEnv#current-type-env))))
          (if (let () (declare (not safe)) (not _%te46602%_))
              (let () '#f)
