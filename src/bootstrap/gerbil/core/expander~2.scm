...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                    ...
                    (if (gx#stx-pair? _%$%hd455505%_)
                        ...
                        (let ((_%$%clauses462520%_
                               (reverse _%$%clauses461508%_)))
                          (if (gx#identifier-list? _%$%hd452489%_)
                              (let* ((_%body689%_
                                      (gx#stx-map
