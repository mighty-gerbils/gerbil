...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                ...
                (let ((_%body4565645742%_ (reverse _%body4565545730%_)))
                  ((lambda (_%g4563145745%_ _%g4563245747%_)
                     (let* ((_%g4576945786%_
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                     ...
                     (let ((_%clause4578045818%_
                            (reverse _%clause4577945806%_)))
                       ((lambda (_%g4577145821%_)
                          (cons (gx#datum->syntax '#f 'with-syntax*)
                                (cons (foldr (lambda (_%g4583645841%_
                                                      _%g4583745844%_)
                                               (cons _%g4583645841%_
                                                     _%g4583745844%_))
                                             '()
                                             _%g4577145821%_)
                                      (foldr (lambda (_%g4583845847%_
                                                      _%g4583945850%_)
                                               (cons _%g4583845847%_
                                                     _%g4583945850%_))
                                             '()
                                             _%g4563145745%_))))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                          (foldr (lambda (_%g4597745980%_ _%g4597845983%_)
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                   ...
                   (if (gx#stx-null? _%tl4588845930%_)
                       (_%__match4633146332%_
                        ...
                        _%target4588645927%_
                        _%tl4588845930%_)
                       (let () (declare (not safe)) (_%g4586145900%_)))))
               (let () (declare (not safe)) (_%g4586145900%_))))))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                    ...
                    (if (gx#stx-pair? _%hd4610046188%_)
                        ...
                        (let ((_%body4610746203%_
                          ...
                          ((lambda (_%g4607846206%_
                                    _%g4607946208%_
                                    _%g4608046209%_)
                             (if (gx#identifier? _%g4608046209%_)
                                 (cons (gx#datum->syntax '#f 'with-identifiers)
                                       (cons (cons (cons _%g4608046209%_
