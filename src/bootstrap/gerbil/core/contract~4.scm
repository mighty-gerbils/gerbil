...
(begin
  (define |gerbil/core/contract~TypeCast[1]#_g82869_|
                         ...
                         (if (let ()
                             ...
                             (let ()
                               ...
                               (##unchecked-structure-ref
                                ...
                                '#f
                                '#f))
                             (unchecked-slot-ref __obj82728 'id)))))
                  (declare (not safe))
                  (##memq __tmp82867 '(t void)))
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                 ...
                                 (_%g4524045255%_ _%g4524145259%_)))))
                     (_%g4523945302%_
                      (list (let ((__obj82729 _%meta45235%_))
                              (if (let ()
                                    (declare (not safe))
                                    (##structure-direct-instance-of?
                                     __obj82729
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                         ...
                         (_%g4530745368%_
                          (list (let ((__obj82727 _%meta45235%_))
                                  (if (let ()
                                        (declare (not safe))
                                        (##structure-direct-instance-of?
                                         __obj82727
                         ...
                         (if (let ()
                             ...
                             (let ()
                               ...
                               (##unchecked-structure-ref
                                ...
                                '#f
                                '#f))
                             (unchecked-slot-ref __obj82732 'id)))))
                  (declare (not safe))
                  (##memq __tmp82868 '(t void)))
                (cons (gx#datum->syntax '#f 'begin-annotation)
                      (cons (cons (gx#datum->syntax '#f '@type)
                                  (cons _%L45503%_ '()))
                            (cons _%L45438%_ '())))
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                 ...
                                 (_%g4545945474%_ _%g4546045478%_)))))
                     (_%g4545845521%_
                      (list (let ((__obj82733 _%meta45454%_))
                              (if (let ()
                                    (declare (not safe))
                                    (##structure-direct-instance-of?
                                     __obj82733
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                         ...
                         (_%g4552645587%_
                          (list (let ((__obj82731 _%meta45454%_))
                                  (if (let ()
                                        (declare (not safe))
                                        (##structure-direct-instance-of?
                                         __obj82731
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
    ...
    (define |gerbil/core/contract~TypeCast[:0:]#:~|
      (lambda (_%$stx45708%_)
        (let* ((_%__stx7738677387%_ _%$stx45708%_)
               (_%g4571345749%_
                (lambda ()
                  (gx#raise-syntax-error
                   '#f
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
            ...
            (if (gx#stx-pair? _%__stx7738677387%_)
                (let ((_%e4571745837%_ (gx#syntax-e _%__stx7738677387%_)))
                                              ...
                                              (let ((_%tl4574045793%_
                                                ...
                                                (if (gx#identifier?
                                                    ...
                                                    (if (gx#free-identifier=?
                                                         |gerbil/core/contract~TypeCast[1]#_g82869_|
                                                         _%hd4573945790%_)
                                                        (if (gx#stx-pair?
                                                             _%tl4574045793%_)
                                                            (let ((_%e4574145796%_
