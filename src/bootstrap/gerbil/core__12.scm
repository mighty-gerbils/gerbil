  ...
  (define |gerbil/core$<more-sugar>[1]#syntax-local-setf-macro?|
    (lambda (_stx33181_)
      (if (gx#identifier? _stx33181_)
          (let ((__tmp50562 (gx#syntax-local-value _stx33181_ false)))
            (declare (not safe))
            (class-instance?
             |gerbil/core$<more-sugar>[1]#setf-macro::t|
             __tmp50562))
  ...
  (define |gerbil/core$<more-sugar>[1]#syntax-local-setq-macro?|
    (lambda (_stx33178_)
      (if (gx#identifier? _stx33178_)
          (let ((__tmp50563 (gx#syntax-local-value _stx33178_ false)))
            (declare (not safe))
            (class-instance?
             |gerbil/core$<more-sugar>[1]#setq-macro::t|
             __tmp50563))
        ...
        (let ((___kont4684146842_
              ...
              (___kont4684946850_
               (lambda (_L33294_ _L33296_)
                 (let ((__tmp50569 (gx#datum->syntax '#f '%#set!))
                       (__tmp50567
                        (let ((__tmp50568
                               (let ()
                                 (declare (not safe))
                                ...
                                (let ((_g50571_
                                  ...
                                  (begin
                                    ...
                                    (let ((_target3356033594_
                                           (let ()
                                             (declare (not safe))
                                             (##vector-ref _g50571_ 0)))
                                          (_tl3356233597_
                                           (let ()
                                             (declare (not safe))
                                             (##vector-ref _g50571_ 1))))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                             2)))
               (error "Context expects 2 values" _g50574_)))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                              ...
                              _g3372533740_)
                       (let ((__tmp50578
                              (let ((__tmp50581 (gx#datum->syntax '#f 'set!))
                                    (__tmp50579
                                     (let ((__tmp50580
                                            (let ()
                                              (declare (not safe))
                                              (cons _g3372333735_ '()))))
                                       (declare (not safe))
                                       (cons _g3372433738_ __tmp50580))))
                                (declare (not safe))
                                (cons __tmp50581 __tmp50579))))
                         (declare (not safe))
                         (cons __tmp50578 _g3372533740_)))))
                (declare (not safe))
                (foldr2 __tmp50577 '() _L33708_ _L33636_)))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                               (declare (not safe))
                                               (cons __tmp50582 __tmp50576))))
                                        (declare (not safe))
                                        (cons __tmp50587 __tmp50575))))
                                  _$e3366533704_))))))
    ...
    (lambda (_stx33761_)
      (let* ((___stx4693246933_ _stx33761_)
        ...
        (let ((___kont4693546936_
               (lambda (_L34157_)
                 (let ((__tmp50592 (gx#datum->syntax '#f 'let))
                       (__tmp50589
                        (let ((__tmp50590
                               (let ((__tmp50591
                                      (lambda (_g3417334176_ _g3417434179_)
                                        (let ()
                                          ...
                                          (cons _g3417334176_
                                                _g3417434179_)))))
                                 (declare (not safe))
                                 (foldr1 __tmp50591 '() _L34157_))))
                          (declare (not safe))
                          (cons '() __tmp50590))))
                   (declare (not safe))
                   (cons __tmp50592 __tmp50589))))
              (___kont4693946940_
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                         (not safe))
                       (##fx= _g50594_ 2)))
                (error "Context expects 2 values" _g50594_)))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                 ...
                 (declare (not safe))
                 (foldr1 __tmp50597 '() _L34041_))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                  (declare (not safe))
                                                  (cons _L33975_ __tmp50596))))
                                           (declare (not safe))
                                           (cons __tmp50598 __tmp50595)))))
                                   _arg3399834037_))))))
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                   ...
                   (_g3395934088_
                    (gx#stx-wrap-source
                     (let ((__tmp50606 (gx#datum->syntax '#f 'lambda))
                           (__tmp50603
                            (let ((__tmp50604
                                   (let ((__tmp50605
                                          (lambda (_g3409134094_ _g3409234097_)
                                            (let ()
                                              ...
                                              (cons _g3409134094_
                                                    _g3409234097_)))))
                                     (declare (not safe))
                                     (foldr1 __tmp50605 '() _L33934_))))
                              (declare (not safe))
                              (cons '() __tmp50604))))
                       (declare (not safe))
                       (cons __tmp50606 __tmp50603))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                  ...
                  (__tmp50622
                   (let ((__tmp50623
                     ...
                     (declare (not safe))
                     (foldr1 __tmp50623 '() _L34393_))))
              (declare (not safe))
              (cons __tmp50624 __tmp50622))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                               (declare (not safe))
                                               (cons __tmp50625 __tmp50621))))
                                        (declare (not safe))
                                        (cons __tmp50620 '()))))
                                 (declare (not safe))
                                 (cons __tmp50626 __tmp50619))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                            2)))
              (error "Context expects 2 values" _g50628_)))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                            ...
                                            (lambda (_g3454834551_
                                              ...
                                              (let ()
                                                ...
                                                (cons _g3454834551_
                                                      _g3454934554_)))))
                                       (declare (not safe))
                                       (foldr1 __tmp50635 '() _L34525_))))
                                (declare (not safe))
                                (cons _L34527_ __tmp50634))))
                         (declare (not safe))
                         (cons '() __tmp50633))))
                  (declare (not safe))
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                   ...
                                                   (cons __tmp50631 '()))))
                                            (declare (not safe))
                                            (cons __tmp50637 __tmp50630))))
                                     (declare (not safe))
                                     (cons __tmp50641 __tmp50629)))
                                 _rest3445234521_
                                 _hd3444234489_
                                 _hd3443934479_))))))
