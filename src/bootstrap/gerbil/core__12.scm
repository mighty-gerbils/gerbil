  ...
  (define |gerbil/core$<more-sugar>[1]#syntax-local-setf-macro?|
    (lambda (_stx33181_)
      (if (gx#identifier? _stx33181_)
          (let ((__tmp50446 (gx#syntax-local-value _stx33181_ false)))
            (declare (not safe))
            (class-instance?
             |gerbil/core$<more-sugar>[1]#setf-macro::t|
             __tmp50446))
  ...
  (define |gerbil/core$<more-sugar>[1]#syntax-local-setq-macro?|
    (lambda (_stx33178_)
      (if (gx#identifier? _stx33178_)
          (let ((__tmp50447 (gx#syntax-local-value _stx33178_ false)))
            (declare (not safe))
            (class-instance?
             |gerbil/core$<more-sugar>[1]#setq-macro::t|
             __tmp50447))
        ...
        (let ((___kont4684146842_
              ...
              (___kont4684946850_
               (lambda (_L33294_ _L33296_)
                 (let ((__tmp50453 (gx#datum->syntax '#f '%#set!))
                       (__tmp50451
                        (let ((__tmp50452
                               (let ()
                                 (declare (not safe))
                                ...
                                (let ((_g50455_
                                  ...
                                  (begin
                                    ...
                                    (let ((_target3356033594_
                                           (let ()
                                             (declare (not safe))
                                             (##vector-ref _g50455_ 0)))
                                          (_tl3356233597_
                                           (let ()
                                             (declare (not safe))
                                             (##vector-ref _g50455_ 1))))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                             2)))
               (error "Context expects 2 values" _g50458_)))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                              ...
                              _g3372533740_)
                       (let ((__tmp50462
                              (let ((__tmp50465 (gx#datum->syntax '#f 'set!))
                                    (__tmp50463
                                     (let ((__tmp50464
                                            (let ()
                                              (declare (not safe))
                                              (cons _g3372333735_ '()))))
                                       (declare (not safe))
                                       (cons _g3372433738_ __tmp50464))))
                                (declare (not safe))
                                (cons __tmp50465 __tmp50463))))
                         (declare (not safe))
                         (cons __tmp50462 _g3372533740_)))))
                (declare (not safe))
                (foldr2 __tmp50461 '() _L33708_ _L33636_)))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                               (declare (not safe))
                                               (cons __tmp50466 __tmp50460))))
                                        (declare (not safe))
                                        (cons __tmp50471 __tmp50459))))
                                  _$e3366533704_))))))
    ...
    (lambda (_stx33761_)
      (let* ((___stx4693246933_ _stx33761_)
        ...
        (let ((___kont4693546936_
               (lambda (_L34157_)
                 (let ((__tmp50476 (gx#datum->syntax '#f 'let))
                       (__tmp50473
                        (let ((__tmp50474
                               (let ((__tmp50475
                                      (lambda (_g3417334176_ _g3417434179_)
                                        (let ()
                                          ...
                                          (cons _g3417334176_
                                                _g3417434179_)))))
                                 (declare (not safe))
                                 (foldr1 __tmp50475 '() _L34157_))))
                          (declare (not safe))
                          (cons '() __tmp50474))))
                   (declare (not safe))
                   (cons __tmp50476 __tmp50473))))
              (___kont4693946940_
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                         (not safe))
                       (##fx= _g50478_ 2)))
                (error "Context expects 2 values" _g50478_)))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                 ...
                 (declare (not safe))
                 (foldr1 __tmp50481 '() _L34041_))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                  (declare (not safe))
                                                  (cons _L33975_ __tmp50480))))
                                           (declare (not safe))
                                           (cons __tmp50482 __tmp50479)))))
                                   _arg3399834037_))))))
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                   ...
                   (_g3395934088_
                    (gx#stx-wrap-source
                     (let ((__tmp50490 (gx#datum->syntax '#f 'lambda))
                           (__tmp50487
                            (let ((__tmp50488
                                   (let ((__tmp50489
                                          (lambda (_g3409134094_ _g3409234097_)
                                            (let ()
                                              ...
                                              (cons _g3409134094_
                                                    _g3409234097_)))))
                                     (declare (not safe))
                                     (foldr1 __tmp50489 '() _L33934_))))
                              (declare (not safe))
                              (cons '() __tmp50488))))
                       (declare (not safe))
                       (cons __tmp50490 __tmp50487))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                  ...
                  (__tmp50496
                   (let ((__tmp50497
                     ...
                     (declare (not safe))
                     (foldr1 __tmp50497 '() _L34275_))))
              (declare (not safe))
              (cons __tmp50498 __tmp50496))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                               (declare (not safe))
                                               (cons __tmp50499 __tmp50495))))
                                        (declare (not safe))
                                        (cons __tmp50494 '()))))
                                 (declare (not safe))
                                    ...
                                    (let ((_g50501_
                                      ...
                                      (begin
                                        ...
                                        (let ((_target3432234363_
                                               (let ()
                                                 (declare (not safe))
                                                 (##vector-ref _g50501_ 0)))
                                              (_tl3432434366_
                                               (let ()
                                                 (declare (not safe))
                                                 (##vector-ref _g50501_ 1))))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                  ...
                  (__tmp50506
                   (let ((__tmp50507
                     ...
                     (declare (not safe))
                     (foldr1 __tmp50507 '() _L34393_))))
              (declare (not safe))
              (cons __tmp50508 __tmp50506))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                               (declare (not safe))
                                               (cons __tmp50509 __tmp50505))))
                                        (declare (not safe))
                                        (cons __tmp50504 '()))))
                                 (declare (not safe))
                                 (cons __tmp50510 __tmp50503))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                            2)))
              (error "Context expects 2 values" _g50512_)))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                            ...
                                            (lambda (_g3454834551_
                                              ...
                                              (let ()
                                                ...
                                                (cons _g3454834551_
                                                      _g3454934554_)))))
                                       (declare (not safe))
                                       (foldr1 __tmp50519 '() _L34525_))))
                                (declare (not safe))
                                (cons _L34527_ __tmp50518))))
                         (declare (not safe))
                         (cons '() __tmp50517))))
                  (declare (not safe))
