  ...
  (define |gerbil/core$<more-sugar>[1]#syntax-local-setf-macro?|
    (lambda (_stx32896_)
      (if (gx#identifier? _stx32896_)
          (let ((__tmp50306 (gx#syntax-local-value _stx32896_ false)))
            (declare (not safe))
            (class-instance?
             |gerbil/core$<more-sugar>[1]#setf-macro::t|
             __tmp50306))
  ...
  (define |gerbil/core$<more-sugar>[1]#syntax-local-setq-macro?|
    (lambda (_stx32893_)
      (if (gx#identifier? _stx32893_)
          (let ((__tmp50307 (gx#syntax-local-value _stx32893_ false)))
            (declare (not safe))
            (class-instance?
             |gerbil/core$<more-sugar>[1]#setq-macro::t|
             __tmp50307))
        ...
        (let ((___kont4680746808_
              ...
              (___kont4681546816_
               (lambda (_L33009_ _L33011_)
                 (let ((__tmp50313 (gx#datum->syntax '#f '%#set!))
                       (__tmp50311
                        (let ((__tmp50312
                               (let ()
                                 (declare (not safe))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                             2)))
               (error "Context expects 2 values" _g50318_)))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                              ...
                              _g3344033455_)
                       (let ((__tmp50322
                              (let ((__tmp50325 (gx#datum->syntax '#f 'set!))
                                    (__tmp50323
                                     (let ((__tmp50324
                                            (let ()
                                              (declare (not safe))
                                              (cons _g3343833450_ '()))))
                                       (declare (not safe))
                                       (cons _g3343933453_ __tmp50324))))
                                (declare (not safe))
                                (cons __tmp50325 __tmp50323))))
                         (declare (not safe))
                         (cons __tmp50322 _g3344033455_)))))
                (declare (not safe))
                (foldr2 __tmp50321 '() _L33423_ _L33351_)))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                               (declare (not safe))
                                               (cons __tmp50326 __tmp50320))))
                                        (declare (not safe))
                                        (cons __tmp50331 __tmp50319))))
                                  _$e3338033419_))))))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                         (not safe))
                       (##fx= _g50338_ 2)))
                (error "Context expects 2 values" _g50338_)))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                 ...
                 (declare (not safe))
                 (foldr1 __tmp50341 '() _L33756_))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                  (declare (not safe))
                                                  (cons _L33690_ __tmp50340))))
                                           (declare (not safe))
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                   ...
                   (_g3367433803_
                    (gx#stx-wrap-source
                     (let ((__tmp50350 (gx#datum->syntax '#f 'lambda))
                           (__tmp50347
                            (let ((__tmp50348
                                   (let ((__tmp50349
                                          (lambda (_g3380633809_ _g3380733812_)
                                            (let ()
                                              ...
                                              (cons _g3380633809_
                                                    _g3380733812_)))))
                                     (declare (not safe))
                                     (foldr1 __tmp50349 '() _L33649_))))
                              (declare (not safe))
                              (cons '() __tmp50348))))
                       (declare (not safe))
                       (cons __tmp50350 __tmp50347))
                                    ...
                                    (let ((_g50351_
                                      ...
                                      (begin
                                        ...
                                        (let ((_target3391933960_
                                               (let ()
                                                 (declare (not safe))
                                                 (##vector-ref _g50351_ 0)))
                                              (_tl3392133963_
                                               (let ()
                                                 (declare (not safe))
                                                 (##vector-ref _g50351_ 1))))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                  ...
                  (__tmp50356
                   (let ((__tmp50357
                     ...
                     (declare (not safe))
                     (foldr1 __tmp50357 '() _L33990_))))
              (declare (not safe))
              (cons __tmp50358 __tmp50356))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                               (declare (not safe))
                                               (cons __tmp50359 __tmp50355))))
                                        (declare (not safe))
                                        (cons __tmp50354 '()))))
                                 (declare (not safe))
                                 (cons __tmp50360 __tmp50353))
                                    ...
                                    (let ((_g50361_
                                      ...
                                      (begin
                                        ...
                                        (let ((_target3403734078_
                                               (let ()
                                                 (declare (not safe))
                                                 (##vector-ref _g50361_ 0)))
                                              (_tl3403934081_
                                               (let ()
                                                 (declare (not safe))
                                                 (##vector-ref _g50361_ 1))))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                  ...
                  (__tmp50366
                   (let ((__tmp50367
                     ...
                     (declare (not safe))
                     (foldr1 __tmp50367 '() _L34108_))))
              (declare (not safe))
              (cons __tmp50368 __tmp50366))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                               (declare (not safe))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                            2)))
              (error "Context expects 2 values" _g50372_)))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                            ...
                                            (lambda (_g3426334266_
                                              ...
                                              (let ()
                                                ...
                                                (cons _g3426334266_
                                                      _g3426434269_)))))
                                       (declare (not safe))
                                       (foldr1 __tmp50379 '() _L34240_))))
                                (declare (not safe))
                                (cons _L34242_ __tmp50378))))
                         (declare (not safe))
                         (cons '() __tmp50377))))
                  (declare (not safe))
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                   ...
                                                   (cons __tmp50375 '()))))
                                            (declare (not safe))
                                            (cons __tmp50381 __tmp50374))))
                                     (declare (not safe))
                                     (cons __tmp50385 __tmp50373)))
                                 _rest3416734236_
                                 _hd3415734204_
                                 _hd3415434194_))))))
