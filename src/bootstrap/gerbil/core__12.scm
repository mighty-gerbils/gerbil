...
(begin
  ...
  (define |gerbil/core$<more-sugar>[1]#setq-macro::t|
    (let ((__tmp50823 (list gerbil/core$<macro-object>#macro-object::t)))
      (declare (not safe))
      (make-class-type
  ...
  (define |gerbil/core$<more-sugar>[1]#setf-macro::t|
    (let ((__tmp50824 (list gerbil/core$<macro-object>#macro-object::t)))
      (declare (not safe))
      (make-class-type
  ...
  (define |gerbil/core$<more-sugar>[1]#syntax-local-setf-macro?|
    (lambda (_stx33073_)
      (if (gx#identifier? _stx33073_)
          (let ((__tmp50825 (gx#syntax-local-value _stx33073_ false)))
            (declare (not safe))
            (class-instance?
             |gerbil/core$<more-sugar>[1]#setf-macro::t|
             __tmp50825))
  ...
  (define |gerbil/core$<more-sugar>[1]#syntax-local-setq-macro?|
    (lambda (_stx33070_)
      (if (gx#identifier? _stx33070_)
          (let ((__tmp50826 (gx#syntax-local-value _stx33070_ false)))
            (declare (not safe))
            (class-instance?
             |gerbil/core$<more-sugar>[1]#setq-macro::t|
             __tmp50826))
        ...
        (let ((___kont4708447085_
              ...
              (___kont4709247093_
               (lambda (_L33186_ _L33188_)
                 (let ((__tmp50832 (gx#datum->syntax '#f '%#set!))
                       (__tmp50830
                        (let ((__tmp50831
                               (let ()
                                 (declare (not safe))
                                ...
                                (let ((_g50834_
                                  ...
                                  (begin
                                    ...
                                    (let ((_target3345233486_
                                           (let ()
                                             (declare (not safe))
                                             (##vector-ref _g50834_ 0)))
                                          (_tl3345433489_
                                           (let ()
                                             (declare (not safe))
                                             (##vector-ref _g50834_ 1))))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                          (let ((__tmp50849
                            ...
                            (declare (not safe))
                            (foldr1 __tmp50849 '() _L33600_)))
                         (__tmp50847
                          (let () (declare (not safe)) (cons _L33526_ '()))))
                     (declare (not safe))
                     (cons __tmp50848 __tmp50847))))
              (declare (not safe))
              (cons __tmp50846 '())))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                   (__tmp50839
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                              ...
                              _g3361733632_)
                       (let ((__tmp50841
                              (let ((__tmp50844 (gx#datum->syntax '#f 'set!))
                                    (__tmp50842
                                     (let ((__tmp50843
                                            (let ()
                                              (declare (not safe))
                                              (cons _g3361533627_ '()))))
                                       (declare (not safe))
                                       (cons _g3361633630_ __tmp50843))))
                                (declare (not safe))
                                (cons __tmp50844 __tmp50842))))
                         (declare (not safe))
                         (cons __tmp50841 _g3361733632_)))))
                (declare (not safe))
                (foldr2 __tmp50840 '() _L33600_ _L33528_)))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                               (declare (not safe))
                                               (cons __tmp50845 __tmp50839))))
                                        (declare (not safe))
                                        (cons __tmp50850 __tmp50838))))
                                  _$e3355733596_))))))
    ...
    (lambda (_stx33653_)
      (let* ((___stx4717547176_ _stx33653_)
        ...
        (let ((___kont4717847179_
               (lambda (_L34049_)
                 (let ((__tmp50855 (gx#datum->syntax '#f 'let))
                       (__tmp50852
                        (let ((__tmp50853
                               (let ((__tmp50854
                                      (lambda (_g3406534068_ _g3406634071_)
                                        (let ()
                                          ...
                                          (cons _g3406534068_
                                                _g3406634071_)))))
                                 (declare (not safe))
                                 (foldr1 __tmp50854 '() _L34049_))))
                          (declare (not safe))
                          (cons '() __tmp50853))))
                   (declare (not safe))
                   (cons __tmp50855 __tmp50852))))
              (___kont4718247183_
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                         (not safe))
                       (##fx= _g50857_ 2)))
                (error "Context expects 2 values" _g50857_)))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                 ...
                 (declare (not safe))
                 (foldr1 __tmp50860 '() _L33933_))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                  (declare (not safe))
                                                  (cons _L33867_ __tmp50859))))
                                           (declare (not safe))
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                   ...
                   (_g3385133980_
                    (gx#stx-wrap-source
                     (let ((__tmp50869 (gx#datum->syntax '#f 'lambda))
                           (__tmp50866
                            (let ((__tmp50867
                                   (let ((__tmp50868
                                          (lambda (_g3398333986_ _g3398433989_)
                                            (let ()
                                              ...
                                              (cons _g3398333986_
                                                    _g3398433989_)))))
                                     (declare (not safe))
                                     (foldr1 __tmp50868 '() _L33826_))))
                              (declare (not safe))
                              (cons '() __tmp50867))))
                       (declare (not safe))
                       (cons __tmp50869 __tmp50866))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                  ...
                  (__tmp50875
                   (let ((__tmp50876
                     ...
                     (declare (not safe))
                     (foldr1 __tmp50876 '() _L34167_))))
              (declare (not safe))
              (cons __tmp50877 __tmp50875))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                               (declare (not safe))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                  ...
                  (__tmp50885
                   (let ((__tmp50886
                     ...
                     (declare (not safe))
                     (foldr1 __tmp50886 '() _L34285_))))
              (declare (not safe))
              (cons __tmp50887 __tmp50885))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                               (declare (not safe))
                                               (cons __tmp50888 __tmp50884))))
                                        (declare (not safe))
                                        (cons __tmp50883 '()))))
                                 (declare (not safe))
                                 (cons __tmp50889 __tmp50882))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                            2)))
              (error "Context expects 2 values" _g50891_)))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                            ...
                                            (lambda (_g3444034443_
                                              ...
                                              (let ()
                                                ...
                                                (cons _g3444034443_
                                                      _g3444134446_)))))
                                       (declare (not safe))
                                       (foldr1 __tmp50898 '() _L34417_))))
                                (declare (not safe))
                                (cons _L34419_ __tmp50897))))
                         (declare (not safe))
                         (cons '() __tmp50896))))
                  (declare (not safe))
                  (cons __tmp50899 __tmp50895))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                   (declare (not safe))
                                                   (cons __tmp50894 '()))))
                                            (declare (not safe))
                                            (cons __tmp50900 __tmp50893))))
                                     (declare (not safe))
                                     (cons __tmp50904 __tmp50892)))
                                 _rest3434434413_
                                 _hd3433434381_
                                 _hd3433134371_))))))
