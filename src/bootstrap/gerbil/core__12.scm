...
(begin
  ...
  (define |gerbil/core$<more-sugar>[1]#setq-macro::t|
    (let ((__tmp50559 (list gerbil/core$<macro-object>#macro-object::t)))
      (declare (not safe))
      (make-class-type
  ...
  (define |gerbil/core$<more-sugar>[1]#setf-macro::t|
    (let ((__tmp50560 (list gerbil/core$<macro-object>#macro-object::t)))
      (declare (not safe))
      (make-class-type
  ...
  (define |gerbil/core$<more-sugar>[1]#syntax-local-setf-macro?|
    (lambda (_stx32896_)
      (if (gx#identifier? _stx32896_)
          (let ((__tmp50561 (gx#syntax-local-value _stx32896_ false)))
            (declare (not safe))
            (class-instance?
             |gerbil/core$<more-sugar>[1]#setf-macro::t|
             __tmp50561))
  ...
  (define |gerbil/core$<more-sugar>[1]#syntax-local-setq-macro?|
    (lambda (_stx32893_)
      (if (gx#identifier? _stx32893_)
          (let ((__tmp50562 (gx#syntax-local-value _stx32893_ false)))
            (declare (not safe))
            (class-instance?
             |gerbil/core$<more-sugar>[1]#setq-macro::t|
             __tmp50562))
        ...
        (let ((___kont4690746908_
              ...
              (___kont4691546916_
               (lambda (_L33009_ _L33011_)
                 (let ((__tmp50568 (gx#datum->syntax '#f '%#set!))
                       (__tmp50566
                        (let ((__tmp50567
                               (let ()
                                 (declare (not safe))
                                 (cons _L33009_ '()))))
                          (declare (not safe))
                          (cons _L33011_ __tmp50567))))
                   (declare (not safe))
                   (cons __tmp50568 __tmp50566)))))
                                ...
                                (let ((_g50570_
                                  ...
                                  (begin
                                    ...
                                    (let ((_target3327533309_
                                           (let ()
                                             (declare (not safe))
                                             (##vector-ref _g50570_ 0)))
                                          (_tl3327733312_
                                           (let ()
                                             (declare (not safe))
                                             (##vector-ref _g50570_ 1))))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                             2)))
               (error "Context expects 2 values" _g50573_)))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                              ...
                              _g3344033455_)
                       (let ((__tmp50577
                              (let ((__tmp50580 (gx#datum->syntax '#f 'set!))
                                    (__tmp50578
                                     (let ((__tmp50579
                                            (let ()
                                              (declare (not safe))
                                              (cons _g3343833450_ '()))))
                                       (declare (not safe))
                                       (cons _g3343933453_ __tmp50579))))
                                (declare (not safe))
                                (cons __tmp50580 __tmp50578))))
                         (declare (not safe))
                         (cons __tmp50577 _g3344033455_)))))
                (declare (not safe))
                (foldr2 __tmp50576 '() _L33423_ _L33351_)))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                               (declare (not safe))
                                               (cons __tmp50581 __tmp50575))))
                                        (declare (not safe))
                                        (cons __tmp50586 __tmp50574))))
                                  _$e3338033419_))))))
    ...
    (lambda (_stx33476_)
      (let* ((___stx4699846999_ _stx33476_)
        ...
        (let ((___kont4700147002_
               (lambda (_L33872_)
                 (let ((__tmp50591 (gx#datum->syntax '#f 'let))
                       (__tmp50588
                        (let ((__tmp50589
                               (let ((__tmp50590
                                      (lambda (_g3388833891_ _g3388933894_)
                                        (let ()
                                          ...
                                          (cons _g3388833891_
                                                _g3388933894_)))))
                                 (declare (not safe))
                                 (foldr1 __tmp50590 '() _L33872_))))
                          (declare (not safe))
                          (cons '() __tmp50589))))
                   (declare (not safe))
                   (cons __tmp50591 __tmp50588))))
              (___kont4700547006_
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                         (not safe))
                       (##fx= _g50593_ 2)))
                (error "Context expects 2 values" _g50593_)))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                 ...
                 (declare (not safe))
                 (foldr1 __tmp50596 '() _L33756_))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                  (declare (not safe))
                                                  (cons _L33690_ __tmp50595))))
                                           (declare (not safe))
                                           (cons __tmp50597 __tmp50594)))))
                                   _arg3371333752_))))))
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                   ...
                   (_g3367433803_
                    (gx#stx-wrap-source
                     (let ((__tmp50605 (gx#datum->syntax '#f 'lambda))
                           (__tmp50602
                            (let ((__tmp50603
                                   (let ((__tmp50604
                                          (lambda (_g3380633809_ _g3380733812_)
                                            (let ()
                                              ...
                                              (cons _g3380633809_
                                                    _g3380733812_)))))
                                     (declare (not safe))
                                     (foldr1 __tmp50604 '() _L33649_))))
                              (declare (not safe))
                              (cons '() __tmp50603))))
                       (declare (not safe))
                       (cons __tmp50605 __tmp50602))
                                    ...
                                    (let ((_g50606_
                                      ...
                                      (begin
                                        ...
                                        (let ((_target3391933960_
                                               (let ()
                                                 (declare (not safe))
                                                 (##vector-ref _g50606_ 0)))
                                              (_tl3392133963_
                                               (let ()
                                                 (declare (not safe))
                                                 (##vector-ref _g50606_ 1))))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                  ...
                  (__tmp50611
                   (let ((__tmp50612
                     ...
                     (declare (not safe))
                     (foldr1 __tmp50612 '() _L33990_))))
              (declare (not safe))
              (cons __tmp50613 __tmp50611))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                               (declare (not safe))
                                               (cons __tmp50614 __tmp50610))))
                                        (declare (not safe))
                                        (cons __tmp50609 '()))))
                                 (declare (not safe))
                                 (cons __tmp50615 __tmp50608))
                                    ...
                                    (let ((_g50616_
                                      ...
                                      (begin
                                        ...
                                        (let ((_target3403734078_
                                               (let ()
                                                 (declare (not safe))
                                                 (##vector-ref _g50616_ 0)))
                                              (_tl3403934081_
                                               (let ()
                                                 (declare (not safe))
                                                 (##vector-ref _g50616_ 1))))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                  ...
                  (__tmp50621
                   (let ((__tmp50622
                     ...
                     (declare (not safe))
                     (foldr1 __tmp50622 '() _L34108_))))
              (declare (not safe))
              (cons __tmp50623 __tmp50621))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                               (declare (not safe))
                                               (cons __tmp50624 __tmp50620))))
                                        (declare (not safe))
                                        (cons __tmp50619 '()))))
                                 (declare (not safe))
                                 (cons __tmp50625 __tmp50618))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                            2)))
              (error "Context expects 2 values" _g50627_)))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                            ...
                                            (lambda (_g3426334266_
                                              ...
                                              (let ()
                                                ...
                                                (cons _g3426334266_
                                                      _g3426434269_)))))
                                       (declare (not safe))
                                       (foldr1 __tmp50634 '() _L34240_))))
                                (declare (not safe))
                                (cons _L34242_ __tmp50633))))
                         (declare (not safe))
                         (cons '() __tmp50632))))
                  (declare (not safe))
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                   ...
                                                   (cons __tmp50630 '()))))
                                            (declare (not safe))
                                            (cons __tmp50636 __tmp50629))))
                                     (declare (not safe))
                                     (cons __tmp50640 __tmp50628)))
                                 _rest3416734236_
                                 _hd3415734204_
                                 _hd3415434194_))))))
