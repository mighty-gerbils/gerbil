...
(begin
  (define gerbil/core$<MOP>$<MOP:2>::timestamp 1707565655)
  (begin
                              ...
                              (let ((_g47306_
                                ...
                                (begin
                                  ...
                                  (let ((_target1931919345_
                                         (let ()
                                           (declare (not safe))
                                           (##vector-ref _g47306_ 0)))
                                        (_tl1932119347_
                                         (let ()
                                           (declare (not safe))
                                           (##vector-ref _g47306_ 1))))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                    ...
                    (let ((__tmp47310
                      ...
                      (declare (not safe))
                      (_loop1932219350_ _lp-tl1932519363_ __tmp47310))))
                                            ...
                                            (lambda (_g1938719390_
                                              ...
                                              (let ()
                                                ...
                                                (cons _g1938719390_
                                                      _g1938819392_)))))
                                       (declare (not safe))
                                       (foldr1 __tmp47309 '() _L19369_))))
                                (declare (not safe))
                                (cons _make19386_ __tmp47308)))
                            _$e19383_)
                           (gx#raise-syntax-error
                            '#f
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
    ...
    (define gerbil/core$<MOP>$<MOP:2>#syntax-local-class-type-info?
      (lambda _g47312_
        (let ((_g47311_ (let () (declare (not safe)) (##length _g47312_))))
          (cond ((let () (declare (not safe)) (##fx= _g47311_ 1))
                 (apply (lambda (_stx19303_)
                          (let ()
                            ...
                            (gerbil/core$<MOP>$<MOP:2>#syntax-local-class-type-info?__0
                             _stx19303_)))
                        _g47312_))
                ((let () (declare (not safe)) (##fx= _g47311_ 2))
