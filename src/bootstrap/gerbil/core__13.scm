...
(begin
  (define |gerbil/core$<more-sugar>[2]#_g34917_|
    (gx#make-syntax-quote 'setq-macro::t #f (gx#current-expander-context) '()))
  (define |gerbil/core$<more-sugar>[2]#_g34918_|
    (gx#make-syntax-quote
     'macro-object::t
     #f
     (gx#current-expander-context)
     '()))
  (define |gerbil/core$<more-sugar>[2]#_g34919_|
    (gx#make-syntax-quote 'setq-macro::t #f (gx#current-expander-context) '()))
  (define |gerbil/core$<more-sugar>[2]#_g34920_|
    (gx#make-syntax-quote
     'make-setq-macro
     #f
     (gx#current-expander-context)
     '()))
  (define |gerbil/core$<more-sugar>[2]#_g34921_|
  ...
  (begin
    (define |gerbil/core$<more-sugar>[:1:]#setq-macro|
      (|gerbil/core$<MOP>$<MOP:2>[1]#make-extended-class-info|
       'runtime-identifier:
       |gerbil/core$<more-sugar>[2]#_g34917_|
       'expander-identifiers:
       (cons (cons |gerbil/core$<more-sugar>[2]#_g34918_| '())
             (cons |gerbil/core$<more-sugar>[2]#_g34919_|
                   (cons |gerbil/core$<more-sugar>[2]#_g34920_|
                         (cons |gerbil/core$<more-sugar>[2]#_g34921_|
                               (cons '() (cons '() '()))))))
       'type-exhibitor:
       (|gerbil/core$<MOP>$<MOP:2>[1]#make-runtime-class-exhibitor|
        'gerbil.core#setq-macro::t
        (list |gerbil/core$<more-sugar>[2]#_g34922_|)
        'setq-macro
        '#f
        '()
        '())))
    (define |gerbil/core$<more-sugar>[:1:]#setf-macro|
      (|gerbil/core$<MOP>$<MOP:2>[1]#make-extended-class-info|
       'runtime-identifier:
       |gerbil/core$<more-sugar>[2]#_g34923_|
       'expander-identifiers:
       (cons (cons |gerbil/core$<more-sugar>[2]#_g34924_| '())
             (cons |gerbil/core$<more-sugar>[2]#_g34925_|
                   (cons |gerbil/core$<more-sugar>[2]#_g34926_|
                         (cons |gerbil/core$<more-sugar>[2]#_g34927_|
                               (cons '() (cons '() '()))))))
       'type-exhibitor:
       (|gerbil/core$<MOP>$<MOP:2>[1]#make-runtime-class-exhibitor|
        'gerbil.core#setf-macro::t
        (list |gerbil/core$<more-sugar>[2]#_g34928_|)
        'setf-macro
        '#f
        '()
        '())))))
