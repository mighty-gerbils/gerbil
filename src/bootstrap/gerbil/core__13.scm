...
(begin
  ...
  (define |gerbil/core$<more-sugar>[2]#_g31794_|
    (gx#make-syntax-quote 'setf-macro::t #f (gx#current-expander-context) '()))
  (define |gerbil/core$<more-sugar>[2]#_g31795_|
    (gx#make-syntax-quote
     'make-setf-macro
     #f
     (gx#current-expander-context)
     '()))
  (define |gerbil/core$<more-sugar>[2]#_g31796_|
    (gx#make-syntax-quote 'setf-macro? #f (gx#current-expander-context) '()))
  (define |gerbil/core$<more-sugar>[2]#_g31797_|
    (gx#make-syntax-quote 'macro-object #f (gx#current-expander-context) '()))
  (begin
    (define |gerbil/core$<more-sugar>[:1:]#setq-macro|
      (|gerbil/core$<MOP>$<MOP:2>[1]#make-extended-class-info|
       'runtime-identifier:
       |gerbil/core$<more-sugar>[2]#_g31786_|
       'expander-identifiers:
       (cons (cons |gerbil/core$<more-sugar>[2]#_g31787_| '())
             (cons |gerbil/core$<more-sugar>[2]#_g31788_|
                   (cons |gerbil/core$<more-sugar>[2]#_g31789_|
                         (cons |gerbil/core$<more-sugar>[2]#_g31790_|
                               (cons '() (cons '() '()))))))
       'type-exhibitor:
       (|gerbil/core$<MOP>$<MOP:2>[1]#make-runtime-class-exhibitor|
        'gerbil.core#setq-macro::t
        (list |gerbil/core$<more-sugar>[2]#_g31791_|)
        'setq-macro
        '#f
        '()
        '())))
    (define |gerbil/core$<more-sugar>[:1:]#setf-macro|
      (|gerbil/core$<MOP>$<MOP:2>[1]#make-extended-class-info|
       'runtime-identifier:
       |gerbil/core$<more-sugar>[2]#_g31792_|
       'expander-identifiers:
       (cons (cons |gerbil/core$<more-sugar>[2]#_g31793_| '())
             (cons |gerbil/core$<more-sugar>[2]#_g31794_|
                   (cons |gerbil/core$<more-sugar>[2]#_g31795_|
                         (cons |gerbil/core$<more-sugar>[2]#_g31796_|
                               (cons '() (cons '() '()))))))
       'type-exhibitor:
       (|gerbil/core$<MOP>$<MOP:2>[1]#make-runtime-class-exhibitor|
        'gerbil.core#setf-macro::t
        (list |gerbil/core$<more-sugar>[2]#_g31797_|)
        'setf-macro
        '#f
        '()
        '())))))
