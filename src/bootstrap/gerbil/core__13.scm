...
(begin
  ...
  (define |gerbil/core::<more-sugar>[2]#_g29635_|
    (gx#core-quote-syntax 'macro-object))
  (begin
    (define |gerbil/core::<more-sugar>[:1:]#setq-macro|
      (|gerbil/core::<MOP>::<MOP:2>[1]#make-extended-class-info|
       'runtime-identifier:
       |gerbil/core::<more-sugar>[2]#_g29624_|
       'expander-identifiers:
       (cons (cons |gerbil/core::<more-sugar>[2]#_g29625_| '())
       ...
       (|gerbil/core::<MOP>::<MOP:2>[1]#make-runtime-class-exhibitor|
        ...
        (list |gerbil/core::<more-sugar>[2]#_g29629_|)
        'setq-macro
        '#f
        '()
        '())))
    (define |gerbil/core::<more-sugar>[:1:]#setf-macro|
      (|gerbil/core::<MOP>::<MOP:2>[1]#make-extended-class-info|
       'runtime-identifier:
       |gerbil/core::<more-sugar>[2]#_g29630_|
       'expander-identifiers:
       (cons (cons |gerbil/core::<more-sugar>[2]#_g29631_| '())
             (cons |gerbil/core::<more-sugar>[2]#_g29632_|
                   (cons |gerbil/core::<more-sugar>[2]#_g29633_|
                         (cons |gerbil/core::<more-sugar>[2]#_g29634_|
                               (cons '() (cons '() '()))))))
       'type-exhibitor:
       (|gerbil/core::<MOP>::<MOP:2>[1]#make-runtime-class-exhibitor|
        'gerbil.core#setf-macro::t
        (list |gerbil/core::<more-sugar>[2]#_g29635_|)
        'setf-macro
        '#f
        '()
        '())))))
