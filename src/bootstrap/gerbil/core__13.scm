...
(begin
  ...
  (define |gerbil/core::<more-sugar>[2]#_g30437_|
    (gx#core-quote-syntax 'macro-object))
  (begin
    (define |gerbil/core::<more-sugar>[:1:]#setq-macro|
      (|gerbil/core::<MOP>::<MOP:2>[1]#make-extended-class-info|
       'runtime-identifier:
       |gerbil/core::<more-sugar>[2]#_g30426_|
       'expander-identifiers:
       (cons (cons |gerbil/core::<more-sugar>[2]#_g30427_| '())
             (cons |gerbil/core::<more-sugar>[2]#_g30428_|
                   (cons |gerbil/core::<more-sugar>[2]#_g30429_|
                         (cons |gerbil/core::<more-sugar>[2]#_g30430_|
                               (cons '() (cons '() '()))))))
       'type-exhibitor:
       (|gerbil/core::<MOP>::<MOP:2>[1]#make-runtime-class-exhibitor|
        'gerbil.core#setq-macro::t
        (list |gerbil/core::<more-sugar>[2]#_g30431_|)
        'setq-macro
        '#f
        '()
        '())))
    (define |gerbil/core::<more-sugar>[:1:]#setf-macro|
      (|gerbil/core::<MOP>::<MOP:2>[1]#make-extended-class-info|
       'runtime-identifier:
       |gerbil/core::<more-sugar>[2]#_g30432_|
       'expander-identifiers:
       (cons (cons |gerbil/core::<more-sugar>[2]#_g30433_| '())
             (cons |gerbil/core::<more-sugar>[2]#_g30434_|
                   (cons |gerbil/core::<more-sugar>[2]#_g30435_|
                         (cons |gerbil/core::<more-sugar>[2]#_g30436_|
                               (cons '() (cons '() '()))))))
       'type-exhibitor:
       (|gerbil/core::<MOP>::<MOP:2>[1]#make-runtime-class-exhibitor|
        'gerbil.core#setf-macro::t
        (list |gerbil/core::<more-sugar>[2]#_g30437_|)
        'setf-macro
        '#f
        '()
        '())))))
