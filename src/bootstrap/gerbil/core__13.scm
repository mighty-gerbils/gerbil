...
(begin
  (define |gerbil/core$<more-sugar>[2]#_g35370_|
  ...
  (begin
    (define |gerbil/core$<more-sugar>[:1:]#setq-macro|
      (|gerbil/core$<MOP>$<MOP:2>[1]#make-extended-class-info|
       'runtime-identifier:
       |gerbil/core$<more-sugar>[2]#_g35370_|
       'expander-identifiers:
       (cons (cons |gerbil/core$<more-sugar>[2]#_g35371_| '())
             (cons |gerbil/core$<more-sugar>[2]#_g35372_|
       ...
       (|gerbil/core$<MOP>$<MOP:2>[1]#make-runtime-class-exhibitor|
        ...
        (list |gerbil/core$<more-sugar>[2]#_g35375_|)
        'setq-macro
        '#f
        '()
        '())))
    (define |gerbil/core$<more-sugar>[:1:]#setf-macro|
      (|gerbil/core$<MOP>$<MOP:2>[1]#make-extended-class-info|
       'runtime-identifier:
       |gerbil/core$<more-sugar>[2]#_g35376_|
       'expander-identifiers:
       (cons (cons |gerbil/core$<more-sugar>[2]#_g35377_| '())
             (cons |gerbil/core$<more-sugar>[2]#_g35378_|
       ...
       (|gerbil/core$<MOP>$<MOP:2>[1]#make-runtime-class-exhibitor|
        ...
        (list |gerbil/core$<more-sugar>[2]#_g35381_|)
        'setf-macro
        '#f
        '()
        '())))))
