...
(begin
  ...
  (define |gerbil/core$<sugar>$<sugar:2>[1]#_g50989_|
    (##structure
     ...
     (gx#current-expander-context)
     '()))
  (define |gerbil/core$<sugar>$<sugar:2>[1]#_g51033_|
    (##structure
     gx#syntax-quote::t
     'unquote-splicing
     #f
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                 ...
                 (if (gx#stx-null? _tl1601616048_)
                     ((lambda (_L16051_ _L16053_)
                        (let ()
                          (let ((__tmp51026 (gx#datum->syntax '#f 'cons))
                                (__tmp51024
                                 (let ((__tmp51025
                                        (let ()
                                          (declare (not safe))
                                          (cons _L16051_ '()))))
                                   (declare (not safe))
                                   (cons _L16053_ __tmp51025))))
                            (declare (not safe))
                            (cons __tmp51026 __tmp51024))))
                      _hd1601716045_
                      _hd1601416035_)
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                            ...
                            (___kont4628446285_
                             (lambda (_L15823_)
                               (let ((__tmp51032 (gx#datum->syntax '#f 'quote))
                                     (__tmp51031
                                      (let ()
                                        (declare (not safe))
                                        (cons _L15823_ '()))))
                                 (declare (not safe))
                                 (cons __tmp51032 __tmp51031)))))
                        (let* ((_g1575615885_
                                (lambda ()
                                          ...
                                          (let ((_e1578816090_
                                            ...
                                            (let ((_tl1578616097_
                                              ...
                                              (if (gx#identifier?
                                                   _hd1578716094_)
                                                  (if (gx#free-identifier=?
                                                       |gerbil/core$<sugar>$<sugar:2>[1]#_g51033_|
                                                       _hd1578716094_)
                                                      (if (gx#stx-pair?
                                                           _tl1578616097_)
                                                          (let ((_e1579116100_
