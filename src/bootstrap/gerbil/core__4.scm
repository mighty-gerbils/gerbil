...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                             '#!void
                             (foldr (lambda (_g71017106_ _g71027109_)
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                               '#!void
                               (foldr (lambda (_g66626667_ _g66636670_)
                                        (cons _g66626667_ _g66636670_))
                                      (begin
                                        '#!void
                                        (foldr (lambda (_g66646673_
                                                        _g66656676_)
                                                 (cons _g66646673_
                                                       _g66656676_))
                                               (cons _L6648_ '())
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                       ...
                       (let ()
                         (list (list (begin
                                       '#!void
                                       (foldr (lambda (_g68716876_ _g68726879_)
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                 ...
                 (_generate-fixnum-dispatch8883_
                  (lambda (_e9497_ _datums9499_ _dispatch9500_ _default9501_)
                    (if (if (>= (_min-fixnum8880_ _datums9499_) '0)
                                          ...
                                          (if (gx#stx-null? _tl1192411964_)
                                              ((lambda (_L11967_ _L11969_)
                                                 (let ((_datum-e11985_
                                                        (gx#stx-e _L11969_)))
                                                   (if (let ((_$e11988_
                                                              (symbol? _datum-e11985_)))
                                                         (if _$e11988_
                                                             _$e11988_
                                                             (let ((_$e11992_
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                            (keyword? _datum-e11985_)))
                       (if _$e11992_ _$e11992_ (immediate? _datum-e11985_)))))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                         _g1210512110_)
                  (cons _g1210412107_ _g1210512110_))
                '()
                _L12085_))))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                           _K1202212081_
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                          _g1286012865_)
                   (cons _g1285912862_ _g1286012865_))
                 '()
                 _L12821_))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                _mid12857_)))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                         _g1342113441_)
                  (cons _g1342013438_ _g1342113441_))
                '()
                _L13372_))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                   (cons (cons (gx#datum->syntax '#f 'begin)
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                         _g1342313447_)
                  (cons _g1342213444_ _g1342313447_))
