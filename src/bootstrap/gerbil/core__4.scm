...
(begin
  ...
  (define |gerbil/core$<sugar>$<sugar:2>[1]#_g49082_|
    (##structure
     ...
     (gx#current-expander-context)
     '()))
  (define |gerbil/core$<sugar>$<sugar:2>[1]#_g51194_|
    (##structure
     gx#syntax-quote::t
     '<...>
     #f
     (gx#current-expander-context)
     '()))
  (define |gerbil/core$<sugar>$<sugar:2>[1]#_g51195_|
    (##structure gx#syntax-quote::t '<> #f (gx#current-expander-context) '()))
  (begin
      ...
      (lambda (_$stx16615_)
        (let* ((___stx4429444295_ _$stx16615_)
          ...
          (let ((___kont4429744298_
                 (lambda (_L16709_)
                   (let ((__tmp51186 (gx#datum->syntax '#f 'quote))
                         (__tmp51185
                ...
                (___kont4429944300_
                 (lambda (_L16668_)
                   (let ((__tmp51192 (gx#datum->syntax '#f 'make-promise))
                         (__tmp51187
                          (let ((__tmp51188
                                 (let ((__tmp51191
                                        (gx#datum->syntax '#f 'lambda%))
                                       (__tmp51189
                                        (let ((__tmp51190
                                          ...
                                          (cons '() __tmp51190))))
                                   (declare (not safe))
                                   (cons __tmp51191 __tmp51189))))
                            (declare (not safe))
                            (cons __tmp51188 '()))))
                     (declare (not safe))
                     (cons __tmp51192 __tmp51187)))))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                            _tail16948_
                            _hd16856_))
                  (let ((__tmp51193 (list _tail16948_)))
                    (declare (not safe))
                    (foldl1 cons __tmp51193 _body16857_))
                  '#t))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                (gx#raise-syntax-error
                                                 '#f
                                     ...
                                     (if (gx#identifier? ___stx4433244333_)
                                         (if (gx#free-identifier=?
                                              |gerbil/core$<sugar>$<sugar:2>[1]#_g51195_|
                                              ___stx4433244333_)
                                             (___kont4433544336_)
                                             (if (gx#free-identifier=?
                                                  |gerbil/core$<sugar>$<sugar:2>[1]#_g51194_|
                                                  ___stx4433244333_)
                                                 (___kont4433744338_)
                                                 (___kont4433944340_)))
                                         (___kont4433944340_))))))
                            ...
                            ((lambda (_L16760_)
                               (if (and (gx#stx-list? _L16760_)
                                        (let ((__tmp51206
                                          ...
                                          (declare (not safe))
                                          (not __tmp51206)))
                                   (let ((_g51196_ (_generate16729_ _L16760_)))
                                     (begin
                                       (let ((_g51197_
                                              (let ()
                                                (declare (not safe))
                                                (if (##values? _g51196_)
                                                    (##vector-length _g51196_)
                                                    1))))
                                         (if (not (let ()
                                                    (declare (not safe))
                                                    (##fx= _g51197_ 3)))
                                       ...
                                       (let ((_hd16773_
                                              (let ()
                                                (declare (not safe))
                                                (##vector-ref _g51196_ 0)))
                                             (_body16775_
                                              (let ()
                                                (declare (not safe))
                                                (##vector-ref _g51196_ 1)))
                                             (_tail?16776_
                                              (let ()
                                                (declare (not safe))
                                                (##vector-ref _g51196_ 2))))
                                         (let* ((_g1677816786_
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                         (gx#datum->syntax '#f 'apply)))
                    (declare (not safe))
                    (cons __tmp51204 _L16821_))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                     (declare (not safe))
                                                     (cons __tmp51203 '()))))
                                              (declare (not safe))
                                              (cons _L16793_ __tmp51202))))
                                       (declare (not safe))
                                       (cons __tmp51205 __tmp51201))
                                     (let ((__tmp51200
                                            (gx#datum->syntax '#f 'lambda%))
                                           (__tmp51198
                                            (let ((__tmp51199
                                                   (let ()
                                                     ...
                                                     (cons _L16821_ '()))))
                                              (declare (not safe))
                                              (cons _L16793_ __tmp51199))))
                                       (declare (not safe))
                                       (cons __tmp51200 __tmp51198))))))
                           _g1680716818_))))
