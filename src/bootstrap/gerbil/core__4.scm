...
(begin
  ...
  (define |gerbil/core$<sugar>$<sugar:2>[1]#_g51036_|
    (##structure
     ...
     (gx#current-expander-context)
     '()))
  (define |gerbil/core$<sugar>$<sugar:2>[1]#_g51047_|
    (##structure
     gx#syntax-quote::t
     '<...>
     #f
      ...
      (lambda (_$stx16615_)
        (let* ((___stx4639146392_ _$stx16615_)
          ...
          (let ((___kont4639446395_
                 (lambda (_L16709_)
                   (let ((__tmp51040 (gx#datum->syntax '#f 'quote))
                         (__tmp51039
                          (let () (declare (not safe)) (cons _L16709_ '()))))
                     (declare (not safe))
                     (cons __tmp51040 __tmp51039))))
                (___kont4639646397_
                 (lambda (_L16668_)
                   (let ((__tmp51046 (gx#datum->syntax '#f 'make-promise))
                         (__tmp51041
                          (let ((__tmp51042
                                 (let ((__tmp51045
                                        (gx#datum->syntax '#f 'lambda%))
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                     ...
                                     (if (gx#identifier? ___stx4642946430_)
                                         (if (gx#free-identifier=?
                                             ...
                                             (___kont4643246433_)
                                             (if (gx#free-identifier=?
                                                  |gerbil/core$<sugar>$<sugar:2>[1]#_g51047_|
                                                  ___stx4642946430_)
                                                 (___kont4643446435_)
                                                 (___kont4643646437_)))
                                         (___kont4643646437_))))))
                            ...
                            ((lambda (_L16760_)
                               (if (and (gx#stx-list? _L16760_)
                                        (let ((__tmp51059
                                          ...
                                          (declare (not safe))
                                          (not __tmp51059)))
                                   (let ((_g51049_ (_generate16729_ _L16760_)))
                                     (begin
                                       (let ((_g51050_
                                              (let ()
                                                (declare (not safe))
                                                (if (##values? _g51049_)
                                                    (##vector-length _g51049_)
                                                    1))))
                                         (if (not (let ()
                                                    (declare (not safe))
                                                    (##fx= _g51050_ 3)))
                                       ...
                                       (let ((_hd16773_
                                              (let ()
                                                (declare (not safe))
                                                (##vector-ref _g51049_ 0)))
                                             (_body16775_
                                              (let ()
                                                (declare (not safe))
                                                (##vector-ref _g51049_ 1)))
                                             (_tail?16776_
                                              (let ()
                                                (declare (not safe))
                                                (##vector-ref _g51049_ 2))))
                                         (let* ((_g1677816786_
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                         (gx#datum->syntax '#f 'apply)))
                    (declare (not safe))
                    (cons __tmp51057 _L16821_))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                     (declare (not safe))
                                                     (cons __tmp51056 '()))))
                                              (declare (not safe))
                                              (cons _L16793_ __tmp51055))))
                                       (declare (not safe))
                                       (cons __tmp51058 __tmp51054))
                                     (let ((__tmp51053
                                            (gx#datum->syntax '#f 'lambda%))
                                           (__tmp51051
                                            (let ((__tmp51052
