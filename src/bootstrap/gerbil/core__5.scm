...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
            ...
            (let* ((___match4391543916_
              ...
              (if (gx#stx-pair? ___stx4386043861_)
                  (let ((_e1701517110_ (gx#syntax-e ___stx4386043861_)))
                    (let ((_tl1701317117_
                        ...
                        (begin
                          (let ((_g48590_
                                 (let ()
                                   (declare (not safe))
                                   (if (##values? _g48589_)
                                       (##vector-length _g48589_)
                                       1))))
                            (if (not (let ()
                                       (declare (not safe))
                                       (##fx= _g48590_ 2)))
                                (error "Context expects 2 values" _g48590_)))
                          (let ((_target1740917430_
                                 (let ()
                                   (declare (not safe))
                                   (##vector-ref _g48589_ 0)))
                                (_tl1741117433_
                                 (let ()
                                   (declare (not safe))
                                   (##vector-ref _g48589_ 1))))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                        ...
                        (cons _L17492_ '()))))
                 (declare (not safe))
                 (cons _L17520_ __tmp48592))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                  (declare (not safe))
                                                  (cons __tmp48593 __tmp48591))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                 ...
                 (declare (not safe))
                 (foldr1 __tmp48599 '() _L17345_))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                  (declare (not safe))
                                                  (cons _L17394_ __tmp48598)))
                                               (__tmp48595
                                                (let ((__tmp48596
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                    ...
                                    (declare (not safe))
                                    (cons __tmp48600 __tmp48594))
                                  (gx#stx-source _stx17206_))))))
                          _g1747817489_))))
                 (_g1747617555_
                  (gx#stx-wrap-source
                   (let ((__tmp48632 (gx#datum->syntax '#f 'defrules))
                         (__tmp48601
                          (let ((__tmp48602
                                 (let ((__tmp48603
                                        (let ((__tmp48616
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                     (__tmp48617
                                                      (let ((__tmp48618
                                                             (let ((__tmp48621
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                            (let ((__tmp48627 (gx#datum->syntax '#f 'lambda))
                                  (__tmp48622
                                   (let ((__tmp48625
                                          (let ((__tmp48626
                                                 ...
                                                 (lambda (_g1756017579_
                                                   ...
                                                   (let ()
                                                     ...
                                                     (cons _g1756017579_
                                                           _g1756117582_)))))
                                            (declare (not safe))
                                            (foldr1 __tmp48624 '() _L17343_))))
                                     (declare (not safe))
                                     (cons __tmp48625 __tmp48623))))
                              (declare (not safe))
                              (cons __tmp48627 __tmp48622)))
                           (__tmp48619
                            (let ((__tmp48620
                              ...
                              (declare (not safe))
                              (foldr1 __tmp48620 '() _L17460_))))
                       (declare (not safe))
                       (cons __tmp48621 __tmp48619))))
                (declare (not safe))
                (cons __tmp48618 '()))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                 (declare (not safe))
                                                 (cons __tmp48628 __tmp48617)))
                                              (__tmp48604
                                               (let ((__tmp48605
                                                      (let ((__tmp48615
                                                             (gx#datum->syntax
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                       ...
                       (declare (not safe))
                       (cons __tmp48608 __tmp48607))))
                (declare (not safe))
                (cons __tmp48615 __tmp48606))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                 (declare (not safe))
                                                 (cons __tmp48605 '()))))
                                          (declare (not safe))
                                          (cons __tmp48616 __tmp48604))))
                                   (declare (not safe))
                                   (cons '() __tmp48603))))
                            (declare (not safe))
                            (cons _L17346_ __tmp48602))))
                     (declare (not safe))
                     (cons __tmp48632 __tmp48601))
                   (gx#stx-source _stx17206_))))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                   _xarg1741717456_))))))
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
            ...
            (let* ((___match4398343984_
              ...
              (if (gx#stx-pair? ___stx4391843919_)
                  (let ((_e1762517719_ (gx#syntax-e ___stx4391843919_)))
                    (let ((_tl1762317726_
