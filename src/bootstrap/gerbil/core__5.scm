...
(begin
  (define |gerbil/core$<sugar>$<sugar:3>[1]#_g48880_|
    (##structure
     gx#syntax-quote::t
     'quote
     #f
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                ...
                (declare (not safe))
                (foldr1 __tmp48801 '() _L17170_))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                 (declare (not safe))
                                                 (cons _L17172_ __tmp48800))))
                                          (declare (not safe))
                                          (cons __tmp48802 __tmp48799))))
                                   (declare (not safe))
                                   (cons __tmp48798 '()))))
                            (declare (not safe))
                            (cons _L17173_ __tmp48797))))
                     (declare (not safe))
                     (cons __tmp48803 __tmp48796))))
                (___kont4409144092_
                 (lambda (_L17084_ _L17086_)
                   (let ((__tmp48806 (gx#datum->syntax '#f 'define-syntax))
                         (__tmp48804
                          (let ((__tmp48805
                                 (let ()
                                   (declare (not safe))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                         (not safe))
                       (##fx= _g48808_ 2)))
                (error "Context expects 2 values" _g48808_)))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                      ...
                                      (let ((_g48809_
                                        ...
                                        (begin
                                          ...
                                          (let ((_target1723217313_
                                                 (let ()
                                                   (declare (not safe))
                                                   (##vector-ref _g48809_ 0)))
                                                (_tl1723417316_
                                                 (let ()
                                                   (declare (not safe))
                                                   (##vector-ref _g48809_ 1))))
                        ...
                        (begin
                          (let ((_g48812_
                                 (let ()
                                   (declare (not safe))
                                   (if (##values? _g48811_)
                                       (##vector-length _g48811_)
                                       1))))
                            (if (not (let ()
                                       (declare (not safe))
                                       (##fx= _g48812_ 2)))
                                (error "Context expects 2 values" _g48812_)))
                          (let ((_target1740917430_
                                 (let ()
                                   (declare (not safe))
                                   (##vector-ref _g48811_ 0)))
                                (_tl1741117433_
                                 (let ()
                                   (declare (not safe))
                                   (##vector-ref _g48811_ 1))))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                 ...
                 (declare (not safe))
                 (foldr1 __tmp48821 '() _L17345_))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                  (declare (not safe))
                                                  (cons _L17394_ __tmp48820)))
                                               (__tmp48817
                                                (let ((__tmp48818
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                    ...
                                    (declare (not safe))
                                    (cons __tmp48822 __tmp48816))
                                  (gx#stx-source _stx17206_))))))
                          _g1747817489_))))
                 (_g1747617555_
                  (gx#stx-wrap-source
                   (let ((__tmp48854 (gx#datum->syntax '#f 'defrules))
                         (__tmp48823
                          (let ((__tmp48824
                                 (let ((__tmp48825
                                        (let ((__tmp48838
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                     (__tmp48839
                                                      (let ((__tmp48840
                                                             (let ((__tmp48843
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                            (let ((__tmp48849 (gx#datum->syntax '#f 'lambda))
                                  (__tmp48844
                                   (let ((__tmp48847
                                          (let ((__tmp48848
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                       ...
                       (declare (not safe))
                       (cons __tmp48830 __tmp48829))))
                (declare (not safe))
                (cons __tmp48837 __tmp48828))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                 (declare (not safe))
                                                 (cons __tmp48827 '()))))
                                          (declare (not safe))
                                   ...
                                   (cons '() __tmp48825))))
                            (declare (not safe))
                            (cons _L17346_ __tmp48824))))
                     (declare (not safe))
                     (cons __tmp48854 __tmp48823))
                   (gx#stx-source _stx17206_))))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                   _xarg1741717456_))))))
        ...
        (let* ((___stx4414244143_ _$stx17614_)
          ...
          (let ((___kont4414544146_
                 (lambda (_L17769_ _L17771_)
                   (let ((__tmp48874 (gx#datum->syntax '#f 'defrules))
                         (__tmp48857
                          (let ((__tmp48858
                                 (let ((__tmp48859
                                        (let ((__tmp48860
                                   ...
                                   (let ((__tmp48871
                                         ...
                                         (__tmp48869
                                          (let ((__tmp48870
                                            ...
                                            (cons __tmp48870 '()))))
                                     (declare (not safe))
                                     (cons __tmp48871 __tmp48869))))
                              (declare (not safe))
                              (cons __tmp48868 '()))))
                       (declare (not safe))
                       (cons __tmp48872 __tmp48867)))
                    (__tmp48862
                     (let ((__tmp48863
                            (let ((__tmp48865 (gx#datum->syntax '#f 'quote))
                                  (__tmp48864
                                   (let ()
                                     (declare (not safe))
                                     (cons _L17769_ '()))))
                              (declare (not safe))
                              (cons __tmp48865 __tmp48864))))
                       (declare (not safe))
                       (cons __tmp48863 '()))))
                (declare (not safe))
                (cons __tmp48866 __tmp48862))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                 (declare (not safe))
                                                 (cons __tmp48873
                                                       __tmp48861))))
                                   ...
                                   (cons '() __tmp48859))))
                            (declare (not safe))
                            (cons _L17771_ __tmp48858))))
                     (declare (not safe))
                     (cons __tmp48874 __tmp48857))))
                (___kont4414744148_
                   ...
                   (let ((__tmp48875
                          (let ((__tmp48876
                                 (let ((__tmp48877
                                   ...
                                   (cons __tmp48877 '()))))
                            (declare (not safe))
                            (cons _L17694_ __tmp48876))))
                     (declare (not safe))
                     (cons _L17695_ __tmp48875)))))
                                            ...
                                            (let ((_tl1763217756_
                                              ...
                                              (if (gx#identifier?
                                                  ...
                                                  (if (gx#free-identifier=?
                                                       |gerbil/core$<sugar>$<sugar:3>[1]#_g48880_|
                                                       _hd1763317753_)
                                                      (if (gx#stx-pair?
                                                           _tl1763217756_)
                                                          (let ((_e1763717759_
