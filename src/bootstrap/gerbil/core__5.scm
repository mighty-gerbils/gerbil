...
(begin
  (define |gerbil/core$<sugar>$<sugar:3>[1]#_g48844_|
    (##structure
     gx#syntax-quote::t
     'quote
     #f
        ...
        (let* ((___stx4418444185_ _$stx17003_)
          ...
          (let ((___kont4418744188_
                 (lambda (_L17170_ _L17172_ _L17173_)
                   (let ((__tmp48767 (gx#datum->syntax '#f 'define-syntax))
                         (__tmp48760
                          (let ((__tmp48761
                                 (let ((__tmp48762
                                        (let ((__tmp48766
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                ...
                (declare (not safe))
                (foldr1 __tmp48765 '() _L17170_))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                 (declare (not safe))
                                                 (cons _L17172_ __tmp48764))))
                                          (declare (not safe))
                                          (cons __tmp48766 __tmp48763))))
                                   (declare (not safe))
                                   (cons __tmp48762 '()))))
                            (declare (not safe))
                            (cons _L17173_ __tmp48761))))
                     (declare (not safe))
                     (cons __tmp48767 __tmp48760))))
                (___kont4419144192_
                 (lambda (_L17084_ _L17086_)
                   (let ((__tmp48770 (gx#datum->syntax '#f 'define-syntax))
                         (__tmp48768
                          (let ((__tmp48769
                                 (let ()
                                   (declare (not safe))
                                   (cons _L17084_ '()))))
                            (declare (not safe))
                            (cons _L17086_ __tmp48769))))
                     (declare (not safe))
                     (cons __tmp48770 __tmp48768)))))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                         (not safe))
                       (##fx= _g48772_ 2)))
                (error "Context expects 2 values" _g48772_)))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                        ...
                        (begin
                          (let ((_g48776_
                                 (let ()
                                   (declare (not safe))
                                   (if (##values? _g48775_)
                                       (##vector-length _g48775_)
                                       1))))
                            (if (not (let ()
                                       (declare (not safe))
                                       (##fx= _g48776_ 2)))
                                (error "Context expects 2 values" _g48776_)))
                          (let ((_target1740917430_
                                 (let ()
                                   (declare (not safe))
                                   (##vector-ref _g48775_ 0)))
                                (_tl1741117433_
                                 (let ()
                                   (declare (not safe))
                                   (##vector-ref _g48775_ 1))))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                        ...
                        (cons _L17492_ '()))))
                 (declare (not safe))
                 (cons _L17520_ __tmp48778))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                  (declare (not safe))
                                                  (cons __tmp48779 __tmp48777))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                 ...
                 (declare (not safe))
                 (foldr1 __tmp48785 '() _L17345_))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                  (declare (not safe))
                                                  (cons _L17394_ __tmp48784)))
                                               (__tmp48781
                                                (let ((__tmp48782
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                    ...
                                    (declare (not safe))
                                    (cons __tmp48786 __tmp48780))
                                  (gx#stx-source _stx17206_))))))
                          _g1747817489_))))
                 (_g1747617555_
                  (gx#stx-wrap-source
                   (let ((__tmp48818 (gx#datum->syntax '#f 'defrules))
                         (__tmp48787
                          (let ((__tmp48788
                                 (let ((__tmp48789
                                        (let ((__tmp48802
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                     (__tmp48803
                                                      (let ((__tmp48804
                                                             (let ((__tmp48807
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                            (let ((__tmp48813 (gx#datum->syntax '#f 'lambda))
                                  (__tmp48808
                                   (let ((__tmp48811
                                          (let ((__tmp48812
                                                 ...
                                                 (lambda (_g1756017579_
                                                   ...
                                                   (let ()
                                                     ...
                                                     (cons _g1756017579_
                                                           _g1756117582_)))))
                                            (declare (not safe))
                                            (foldr1 __tmp48810 '() _L17343_))))
                                     (declare (not safe))
                                     (cons __tmp48811 __tmp48809))))
                              (declare (not safe))
                              (cons __tmp48813 __tmp48808)))
                           (__tmp48805
                            (let ((__tmp48806
                              ...
                              (declare (not safe))
                              (foldr1 __tmp48806 '() _L17460_))))
                       (declare (not safe))
                       (cons __tmp48807 __tmp48805))))
                (declare (not safe))
                (cons __tmp48804 '()))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                 (declare (not safe))
                                                 (cons __tmp48814 __tmp48803)))
                                              (__tmp48790
                                               (let ((__tmp48791
                                                      (let ((__tmp48801
                                                             (gx#datum->syntax
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                 ...
                                                 (cons __tmp48791 '()))))
                                          (declare (not safe))
                                          (cons __tmp48802 __tmp48790))))
                                   (declare (not safe))
                                   (cons '() __tmp48789))))
                            (declare (not safe))
                            (cons _L17346_ __tmp48788))))
                     (declare (not safe))
                     (cons __tmp48818 __tmp48787))
                   (gx#stx-source _stx17206_))))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                   _xarg1741717456_))))))
        ...
        (let* ((___stx4424244243_ _$stx17614_)
          ...
          (let ((___kont4424544246_
                 (lambda (_L17769_ _L17771_)
                   (let ((__tmp48838 (gx#datum->syntax '#f 'defrules))
                         (__tmp48821
                          (let ((__tmp48822
                                 (let ((__tmp48823
                                        (let ((__tmp48824
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                    ...
                    (__tmp48826
                     (let ((__tmp48827
                            (let ((__tmp48829 (gx#datum->syntax '#f 'quote))
                                  (__tmp48828
                                   (let ()
                                     (declare (not safe))
                                     (cons _L17769_ '()))))
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                   ...
                                   (cons '() __tmp48823))))
                            (declare (not safe))
                            (cons _L17771_ __tmp48822))))
                     (declare (not safe))
                     (cons __tmp48838 __tmp48821))))
                (___kont4424744248_
                   ...
                   (let ((__tmp48839
                          (let ((__tmp48840
                                 (let ((__tmp48841
                                   ...
                                   (cons __tmp48841 '()))))
                            (declare (not safe))
                            (cons _L17694_ __tmp48840))))
                     (declare (not safe))
                     (cons _L17695_ __tmp48839)))))
                                            ...
                                            (let ((_tl1763217756_
                                              ...
                                              (if (gx#identifier?
                                                  ...
                                                  (if (gx#free-identifier=?
                                                       |gerbil/core$<sugar>$<sugar:3>[1]#_g48844_|
                                                       _hd1763317753_)
                                                      (if (gx#stx-pair?
                                                           _tl1763217756_)
                                                          (let ((_e1763717759_
