...
(begin
  (define |gerbil/core$<sugar>$<sugar:3>[1]#_g51065_|
    (##structure
     gx#syntax-quote::t
     'quote
     #f
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                 (declare (not safe))
                                                 (cons _L17172_ __tmp50994))))
                                          (declare (not safe))
                                          (cons __tmp50995 __tmp50993))))
                                   (declare (not safe))
                                   (cons __tmp50992 '()))))
                            (declare (not safe))
                            (cons _L17173_ __tmp50991))))
                     (declare (not safe))
                     (cons __tmp50996 __tmp50990))))
                (___kont4647346474_
                 (lambda (_L17084_ _L17086_)
                   (let ((__tmp50999 (gx#datum->syntax '#f 'define-syntax))
                         (__tmp50997
                          (let ((__tmp50998
                                 (let ()
                                   (declare (not safe))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                         (not safe))
                       (##fx= _g51001_ 2)))
                (error "Context expects 2 values" _g51001_)))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                      ...
                                      (let ((_g51002_
                                        ...
                                        (begin
                                          ...
                                          (let ((_target1723217313_
                                                 (let ()
                                                   (declare (not safe))
                                                   (##vector-ref _g51002_ 0)))
                                                (_tl1723417316_
                                                 (let ()
                                                   (declare (not safe))
                                                   (##vector-ref _g51002_ 1))))
                        ...
                        (begin
                          (let ((_g51005_
                                 (let ()
                                   (declare (not safe))
                                   (if (##values? _g51004_)
                                       (##vector-length _g51004_)
                                       1))))
                            (if (not (let ()
                                       (declare (not safe))
                                       (##fx= _g51005_ 2)))
                                (error "Context expects 2 values" _g51005_)))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                        ...
                        (cons _L17492_ '()))))
                 (declare (not safe))
                 (cons _L17520_ __tmp51007))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                  (declare (not safe))
                                                  (cons __tmp51008 __tmp51006))
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                           (declare (not safe))
                                           (cons __tmp51011 __tmp51010))))
                                    (declare (not safe))
                                    (cons __tmp51013 __tmp51009))
                                  (gx#stx-source _stx17206_))))))
                          _g1747817489_))))
                 (_g1747617555_
                  (gx#stx-wrap-source
                   (let ((__tmp51041 (gx#datum->syntax '#f 'defrules))
                         (__tmp51014
                          (let ((__tmp51015
                                 (let ((__tmp51016
                                        (let ((__tmp51029
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                     (__tmp51030
                                                      (let ((__tmp51031
                                                             (let ((__tmp51033
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                            (let ((__tmp51037 (gx#datum->syntax '#f 'lambda))
                                  (__tmp51034
                                   (let ((__tmp51036
                                         ...
                                         (__tmp51035
                                          (foldr (lambda (_g1756017579_
                                                 ...
                                                 _L17343_)))
                                     (declare (not safe))
                                     (cons __tmp51036 __tmp51035))))
                              (declare (not safe))
                              (cons __tmp51037 __tmp51034)))
                           (__tmp51032
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                ...
                (declare (not safe))
                (cons __tmp51028 __tmp51019))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                 (declare (not safe))
                                                 (cons __tmp51018 '()))))
                                          (declare (not safe))
                                          (cons __tmp51029 __tmp51017))))
                                   (declare (not safe))
                                   (cons '() __tmp51016))))
                            (declare (not safe))
                            (cons _L17346_ __tmp51015))))
                     (declare (not safe))
                     (cons __tmp51041 __tmp51014))
                   (gx#stx-source _stx17206_))))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                   _xarg1741717456_))))))
        ...
        (let* ((___stx4652446525_ _$stx17614_)
          ...
          (let ((___kont4652746528_
                 (lambda (_L17769_ _L17771_)
                   (let ((__tmp51059 (gx#datum->syntax '#f 'defrules))
                         (__tmp51042
                          (let ((__tmp51043
                                 (let ((__tmp51044
                                        (let ((__tmp51045
                                   ...
                                   (let ((__tmp51056
                                         ...
                                         (__tmp51054
                                          (let ((__tmp51055
                                            ...
                                            (cons __tmp51055 '()))))
                                     (declare (not safe))
                                     (cons __tmp51056 __tmp51054))))
                              (declare (not safe))
                              (cons __tmp51053 '()))))
                       (declare (not safe))
                       (cons __tmp51057 __tmp51052)))
                    (__tmp51047
                     (let ((__tmp51048
                            (let ((__tmp51050 (gx#datum->syntax '#f 'quote))
                                  (__tmp51049
                                   (let ()
                                     (declare (not safe))
                                     (cons _L17769_ '()))))
                              (declare (not safe))
                              (cons __tmp51050 __tmp51049))))
                       (declare (not safe))
                       (cons __tmp51048 '()))))
                (declare (not safe))
                (cons __tmp51051 __tmp51047))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                 (declare (not safe))
                                                 (cons __tmp51058
                                                       __tmp51046))))
                                   ...
                                   (cons '() __tmp51044))))
                            (declare (not safe))
                            (cons _L17771_ __tmp51043))))
                     (declare (not safe))
                     (cons __tmp51059 __tmp51042))))
                (___kont4652946530_
                   ...
                   (let ((__tmp51060
                          (let ((__tmp51061
                                 (let ((__tmp51062
                                   ...
                                   (cons __tmp51062 '()))))
                            (declare (not safe))
                            (cons _L17694_ __tmp51061))))
                     (declare (not safe))
                     (cons _L17695_ __tmp51060)))))
                                            ...
                                            (let ((_tl1763217756_
                                              ...
                                              (if (gx#identifier?
                                                  ...
                                                  (if (gx#free-identifier=?
                                                       |gerbil/core$<sugar>$<sugar:3>[1]#_g51065_|
                                                       _hd1763317753_)
                                                      (if (gx#stx-pair?
                                                           _tl1763217756_)
                                                          (let ((_e1763717759_
