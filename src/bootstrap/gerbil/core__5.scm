...
(begin
  (define |gerbil/core$<sugar>$<sugar:3>[1]#_g42700_|
    (##structure
     gx#syntax-quote::t
     'quote
     #f
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                         (not safe))
                       (##fx= _g42695_ 2)))
                (error "Context expects 2 values" _g42695_)))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                      ...
                                      (let ((_g42696_
                                        ...
                                        (begin
                                          ...
                                          (let ((_target1722617307_
                                                 (let ()
                                                   (declare (not safe))
                                                   (##vector-ref _g42696_ 0)))
                                                (_tl1722817310_
                                                 (let ()
                                                   (declare (not safe))
                                                   (##vector-ref _g42696_ 1))))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                        ...
                        (begin
                          ...
                          (let ((_target1740317424_
                                 (let ()
                                   (declare (not safe))
                                   (##vector-ref _g42698_ 0)))
                                (_tl1740517427_
                                 (let ()
                                   (declare (not safe))
                                   (##vector-ref _g42698_ 1))))
                                            ...
                                            (let ((_tl1762617750_
                                              ...
                                              (if (gx#identifier?
                                                  ...
                                                  (if (gx#free-identifier=?
                                                       |gerbil/core$<sugar>$<sugar:3>[1]#_g42700_|
                                                       _hd1762717747_)
                                                      (if (gx#stx-pair?
                                                           _tl1762617750_)
                                                          (let ((_e1763117753_
