...
(begin
  (define |gerbil/core$<sugar>$<sugar:3>[1]#_g51112_|
    (##structure
     gx#syntax-quote::t
     'quote
     #f
        ...
        (let* ((___stx4646546466_ _$stx17003_)
          ...
          (let ((___kont4646846469_
                 (lambda (_L17170_ _L17172_ _L17173_)
                   (let ((__tmp51043 (gx#datum->syntax '#f 'define-syntax))
                         (__tmp51037
                          (let ((__tmp51038
                                 (let ((__tmp51039
                                        (let ((__tmp51042
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                 (declare (not safe))
                                                 (cons _L17172_ __tmp51041))))
                                          (declare (not safe))
                                          (cons __tmp51042 __tmp51040))))
                                   (declare (not safe))
                                   (cons __tmp51039 '()))))
                            (declare (not safe))
                            (cons _L17173_ __tmp51038))))
                     (declare (not safe))
                     (cons __tmp51043 __tmp51037))))
                (___kont4647246473_
                 (lambda (_L17084_ _L17086_)
                   (let ((__tmp51046 (gx#datum->syntax '#f 'define-syntax))
                         (__tmp51044
                          (let ((__tmp51045
                                 (let ()
                                   (declare (not safe))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                        ...
                        (begin
                          ...
                          (let ((_target1740917430_
                                 (let ()
                                   (declare (not safe))
                                   (##vector-ref _g51051_ 0)))
                                (_tl1741117433_
                                 (let ()
                                   (declare (not safe))
                                   (##vector-ref _g51051_ 1))))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                        ...
                        (cons _L17492_ '()))))
                 (declare (not safe))
                 (cons _L17520_ __tmp51054))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                  (declare (not safe))
                                                  (cons __tmp51055 __tmp51053))
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                    ...
                                    (declare (not safe))
                                    (cons __tmp51060 __tmp51056))
                                  (gx#stx-source _stx17206_))))))
                          _g1747817489_))))
                 (_g1747617555_
                  (gx#stx-wrap-source
                   (let ((__tmp51088 (gx#datum->syntax '#f 'defrules))
                         (__tmp51061
                          (let ((__tmp51062
                                 (let ((__tmp51063
                                        (let ((__tmp51076
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                            ...
                            _L17460_)))
                (declare (not safe))
                (cons __tmp51087 __tmp51086)))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                     (__tmp51077
                                                      (let ((__tmp51078
                                                             (let ((__tmp51080
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                            (let ((__tmp51084 (gx#datum->syntax '#f 'lambda))
                                  (__tmp51081
                                   (let ((__tmp51083
                           ...
                           (__tmp51079
                            (foldr (lambda (_g1755817585_ _g1755917588_)
                                   ...
                                   _L17460_)))
                       (declare (not safe))
                       (cons __tmp51080 __tmp51079))))
                (declare (not safe))
                (cons __tmp51078 '()))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                 (declare (not safe))
                                                 (cons __tmp51085 __tmp51077)))
                                              (__tmp51064
                                               (let ((__tmp51065
                                                      (let ((__tmp51075
                                                             (gx#datum->syntax
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                ...
                (declare (not safe))
                (cons __tmp51075 __tmp51066))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                 (declare (not safe))
                                                 (cons __tmp51065 '()))))
                                          (declare (not safe))
                                          (cons __tmp51076 __tmp51064))))
                                   (declare (not safe))
                                   (cons '() __tmp51063))))
                            (declare (not safe))
                            (cons _L17346_ __tmp51062))))
                     (declare (not safe))
                     (cons __tmp51088 __tmp51061))
                   (gx#stx-source _stx17206_))))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                   _xarg1741717456_))))))
        ...
        (let* ((___stx4652346524_ _$stx17614_)
          ...
          (let ((___kont4652646527_
                 (lambda (_L17769_ _L17771_)
                   (let ((__tmp51106 (gx#datum->syntax '#f 'defrules))
                         (__tmp51089
                          (let ((__tmp51090
                                 (let ((__tmp51091
                                        (let ((__tmp51092
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                   ...
                                   (cons '() __tmp51091))))
                            (declare (not safe))
                            (cons _L17771_ __tmp51090))))
                     (declare (not safe))
                     (cons __tmp51106 __tmp51089))))
                (___kont4652846529_
                   ...
                   (let ((__tmp51107
                          (let ((__tmp51108
                                 (let ((__tmp51109
                                   ...
                                   (cons __tmp51109 '()))))
                            (declare (not safe))
                            (cons _L17694_ __tmp51108))))
                     (declare (not safe))
                     (cons _L17695_ __tmp51107)))))
                                            ...
                                            (let ((_tl1763217756_
                                              ...
                                              (if (gx#identifier?
                                                  ...
                                                  (if (gx#free-identifier=?
                                                       |gerbil/core$<sugar>$<sugar:3>[1]#_g51112_|
                                                       _hd1763317753_)
                                                      (if (gx#stx-pair?
                                                           _tl1763217756_)
                                                          (let ((_e1763717759_
