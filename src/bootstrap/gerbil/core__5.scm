...
(begin
  (define |gerbil/core$<sugar>$<sugar:3>[1]#_g48915_|
    (##structure
     gx#syntax-quote::t
     'quote
     #f
        ...
        (let* ((___stx4409444095_ _$stx17003_)
          ...
          (let ((___kont4409744098_
                 (lambda (_L17170_ _L17172_ _L17173_)
                   (let ((__tmp48838 (gx#datum->syntax '#f 'define-syntax))
                         (__tmp48831
                          (let ((__tmp48832
                                 (let ((__tmp48833
                                        (let ((__tmp48837
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                ...
                (declare (not safe))
                (foldr1 __tmp48836 '() _L17170_))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                 (declare (not safe))
                                                 (cons _L17172_ __tmp48835))))
                                          (declare (not safe))
                                          (cons __tmp48837 __tmp48834))))
                                   (declare (not safe))
                                   (cons __tmp48833 '()))))
                            (declare (not safe))
                            (cons _L17173_ __tmp48832))))
                     (declare (not safe))
                     (cons __tmp48838 __tmp48831))))
                (___kont4410144102_
                 (lambda (_L17084_ _L17086_)
                   (let ((__tmp48841 (gx#datum->syntax '#f 'define-syntax))
                         (__tmp48839
                          (let ((__tmp48840
                                 (let ()
                                   (declare (not safe))
                                   (cons _L17084_ '()))))
                            (declare (not safe))
                            (cons _L17086_ __tmp48840))))
                     (declare (not safe))
                     (cons __tmp48841 __tmp48839)))))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                         (not safe))
                       (##fx= _g48843_ 2)))
                (error "Context expects 2 values" _g48843_)))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                      ...
                                      (let ((_g48844_
                                        ...
                                        (begin
                                          ...
                                          (let ((_target1723217313_
                                                 (let ()
                                                   (declare (not safe))
                                                   (##vector-ref _g48844_ 0)))
                                                (_tl1723417316_
                                                 (let ()
                                                   (declare (not safe))
                                                   (##vector-ref _g48844_ 1))))
                        ...
                        (begin
                          (let ((_g48847_
                                 (let ()
                                   (declare (not safe))
                                   (if (##values? _g48846_)
                                       (##vector-length _g48846_)
                                       1))))
                            (if (not (let ()
                                       (declare (not safe))
                                       (##fx= _g48847_ 2)))
                                (error "Context expects 2 values" _g48847_)))
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                  ...
                                                  (foldr1 __tmp48853
                                                          ...
                                                          _L17343_))))
                                           (declare (not safe))
                                           (cons __tmp48854 __tmp48852))))
                                    (declare (not safe))
                                    (cons __tmp48857 __tmp48851))
                                  (gx#stx-source _stx17206_))))))
                          _g1747817489_))))
                 (_g1747617555_
                  (gx#stx-wrap-source
                   (let ((__tmp48889 (gx#datum->syntax '#f 'defrules))
                         (__tmp48858
                          (let ((__tmp48859
                                 (let ((__tmp48860
                                        (let ((__tmp48873
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                       ...
                       (declare (not safe))
                       (foldr1 __tmp48887 '() _L17460_))))
                (declare (not safe))
                (cons __tmp48888 __tmp48886)))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                     (__tmp48874
                                                      (let ((__tmp48875
                                                             (let ((__tmp48878
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                            (let ((__tmp48884 (gx#datum->syntax '#f 'lambda))
                                  (__tmp48879
                                   (let ((__tmp48882
                                          (let ((__tmp48883
                                                 ...
                                                 (lambda (_g1756017579_
                                                   ...
                                                   (let ()
                                                     ...
                                                     (cons _g1756017579_
                                                           _g1756117582_)))))
                                            (declare (not safe))
                                            (foldr1 __tmp48881 '() _L17343_))))
                                     (declare (not safe))
                                     (cons __tmp48882 __tmp48880))))
                              (declare (not safe))
                              (cons __tmp48884 __tmp48879)))
                           (__tmp48876
                            (let ((__tmp48877
                            ...
                            (let ((__tmp48871
                                  ...
                                  (__tmp48866
                                   (let ((__tmp48867
                                     ...
                                     (cons __tmp48867 '()))))
                              (declare (not safe))
                              (cons __tmp48871 __tmp48866)))
                           (__tmp48864
                            (let () (declare (not safe)) (cons _L17394_ '()))))
                       (declare (not safe))
                       (cons __tmp48865 __tmp48864))))
                (declare (not safe))
                (cons __tmp48872 __tmp48863))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                 (declare (not safe))
                                                 (cons __tmp48862 '()))))
                                          (declare (not safe))
                                          (cons __tmp48873 __tmp48861))))
                                   (declare (not safe))
                                   (cons '() __tmp48860))))
                            (declare (not safe))
                            (cons _L17346_ __tmp48859))))
                     (declare (not safe))
                     (cons __tmp48889 __tmp48858))
                   (gx#stx-source _stx17206_))))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                   _xarg1741717456_))))))
        ...
        (let* ((___stx4415244153_ _$stx17614_)
          ...
          (let ((___kont4415544156_
                 (lambda (_L17769_ _L17771_)
                   (let ((__tmp48909 (gx#datum->syntax '#f 'defrules))
                         (__tmp48892
                          (let ((__tmp48893
                                 (let ((__tmp48894
                                        (let ((__tmp48895
                                   ...
                                   (let ((__tmp48906
                                         ...
                                         (__tmp48904
                                          (let ((__tmp48905
                                            ...
                                            (cons __tmp48905 '()))))
                                     (declare (not safe))
                                     (cons __tmp48906 __tmp48904))))
                              (declare (not safe))
                              (cons __tmp48903 '()))))
                       (declare (not safe))
                       (cons __tmp48907 __tmp48902)))
                    (__tmp48897
                     (let ((__tmp48898
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                   ...
                                   (cons '() __tmp48894))))
                            (declare (not safe))
                            (cons _L17771_ __tmp48893))))
                     (declare (not safe))
                     (cons __tmp48909 __tmp48892))))
                (___kont4415744158_
                                        ...
                                        (let ((__tmp48914
                                              ...
                                              (__tmp48913
                                               (let ()
                                                 ...
                                                 (cons _L17692_ '()))))
                                          (declare (not safe))
                                          (cons __tmp48914 __tmp48913))))
                                   (declare (not safe))
                                   (cons __tmp48912 '()))))
                            (declare (not safe))
                            (cons _L17694_ __tmp48911))))
                     (declare (not safe))
                     (cons _L17695_ __tmp48910)))))
                                            ...
                                            (let ((_tl1763217756_
                                              ...
                                              (if (gx#identifier?
                                                  ...
                                                  (if (gx#free-identifier=?
                                                       |gerbil/core$<sugar>$<sugar:3>[1]#_g48915_|
                                                       _hd1763317753_)
                                                      (if (gx#stx-pair?
                                                           _tl1763217756_)
                                                          (let ((_e1763717759_
