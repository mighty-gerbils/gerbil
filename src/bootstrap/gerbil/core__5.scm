...
(begin
  (define |gerbil/core$<sugar>$<sugar:3>[1]#_g49054_|
    (##structure
     gx#syntax-quote::t
     'quote
     #f
        ...
        (let* ((___stx4436144362_ _$stx17003_)
          ...
          (let ((___kont4436444365_
                 (lambda (_L17170_ _L17172_ _L17173_)
                   (let ((__tmp48977 (gx#datum->syntax '#f 'define-syntax))
                         (__tmp48970
                          (let ((__tmp48971
                                 (let ((__tmp48972
                                        (let ((__tmp48976
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                ...
                (declare (not safe))
                (foldr1 __tmp48975 '() _L17170_))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                 (declare (not safe))
                                                 (cons _L17172_ __tmp48974))))
                                          (declare (not safe))
                                          (cons __tmp48976 __tmp48973))))
                                   (declare (not safe))
                                   (cons __tmp48972 '()))))
                            (declare (not safe))
                            (cons _L17173_ __tmp48971))))
                     (declare (not safe))
                     (cons __tmp48977 __tmp48970))))
                (___kont4436844369_
                 (lambda (_L17084_ _L17086_)
                   (let ((__tmp48980 (gx#datum->syntax '#f 'define-syntax))
                         (__tmp48978
                          (let ((__tmp48979
                                 (let ()
                                   (declare (not safe))
                                   (cons _L17084_ '()))))
                            (declare (not safe))
                            (cons _L17086_ __tmp48979))))
                     (declare (not safe))
                     (cons __tmp48980 __tmp48978)))))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                         (not safe))
                       (##fx= _g48982_ 2)))
                (error "Context expects 2 values" _g48982_)))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                        ...
                        (begin
                          (let ((_g48986_
                            ...
                            (if (not (let ()
                                       (declare (not safe))
                                       (##fx= _g48986_ 2)))
                                (error "Context expects 2 values" _g48986_)))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                        ...
                        (cons _L17492_ '()))))
                 (declare (not safe))
                 (cons _L17520_ __tmp48988))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                  (declare (not safe))
                                                  (cons __tmp48989 __tmp48987))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                 ...
                 (declare (not safe))
                 (foldr1 __tmp48995 '() _L17345_))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                  (declare (not safe))
                                                  (cons _L17394_ __tmp48994)))
                                               (__tmp48991
                                                (let ((__tmp48992
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                    ...
                                    (declare (not safe))
                                    (cons __tmp48996 __tmp48990))
                                  (gx#stx-source _stx17206_))))))
                          _g1747817489_))))
                 (_g1747617555_
                  (gx#stx-wrap-source
                   (let ((__tmp49028 (gx#datum->syntax '#f 'defrules))
                         (__tmp48997
                          (let ((__tmp48998
                                 (let ((__tmp48999
                                        (let ((__tmp49012
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                       ...
                       (declare (not safe))
                       (foldr1 __tmp49026 '() _L17460_))))
                (declare (not safe))
                (cons __tmp49027 __tmp49025)))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                     (__tmp49013
                                                      (let ((__tmp49014
                                                             (let ((__tmp49017
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                            (let ((__tmp49023 (gx#datum->syntax '#f 'lambda))
                                  (__tmp49018
                                   (let ((__tmp49021
                                          (let ((__tmp49022
                                                 ...
                                                 (lambda (_g1756017579_
                                                   ...
                                                   (let ()
                                                     ...
                                                     (cons _g1756017579_
                                                           _g1756117582_)))))
                                            (declare (not safe))
                                            (foldr1 __tmp49020 '() _L17343_))))
                                     (declare (not safe))
                                     (cons __tmp49021 __tmp49019))))
                              (declare (not safe))
                              (cons __tmp49023 __tmp49018)))
                           (__tmp49015
                            (let ((__tmp49016
                              ...
                              (declare (not safe))
                              (foldr1 __tmp49016 '() _L17460_))))
                       (declare (not safe))
                       (cons __tmp49017 __tmp49015))))
                (declare (not safe))
                (cons __tmp49014 '()))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                 (declare (not safe))
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                ...
                (declare (not safe))
                (cons __tmp49011 __tmp49002))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                 (declare (not safe))
                                                 (cons __tmp49001 '()))))
                                          (declare (not safe))
                                          (cons __tmp49012 __tmp49000))))
                                   (declare (not safe))
                                   (cons '() __tmp48999))))
                            (declare (not safe))
                            (cons _L17346_ __tmp48998))))
                     (declare (not safe))
                     (cons __tmp49028 __tmp48997))
                   (gx#stx-source _stx17206_))))))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                   _xarg1741717456_))))))
        ...
        (let* ((___stx4441944420_ _$stx17614_)
          ...
          (let ((___kont4442244423_
                 (lambda (_L17769_ _L17771_)
                   (let ((__tmp49048 (gx#datum->syntax '#f 'defrules))
                         (__tmp49031
                          (let ((__tmp49032
                                 (let ((__tmp49033
                                        (let ((__tmp49034
                                   ...
                                   (let ((__tmp49045
                                         ...
                                         (__tmp49043
                                          (let ((__tmp49044
                                            ...
                                            (cons __tmp49044 '()))))
                                     (declare (not safe))
                                     (cons __tmp49045 __tmp49043))))
                              (declare (not safe))
                              (cons __tmp49042 '()))))
                       (declare (not safe))
                       (cons __tmp49046 __tmp49041)))
                    (__tmp49036
                     (let ((__tmp49037
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                   ...
                                   (cons '() __tmp49033))))
                            (declare (not safe))
                            (cons _L17771_ __tmp49032))))
                     (declare (not safe))
                     (cons __tmp49048 __tmp49031))))
                (___kont4442444425_
                                        ...
                                        (let ((__tmp49053
                                              ...
                                              (__tmp49052
                                               (let ()
                                                 ...
                                                 (cons _L17692_ '()))))
                                          (declare (not safe))
                                          (cons __tmp49053 __tmp49052))))
                                   (declare (not safe))
                                   (cons __tmp49051 '()))))
                            (declare (not safe))
                            (cons _L17694_ __tmp49050))))
                     (declare (not safe))
                     (cons _L17695_ __tmp49049)))))
                                            ...
                                            (let ((_tl1763217756_
                                              ...
                                              (if (gx#identifier?
                                                  ...
                                                  (if (gx#free-identifier=?
                                                       |gerbil/core$<sugar>$<sugar:3>[1]#_g49054_|
                                                       _hd1763317753_)
                                                      (if (gx#stx-pair?
                                                           _tl1763217756_)
                                                          (let ((_e1763717759_
